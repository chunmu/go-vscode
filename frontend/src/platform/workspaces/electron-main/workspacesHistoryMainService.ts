...
import { Emitter, Event as CommonEvent } from '../../../base/common/event.ts';
import { normalizeDriveLetter, splitRecentLabel } from '../../../base/common/labels.ts';
import { Disposable } from '../../../base/common/lifecycle.ts';
import { Schemas } from '../../../base/common/network.ts';
import { isMacintosh, isWindows } from '../../../base/common/platform.ts';
import { basename, extUriBiasedIgnorePathCase, originalFSPath } from '../../../base/common/resources.ts';
import { URI } from '../../../base/common/uri.ts';
import { Promises } from '../../../base/node/pfs.ts';
import { localize } from '../../../nls.ts';
import { createDecorator } from '../../instantiation/common/instantiation.ts';
import { ILifecycleMainService, LifecycleMainPhase } from '../../lifecycle/electron-main/lifecycleMainService.ts';
import { ILogService } from '../../log/common/log.ts';
import { StorageScope, StorageTarget } from '../../storage/common/storage.ts';
import { IApplicationStorageMainService } from '../../storage/electron-main/storageMainService.ts';
import { IRecent, IRecentFile, IRecentFolder, IRecentlyOpened, IRecentWorkspace, isRecentFile, isRecentFolder, isRecentWorkspace, restoreRecentlyOpened, toStoreData } from '../common/workspaces.ts';
import { IWorkspaceIdentifier, WORKSPACE_EXTENSION } from '../../workspace/common/workspace.ts';
import { IWorkspacesManagementMainService } from './workspacesManagementMainService.ts';
