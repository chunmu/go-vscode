...
import { AddFirstParameterToFunctions } from '../../../base/common/types.ts';
...
import { IEnterWorkspaceResult, IRecent, IRecentlyOpened, IWorkspaceFolderCreationData, IWorkspacesService } from '../common/workspaces.ts';
import { IWorkspaceIdentifier } from '../../workspace/common/workspace.ts';
import { IWorkspacesHistoryMainService } from './workspacesHistoryMainService.ts';
