...
import { isUNC, toSlashes } from '../../../../base/common/extpath.ts';
...
import { extUriBiasedIgnorePathCase } from '../../../../base/common/resources.ts';
...
import { IWorkspaceBackupInfo, IFolderBackupInfo } from '../../../backup/common/backup.ts';
import { IBackupMainService } from '../../../backup/electron-main/backup.ts';
import { IEmptyWindowBackupInfo } from '../../../backup/node/backup.ts';
import { INativeOpenDialogOptions } from '../../../dialogs/common/dialogs.ts';
import { IDialogMainService } from '../../../dialogs/electron-main/dialogMainService.ts';
import { EnvironmentMainService } from '../../../environment/electron-main/environmentMainService.ts';
...
import { SaveStrategy, StateService } from '../../../state/node/stateService.ts';
import { UriIdentityService } from '../../../uriIdentity/common/uriIdentityService.ts';
import { UserDataProfilesMainService } from '../../../userDataProfile/electron-main/userDataProfile.ts';
import { IRawFileWorkspaceFolder, IRawUriWorkspaceFolder, WORKSPACE_EXTENSION } from '../../../workspace/common/workspace.ts';
import { IStoredWorkspace, IStoredWorkspaceFolder, IWorkspaceFolderCreationData, rewriteWorkspaceFileForNewLocation } from '../../common/workspaces.ts';
import { WorkspacesManagementMainService } from '../../electron-main/workspacesManagementMainService.ts';
