...
import { COI, FileAccess, Schemas, CacheControlheaders, DocumentPolicyheaders } from '../../../base/common/network.ts';
...
import { IIPCObjectUrl, IProtocolMainService } from './protocol.ts';
