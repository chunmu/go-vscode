...
import { isChrome, isEdge, isFirefox, isLinux, isMacintosh, isSafari, isWeb, isWindows } from '../../../base/common/platform.ts';
import { isFalsyOrWhitespace } from '../../../base/common/strings.ts';
import { Scanner, LexingError, Token, TokenType } from './scanner.ts';
