...
import { Disposable, IDisposable, isDisposable } from '../../../base/common/lifecycle.ts';
import { Schemas } from '../../../base/common/network.ts';
import Severity from '../../../base/common/severity.ts';
import { URI } from '../../../base/common/uri.ts';
import * as nls from '../../../nls.ts';
import { IDialogService } from '../../dialogs/common/dialogs.ts';
...
import { IPastFutureElements, IResourceUndoRedoElement, IUndoRedoElement, IUndoRedoService, IWorkspaceUndoRedoElement, ResourceEditStackSnapshot, UndoRedoElementType, UndoRedoGroup, UndoRedoSource, UriComparisonKeyComputer } from './undoRedo.ts';
