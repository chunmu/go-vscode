...
import { isEqualOrParent, joinPath } from '../../../base/common/resources.ts';
...
import { IExtensionManifest, parseApiProposals } from './extensions.ts';
import { allApiProposals } from './extensionsApiProposals.ts';
