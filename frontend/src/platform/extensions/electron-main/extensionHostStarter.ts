...
import { IExtensionHostProcessOptions, IExtensionHostStarter } from '../common/extensionHostStarter.ts';
...
import { WindowUtilityProcess } from '../../utilityProcess/electron-main/utilityProcess.ts';
