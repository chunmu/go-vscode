...
import { importAMDNodeModule, resolveAmdNodeModulePath } from '../../../amdX.ts';
...
import { AbstractSignService, IVsdaValidator } from '../common/abstractSignService.ts';
import { ISignService } from '../common/sign.ts';
