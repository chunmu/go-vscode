...
import { dirname, isEqual, joinPath } from '../../../../base/common/resources.ts';
...
import { AbstractNativeEnvironmentService } from '../../../environment/common/environmentService.ts';
import { FileService } from '../../../files/common/fileService.ts';
import { FileChangeType, FileSystemProviderCapabilities, FileType, IFileChange, IFileOpenOptions, IFileReadStreamOptions, IFileService, IFileSystemProviderWithFileReadStreamCapability, IFileSystemProviderWithFileReadWriteCapability, IFileSystemProviderWithOpenReadWriteCloseCapability, IStat } from '../../../files/common/files.ts';
...
import { FileUserDataProvider } from '../../common/fileUserDataProvider.ts';
