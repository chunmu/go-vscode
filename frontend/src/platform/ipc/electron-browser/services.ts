...
import { IChannel, ProxyChannel } from '../../../base/parts/ipc/common/ipc.ts';
import { SyncDescriptor } from '../../instantiation/common/descriptors.ts';
import { registerSingleton } from '../../instantiation/common/extensions.ts';
import { createDecorator, IInstantiationService, ServiceIdentifier } from '../../instantiation/common/instantiation.ts';
import { IMainProcessService } from '../common/mainProcessService.ts';
import { IRemoteService } from '../common/services.ts';
