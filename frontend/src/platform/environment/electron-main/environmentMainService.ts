...
import { createStaticIPCHandle } from '../../../base/parts/ipc/node/ipc.net.ts';
import { IEnvironmentService, INativeEnvironmentService } from '../common/environment.ts';
import { NativeEnvironmentService } from '../node/environmentService.ts';
