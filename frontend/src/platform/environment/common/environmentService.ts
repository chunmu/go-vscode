...
import { dirname, join, normalize, resolve } from '../../../base/common/path.ts';
import { env } from '../../../base/common/process.ts';
import { joinPath } from '../../../base/common/resources.ts';
import { URI } from '../../../base/common/uri.ts';
import { NativeParsedArgs } from './argv.ts';
import { ExtensionKind, IExtensionHostDebugParams, INativeEnvironmentService } from './environment.ts';
