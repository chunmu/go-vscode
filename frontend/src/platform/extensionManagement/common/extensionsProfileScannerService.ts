...
import { Metadata, isIExtensionIdentifier } from './extensionManagement.ts';
import { areSameExtensions } from './extensionManagementUtil.ts';
import { IExtension, IExtensionIdentifier } from '../../extensions/common/extensions.ts';
...
import { Mutable, isObject, isString, isUndefined } from '../../../base/common/types.ts';
