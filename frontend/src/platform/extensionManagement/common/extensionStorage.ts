...
import { IProfileStorageValueChangeEvent, IStorageService, StorageScope, StorageTarget } from '../../storage/common/storage.ts';
import { adoptToGalleryExtensionId, areSameExtensions, getExtensionId } from './extensionManagementUtil.ts';
...
import { IExtension } from '../../extensions/common/extensions.ts';
import { isString } from '../../../base/common/types.ts';
import { IStringDictionary } from '../../../base/common/collections.ts';
import { IExtensionManagementService, IGalleryExtension } from './extensionManagement.ts';
