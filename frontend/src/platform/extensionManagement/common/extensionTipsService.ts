...
import { IConfigBasedExtensionTip as IRawConfigBasedExtensionTip } from '../../../base/common/product.ts';
import { joinPath } from '../../../base/common/resources.ts';
import { URI } from '../../../base/common/uri.ts';
import { IConfigBasedExtensionTip, IExecutableBasedExtensionTip, IExtensionManagementService, IExtensionTipsService, ILocalExtension } from './extensionManagement.ts';
...
import { areSameExtensions } from './extensionManagementUtil.ts';
import { IExtensionRecommendationNotificationService, RecommendationsNotificationResult, RecommendationSource } from '../../extensionRecommendations/common/extensionRecommendations.ts';
