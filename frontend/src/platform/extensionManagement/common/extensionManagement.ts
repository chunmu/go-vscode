...
import { FileOperationError, FileOperationResult, IFileService, IFileStat } from '../../files/common/files.ts';
import { createDecorator } from '../../instantiation/common/instantiation.ts';
import { Registry } from '../../registry/common/platform.ts';
import { IExtensionGalleryManifest } from './extensionGalleryManifest.ts';
