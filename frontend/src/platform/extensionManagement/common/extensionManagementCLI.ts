...
import { getErrorMessage, isCancellationError } from '../../../base/common/errors.ts';
import { Schemas } from '../../../base/common/network.ts';
import { basename } from '../../../base/common/resources.ts';
import { gt } from '../../../base/common/semver/semver.ts';
import { URI } from '../../../base/common/uri.ts';
import { localize } from '../../../nls.ts';
import { EXTENSION_IDENTIFIER_REGEX, IExtensionGalleryService, IExtensionInfo, IExtensionManagementService, IGalleryExtension, ILocalExtension, InstallOptions, InstallExtensionInfo, InstallOperation } from './extensionManagement.ts';
import { areSameExtensions, getExtensionId, getGalleryExtensionId, getIdAndVersion } from './extensionManagementUtil.ts';
import { ExtensionType, EXTENSION_CATEGORIES, IExtensionManifest } from '../../extensions/common/extensions.ts';
import { ILogger } from '../../log/common/log.ts';
