...
import { CancellationError, getErrorMessage, isCancellationError } from '../../../base/common/errors.ts';
import { IPager } from '../../../base/common/paging.ts';
import { isWeb, platform } from '../../../base/common/platform.ts';
import { arch } from '../../../base/common/process.ts';
import { isBoolean, isNumber, isString } from '../../../base/common/types.ts';
import { URI } from '../../../base/common/uri.ts';
import { IHeaders, IRequestContext, IRequestOptions, isOfflineError } from '../../../base/parts/request/common/request.ts';
...
import { getTargetPlatform, IExtensionGalleryService, IExtensionIdentifier, IExtensionInfo, IGalleryExtension, IGalleryExtensionAsset, IGalleryExtensionAssets, IGalleryExtensionVersion, InstallOperation, IQueryOptions, IExtensionsControlManifest, isNotWebExtensionInWebTargetPlatform, isTargetPlatformCompatible, ITranslation, SortOrder, StatisticType, toTargetPlatform, WEB_EXTENSION_TAG, IExtensionQueryOptions, IDeprecationInfo, ISearchPrefferedResults, ExtensionGalleryError, ExtensionGalleryErrorCode, IProductVersion, IAllowedExtensionsService, EXTENSION_IDENTIFIER_REGEX, SortBy, FilterType, MaliciousExtensionInfo, ExtensionRequestsTimeoutConfigKey } from './extensionManagement.ts';
import { adoptToGalleryExtensionId, areSameExtensions, getGalleryExtensionId, getGalleryExtensionTelemetryData } from './extensionManagementUtil.ts';
import { IExtensionManifest, TargetPlatform } from '../../extensions/common/extensions.ts';
import { areApiProposalsCompatible, isEngineValid } from '../../extensions/common/extensionValidator.ts';
...
import { asJson, asTextOrError, IRequestService, isClientError, isServerError, isSuccess } from '../../request/common/request.ts';
...
import { ExtensionGalleryResourceType, Flag, getExtensionGalleryManifestResourceUri, IExtensionGalleryManifest, IExtensionGalleryManifestService, ExtensionGalleryManifestStatus } from './extensionGalleryManifest.ts';
import { TelemetryTrustedValue } from '../../telemetry/common/telemetryUtils.ts';
