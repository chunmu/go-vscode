...
import { IExtensionIdentifier, IGalleryExtension, ILocalExtension, MaliciousExtensionInfo, getTargetPlatform } from './extensionManagement.ts';
import { ExtensionIdentifier, IExtension, TargetPlatform, UNDEFINED_PUBLISHER } from '../../extensions/common/extensions.ts';
import { IFileService } from '../../files/common/files.ts';
import { isLinux, platform } from '../../../base/common/platform.ts';
