...
import { IGalleryExtension, AllowedExtensionsConfigKey, IAllowedExtensionsService, AllowedExtensionsConfigValueType } from './extensionManagement.ts';
import { ExtensionType, IExtension, TargetPlatform } from '../../extensions/common/extensions.ts';
...
import { isBoolean, isObject, isUndefined } from '../../../base/common/types.ts';
