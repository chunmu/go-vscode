...
import { ILocalizedString } from '../../../action/common/action.ts';
import { IConfigurationNode } from '../../../configuration/common/configurationRegistry.ts';
import { localizeManifest } from '../../common/extensionNls.ts';
import { IExtensionManifest } from '../../../extensions/common/extensions.ts';
import { NullLogger } from '../../../log/common/log.ts';
