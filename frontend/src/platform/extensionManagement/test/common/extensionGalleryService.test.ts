...
import { isUUID } from '../../../../base/common/uuid.ts';
import { mock } from '../../../../base/test/common/mock.ts';
import { IConfigurationService } from '../../../configuration/common/configuration.ts';
import { TestConfigurationService } from '../../../configuration/test/common/testConfigurationService.ts';
import { IEnvironmentService } from '../../../environment/common/environment.ts';
import { IRawGalleryExtensionVersion, sortExtensionVersions, filterLatestExtensionVersionsForTargetPlatform } from '../../common/extensionGalleryService.ts';
...
import { TelemetryConfiguration, TELEMETRY_SETTING_ID } from '../../../telemetry/common/telemetry.ts';
