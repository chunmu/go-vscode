...
import { AllowedExtensionsService } from '../../common/allowedExtensionsService.ts';
...
import { AllowedExtensionsConfigKey, IGalleryExtension, ILocalExtension } from '../../common/extensionManagement.ts';
import { ExtensionType, IExtensionManifest, TargetPlatform } from '../../../extensions/common/extensions.ts';
import { Event } from '../../../../base/common/event.ts';
import { ConfigurationTarget } from '../../../configuration/common/configuration.ts';
