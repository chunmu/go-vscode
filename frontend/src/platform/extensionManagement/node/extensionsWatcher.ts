...
import { combinedDisposable, Disposable, DisposableMap } from '../../../base/common/lifecycle.ts';
import { ResourceSet } from '../../../base/common/map.ts';
import { URI } from '../../../base/common/uri.ts';
import { getIdAndVersion } from '../common/extensionManagementUtil.ts';
import { DidAddProfileExtensionsEvent, DidRemoveProfileExtensionsEvent, IExtensionsProfileScannerService, ProfileExtensionsEvent } from '../common/extensionsProfileScannerService.ts';
import { IExtensionsScannerService } from '../common/extensionsScannerService.ts';
import { INativeServerExtensionManagementService } from './extensionManagementService.ts';
import { ExtensionIdentifier, IExtension, IExtensionIdentifier } from '../../extensions/common/extensions.ts';
import { FileChangesEvent, FileChangeType, IFileService } from '../../files/common/files.ts';
