...
import { Promises as FSPromises } from '../../../base/node/pfs.ts';
import { buffer, CorruptZipMessage } from '../../../base/node/zip.ts';
import { INativeEnvironmentService } from '../../environment/common/environment.ts';
import { toExtensionManagementError } from '../common/abstractExtensionManagementService.ts';
import { ExtensionManagementError, ExtensionManagementErrorCode, ExtensionSignatureVerificationCode, IExtensionGalleryService, IGalleryExtension, InstallOperation } from '../common/extensionManagement.ts';
import { ExtensionKey, groupByExtension } from '../common/extensionManagementUtil.ts';
import { fromExtractError } from './extensionManagementUtil.ts';
import { IExtensionSignatureVerificationService } from './extensionSignatureVerificationService.ts';
import { TargetPlatform } from '../../extensions/common/extensions.ts';
import { FileOperationResult, IFileService, IFileStatWithMetadata, toFileOperationResult } from '../../files/common/files.ts';
