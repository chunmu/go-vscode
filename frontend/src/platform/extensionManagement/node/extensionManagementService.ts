...
import { Promises, Queue } from '../../../base/common/async.ts';
import { VSBuffer } from '../../../base/common/buffer.ts';
import { CancellationToken } from '../../../base/common/cancellation.ts';
import { IStringDictionary } from '../../../base/common/collections.ts';
import { CancellationError, getErrorMessage } from '../../../base/common/errors.ts';
...
import * as semver from '../../../base/common/semver/semver.ts';
import { isBoolean, isDefined, isUndefined } from '../../../base/common/types.ts';
import { URI } from '../../../base/common/uri.ts';
import { generateUuid } from '../../../base/common/uuid.ts';
import * as pfs from '../../../base/node/pfs.ts';
import { extract, IFile, zip } from '../../../base/node/zip.ts';
import * as nls from '../../../nls.ts';
import { IDownloadService } from '../../download/common/download.ts';
import { INativeEnvironmentService } from '../../environment/common/environment.ts';
import { AbstractExtensionManagementService, AbstractExtensionTask, IInstallExtensionTask, InstallExtensionTaskOptions, IUninstallExtensionTask, toExtensionManagementError, UninstallExtensionTaskOptions } from '../common/abstractExtensionManagementService.ts';
import {
...
} from '../common/extensionManagement.ts';
import { areSameExtensions, computeTargetPlatform, ExtensionKey, getGalleryExtensionId, groupByExtension } from '../common/extensionManagementUtil.ts';
import { IExtensionsProfileScannerService, IScannedProfileExtension } from '../common/extensionsProfileScannerService.ts';
import { IExtensionsScannerService, IScannedExtension, ManifestMetadata, UserExtensionsScanOptions } from '../common/extensionsScannerService.ts';
import { ExtensionsDownloader } from './extensionDownloader.ts';
import { ExtensionsLifecycle } from './extensionLifecycle.ts';
import { fromExtractError, getManifest } from './extensionManagementUtil.ts';
import { ExtensionsManifestCache } from './extensionsManifestCache.ts';
import { DidChangeProfileExtensionsEvent, ExtensionsWatcher } from './extensionsWatcher.ts';
import { ExtensionType, IExtension, IExtensionManifest, TargetPlatform } from '../../extensions/common/extensions.ts';
import { isEngineValid } from '../../extensions/common/extensionValidator.ts';
import { FileChangesEvent, FileChangeType, FileOperationResult, IFileService, IFileStat, toFileOperationResult } from '../../files/common/files.ts';
import { IInstantiationService, refineServiceDecorator } from '../../instantiation/common/instantiation.ts';
...
import { IExtensionGalleryManifestService } from '../common/extensionGalleryManifest.ts';
