...
import { INativeWindowConfiguration, IWindowSettings } from '../../window/common/window.ts';
import { IWindowsMainService } from './windows.ts';
import { defaultWindowState, ICodeWindow, IWindowState as IWindowUIState, WindowMode } from '../../window/electron-main/window.ts';
import { isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier } from '../../workspace/common/workspace.ts';
