...
import { addUNCHostToAllowlist } from '../../../base/node/unc.ts';
...
import { isWindowsDriveLetter, parseLineAndColumnAware, sanitizeFilePath, toSlashes } from '../../../base/common/extpath.ts';
import { getPathLabel } from '../../../base/common/labels.ts';
import { Disposable, DisposableStore, IDisposable } from '../../../base/common/lifecycle.ts';
import { Schemas } from '../../../base/common/network.ts';
import { basename, join, normalize, posix } from '../../../base/common/path.ts';
import { getMarks, mark } from '../../../base/common/performance.ts';
import { IProcessEnvironment, isMacintosh, isWindows, OS } from '../../../base/common/platform.ts';
import { cwd } from '../../../base/common/process.ts';
import { extUriBiasedIgnorePathCase, isEqualAuthority, normalizePath, originalFSPath, removeTrailingPathSeparator } from '../../../base/common/resources.ts';
import { assertReturnsDefined } from '../../../base/common/types.ts';
import { URI } from '../../../base/common/uri.ts';
import { getNLSLanguage, getNLSMessages, localize } from '../../../nls.ts';
import { IBackupMainService } from '../../backup/electron-main/backup.ts';
import { IEmptyWindowBackupInfo } from '../../backup/node/backup.ts';
import { IConfigurationService } from '../../configuration/common/configuration.ts';
import { IDialogMainService } from '../../dialogs/electron-main/dialogMainService.ts';
import { NativeParsedArgs } from '../../environment/common/argv.ts';
import { IEnvironmentMainService } from '../../environment/electron-main/environmentMainService.ts';
import { FileType, IFileService } from '../../files/common/files.ts';
...
import { IProtocolMainService } from '../../protocol/electron-main/protocol.ts';
import { getRemoteAuthority } from '../../remote/common/remoteHosts.ts';
import { IStateService } from '../../state/node/state.ts';
import { IAddRemoveFoldersRequest, INativeOpenFileRequest, INativeWindowConfiguration, IOpenEmptyWindowOptions, IPath, IPathsToWaitFor, isFileToOpen, isFolderToOpen, isWorkspaceToOpen, IWindowOpenable, IWindowSettings } from '../../window/common/window.ts';
import { CodeWindow } from './windowImpl.ts';
import { IOpenConfiguration, IOpenEmptyConfiguration, IWindowsCountChangedEvent, IWindowsMainService, OpenContext, getLastFocused } from './windows.ts';
import { findWindowOnExtensionDevelopmentPath, findWindowOnFile, findWindowOnWorkspaceOrFolder } from './windowsFinder.ts';
import { IWindowState, WindowsStateHandler } from './windowsStateHandler.ts';
import { IRecent } from '../../workspaces/common/workspaces.ts';
import { hasWorkspaceFileExtension, IAnyWorkspaceIdentifier, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier, toWorkspaceIdentifier } from '../../workspace/common/workspace.ts';
import { createEmptyWorkspaceIdentifier, getSingleFolderWorkspaceIdentifier, getWorkspaceIdentifier } from '../../workspaces/node/workspaces.ts';
import { IWorkspacesHistoryMainService } from '../../workspaces/electron-main/workspacesHistoryMainService.ts';
import { IWorkspacesManagementMainService } from '../../workspaces/electron-main/workspacesManagementMainService.ts';
import { ICodeWindow, UnloadReason } from '../../window/electron-main/window.ts';
import { IThemeMainService } from '../../theme/electron-main/themeMainService.ts';
import { IEditorOptions, ITextEditorOptions } from '../../editor/common/editor.ts';
import { IUserDataProfile } from '../../userDataProfile/common/userDataProfile.ts';
import { IPolicyService } from '../../policy/common/policy.ts';
import { IUserDataProfilesMainService } from '../../userDataProfile/electron-main/userDataProfile.ts';
import { ILoggerMainService } from '../../log/electron-main/loggerService.ts';
import { IAuxiliaryWindowsMainService } from '../../auxiliaryWindow/electron-main/auxiliaryWindows.ts';
import { IAuxiliaryWindow } from '../../auxiliaryWindow/electron-main/auxiliaryWindow.ts';
import { ICSSDevelopmentService } from '../../cssDev/node/cssDevService.ts';
