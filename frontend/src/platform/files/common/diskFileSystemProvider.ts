...
import { removeTrailingPathSeparator } from '../../../base/common/extpath.ts';
import { Disposable, IDisposable, toDisposable } from '../../../base/common/lifecycle.ts';
import { normalize } from '../../../base/common/path.ts';
import { URI } from '../../../base/common/uri.ts';
import { IFileChange, IFileSystemProvider, IWatchOptions } from './files.ts';
import { AbstractNonRecursiveWatcherClient, AbstractUniversalWatcherClient, ILogMessage, INonRecursiveWatchRequest, IRecursiveWatcherOptions, isRecursiveWatchRequest, IUniversalWatchRequest, reviveFileChanges } from './watcher.ts';
