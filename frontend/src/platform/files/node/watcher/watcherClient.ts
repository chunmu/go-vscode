...
import { getNextTickChannel, ProxyChannel } from '../../../../base/parts/ipc/common/ipc.ts';
import { Client } from '../../../../base/parts/ipc/node/ipc.cp.ts';
import { IFileChange } from '../../common/files.ts';
import { AbstractUniversalWatcherClient, ILogMessage, IUniversalWatcher } from '../../common/watcher.ts';
