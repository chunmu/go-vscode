...
import { RunOnceWorker, ThrottledWorker } from '../../../../../base/common/async.ts';
import { CancellationToken, CancellationTokenSource } from '../../../../../base/common/cancellation.ts';
import { isEqual, isEqualOrParent } from '../../../../../base/common/extpath.ts';
import { Disposable, DisposableStore, IDisposable, thenRegisterOrDispose, toDisposable } from '../../../../../base/common/lifecycle.ts';
import { normalizeNFC } from '../../../../../base/common/normalization.ts';
...
import { FileChangeFilter, FileChangeType, IFileChange } from '../../../common/files.ts';
import { ILogMessage, coalesceEvents, INonRecursiveWatchRequest, parseWatcherPatterns, IRecursiveWatcherWithSubscribe, isFiltered, isWatchRequestWithCorrelation } from '../../../common/watcher.ts';
import { Lazy } from '../../../../../base/common/lazy.ts';
import { ParsedPattern } from '../../../../../base/common/glob.ts';
