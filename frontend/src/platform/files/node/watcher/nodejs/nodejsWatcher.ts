...
import { patternsEquals } from '../../../../../base/common/glob.ts';
import { BaseWatcher } from '../baseWatcher.ts';
import { isLinux } from '../../../../../base/common/platform.ts';
import { INonRecursiveWatchRequest, INonRecursiveWatcher, IRecursiveWatcherWithSubscribe } from '../../../common/watcher.ts';
import { NodeJSFileWatcherLibrary } from './nodejsWatcherLib.ts';
import { ThrottledWorker } from '../../../../../base/common/async.ts';
