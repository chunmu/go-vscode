...
import { bufferToReadable, bufferToStream, VSBuffer } from '../../../../base/common/buffer.ts';
...
import { consumeStream, newWriteableStream, ReadableStreamEvents } from '../../../../base/common/stream.ts';
...
import { NullFileSystemProvider } from '../common/nullFileSystemProvider.ts';
