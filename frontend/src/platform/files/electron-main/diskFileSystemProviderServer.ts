...
import { IFileDeleteOptions, IFileChange, IWatchOptions, createFileSystemProviderError, FileSystemProviderErrorCode } from '../common/files.ts';
import { DiskFileSystemProvider } from '../node/diskFileSystemProvider.ts';
import { basename, normalize } from '../../../base/common/path.ts';
import { IDisposable } from '../../../base/common/lifecycle.ts';
import { ILogService } from '../../log/common/log.ts';
import { AbstractDiskFileSystemProviderChannel, AbstractSessionFileWatcher, ISessionFileWatcher } from '../node/diskFileSystemProviderServer.ts';
import { DefaultURITransformer, IURITransformer } from '../../../base/common/uriIpc.ts';
