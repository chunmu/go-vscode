...
import { basename, extname, normalize } from '../../../base/common/path.ts';
import { isLinux } from '../../../base/common/platform.ts';
import { extUri, extUriIgnorePathCase, joinPath } from '../../../base/common/resources.ts';
...
import { FileSystemObserverRecord, WebFileSystemAccess, WebFileSystemObserver } from './webFileSystemAccess.ts';
