...
import { upgradeToISocket } from '../../../base/parts/ipc/node/ipc.net.ts';
import { OPTIONS, parseArgs } from '../../environment/node/argv.ts';
import { IWindowsMainService, OpenContext } from '../../windows/electron-main/windows.ts';
import { IOpenExtensionWindowResult } from '../common/extensionHostDebug.ts';
import { ExtensionHostDebugBroadcastChannel } from '../common/extensionHostDebugIpc.ts';
