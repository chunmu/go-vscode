...
import { strictEquals } from '../../../base/common/equals.ts';
import { DisposableStore, IDisposable } from '../../../base/common/lifecycle.ts';
import { DebugLocation } from '../../../base/common/observable.ts';
// eslint-disable-next-line local/code-no-deep-import-of-internal
import { DebugNameData } from '../../../base/common/observableInternal/debugName.ts';
// eslint-disable-next-line local/code-no-deep-import-of-internal
import { ObservableValue } from '../../../base/common/observableInternal/observables/observableValue.ts';
