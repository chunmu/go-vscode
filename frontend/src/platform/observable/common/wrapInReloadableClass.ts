 ...
 *--------------------------------------------------------------------------------------------*/
import { isHotReloadEnabled } from '../../../base/common/hotReload.ts';
import { readHotReloadableExport } from '../../../base/common/hotReloadHelpers.ts';
import { IDisposable } from '../../../base/common/lifecycle.ts';
import { autorunWithStore } from '../../../base/common/observable.ts';
import { BrandedService, GetLeadingNonServiceArgs, IInstantiationService } from '../../instantiation/common/instantiation.ts';
