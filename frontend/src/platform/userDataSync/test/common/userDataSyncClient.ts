...
import { FormattingOptions } from '../../../../base/common/jsonFormatter.ts';
import { Disposable } from '../../../../base/common/lifecycle.ts';
import { Schemas } from '../../../../base/common/network.ts';
import { joinPath } from '../../../../base/common/resources.ts';
import { URI } from '../../../../base/common/uri.ts';
import { generateUuid } from '../../../../base/common/uuid.ts';
import { IHeaders, IRequestContext, IRequestOptions } from '../../../../base/parts/request/common/request.ts';
import { IConfigurationService } from '../../../configuration/common/configuration.ts';
import { ConfigurationService } from '../../../configuration/common/configurationService.ts';
import { IEnvironmentService } from '../../../environment/common/environment.ts';
import { GlobalExtensionEnablementService } from '../../../extensionManagement/common/extensionEnablementService.ts';
import { DidUninstallExtensionEvent, IExtensionGalleryService, IExtensionManagementService, IGlobalExtensionEnablementService, InstallExtensionResult } from '../../../extensionManagement/common/extensionManagement.ts';
import { IFileService } from '../../../files/common/files.ts';
import { FileService } from '../../../files/common/fileService.ts';
import { InMemoryFileSystemProvider } from '../../../files/common/inMemoryFilesystemProvider.ts';
import { TestInstantiationService } from '../../../instantiation/test/common/instantiationServiceMock.ts';
...
import { AuthInfo, Credentials, IRequestService } from '../../../request/common/request.ts';
import { InMemoryStorageService, IStorageService } from '../../../storage/common/storage.ts';
import { ITelemetryService } from '../../../telemetry/common/telemetry.ts';
import { NullTelemetryService } from '../../../telemetry/common/telemetryUtils.ts';
import { IUriIdentityService } from '../../../uriIdentity/common/uriIdentity.ts';
import { UriIdentityService } from '../../../uriIdentity/common/uriIdentityService.ts';
import { ExtensionStorageService, IExtensionStorageService } from '../../../extensionManagement/common/extensionStorage.ts';
import { IgnoredExtensionsManagementService, IIgnoredExtensionsManagementService } from '../../common/ignoredExtensions.ts';
...
import { IUserDataSyncAccountService, UserDataSyncAccountService } from '../../common/userDataSyncAccount.ts';
import { UserDataSyncLocalStoreService } from '../../common/userDataSyncLocalStoreService.ts';
import { IUserDataSyncMachinesService, UserDataSyncMachinesService } from '../../common/userDataSyncMachines.ts';
import { UserDataSyncEnablementService } from '../../common/userDataSyncEnablementService.ts';
import { UserDataSyncService } from '../../common/userDataSyncService.ts';
import { UserDataSyncStoreManagementService, UserDataSyncStoreService } from '../../common/userDataSyncStoreService.ts';
import { InMemoryUserDataProfilesService, IUserDataProfile, IUserDataProfilesService } from '../../../userDataProfile/common/userDataProfile.ts';
import { NullPolicyService } from '../../../policy/common/policy.ts';
import { IUserDataProfileStorageService } from '../../../userDataProfile/common/userDataProfileStorageService.ts';
import { TestUserDataProfileStorageService } from '../../../userDataProfile/test/common/userDataProfileStorageService.test.ts';
