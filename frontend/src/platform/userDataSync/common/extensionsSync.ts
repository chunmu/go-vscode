...
import { IUserDataProfile, IUserDataProfilesService } from '../../userDataProfile/common/userDataProfile.ts';
import { AbstractInitializer, AbstractSynchroniser, getSyncResourceLogLabel, IAcceptResult, IMergeResult, IResourcePreview } from './abstractSynchronizer.ts';
import { IMergeResult as IExtensionMergeResult, merge } from './extensionsMerge.ts';
import { IIgnoredExtensionsManagementService } from './ignoredExtensions.ts';
import { Change, IRemoteUserData, ISyncData, ISyncExtension, IUserDataSyncLocalStoreService, IUserDataSynchroniser, IUserDataSyncLogService, IUserDataSyncEnablementService, IUserDataSyncStoreService, SyncResource, USER_DATA_SYNC_SCHEME, ILocalSyncExtension } from './userDataSync.ts';
