...
import { ConfigurationTarget, IConfigurationService } from '../../configuration/common/configuration.ts';
import { ConfigurationModelParser } from '../../configuration/common/configurationModels.ts';
import { IEnvironmentService } from '../../environment/common/environment.ts';
import { IExtensionManagementService } from '../../extensionManagement/common/extensionManagement.ts';
import { ExtensionType } from '../../extensions/common/extensions.ts';
import { FileOperationError, FileOperationResult, IFileService } from '../../files/common/files.ts';
