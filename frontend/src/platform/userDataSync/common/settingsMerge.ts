...
import { JSONVisitor, parse, visit } from '../../../base/common/json.ts';
import { applyEdits, setProperty, withFormatting } from '../../../base/common/jsonEdit.ts';
import { Edit, FormattingOptions, getEOL } from '../../../base/common/jsonFormatter.ts';
import * as objects from '../../../base/common/objects.ts';
import { IConfigurationService } from '../../configuration/common/configuration.ts';
import * as contentUtil from './content.ts';
import { getDisallowedIgnoredSettings, IConflictSetting } from './userDataSync.ts';
