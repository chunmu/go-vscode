...
import { ISyncData, ISyncResourceHandle, IUserData, IUserDataSyncLocalStoreService, IUserDataSyncLogService, IUserDataSyncStoreService, SyncResource, UserDataSyncError, UserDataSyncErrorCode, USER_DATA_SYNC_SCHEME, IUserDataSyncResourceProviderService, ISyncUserDataProfile, CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM, IUserDataSyncResource } from './userDataSync.ts';
import { IUserDataProfile, IUserDataProfilesService } from '../../userDataProfile/common/userDataProfile.ts';
import { isSyncData } from './abstractSynchronizer.ts';
import { parseSnippets } from './snippetsSync.ts';
import { parseSettingsSyncContent } from './settingsSync.ts';
import { getKeybindingsContentFromSyncContent } from './keybindingsSync.ts';
import { IConfigurationService } from '../../configuration/common/configuration.ts';
import { getTasksContentFromSyncContent } from './tasksSync.ts';
import { getMcpContentFromSyncContent } from './mcpSync.ts';
import { LocalExtensionsProvider, parseExtensions, stringify as stringifyExtensions } from './extensionsSync.ts';
import { LocalGlobalStateProvider, stringify as stringifyGlobalState } from './globalStateSync.ts';
import { IInstantiationService } from '../../instantiation/common/instantiation.ts';
import { parseUserDataProfilesManifest, stringifyLocalProfiles } from './userDataProfilesManifestSync.ts';
import { toFormattedString } from '../../../base/common/jsonFormatter.ts';
import { trim } from '../../../base/common/strings.ts';
import { IMachinesData, IUserDataSyncMachine } from './userDataSyncMachines.ts';
import { parsePrompts } from './promptsSync/promptsSync.ts';
