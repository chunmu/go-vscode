...
import { allSettings, ConfigurationScope, Extensions as ConfigurationExtensions, IConfigurationRegistry, IRegisteredConfigurationPropertySchema, getAllConfigurationProperties, parseScope } from '../../configuration/common/configurationRegistry.ts';
import { IEnvironmentService } from '../../environment/common/environment.ts';
import { EXTENSION_IDENTIFIER_PATTERN, IExtensionIdentifier } from '../../extensionManagement/common/extensionManagement.ts';
import { IExtensionManifest } from '../../extensions/common/extensions.ts';
import { createDecorator } from '../../instantiation/common/instantiation.ts';
import { Extensions as JSONExtensions, IJSONContributionRegistry } from '../../jsonschemas/common/jsonContributionRegistry.ts';
import { ILogService } from '../../log/common/log.ts';
import { Registry } from '../../registry/common/platform.ts';
import { IUserDataProfile, UseDefaultProfileFlags } from '../../userDataProfile/common/userDataProfile.ts';
import { IUserDataSyncMachine } from './userDataSyncMachines.ts';
