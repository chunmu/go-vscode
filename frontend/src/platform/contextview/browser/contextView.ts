...
import { AnchorAlignment, AnchorAxisAlignment, IAnchor, IContextViewProvider } from '../../../base/browser/ui/contextview/contextview.ts';
import { IAction } from '../../../base/common/actions.ts';
import { Event } from '../../../base/common/event.ts';
import { IDisposable } from '../../../base/common/lifecycle.ts';
import { IMenuActionOptions, MenuId } from '../../actions/common/actions.ts';
