...
import { CancelablePromise, createCancelablePromise, promiseWithResolvers } from '../../../base/common/async.ts';
...
import { IIPCLogger } from '../../../base/parts/ipc/common/ipc.ts';
import { Client, ISocket, PersistentProtocol, ProtocolConstants, SocketCloseEventType } from '../../../base/parts/ipc/common/ipc.net.ts';
import { ILogService } from '../../log/common/log.ts';
import { RemoteAgentConnectionContext } from './remoteAgentEnvironment.ts';
import { RemoteAuthorityResolverError, RemoteConnection } from './remoteAuthorityResolver.ts';
import { IRemoteSocketFactoryService } from './remoteSocketFactoryService.ts';
