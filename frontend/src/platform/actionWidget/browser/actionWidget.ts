...
import { acceptSelectedActionCommand, ActionList, IActionListDelegate, IActionListItem, previewSelectedActionCommand } from './actionList.ts';
import { Action2, registerAction2 } from '../../actions/common/actions.ts';
import { IContextKeyService, RawContextKey } from '../../contextkey/common/contextkey.ts';
...
import { KeybindingWeight } from '../../keybinding/common/keybindingsRegistry.ts';
import { inputActiveOptionBackground, registerColor } from '../../theme/common/colorRegistry.ts';
