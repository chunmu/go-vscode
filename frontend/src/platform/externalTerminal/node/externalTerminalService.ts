...
import { sanitizeProcessEnvironment } from '../../../base/common/processes.ts';
import * as pfs from '../../../base/node/pfs.ts';
import * as processes from '../../../base/node/processes.ts';
import * as nls from '../../../nls.ts';
import { DEFAULT_TERMINAL_OSX, IExternalTerminalService, IExternalTerminalSettings, ITerminalForPlatform } from '../common/externalTerminal.ts';
import { ITerminalEnvironment } from '../../terminal/common/terminal.ts';
