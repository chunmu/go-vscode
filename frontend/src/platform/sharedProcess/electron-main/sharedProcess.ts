...
import { validatedIpcMain } from '../../../base/parts/ipc/electron-main/ipcMain.ts';
import { Barrier, DeferredPromise } from '../../../base/common/async.ts';
...
import { ISharedProcessConfiguration } from '../node/sharedProcess.ts';
...
import { parseSharedProcessDebugPort } from '../../environment/node/environmentService.ts';
import { assertReturnsDefined } from '../../../base/common/types.ts';
import { SharedProcessChannelConnection, SharedProcessRawConnection, SharedProcessLifecycle } from '../common/sharedProcess.ts';
