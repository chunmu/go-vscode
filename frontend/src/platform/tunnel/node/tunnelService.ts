...
import { BROWSER_RESTRICTED_PORTS, findFreePortFaster } from '../../../base/node/ports.ts';
import { NodeSocket } from '../../../base/parts/ipc/node/ipc.net.ts';

import { Barrier } from '../../../base/common/async.ts';
import { Disposable } from '../../../base/common/lifecycle.ts';
import { OS } from '../../../base/common/platform.ts';
import { ISocket } from '../../../base/parts/ipc/common/ipc.net.ts';
...
import { IAddressProvider, IConnectionOptions, connectRemoteAgentTunnel } from '../../remote/common/remoteAgentConnection.ts';
import { IRemoteSocketFactoryService } from '../../remote/common/remoteSocketFactoryService.ts';
import { ISignService } from '../../sign/common/sign.ts';
import { AbstractTunnelService, ISharedTunnelsService, ITunnelProvider, ITunnelService, RemoteTunnel, TunnelPrivacyId, isAllInterfaces, isLocalhost, isPortPrivileged, isTunnelProvider } from '../common/tunnel.ts';
