...
import { WebWorkerDescriptor } from '../../webWorker/browser/webWorkerDescriptor.ts';
...
import { IWebWorkerService } from '../../webWorker/browser/webWorkerService.ts';
import { ILogService } from '../../log/common/log.ts';
import { IV8Profile } from '../common/profiling.ts';
import { BottomUpSample } from '../common/profilingModel.ts';
import { reportSample } from '../common/profilingTelemetrySpec.ts';
