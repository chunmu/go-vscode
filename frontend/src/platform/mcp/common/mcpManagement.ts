...
import { IIterativePager } from '../../../base/common/paging.ts';
import { URI } from '../../../base/common/uri.ts';
import { SortBy, SortOrder } from '../../extensionManagement/common/extensionManagement.ts';
import { createDecorator } from '../../instantiation/common/instantiation.ts';
import { IMcpServerConfiguration, IMcpServerVariable } from './mcpPlatformTypes.ts';
