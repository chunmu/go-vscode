...
import { IPartsSplash } from '../common/themeService.ts';
import { IColorScheme } from '../../window/common/window.ts';
import { ThemeTypeSelector } from '../common/theme.ts';
...
import { IThemeMainService } from './themeMainService.ts';
