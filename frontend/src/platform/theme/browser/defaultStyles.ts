 ...
 *--------------------------------------------------------------------------------------------*/
import { IButtonStyles } from '../../../base/browser/ui/button/button.ts';
import { IKeybindingLabelStyles } from '../../../base/browser/ui/keybindingLabel/keybindingLabel.ts';
...
import { IProgressBarStyles } from '../../../base/browser/ui/progressbar/progressbar.ts';
import { ICheckboxStyles, IToggleStyles } from '../../../base/browser/ui/toggle/toggle.ts';
import { IDialogStyles } from '../../../base/browser/ui/dialog/dialog.ts';
import { IInputBoxStyles } from '../../../base/browser/ui/inputbox/inputBox.ts';
import { IFindWidgetStyles } from '../../../base/browser/ui/tree/abstractTree.ts';
import { ICountBadgeStyles } from '../../../base/browser/ui/countBadge/countBadge.ts';
import { IBreadcrumbsWidgetStyles } from '../../../base/browser/ui/breadcrumbs/breadcrumbsWidget.ts';
import { IListStyles } from '../../../base/browser/ui/list/listWidget.ts';
import { ISelectBoxStyles } from '../../../base/browser/ui/selectBox/selectBox.ts';
import { Color } from '../../../base/common/color.ts';
import { IMenuStyles } from '../../../base/browser/ui/menu/menu.ts';
import { IRadioStyles } from '../../../base/browser/ui/radio/radio.ts';
