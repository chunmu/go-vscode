...
import { getIconRegistry, IconContribution, IconFontDefinition } from '../common/iconRegistry.ts';
import { IProductIconTheme, IThemeService } from '../common/themeService.ts';
