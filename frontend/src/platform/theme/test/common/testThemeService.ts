...
import { IconContribution } from '../../common/iconRegistry.ts';
import { ColorScheme } from '../../common/theme.ts';
import { IColorTheme, IFileIconTheme, IProductIconTheme, IThemeService, ITokenStyle } from '../../common/themeService.ts';
