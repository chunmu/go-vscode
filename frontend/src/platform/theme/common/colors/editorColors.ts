...
import { registerColor, transparent, lessProminent, darken, lighten } from '../colorUtils.ts';

// Import the colors we need
import { foreground, contrastBorder, activeContrastBorder } from './baseColors.ts';
import { scrollbarShadow, badgeBackground } from './miscColors.ts';
