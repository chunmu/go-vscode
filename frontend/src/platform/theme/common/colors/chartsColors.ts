...
import { foreground } from './baseColors.ts';
import { editorErrorForeground, editorInfoForeground, editorWarningForeground } from './editorColors.ts';
import { minimapFindMatch } from './minimapColors.ts';
