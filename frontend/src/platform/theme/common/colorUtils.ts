...
import { IJSONContributionRegistry, Extensions as JSONExtensions } from '../../jsonschemas/common/jsonContributionRegistry.ts';
import * as platform from '../../registry/common/platform.ts';
import { IColorTheme } from './themeService.ts';
