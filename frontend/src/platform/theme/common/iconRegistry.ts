...
import { getCodiconFontCharacters } from '../../../base/common/codiconsUtil.ts';
import { ThemeIcon, IconIdentifier } from '../../../base/common/themables.ts';
...
import * as platform from '../../registry/common/platform.ts';
