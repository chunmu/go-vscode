...
import { basename, join } from '../../../base/common/path.ts';
...
import { virtualMachineHint } from '../../../base/node/id.ts';
import { IDirent, Promises as pfs } from '../../../base/node/pfs.ts';
import { listProcesses } from '../../../base/node/ps.ts';
import { IDiagnosticsService, IMachineInfo, IMainProcessDiagnostics, IRemoteDiagnosticError, IRemoteDiagnosticInfo, isRemoteDiagnosticError, IWorkspaceInformation, PerformanceInfo, SystemInfo, WorkspaceStatItem, WorkspaceStats } from '../common/diagnostics.ts';
import { ByteSize } from '../../files/common/files.ts';
import { IProductService } from '../../product/common/productService.ts';
import { ITelemetryService } from '../../telemetry/common/telemetry.ts';
import { IWorkspace } from '../../workspace/common/workspace.ts';
