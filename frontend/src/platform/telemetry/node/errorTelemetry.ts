...
import { isCancellationError, isSigPipeError, onUnexpectedError, setUnexpectedErrorHandler } from '../../../base/common/errors.ts';
import BaseErrorTelemetry from '../common/errorTelemetry.ts';
