...
import { Client as TelemetryClient } from '../../../base/parts/ipc/node/ipc.cp.ts';
...
import { ILoggerService } from '../../log/common/log.ts';
import { IProductService } from '../../product/common/productService.ts';
import { ICustomEndpointTelemetryService, ITelemetryData, ITelemetryEndpoint, ITelemetryService } from '../common/telemetry.ts';
import { TelemetryAppenderClient } from '../common/telemetryIpc.ts';
import { TelemetryLogAppender } from '../common/telemetryLogAppender.ts';
import { TelemetryService } from '../common/telemetryService.ts';
