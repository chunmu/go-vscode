...
import ErrorTelemetry from '../../browser/errorTelemetry.ts';
import { TelemetryConfiguration, TelemetryLevel } from '../../common/telemetry.ts';
import { ITelemetryServiceConfig, TelemetryService } from '../../common/telemetryService.ts';
import { ITelemetryAppender, NullAppender } from '../../common/telemetryUtils.ts';
...
class ErrorTestingSettings {
	...
	public stack: string[];
	public randomUserFile: string = 'a/path/that/doe_snt/con-tain/code/names.ts';
...
suite('TelemetryService', () => {
	...
	test('Unexpected Error Telemetry removes Windows PII but preserves code path', sinonTestFn(function (this: any) {
		...
		try {
			...
			const codePath = 'out/vs/workbench/workbench.desktop.main.ts';
			const stack = [
