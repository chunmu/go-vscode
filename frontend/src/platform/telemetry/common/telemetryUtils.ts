...
import { cloneAndChange, safeStringify } from '../../../base/common/objects.ts';
...
import { LoggerGroup } from '../../log/common/log.ts';
import { IProductService } from '../../product/common/productService.ts';
import { getRemoteName } from '../../remote/common/remoteHosts.ts';
import { verifyMicrosoftInternalDomain } from './commonProperties.ts';
import { ICustomEndpointTelemetryService, ITelemetryData, ITelemetryEndpoint, ITelemetryService, TelemetryConfiguration, TelemetryLevel, TELEMETRY_CRASH_REPORTER_SETTING_ID, TELEMETRY_OLD_SETTING_ID, TELEMETRY_SETTING_ID } from './telemetry.ts';
