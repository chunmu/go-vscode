...
import { binarySearch } from '../../../base/common/arrays.ts';
import { errorHandler, ErrorNoTelemetry, PendingMigrationError } from '../../../base/common/errors.ts';
import { DisposableStore, toDisposable } from '../../../base/common/lifecycle.ts';
import { safeStringify } from '../../../base/common/objects.ts';
import { FileOperationError } from '../../files/common/files.ts';
import { ITelemetryService } from './telemetry.ts';
