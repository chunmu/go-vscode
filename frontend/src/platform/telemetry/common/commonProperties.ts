...
import { isLinuxSnap, platform, Platform, PlatformToString } from '../../../base/common/platform.ts';
import { env, platform as nodePlatform } from '../../../base/common/process.ts';
import { generateUuid } from '../../../base/common/uuid.ts';
import { ICommonProperties } from './telemetry.ts';
