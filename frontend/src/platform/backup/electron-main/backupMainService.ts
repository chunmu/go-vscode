...
import { isEqual } from '../../../base/common/extpath.ts';
...
import { Promises, RimRafMode } from '../../../base/node/pfs.ts';
import { IBackupMainService } from './backup.ts';
import { ISerializedBackupWorkspaces, IEmptyWindowBackupInfo, isEmptyWindowBackupInfo, deserializeWorkspaceInfos, deserializeFolderInfos, ISerializedWorkspaceBackupInfo, ISerializedFolderBackupInfo, ISerializedEmptyWindowBackupInfo } from '../node/backup.ts';
...
import { HotExitConfiguration, IFilesConfiguration } from '../../files/common/files.ts';
import { ILogService } from '../../log/common/log.ts';
import { IFolderBackupInfo, isFolderBackupInfo, IWorkspaceBackupInfo } from '../common/backup.ts';
import { isWorkspaceIdentifier } from '../../workspace/common/workspace.ts';
import { createEmptyWorkspaceIdentifier } from '../../workspaces/node/workspaces.ts';
