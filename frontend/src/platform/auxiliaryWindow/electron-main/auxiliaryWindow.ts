...
import { hasNativeTitlebar, TitlebarStyle } from '../../window/common/window.ts';
import { IBaseWindow, WindowMode } from '../../window/electron-main/window.ts';
import { BaseWindow } from '../../windows/electron-main/windowImpl.ts';
