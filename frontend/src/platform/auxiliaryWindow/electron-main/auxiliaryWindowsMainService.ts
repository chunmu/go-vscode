...
import { AuxiliaryWindow, IAuxiliaryWindow } from './auxiliaryWindow.ts';
import { IAuxiliaryWindowsMainService } from './auxiliaryWindows.ts';
import { IInstantiationService } from '../../instantiation/common/instantiation.ts';
import { ILogService } from '../../log/common/log.ts';
import { IWindowState, WindowMode, defaultAuxWindowState } from '../../window/electron-main/window.ts';
import { IDefaultBrowserWindowOptionsOverrides, WindowStateValidator, defaultBrowserWindowOptions, getLastFocused } from '../../windows/electron-main/windows.ts';
