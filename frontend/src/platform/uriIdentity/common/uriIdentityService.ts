...
import { IUriIdentityService } from './uriIdentity.ts';
import { URI } from '../../../base/common/uri.ts';
import { InstantiationType, registerSingleton } from '../../instantiation/common/extensions.ts';
import { IFileService, FileSystemProviderCapabilities, IFileSystemProviderCapabilitiesChangeEvent, IFileSystemProviderRegistrationEvent } from '../../files/common/files.ts';
import { ExtUri, IExtUri, normalizePath } from '../../../base/common/resources.ts';
