...
import { getZoomLevel, setZoomFactor, setZoomLevel } from '../../../base/browser/browser.ts';
import { getActiveWindow, getWindows } from '../../../base/browser/dom.ts';
import { mainWindow } from '../../../base/browser/window.ts';
import { ISandboxConfiguration } from '../../../base/parts/sandbox/common/sandboxTypes.ts';
import { ISandboxGlobals, ipcRenderer, webFrame } from '../../../base/parts/sandbox/electron-browser/globals.ts';
import { zoomLevelToZoomFactor } from '../common/window.ts';
