...
import { PerformanceMark } from '../../../base/common/performance.ts';
import { isMacintosh, isNative, isWeb } from '../../../base/common/platform.ts';
import { URI, UriComponents, UriDto } from '../../../base/common/uri.ts';
import { ISandboxConfiguration } from '../../../base/parts/sandbox/common/sandboxTypes.ts';
...
import { FileType } from '../../files/common/files.ts';
import { ILoggerResource, LogLevel } from '../../log/common/log.ts';
import { PolicyDefinition, PolicyValue } from '../../policy/common/policy.ts';
import { IPartsSplash } from '../../theme/common/themeService.ts';
import { IUserDataProfile } from '../../userDataProfile/common/userDataProfile.ts';
import { IAnyWorkspaceIdentifier, ISingleFolderWorkspaceIdentifier, IWorkspaceIdentifier } from '../../workspace/common/workspace.ts';
