...
import { collapseTildePath, sanitizeCwd, escapeNonWindowsPath } from '../../common/terminalEnvironment.ts';
import { PosixShellType, WindowsShellType, GeneralShellType } from '../../common/terminal.ts';
