...
import { basename, delimiter, normalize, dirname, resolve } from '../../../base/common/path.ts';
import { isLinux, isWindows } from '../../../base/common/platform.ts';
import { findExecutable } from '../../../base/node/processes.ts';
import { hasKey, isObject, isString } from '../../../base/common/types.ts';
import { URI } from '../../../base/common/uri.ts';
import * as pfs from '../../../base/node/pfs.ts';
import { enumeratePowerShellInstallations } from '../../../base/node/powershell.ts';
import { IConfigurationService } from '../../configuration/common/configuration.ts';
import { ILogService } from '../../log/common/log.ts';
import { ITerminalEnvironment, ITerminalExecutable, ITerminalProfile, ITerminalProfileSource, ITerminalUnsafePath, ProfileSource, TerminalIcon, TerminalSettingId } from '../common/terminal.ts';
