...
import { Client, IIPCOptions } from '../../../base/parts/ipc/node/ipc.cp.ts';
import { IEnvironmentService, INativeEnvironmentService } from '../../environment/common/environment.ts';
import { parsePtyHostDebugPort } from '../../environment/node/environmentService.ts';
import { IReconnectConstants } from '../common/terminal.ts';
