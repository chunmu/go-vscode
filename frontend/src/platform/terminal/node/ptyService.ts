...
import { AutoOpenBarrier, ProcessTimeRunOnceScheduler, Promises, Queue, timeout } from '../../../base/common/async.ts';
import { Emitter, Event } from '../../../base/common/event.ts';
import { Disposable, toDisposable } from '../../../base/common/lifecycle.ts';
import { IProcessEnvironment, isWindows, OperatingSystem, OS } from '../../../base/common/platform.ts';
import { URI } from '../../../base/common/uri.ts';
import { getSystemShell } from '../../../base/node/shell.ts';
import { ILogService, LogLevel } from '../../log/common/log.ts';
import { RequestStore } from '../common/requestStore.ts';
...
import { TerminalDataBufferer } from '../common/terminalDataBuffering.ts';
import { escapeNonWindowsPath } from '../common/terminalEnvironment.ts';
import type { ISerializeOptions, SerializeAddon as XtermSerializeAddon } from '@xterm/addon-serialize';
import type { Unicode11Addon as XtermUnicode11Addon } from '@xterm/addon-unicode11';
import { IGetTerminalLayoutInfoArgs, IProcessDetails, ISetTerminalLayoutInfoArgs, ITerminalTabLayoutInfoDto } from '../common/terminalProcess.ts';
import { getWindowsBuildNumber } from './terminalEnvironment.ts';
import { TerminalProcess } from './terminalProcess.ts';
import { localize } from '../../../nls.ts';
import { ignoreProcessNames } from './childProcessMonitor.ts';
import { ErrorNoTelemetry } from '../../../base/common/errors.ts';
import { ShellIntegrationAddon } from '../common/xterm/shellIntegrationAddon.ts';
import { formatMessageForTerminal } from '../common/terminalStrings.ts';
import { IPtyHostProcessReplayEvent } from '../common/capabilities/capabilities.ts';
...
import { AutoRepliesPtyServiceContribution } from './terminalContrib/autoReplies/autoRepliesContribController.ts';
import { hasKey, isFunction, isNumber, isString } from '../../../base/common/types.ts';
