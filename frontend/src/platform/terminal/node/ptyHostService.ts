...
import { IProcessEnvironment, OS, OperatingSystem, isWindows } from '../../../base/common/platform.ts';
...
import { ILogService, ILoggerService, LogLevel } from '../../log/common/log.ts';
import { RemoteLoggerChannelClient } from '../../log/common/logIpc.ts';
import { getResolvedShellEnv } from '../../shell/node/shellEnv.ts';
...
import { registerTerminalPlatformConfiguration } from '../common/terminalPlatformConfiguration.ts';
import { IGetTerminalLayoutInfoArgs, IProcessDetails, ISetTerminalLayoutInfoArgs } from '../common/terminalProcess.ts';
import { IPtyHostConnection, IPtyHostStarter } from './ptyHost.ts';
import { detectAvailableProfiles } from './terminalProfiles.ts';
