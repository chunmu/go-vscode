...
import { IShellLaunchConfig, ITerminalEnvironment, ITerminalProcessOptions, ShellIntegrationInjectionFailureReason } from '../common/terminal.ts';
import { EnvironmentVariableMutatorType } from '../common/environmentVariable.ts';
import { deserializeEnvironmentVariableCollections } from '../common/environmentVariableShared.ts';
import { MergedEnvironmentVariableCollection } from '../common/environmentVariableCollection.ts';
import { chmod, realpathSync, mkdirSync } from 'fs';
import { promisify } from 'util';
import { isString, SingleOrMany } from '../../../base/common/types.ts';
