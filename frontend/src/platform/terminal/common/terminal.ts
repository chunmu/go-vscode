...
import { IProcessEnvironment, OperatingSystem } from '../../../base/common/platform.ts';
import { URI, UriComponents } from '../../../base/common/uri.ts';
import { createDecorator } from '../../instantiation/common/instantiation.ts';
import { IPtyHostProcessReplayEvent, ISerializedCommandDetectionCapability, ITerminalCapabilityStore, type ITerminalCommand } from './capabilities/capabilities.ts';
import { IGetTerminalLayoutInfoArgs, IProcessDetails, ISetTerminalLayoutInfoArgs } from './terminalProcess.ts';
import { ThemeIcon } from '../../../base/common/themables.ts';
import { ISerializableEnvironmentVariableCollections } from './environmentVariable.ts';
import { IWorkspaceFolder } from '../../workspace/common/workspace.ts';
import { Registry } from '../../registry/common/platform.ts';
import type * as performance from '../../../base/common/performance.ts';
import { ILogService } from '../../log/common/log.ts';
import type { IAction } from '../../../base/common/actions.ts';
import type { IDisposable } from '../../../base/common/lifecycle.ts';
import type { SingleOrMany } from '../../../base/common/types.ts';
