...
import { Codicon, getAllCodicons } from '../../../base/common/codicons.ts';
import { IJSONSchema, IJSONSchemaMap } from '../../../base/common/jsonSchema.ts';
import { OperatingSystem, Platform, PlatformToString } from '../../../base/common/platform.ts';
import { localize } from '../../../nls.ts';
import { ConfigurationScope, Extensions, IConfigurationNode, IConfigurationRegistry } from '../../configuration/common/configurationRegistry.ts';
import { Registry } from '../../registry/common/platform.ts';
import { IExtensionTerminalProfile, ITerminalProfile, TerminalSettingId } from './terminal.ts';
import { createProfileSchemaEnums } from './terminalProfiles.ts';
