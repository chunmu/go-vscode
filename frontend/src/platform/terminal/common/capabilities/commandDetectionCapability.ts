...
import { Disposable, MandatoryMutableDisposable, MutableDisposable } from '../../../../base/common/lifecycle.ts';
import { ILogService } from '../../../log/common/log.ts';
import { isString } from '../../../../base/common/types.ts';
import { CommandInvalidationReason, ICommandDetectionCapability, ICommandInvalidationRequest, IHandleCommandOptions, ISerializedCommandDetectionCapability, ISerializedTerminalCommand, ITerminalCommand, TerminalCapability } from './capabilities.ts';
import { ITerminalOutputMatcher } from '../terminal.ts';
import { ICurrentPartialCommand, isFullTerminalCommand, PartialTerminalCommand, TerminalCommand } from './commandDetection/terminalCommand.ts';
import { PromptInputModel, type IPromptInputModel } from './commandDetection/promptInputModel.ts';
