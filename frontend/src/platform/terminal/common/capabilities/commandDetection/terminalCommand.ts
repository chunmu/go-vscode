...
import { IMarkProperties, ISerializedTerminalCommand, ITerminalCommand } from '../capabilities.ts';
import { ITerminalOutputMatcher, ITerminalOutputMatch } from '../../terminal.ts';
