...
import { IShellIntegration, ShellIntegrationStatus } from '../terminal.ts';
import { Disposable, dispose, IDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { TerminalCapabilityStore } from '../capabilities/terminalCapabilityStore.ts';
import { CommandDetectionCapability } from '../capabilities/commandDetectionCapability.ts';
import { CwdDetectionCapability } from '../capabilities/cwdDetectionCapability.ts';
import { IBufferMarkCapability, ICommandDetectionCapability, ICwdDetectionCapability, IPromptTypeDetectionCapability, ISerializedCommandDetectionCapability, IShellEnvDetectionCapability, TerminalCapability } from '../capabilities/capabilities.ts';
import { PartialCommandDetectionCapability } from '../capabilities/partialCommandDetectionCapability.ts';
import { ILogService } from '../../../log/common/log.ts';
import { ITelemetryService } from '../../../telemetry/common/telemetry.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { BufferMarkCapability } from '../capabilities/bufferMarkCapability.ts';
import type { ITerminalAddon, Terminal } from '@xterm/headless';
import { URI } from '../../../../base/common/uri.ts';
import { sanitizeCwd } from '../terminalEnvironment.ts';
import { removeAnsiEscapeCodesFromPrompt } from '../../../../base/common/strings.ts';
import { ShellEnvDetectionCapability } from '../capabilities/shellEnvDetectionCapability.ts';
import { PromptTypeDetectionCapability } from '../capabilities/promptTypeDetectionCapability.ts';
