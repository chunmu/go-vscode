...
import { isIMenuItem, MenuId, MenuRegistry } from '../../common/actions.ts';
import { MenuService } from '../../common/menuService.ts';
import { NullCommandService } from '../../../commands/test/common/nullCommandService.ts';
import { MockContextKeyService, MockKeybindingService } from '../../../keybinding/test/common/mockKeybindingService.ts';
import { InMemoryStorageService } from '../../../storage/common/storage.ts';
