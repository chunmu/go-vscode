...
import { IS_NEW_KEY, StorageScope } from '../../common/storage.ts';
import { IStorageChangeEvent, IStorageMain, IStorageMainOptions } from '../../electron-main/storageMain.ts';
import { StorageMainService } from '../../electron-main/storageMainService.ts';
import { currentSessionDateStorageKey, firstSessionDateStorageKey } from '../../../telemetry/common/telemetry.ts';
...
import { TestLifecycleMainService } from '../../../test/electron-main/workbenchTestServices.ts';
