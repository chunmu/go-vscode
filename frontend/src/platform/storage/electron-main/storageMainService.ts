...
import { IStorage } from '../../../base/parts/storage/common/storage.ts';
...
import { ILifecycleMainService, LifecycleMainPhase, ShutdownReason } from '../../lifecycle/electron-main/lifecycleMainService.ts';
import { ILogService } from '../../log/common/log.ts';
import { AbstractStorageService, isProfileUsingDefaultStorage, IStorageService, StorageScope, StorageTarget } from '../common/storage.ts';
import { ApplicationStorageMain, ProfileStorageMain, InMemoryStorageMain, IStorageMain, IStorageMainOptions, WorkspaceStorageMain, IStorageChangeEvent } from './storageMain.ts';
...
import { IAnyWorkspaceIdentifier } from '../../workspace/common/workspace.ts';
