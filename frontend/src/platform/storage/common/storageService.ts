...
import { IStorage, Storage } from '../../../base/parts/storage/common/storage.ts';
import { IEnvironmentService } from '../../environment/common/environment.ts';
import { IRemoteService } from '../../ipc/common/services.ts';
import { AbstractStorageService, isProfileUsingDefaultStorage, StorageScope, WillSaveStateReason } from './storage.ts';
import { ApplicationStorageDatabaseClient, ProfileStorageDatabaseClient, WorkspaceStorageDatabaseClient } from './storageIpc.ts';
import { isUserDataProfile, IUserDataProfile } from '../../userDataProfile/common/userDataProfile.ts';
