...
import { EventType, EventHelper, addDisposableListener, ModifierKeyEmitter, getActiveElement, hasWindow, getWindowById, getWindows, $ } from '../../base/browser/dom.ts';
import { Action, Separator, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent } from '../../base/common/actions.ts';
import { IFileService } from '../../platform/files/common/files.ts';
import { EditorResourceAccessor, IUntitledTextResourceEditorInput, SideBySideEditor, pathsToEditors, IResourceDiffEditorInput, IUntypedEditorInput, IEditorPane, isResourceEditorInput, IResourceMergeEditorInput } from '../common/editor.ts';
import { IEditorService } from '../services/editor/common/editorService.ts';
import { ITelemetryService } from '../../platform/telemetry/common/telemetry.ts';
import { WindowMinimumSize, IOpenFileRequest, IAddRemoveFoldersRequest, INativeRunActionInWindowRequest, INativeRunKeybindingInWindowRequest, INativeOpenFileRequest, hasNativeTitlebar } from '../../platform/window/common/window.ts';
import { ITitleService } from '../services/title/browser/titleService.ts';
import { IWorkbenchThemeService } from '../services/themes/common/workbenchThemeService.ts';
import { ApplyZoomTarget, applyZoom } from '../../platform/window/electron-browser/window.ts';
import { setFullscreen, getZoomLevel, onDidChangeZoomLevel, getZoomFactor } from '../../base/browser/browser.ts';
import { ICommandService, CommandsRegistry } from '../../platform/commands/common/commands.ts';
import { IResourceEditorInput } from '../../platform/editor/common/editor.ts';
import { ipcRenderer, process } from '../../base/parts/sandbox/electron-browser/globals.ts';
import { IWorkspaceEditingService } from '../services/workspaces/common/workspaceEditing.ts';
import { IMenuService, MenuId, IMenu, MenuItemAction, MenuRegistry } from '../../platform/actions/common/actions.ts';
...
import { LifecyclePhase, ILifecycleService, WillShutdownEvent, ShutdownReason, BeforeShutdownErrorEvent, BeforeShutdownEvent } from '../services/lifecycle/common/lifecycle.ts';
import { IWorkspaceFolderCreationData } from '../../platform/workspaces/common/workspaces.ts';
import { IIntegrityService } from '../services/integrity/common/integrity.ts';
import { isWindows, isMacintosh } from '../../base/common/platform.ts';
import { IProductService } from '../../platform/product/common/productService.ts';
import { INotificationService, NeverShowAgainScope, NotificationPriority, Severity } from '../../platform/notification/common/notification.ts';
...
import { IAccessibilityService, AccessibilitySupport } from '../../platform/accessibility/common/accessibility.ts';
import { WorkbenchState, IWorkspaceContextService } from '../../platform/workspace/common/workspace.ts';
...
import { IOpenerService, IResolvedExternalUri, OpenOptions } from '../../platform/opener/common/opener.ts';
import { Schemas } from '../../base/common/network.ts';
import { INativeHostService } from '../../platform/native/common/native.ts';
import { posix } from '../../base/common/path.ts';
import { ITunnelService, RemoteTunnel, extractLocalHostUriMetaDataForPortMapping, extractQueryLocalHostUriMetaDataForPortMapping } from '../../platform/tunnel/common/tunnel.ts';
import { IWorkbenchLayoutService, positionFromString, Position } from '../services/layout/browser/layoutService.ts';
...
import { IAddressProvider, IAddress } from '../../platform/remote/common/remoteAgentConnection.ts';
...
import { AuthInfo } from '../../base/parts/sandbox/electron-browser/electronTypes.ts';
import { ILogService } from '../../platform/log/common/log.ts';
import { IInstantiationService } from '../../platform/instantiation/common/instantiation.ts';
import { whenEditorClosed } from '../browser/editor.ts';
...
import { IUtilityProcessWorkerWorkbenchService } from '../services/utilityProcess/electron-browser/utilityProcessWorkerWorkbenchService.ts';
import { registerWindowDriver } from '../services/driver/browser/driver.ts';
import { mainWindow } from '../../base/browser/window.ts';
import { BaseWindow } from '../browser/window.ts';
import { IHostService } from '../services/host/browser/host.ts';
import { IStatusbarService, ShowTooltipCommand, StatusbarAlignment } from '../services/statusbar/browser/statusbar.ts';
import { ActionBar } from '../../base/browser/ui/actionbar/actionbar.ts';
import { ThemeIcon } from '../../base/common/themables.ts';
import { getWorkbenchContribution } from '../common/contributions.ts';
import { DynamicWorkbenchSecurityConfiguration } from '../common/configuration.ts';
import { nativeHoverDelegate } from '../../platform/hover/browser/hover.ts';
import { WINDOW_ACTIVE_BORDER, WINDOW_INACTIVE_BORDER } from '../common/theme.ts';
