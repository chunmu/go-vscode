...
import { INativeWindowConfiguration, IWindowsConfiguration } from '../../platform/window/common/window.ts';
import { Workbench } from '../browser/workbench.ts';
import { NativeWindow } from './window.ts';
import { setFullscreen } from '../../base/browser/browser.ts';
import { domContentLoaded } from '../../base/browser/dom.ts';
...
import { INativeWorkbenchEnvironmentService, NativeWorkbenchEnvironmentService } from '../services/environment/electron-browser/environmentService.ts';
import { ServiceCollection } from '../../platform/instantiation/common/serviceCollection.ts';
import { ILoggerService, ILogService, LogLevel } from '../../platform/log/common/log.ts';
import { NativeWorkbenchStorageService } from '../services/storage/electron-browser/storageService.ts';
import { IWorkspaceContextService, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IAnyWorkspaceIdentifier, reviveIdentifier, toWorkspaceIdentifier } from '../../platform/workspace/common/workspace.ts';
...
import { SharedProcessService } from '../services/sharedProcess/electron-browser/sharedProcessService.ts';
import { RemoteAuthorityResolverService } from '../../platform/remote/electron-browser/remoteAuthorityResolverService.ts';
import { IRemoteAuthorityResolverService, RemoteConnectionType } from '../../platform/remote/common/remoteAuthorityResolver.ts';
import { RemoteAgentService } from '../services/remote/electron-browser/remoteAgentService.ts';
...
import { INativeKeyboardLayoutService, NativeKeyboardLayoutService } from '../services/keybinding/electron-browser/nativeKeyboardLayoutService.ts';
import { ElectronIPCMainProcessService } from '../../platform/ipc/electron-browser/mainProcessService.ts';
import { LoggerChannelClient } from '../../platform/log/common/logIpc.ts';
import { ProxyChannel } from '../../base/parts/ipc/common/ipc.ts';
import { NativeLogService } from '../services/log/electron-browser/logService.ts';
...
import { IUtilityProcessWorkerWorkbenchService, UtilityProcessWorkerWorkbenchService } from '../services/utilityProcess/electron-browser/utilityProcessWorkerWorkbenchService.ts';
import { isCI, isMacintosh, isTahoeOrNewer } from '../../base/common/platform.ts';
import { Schemas } from '../../base/common/network.ts';
import { DiskFileSystemProvider } from '../services/files/electron-browser/diskFileSystemProvider.ts';
import { FileUserDataProvider } from '../../platform/userData/common/fileUserDataProvider.ts';
import { IUserDataProfilesService, reviveProfile } from '../../platform/userDataProfile/common/userDataProfile.ts';
import { UserDataProfilesService } from '../../platform/userDataProfile/common/userDataProfileIpc.ts';
import { PolicyChannelClient } from '../../platform/policy/common/policyIpc.ts';
...
import { RemoteSocketFactoryService, IRemoteSocketFactoryService } from '../../platform/remote/common/remoteSocketFactoryService.ts';
import { ElectronRemoteResourceLoader } from '../../platform/remote/electron-browser/electronRemoteResourceLoader.ts';
...
import { MultiplexPolicyService } from '../services/policies/common/multiplexPolicyService.ts';
