...
import { Composite, CompositeDescriptor, CompositeRegistry } from './composite.ts';
import { IConstructorSignature, BrandedService, IInstantiationService } from '../../platform/instantiation/common/instantiation.ts';
...
import { MenuId, SubmenuItemAction } from '../../platform/actions/common/actions.ts';
...
import { ViewPaneContainer, ViewsSubMenu } from './parts/views/viewPaneContainer.ts';
...
import { VIEWPANE_FILTER_ACTION } from './parts/views/viewPane.ts';
