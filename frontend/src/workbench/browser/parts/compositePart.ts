...
import { defaultGenerator } from '../../../base/common/idGenerator.ts';
import { IDisposable, dispose, DisposableStore, MutableDisposable, } from '../../../base/common/lifecycle.ts';
...
import { Part, IPartOptions } from '../part.ts';
import { Composite, CompositeRegistry } from '../composite.ts';
...
import { IProgressIndicator, IEditorProgressService } from '../../../platform/progress/common/progress.ts';
...
import { Dimension, append, $, hide, show } from '../../../base/browser/dom.ts';
