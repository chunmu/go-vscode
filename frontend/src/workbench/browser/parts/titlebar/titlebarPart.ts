...
import { MultiWindowParts, Part } from '../../part.ts';
import { ITitleService } from '../../../services/title/browser/titleService.ts';
import { getWCOTitlebarAreaRect, getZoomFactor, isWCOEnabled } from '../../../../base/browser/browser.ts';
import { MenuBarVisibility, getTitleBarStyle, getMenuBarVisibility, hasCustomTitlebar, hasNativeTitlebar, DEFAULT_CUSTOM_TITLEBAR_HEIGHT, getWindowControlsStyle, WindowControlsStyle, TitlebarStyle, MenuSettings, hasNativeMenu } from '../../../../platform/window/common/window.ts';
...
import { TITLE_BAR_ACTIVE_BACKGROUND, TITLE_BAR_ACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_BACKGROUND, TITLE_BAR_BORDER, WORKBENCH_BACKGROUND } from '../../../common/theme.ts';
import { isMacintosh, isWindows, isLinux, isWeb, isNative, platformLocale } from '../../../../base/common/platform.ts';
import { Color } from '../../../../base/common/color.ts';
import { EventType, EventHelper, Dimension, append, $, addDisposableListener, prepend, reset, getWindow, getWindowId, isAncestor, getActiveDocument, isHTMLElement } from '../../../../base/browser/dom.ts';
import { CustomMenubarControl } from './menubarControl.ts';
...
import { Parts, IWorkbenchLayoutService, ActivityBarPosition, LayoutSettings, EditorActionsLocation, EditorTabsMode } from '../../../services/layout/browser/layoutService.ts';
import { createActionViewItem, fillInActionBarActions } from '../../../../platform/actions/browser/menuEntryActionViewItem.ts';
import { Action2, IMenu, IMenuService, MenuId, registerAction2 } from '../../../../platform/actions/common/actions.ts';
...
import { CommandCenterControl } from './commandCenterControl.ts';
...
import { ACCOUNTS_ACTIVITY_ID, GLOBAL_ACTIVITY_ID } from '../../../common/activity.ts';
import { AccountsActivityActionViewItem, isAccountsActionVisible, SimpleAccountActivityActionViewItem, SimpleGlobalActivityActionViewItem } from '../globalCompositeBar.ts';
...
import { ActionRunner, IAction } from '../../../../base/common/actions.ts';
import { IEditorService } from '../../../services/editor/common/editorService.ts';
import { ActionsOrientation, IActionViewItem, prepareActions } from '../../../../base/browser/ui/actionbar/actionbar.ts';
import { EDITOR_CORE_NAVIGATION_COMMANDS } from '../editor/editorCommands.ts';
import { AnchorAlignment } from '../../../../base/browser/ui/contextview/contextview.ts';
import { EditorPane } from '../editor/editorPane.ts';
...
import { EditorCommandsContextActionRunner } from '../editor/editorTabsControl.ts';
import { IEditorCommandsContext, IEditorPartOptionsChangeEvent, IToolbarActions } from '../../../common/editor.ts';
import { CodeWindow, mainWindow } from '../../../../base/browser/window.ts';
import { ACCOUNTS_ACTIVITY_TILE_ACTION, GLOBAL_ACTIVITY_TITLE_ACTION } from './titlebarActions.ts';
import { IView } from '../../../../base/browser/ui/grid/grid.ts';
...
import { IsCompactTitleBarContext, TitleBarVisibleContext } from '../../../common/contextkeys.ts';
