...
import { IMenuService, MenuId, IMenu, SubmenuItemAction, registerAction2, Action2, MenuItemAction, MenuRegistry } from '../../../../platform/actions/common/actions.ts';
import { MenuBarVisibility, IWindowOpenable, getMenuBarVisibility, MenuSettings, hasNativeMenu } from '../../../../platform/window/common/window.ts';
import { IContextKeyService } from '../../../../platform/contextkey/common/contextkey.ts';
import { IAction, Action, SubmenuAction, Separator, IActionRunner, ActionRunner, WorkbenchActionExecutedEvent, WorkbenchActionExecutedClassification, toAction } from '../../../../base/common/actions.ts';
import { addDisposableListener, Dimension, EventType } from '../../../../base/browser/dom.ts';
import { IKeybindingService } from '../../../../platform/keybinding/common/keybinding.ts';
import { isMacintosh, isWeb, isIOS, isNative } from '../../../../base/common/platform.ts';
...
import { IRecentlyOpened, isRecentFolder, IRecent, isRecentWorkspace, IWorkspacesService } from '../../../../platform/workspaces/common/workspaces.ts';
import { RunOnceScheduler } from '../../../../base/common/async.ts';
import { URI } from '../../../../base/common/uri.ts';
import { ILabelService, Verbosity } from '../../../../platform/label/common/label.ts';
import { IUpdateService, StateType } from '../../../../platform/update/common/update.ts';
...
import { MenuBar, IMenuBarOptions } from '../../../../base/browser/ui/menu/menubar.ts';
import { HorizontalDirection, IMenuDirection, VerticalDirection } from '../../../../base/browser/ui/menu/menu.ts';
import { mnemonicMenuLabel, unmnemonicLabel } from '../../../../base/common/labels.ts';
...
import { BrowserFeatures } from '../../../../base/browser/canIUse.ts';
...
import { IsMacNativeContext, IsWebContext } from '../../../../platform/contextkey/common/contextkeys.ts';
import { ICommandService } from '../../../../platform/commands/common/commands.ts';
import { ITelemetryService } from '../../../../platform/telemetry/common/telemetry.ts';
import { OpenRecentAction } from '../../actions/windowActions.ts';
...
import { defaultMenuStyles } from '../../../../platform/theme/browser/defaultStyles.ts';
import { mainWindow } from '../../../../base/browser/window.ts';
import { ActivityBarPosition } from '../../../services/layout/browser/layoutService.ts';
