...
import { DisposableStore, Disposable } from '../../../base/common/lifecycle.ts';
...
import { CompositeBarActionViewItem, CompositeBarAction, IActivityHoverOptions, ICompositeBarActionViewItemOptions, ICompositeBarColors } from './compositeBarActions.ts';
import { Codicon } from '../../../base/common/codicons.ts';
import { ThemeIcon } from '../../../base/common/themables.ts';
import { registerIcon } from '../../../platform/theme/common/iconRegistry.ts';
import { Action, IAction, Separator, SubmenuAction, toAction } from '../../../base/common/actions.ts';
import { IMenu, IMenuService, MenuId } from '../../../platform/actions/common/actions.ts';
import { addDisposableListener, EventType, append, clearNode, hide, show, EventHelper, $, runWhenWindowIdle, getWindow } from '../../../base/browser/dom.ts';
...
import { AnchorAlignment, AnchorAxisAlignment } from '../../../base/browser/ui/contextview/contextview.ts';
...
import { AuthenticationSessionAccount, IAuthenticationService, INTERNAL_AUTH_PROVIDER_PREFIX } from '../../services/authentication/common/authentication.ts';
...
import { DEFAULT_ICON } from '../../services/userDataProfile/common/userDataProfileIcons.ts';
import { isString } from '../../../base/common/types.ts';
import { KeyCode } from '../../../base/common/keyCodes.ts';
import { ACTIVITY_BAR_BADGE_BACKGROUND, ACTIVITY_BAR_BADGE_FOREGROUND } from '../../common/theme.ts';
