...
import { IEditorControl, IEditorPane, IEditorOpenContext, EditorExtensions, SIDE_BY_SIDE_EDITOR_ID, SideBySideEditor as Side, IEditorPaneSelection, IEditorPaneWithSelection, IEditorPaneSelectionChangeEvent, isEditorPaneWithSelection, EditorPaneSelectionCompareResult } from '../../../common/editor.ts';
...
import { IEditorPaneRegistry } from '../../editor.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { IEditorGroup, IEditorGroupsService } from '../../../services/editor/common/editorGroupsService.ts';
import { SplitView, Sizing, Orientation } from '../../../../base/browser/ui/splitview/splitview.ts';
import { Event, Relay, Emitter } from '../../../../base/common/event.ts';
...
import { DEFAULT_EDITOR_MIN_DIMENSIONS } from './editor.ts';
import { DisposableStore } from '../../../../base/common/lifecycle.ts';
import { SIDE_BY_SIDE_EDITOR_HORIZONTAL_BORDER, SIDE_BY_SIDE_EDITOR_VERTICAL_BORDER } from '../../../common/theme.ts';
