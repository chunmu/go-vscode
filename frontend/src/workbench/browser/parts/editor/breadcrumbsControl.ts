...
import { BreadcrumbsItem, BreadcrumbsWidget, IBreadcrumbsItemEvent, IBreadcrumbsWidgetStyles } from '../../../../base/browser/ui/breadcrumbs/breadcrumbsWidget.ts';
...
import { combinedDisposable, DisposableStore, IDisposable, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { basename, extUri } from '../../../../base/common/resources.ts';
import { URI } from '../../../../base/common/uri.ts';
import { DocumentSymbol } from '../../../../editor/common/languages.ts';
import { OutlineElement } from '../../../../editor/contrib/documentSymbols/browser/outlineModel.ts';
...
import { fillInSymbolsDragData, LocalSelectionTransfer } from '../../../../platform/dnd/browser/dnd.ts';
import { FileKind, IFileService, IFileStat } from '../../../../platform/files/common/files.ts';
...
import { IListService, WorkbenchAsyncDataTree, WorkbenchDataTree, WorkbenchListFocusContextKey } from '../../../../platform/list/browser/listService.ts';
...
import { EditorResourceAccessor, IEditorPartOptions, SideBySideEditor } from '../../../common/editor.ts';
import { IEditorGroupsService } from '../../../services/editor/common/editorGroupsService.ts';
import { ACTIVE_GROUP, ACTIVE_GROUP_TYPE, IEditorService, SIDE_GROUP, SIDE_GROUP_TYPE } from '../../../services/editor/common/editorService.ts';
import { IOutline } from '../../../services/outline/browser/outline.ts';
import { DraggedEditorIdentifier, fillEditorsDragData } from '../../dnd.ts';
import { DEFAULT_LABELS_CONTAINER, ResourceLabels } from '../../labels.ts';
import { BreadcrumbsConfig, IBreadcrumbsService } from './breadcrumbs.ts';
import { BreadcrumbsModel, FileElement, OutlineElement2 } from './breadcrumbsModel.ts';
import { BreadcrumbsFilePicker, BreadcrumbsOutlinePicker } from './breadcrumbsPicker.ts';
import { IEditorGroupView } from './editor.ts';
