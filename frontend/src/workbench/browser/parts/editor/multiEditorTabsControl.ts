...
import { EditorResourceAccessor, Verbosity, IEditorPartOptions, SideBySideEditor, DEFAULT_EDITOR_ASSOCIATION, EditorInputCapabilities, IUntypedEditorInput, preventEditorClose, EditorCloseMethod, EditorsOrder, IToolbarActions } from '../../../common/editor.ts';
...
import { ResourceLabels, IResourceLabel, DEFAULT_LABELS_CONTAINER } from '../../labels.ts';
...
import { EditorCommandsContextActionRunner, EditorTabsControl } from './editorTabsControl.ts';
import { IQuickInputService } from '../../../../platform/quickinput/common/quickInput.ts';
import { IDisposable, dispose, DisposableStore, combinedDisposable, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { ScrollableElement } from '../../../../base/browser/ui/scrollbar/scrollableElement.ts';
...
import { activeContrastBorder, contrastBorder, editorBackground } from '../../../../platform/theme/common/colorRegistry.ts';
import { ResourcesDropHandler, DraggedEditorIdentifier, DraggedEditorGroupIdentifier, extractTreeDropData, isWindowDraggedOver } from '../../dnd.ts';
import { Color } from '../../../../base/common/color.ts';
import { INotificationService } from '../../../../platform/notification/common/notification.ts';
import { MergeGroupMode, IMergeGroupOptions } from '../../../services/editor/common/editorGroupsService.ts';
import { addDisposableListener, EventType, EventHelper, Dimension, scheduleAtNextAnimationFrame, findParentWithClass, clearNode, DragAndDropObserver, isMouseEvent, getWindow, $ } from '../../../../base/browser/dom.ts';
import { localize } from '../../../../nls.ts';
import { IEditorGroupsView, EditorServiceImpl, IEditorGroupView, IInternalEditorOpenOptions, IEditorPartsView, prepareMoveCopyEditors } from './editor.ts';
import { CloseEditorTabAction, UnpinEditorAction } from './editorActions.ts';
...
import { IPath, win32, posix } from '../../../../base/common/path.ts';
import { coalesce, insert } from '../../../../base/common/arrays.ts';
import { isHighContrast } from '../../../../platform/theme/common/theme.ts';
import { isSafari } from '../../../../base/browser/browser.ts';
import { equals } from '../../../../base/common/objects.ts';
import { EditorActivation, IEditorOptions } from '../../../../platform/editor/common/editor.ts';
import { UNLOCK_GROUP_COMMAND_ID } from './editorCommands.ts';
...
import { applyDragImage } from '../../../../base/browser/ui/dnd/dnd.ts';
