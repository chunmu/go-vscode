...
import { Dimension, $, EventHelper, addDisposableGenericMouseDownListener, getWindow, isAncestorOfActiveElement, getActiveElement, isHTMLElement } from '../../../../base/browser/dom.ts';
import { Event, Emitter, Relay, PauseableEmitter } from '../../../../base/common/event.ts';
import { contrastBorder, editorBackground } from '../../../../platform/theme/common/colorRegistry.ts';
import { GroupDirection, GroupsArrangement, GroupOrientation, IMergeGroupOptions, MergeGroupMode, GroupsOrder, GroupLocation, IFindGroupScope, EditorGroupLayout, GroupLayoutArgument, IEditorSideGroup, IEditorDropTargetDelegate, IEditorPart } from '../../../services/editor/common/editorGroupsService.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { IView, orthogonal, LayoutPriority, IViewSize, Direction, SerializableGrid, Sizing, ISerializedGrid, ISerializedNode, Orientation, GridBranchNode, isGridBranchNode, GridNode, createSerializedGrid, Grid } from '../../../../base/browser/ui/grid/grid.ts';
import { GroupIdentifier, EditorInputWithOptions, IEditorPartOptions, IEditorPartOptionsChangeEvent, GroupModelChangeKind } from '../../../common/editor.ts';
import { EDITOR_GROUP_BORDER, EDITOR_PANE_BACKGROUND } from '../../../common/theme.ts';
import { distinct, coalesce } from '../../../../base/common/arrays.ts';
import { IEditorGroupView, getEditorPartOptions, impactsEditorPartOptions, IEditorPartCreationOptions, IEditorPartsView, IEditorGroupsView, IEditorGroupViewOptions } from './editor.ts';
import { EditorGroupView } from './editorGroupView.ts';
...
import { ISerializedEditorGroupModel, isSerializedEditorGroupModel } from '../../../common/editor/editorGroupModel.ts';
import { EditorDropTarget } from './editorDropTarget.ts';
import { Color } from '../../../../base/common/color.ts';
import { CenteredViewLayout, CenteredViewState } from '../../../../base/browser/ui/centered/centeredViewLayout.ts';
import { onUnexpectedError } from '../../../../base/common/errors.ts';
import { Parts, IWorkbenchLayoutService, Position } from '../../../services/layout/browser/layoutService.ts';
import { DeepPartial, assertType } from '../../../../base/common/types.ts';
import { CompositeDragAndDropObserver } from '../../dnd.ts';
import { DeferredPromise, Promises } from '../../../../base/common/async.ts';
import { findGroup } from '../../../services/editor/common/editorGroupFinder.ts';
...
import { EditorPartMaximizedEditorGroupContext, EditorPartMultipleEditorGroupsContext, IsAuxiliaryWindowContext } from '../../../common/contextkeys.ts';
