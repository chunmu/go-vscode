...
import { compareFileNames } from '../../../../base/common/comparers.ts';
...
import { IDisposable, DisposableStore, MutableDisposable, Disposable } from '../../../../base/common/lifecycle.ts';
import { posix, relative } from '../../../../base/common/path.ts';
import { basename, dirname, isEqual } from '../../../../base/common/resources.ts';
import { URI } from '../../../../base/common/uri.ts';
import './media/breadcrumbscontrol.css';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { FileKind, IFileService, IFileStat } from '../../../../platform/files/common/files.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { WorkbenchDataTree, WorkbenchAsyncDataTree } from '../../../../platform/list/browser/listService.ts';
import { breadcrumbsPickerBackground, widgetBorder, widgetShadow } from '../../../../platform/theme/common/colorRegistry.ts';
import { isWorkspace, isWorkspaceFolder, IWorkspace, IWorkspaceContextService, IWorkspaceFolder } from '../../../../platform/workspace/common/workspace.ts';
import { ResourceLabels, IResourceLabel, DEFAULT_LABELS_CONTAINER } from '../../labels.ts';
import { BreadcrumbsConfig } from './breadcrumbs.ts';
import { OutlineElement2, FileElement } from './breadcrumbsModel.ts';
import { IAsyncDataSource, ITreeRenderer, ITreeNode, ITreeFilter, TreeVisibility, ITreeSorter } from '../../../../base/browser/ui/tree/tree.ts';
import { IIdentityProvider, IListVirtualDelegate, IKeyboardNavigationLabelProvider } from '../../../../base/browser/ui/list/list.ts';
import { IFileIconTheme, IThemeService } from '../../../../platform/theme/common/themeService.ts';
import { IListAccessibilityProvider } from '../../../../base/browser/ui/list/listWidget.ts';
import { localize } from '../../../../nls.ts';
import { IOutline, IOutlineComparator } from '../../../services/outline/browser/outline.ts';
