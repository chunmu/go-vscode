...
import { IEditorOpenContext, isEditorOpenError } from '../../../common/editor.ts';
...
import { Dimension, size, clearNode, $, EventHelper } from '../../../../base/browser/dom.ts';
...
import { IWorkspaceContextService, isSingleFolderWorkspaceIdentifier, toWorkspaceIdentifier } from '../../../../platform/workspace/common/workspace.ts';
import { EditorOpenSource, IEditorOptions } from '../../../../platform/editor/common/editor.ts';
import { computeEditorAriaLabel, EditorPaneDescriptor } from '../../editor.ts';
import { ButtonBar } from '../../../../base/browser/ui/button/button.ts';
...
import { FileChangeType, FileOperationError, FileOperationResult, IFileService } from '../../../../platform/files/common/files.ts';
