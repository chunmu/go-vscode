...
import { IEditorIdentifier, IEditorCommandsContext, CloseDirection, SaveReason, EditorsOrder, EditorInputCapabilities, DEFAULT_EDITOR_ASSOCIATION, GroupIdentifier, EditorResourceAccessor } from '../../../common/editor.ts';
...
import { GoFilter, IHistoryService } from '../../../services/history/common/history.ts';
...
import { IEditorGroupsService, IEditorGroup, GroupsArrangement, GroupLocation, GroupDirection, preferredSideBySideGroupDirection, IFindGroupScope, GroupOrientation, EditorGroupLayout, GroupsOrder, MergeGroupMode } from '../../../services/editor/common/editorGroupsService.ts';
...
import { ItemActivation, IQuickInputService } from '../../../../platform/quickinput/common/quickInput.ts';
import { AllEditorsByMostRecentlyUsedQuickAccess, ActiveGroupEditorsByMostRecentlyUsedQuickAccess, AllEditorsByAppearanceQuickAccess } from './editorQuickAccess.ts';
...
import { isLinux, isNative, isWindows } from '../../../../base/common/platform.ts';
...
import { IKeybindingRule, KeybindingWeight } from '../../../../platform/keybinding/common/keybindingsRegistry.ts';
...
import { getActiveDocument } from '../../../../base/browser/dom.ts';
...
import { resolveCommandsContext } from './editorCommandsContext.ts';
