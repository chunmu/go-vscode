...
import { getWindowById, runAtThisOrScheduleAtNextAnimationFrame } from '../../../../base/browser/dom.ts';
import { format, compare, splitLines } from '../../../../base/common/strings.ts';
import { extname, basename, isEqual } from '../../../../base/common/resources.ts';
import { areFunctions, assertReturnsDefined } from '../../../../base/common/types.ts';
...
import { IFileEditorInput, EditorResourceAccessor, IEditorPane, SideBySideEditor } from '../../../common/editor.ts';
import { EditorInput } from '../../../common/editor/editorInput.ts';
import { Disposable, MutableDisposable, DisposableStore } from '../../../../base/common/lifecycle.ts';
import { IEditorAction } from '../../../../editor/common/editorCommon.ts';
import { EndOfLineSequence } from '../../../../editor/common/model.ts';
import { TrimTrailingWhitespaceAction } from '../../../../editor/contrib/linesOperations/browser/linesOperations.ts';
import { IndentUsingSpaces, IndentUsingTabs, ChangeTabDisplaySize, DetectIndentation, IndentationToSpacesAction, IndentationToTabsAction } from '../../../../editor/contrib/indentation/browser/indentation.ts';
...
import { IFileService, FILES_ASSOCIATIONS_CONFIG } from '../../../../platform/files/common/files.ts';
...
import { EncodingMode, IEncodingSupport, ILanguageSupport, ITextFileService } from '../../../services/textfile/common/textfiles.ts';
import { SUPPORTED_ENCODINGS } from '../../../services/textfile/common/encoding.ts';
import { ConfigurationChangedEvent, EditorOption } from '../../../../editor/common/config/editorOptions.ts';
...
import { ICodeEditor, getCodeEditor } from '../../../../editor/browser/editorBrowser.ts';
...
import { Promises, timeout } from '../../../../base/common/async.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { IWorkbenchContribution } from '../../../common/contributions.ts';
import { IStatusbarEntryAccessor, IStatusbarService, StatusbarAlignment, IStatusbarEntry } from '../../../services/statusbar/browser/statusbar.ts';
import { IMarker, IMarkerService, MarkerSeverity, IMarkerData } from '../../../../platform/markers/common/markers.ts';
...
import { AutomaticLanguageDetectionLikelyWrongClassification, AutomaticLanguageDetectionLikelyWrongId, IAutomaticLanguageDetectionLikelyWrongData, ILanguageDetectionService } from '../../../services/languageDetection/common/languageDetectionWorkerService.ts';
...
import { TabFocus } from '../../../../editor/browser/config/tabFocus.ts';
import { IEditorGroupsService, IEditorPart } from '../../../services/editor/common/editorGroupsService.ts';
import { InputMode } from '../../../../editor/common/inputMode.ts';
