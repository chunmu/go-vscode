...
import { ActiveAuxiliaryContext, AuxiliaryBarFocusContext } from '../../../common/contextkeys.ts';
...
import { ToggleAuxiliaryBarAction } from './auxiliaryBarActions.ts';
import { assertReturnsDefined } from '../../../../base/common/types.ts';
import { LayoutPriority } from '../../../../base/browser/ui/splitview/splitview.ts';
import { ToggleSidebarPositionAction } from '../../actions/layoutActions.ts';
