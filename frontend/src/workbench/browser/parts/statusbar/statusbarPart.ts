...
import { Disposable, DisposableStore, disposeIfDisposable, IDisposable, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { MultiWindowParts, Part } from '../../part.ts';
import { EventType as TouchEventType, Gesture, GestureEvent } from '../../../../base/browser/touch.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { StatusbarAlignment, IStatusbarService, IStatusbarEntry, IStatusbarEntryAccessor, IStatusbarStyleOverride, isStatusbarEntryLocation, IStatusbarEntryLocation, isStatusbarEntryPriority, IStatusbarEntryPriority } from '../../../services/statusbar/browser/statusbar.ts';
...
import { contrastBorder, activeContrastBorder } from '../../../../platform/theme/common/colorRegistry.ts';
import { EventHelper, addDisposableListener, EventType, clearNode, getWindow, isHTMLElement, $ } from '../../../../base/browser/dom.ts';
...
import { ToggleStatusbarVisibilityAction } from '../../actions/layoutActions.ts';
...
import { WorkbenchHoverDelegate } from '../../../../platform/hover/browser/hover.ts';
import { HideStatusbarEntryAction, ManageExtensionAction, ToggleStatusbarEntryVisibilityAction } from './statusbarActions.ts';
import { IStatusbarViewModelEntry, StatusbarViewModel } from './statusbarModel.ts';
import { StatusbarEntryItem } from './statusbarItem.ts';
import { StatusBarFocused } from '../../../common/contextkeys.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { IView } from '../../../../base/browser/ui/grid/grid.ts';
import { isManagedHoverTooltipHTMLElement, isManagedHoverTooltipMarkdownString } from '../../../../base/browser/ui/hover/hover.ts';
