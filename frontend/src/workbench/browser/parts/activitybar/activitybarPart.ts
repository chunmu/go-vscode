...
import { ActivityBarPosition, IWorkbenchLayoutService, LayoutSettings, Parts, Position } from '../../../services/layout/browser/layoutService.ts';
...
import { ToggleSidebarPositionAction, ToggleSidebarVisibilityAction } from '../../actions/layoutActions.ts';
import { IThemeService, IColorTheme, registerThemingParticipant } from '../../../../platform/theme/common/themeService.ts';
...
import { activeContrastBorder, contrastBorder, focusBorder } from '../../../../platform/theme/common/colorRegistry.ts';
import { addDisposableListener, append, EventType, isAncestor, $, clearNode } from '../../../../base/browser/dom.ts';
import { assertReturnsDefined } from '../../../../base/common/types.ts';
import { CustomMenubarControl } from '../titlebar/menubarControl.ts';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { getMenuBarVisibility, MenuSettings } from '../../../../platform/window/common/window.ts';
...
import { IPaneCompositeBarOptions, PaneCompositeBar } from '../paneCompositeBar.ts';
import { GlobalCompositeBar } from '../globalCompositeBar.ts';
...
import { IViewDescriptorService, ViewContainerLocation, ViewContainerLocationToString } from '../../../common/views.ts';
