...
import { Extensions, PaneComposite, PaneCompositeDescriptor, PaneCompositeRegistry } from '../panecomposite.ts';
...
import { CompositePart, ICompositePartOptions, ICompositeTitleLabel } from './compositePart.ts';
import { IPaneCompositeBarOptions, PaneCompositeBar } from './paneCompositeBar.ts';
import { Dimension, EventHelper, trackFocus, $, addDisposableListener, EventType, prepend, getWindow } from '../../../base/browser/dom.ts';
...
import { ViewsSubMenu } from './views/viewPaneContainer.ts';
