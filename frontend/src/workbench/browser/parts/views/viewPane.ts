...
import { asCssVariable, foreground } from '../../../../platform/theme/common/colorRegistry.ts';
import { after, append, $, trackFocus, EventType, addDisposableListener, Dimension, reset, isAncestorOfActiveElement, isActiveElement } from '../../../../base/browser/dom.ts';
import { createCSSRule } from '../../../../base/browser/domStylesheets.ts';
import { asCssValueWithDefault, asCSSUrl } from '../../../../base/browser/cssValue.ts';
import { DisposableMap, DisposableStore, toDisposable } from '../../../../base/common/lifecycle.ts';
import { Action, IAction, IActionRunner } from '../../../../base/common/actions.ts';
...
import { IPaneOptions, Pane, IPaneStyles } from '../../../../base/browser/ui/splitview/paneview.ts';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { Extensions as ViewContainerExtensions, IView, IViewDescriptorService, ViewContainerLocation, IViewsRegistry, IViewContentDescriptor, defaultViewIcon, ViewContainerLocationToString } from '../../../common/views.ts';
...
import { assertReturnsDefined, PartialExcept } from '../../../../base/common/types.ts';
import { IInstantiationService, ServicesAccessor } from '../../../../platform/instantiation/common/instantiation.ts';
import { MenuId, Action2, IAction2Options, SubmenuItemAction } from '../../../../platform/actions/common/actions.ts';
...
import { Orientation } from '../../../../base/browser/ui/sash/sash.ts';
import { ProgressBar } from '../../../../base/browser/ui/progressbar/progressbar.ts';
import { AbstractProgressScope, ScopedProgressIndicator } from '../../../services/progress/browser/progressIndicator.ts';
...
import { IDropdownMenuActionViewItemOptions } from '../../../../base/browser/ui/dropdown/dropdownActionViewItem.ts';
import { WorkbenchToolBar } from '../../../../platform/actions/browser/toolbar.ts';
import { FilterWidget, IFilterWidgetOptions } from './viewFilter.ts';
import { BaseActionViewItem } from '../../../../base/browser/ui/actionbar/actionViewItems.ts';
...
import { IListStyles } from '../../../../base/browser/ui/list/listWidget.ts';
...
import { ViewMenuActions } from './viewMenuActions.ts';
