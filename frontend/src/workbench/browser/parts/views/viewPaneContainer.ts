...
import { $, addDisposableListener, Dimension, DragAndDropObserver, EventType, getWindow, isAncestor } from '../../../../base/browser/dom.ts';
import { StandardMouseEvent } from '../../../../base/browser/mouseEvent.ts';
import { EventType as TouchEventType, Gesture } from '../../../../base/browser/touch.ts';
import { IActionViewItem } from '../../../../base/browser/ui/actionbar/actionbar.ts';
import { IBoundarySashes, Orientation } from '../../../../base/browser/ui/sash/sash.ts';
import { IPaneViewOptions, PaneView } from '../../../../base/browser/ui/splitview/paneview.ts';
...
import { combinedDisposable, DisposableStore, IDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
...
import { Action2, IAction2Options, ISubmenuItem, MenuId, MenuRegistry, registerAction2 } from '../../../../platform/actions/common/actions.ts';
...
import { activeContrastBorder, asCssVariable } from '../../../../platform/theme/common/colorRegistry.ts';
...
import { CompositeDragAndDropObserver, toggleDropEffect } from '../../dnd.ts';
import { ViewPane } from './viewPane.ts';
...
import { IAddedViewDescriptorRef, ICustomViewDescriptor, IView, IViewContainerModel, IViewDescriptor, IViewDescriptorRef, IViewDescriptorService, IViewPaneContainer, ViewContainer, ViewContainerLocation, ViewVisibilityState } from '../../../common/views.ts';
...
import { isHorizontal, IWorkbenchLayoutService, LayoutSettings } from '../../../services/layout/browser/layoutService.ts';
import { IBaseActionViewItemOptions } from '../../../../base/browser/ui/actionbar/actionViewItems.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { ViewContainerMenuActions } from './viewMenuActions.ts';
