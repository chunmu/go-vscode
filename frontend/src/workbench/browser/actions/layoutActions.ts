...
import { MenuId, MenuRegistry, registerAction2, Action2 } from '../../../platform/actions/common/actions.ts';
...
import { EditorActionsLocation, EditorTabsMode, IWorkbenchLayoutService, LayoutSettings, Parts, Position, ZenModeSettings, positionToString } from '../../services/layout/browser/layoutService.ts';
import { ServicesAccessor, IInstantiationService } from '../../../platform/instantiation/common/instantiation.ts';
import { KeyMod, KeyCode, KeyChord } from '../../../base/common/keyCodes.ts';
import { isWindows, isLinux, isWeb, isMacintosh, isNative } from '../../../base/common/platform.ts';
...
import { IViewDescriptorService, ViewContainerLocation, IViewDescriptor, ViewContainerLocationToString } from '../../common/views.ts';
import { IViewsService } from '../../services/views/common/viewsService.ts';
import { QuickPickItem, IQuickInputService, IQuickPickItem, IQuickPickSeparator, IQuickPick } from '../../../platform/quickinput/common/quickInput.ts';
...
import { ToggleAuxiliaryBarAction } from '../parts/auxiliarybar/auxiliaryBarActions.ts';
import { TogglePanelAction } from '../parts/panel/panelActions.ts';
...
import { MenuSettings, TitlebarStyle } from '../../../platform/window/common/window.ts';
import { IPreferencesService } from '../../services/preferences/common/preferences.ts';
import { QuickInputAlignmentContextKey } from '../../../platform/quickinput/browser/quickInput.ts';
