...
import { IsMainWindowFullscreenContext } from '../../common/contextkeys.ts';
import { IsMacNativeContext, IsDevelopmentContext, IsWebContext, IsIOSContext } from '../../../platform/contextkey/common/contextkeys.ts';
...
import { IQuickInputButton, IQuickInputService, IQuickPickSeparator, IKeyMods, IQuickPickItem } from '../../../platform/quickinput/common/quickInput.ts';
import { IWorkspaceContextService, IWorkspaceIdentifier, isWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier } from '../../../platform/workspace/common/workspace.ts';
...
import { IRecent, isRecentFolder, isRecentWorkspace, IWorkspacesService } from '../../../platform/workspaces/common/workspaces.ts';
...
import { splitRecentLabel } from '../../../base/common/labels.ts';
import { isMacintosh, isWeb, isWindows } from '../../../base/common/platform.ts';
...
import { isFolderBackupInfo, isWorkspaceBackupInfo } from '../../../platform/backup/common/backup.ts';
import { getActiveElement, getActiveWindow, isHTMLElement } from '../../../base/browser/dom.ts';
