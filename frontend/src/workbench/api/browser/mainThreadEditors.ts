...
import { IDisposable, dispose, DisposableStore } from '../../../base/common/lifecycle.ts';
import { equals as objectEquals } from '../../../base/common/objects.ts';
...
import { IDecorationOptions, IDecorationRenderOptions } from '../../../editor/common/editorCommon.ts';
...
import { ITextEditorOptions, IResourceEditorInput, EditorActivation, EditorResolution, ITextEditorDiffInformation, isTextEditorDiffInformationEqual, ITextEditorChange } from '../../../platform/editor/common/editor.ts';
...
import { ExtHostContext, ExtHostEditorsShape, IApplyEditsOptions, ITextDocumentShowOptions, ITextEditorConfigurationUpdate, ITextEditorPositionData, IUndoStopOptions, MainThreadTextEditorsShape, TextEditorRevealType } from '../common/extHost.protocol.ts';
import { editorGroupToColumn, columnToEditorGroup, EditorGroupColumn } from '../../services/editor/common/editorGroupColumn.ts';
...
import { IEditorControl } from '../../common/editor.ts';
...
import { autorun, constObservable, derived, derivedOpts, IObservable, observableFromEvent } from '../../../base/common/observable.ts';
import { IUriIdentityService } from '../../../platform/uriIdentity/common/uriIdentity.ts';
import { isITextModel } from '../../../editor/common/model.ts';
import { LineRangeMapping } from '../../../editor/common/diff/rangeMapping.ts';
import { equals } from '../../../base/common/arrays.ts';
import { Event } from '../../../base/common/event.ts';
import { DiffAlgorithmName } from '../../../editor/common/services/editorWorker.ts';
