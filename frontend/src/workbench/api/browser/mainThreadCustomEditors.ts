...
import { multibyteAwareBtoa } from '../../../base/common/strings.ts';
...
import { isCancellationError, onUnexpectedError } from '../../../base/common/errors.ts';
import { Emitter, Event } from '../../../base/common/event.ts';
import { Disposable, DisposableMap, DisposableStore, IReference } from '../../../base/common/lifecycle.ts';
import { Schemas } from '../../../base/common/network.ts';
import { basename } from '../../../base/common/path.ts';
import { isEqual, isEqualOrParent, toLocalResource } from '../../../base/common/resources.ts';
...
import { IUndoRedoService, UndoRedoElementType } from '../../../platform/undoRedo/common/undoRedo.ts';
...
import { CustomDocumentBackupData } from '../../contrib/customEditor/browser/customEditorInputFactory.ts';
import { ICustomEditorModel, ICustomEditorService } from '../../contrib/customEditor/common/customEditor.ts';
import { CustomTextEditorModel } from '../../contrib/customEditor/common/customTextEditorModel.ts';
import { ExtensionKeyedWebviewOriginStore, WebviewExtensionDescription } from '../../contrib/webview/browser/webview.ts';
import { WebviewInput } from '../../contrib/webviewPanel/browser/webviewEditorInput.ts';
import { IWebviewWorkbenchService } from '../../contrib/webviewPanel/browser/webviewWorkbenchService.ts';
...
import { ResourceWorkingCopy } from '../../services/workingCopy/common/resourceWorkingCopy.ts';
import { IWorkingCopy, IWorkingCopyBackup, IWorkingCopySaveEvent, NO_TYPE_ID, WorkingCopyCapabilities } from '../../services/workingCopy/common/workingCopy.ts';
import { IWorkingCopyFileService, WorkingCopyFileEvent } from '../../services/workingCopy/common/workingCopyFileService.ts';
