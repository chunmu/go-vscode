...
import { CompletionContext, CompletionItem, CompletionItemKind, CompletionList } from '../../../editor/common/languages.ts';
...
import { IChatWidgetService } from '../../contrib/chat/browser/chat.ts';
import { AddDynamicVariableAction, IAddDynamicVariableContext } from '../../contrib/chat/browser/contrib/chatDynamicVariables.ts';
import { IChatAgentHistoryEntry, IChatAgentImplementation, IChatAgentRequest, IChatAgentService } from '../../contrib/chat/common/chatAgents.ts';
import { IChatEditingService, IChatRelatedFileProviderMetadata } from '../../contrib/chat/common/chatEditingService.ts';
import { IChatModel } from '../../contrib/chat/common/chatModel.ts';
import { ChatRequestAgentPart } from '../../contrib/chat/common/chatParserTypes.ts';
import { ChatRequestParser } from '../../contrib/chat/common/chatRequestParser.ts';
import { IChatContentInlineReference, IChatContentReference, IChatFollowup, IChatNotebookEdit, IChatProgress, IChatService, IChatTask, IChatTaskSerialized, IChatWarningMessage } from '../../contrib/chat/common/chatService.ts';
import { IChatSessionsService } from '../../contrib/chat/common/chatSessionsService.ts';
import { LocalChatSessionUri } from '../../contrib/chat/common/chatUri.ts';
import { ChatAgentLocation, ChatModeKind } from '../../contrib/chat/common/constants.ts';
...
import { ExtHostChatAgentsShape2, ExtHostContext, IChatNotebookEditDto, IChatParticipantMetadata, IChatProgressDto, IDynamicChatAgentProps, IExtensionChatAgentMetadata, MainContext, MainThreadChatAgentsShape2 } from '../common/extHost.protocol.ts';
