...
import { ProcessTimeRunOnceScheduler } from '../../../base/common/async.ts';
import { VSBuffer } from '../../../base/common/buffer.ts';
import { PendingMigrationError, isCancellationError, isSigPipeError, onUnexpectedError, onUnexpectedExternalError } from '../../../base/common/errors.ts';
...
import { BufferedEmitter, PersistentProtocol, ProtocolConstants } from '../../../base/parts/ipc/common/ipc.net.ts';
import { NodeSocket, WebSocketNodeSocket } from '../../../base/parts/ipc/node/ipc.net.ts';
import type { MessagePortMain, MessageEvent as UtilityMessageEvent } from '../../../base/parts/sandbox/node/electronTypes.ts';
import { boolean } from '../../../editor/common/config/editorOptions.ts';
import product from '../../../platform/product/common/product.ts';
import { ExtensionHostMain, IExitFn } from '../common/extensionHostMain.ts';
import { IHostUtils } from '../common/extHostExtensionService.ts';
import { createURITransformer } from '../../../base/common/uriTransformer.ts';
import { ExtHostConnectionType, readExtHostConnection } from '../../services/extensions/common/extensionHostEnv.ts';
import { ExtensionHostExitCode, IExtHostReadyMessage, IExtHostReduceGraceTimeMessage, IExtHostSocketMessage, IExtensionHostInitData, MessageType, createMessageOfType, isMessageOfType } from '../../services/extensions/common/extensionHostProtocol.ts';
import { IDisposable } from '../../../base/common/lifecycle.ts';
import '../common/extHost.common.services.ts';
import './extHost.node.services.ts';
