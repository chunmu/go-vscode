...
import { mapArrayOrNot } from '../../../../base/common/arrays.ts';
...
import { MainContext, MainThreadSearchShape } from '../../common/extHost.protocol.ts';
...
import { Range } from '../../common/extHostTypes.ts';
import { URITransformerService } from '../../common/extHostUriTransformerService.ts';
import { NativeExtHostSearch } from '../../node/extHostSearch.ts';
import { TestRPCProtocol } from '../common/testRPCProtocol.ts';
import { IFileMatch, IFileQuery, IPatternInfo, IRawFileMatch2, ISearchCompleteStats, ISearchQuery, ITextQuery, QueryType, resultIsMatch } from '../../../services/search/common/search.ts';
