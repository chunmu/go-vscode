...
import { combinedDisposable } from '../../../base/common/lifecycle.ts';
import { Schemas, matchesScheme } from '../../../base/common/network.ts';
...
import { score, targetsNotebooks } from '../../../editor/common/languageSelector.ts';
import * as languageConfiguration from '../../../editor/common/languages/languageConfiguration.ts';
import { OverviewRulerLane } from '../../../editor/common/model.ts';
import { ExtensionError, ExtensionIdentifierSet, IExtensionDescription } from '../../../platform/extensions/common/extensions.ts';
...
import { ILogService, ILoggerService, LogLevel } from '../../../platform/log/common/log.ts';
...
import { DebugConfigurationProviderTriggerKind } from '../../contrib/debug/common/debug.ts';
...
import { ProxyIdentifier } from '../../services/extensions/common/proxyIdentifier.ts';
import { AISearchKeyword, ExcludeSettingOptions, TextSearchCompleteMessageType, TextSearchContext2, TextSearchMatch2 } from '../../services/search/common/searchExtTypes.ts';
import { CandidatePortSource, ExtHostContext, ExtHostLogLevelServiceShape, MainContext } from './extHost.protocol.ts';
import { ExtHostRelatedInformation } from './extHostAiRelatedInformation.ts';
import { ExtHostAiSettingsSearch } from './extHostAiSettingsSearch.ts';
import { ExtHostApiCommands } from './extHostApiCommands.ts';
...
import { ExtHostBulkEdits } from './extHostBulkEdits.ts';
import { ExtHostChatAgents2 } from './extHostChatAgents2.ts';
import { ExtHostChatOutputRenderer } from './extHostChatOutputRenderer.ts';
import { ExtHostChatSessions } from './extHostChatSessions.ts';
import { ExtHostChatStatus } from './extHostChatStatus.ts';
import { ExtHostClipboard } from './extHostClipboard.ts';
import { ExtHostEditorInsets } from './extHostCodeInsets.ts';
import { ExtHostCodeMapper } from './extHostCodeMapper.ts';
import { IExtHostCommands } from './extHostCommands.ts';
import { createExtHostComments } from './extHostComments.ts';
import { ExtHostConfigProvider, IExtHostConfiguration } from './extHostConfiguration.ts';
import { ExtHostCustomEditors } from './extHostCustomEditors.ts';
import { IExtHostDataChannels } from './extHostDataChannels.ts';
import { IExtHostDebugService } from './extHostDebugService.ts';
import { IExtHostDecorations } from './extHostDecorations.ts';
import { ExtHostDiagnostics } from './extHostDiagnostics.ts';
import { ExtHostDialogs } from './extHostDialogs.ts';
import { ExtHostDocumentContentProvider } from './extHostDocumentContentProviders.ts';
import { ExtHostDocumentSaveParticipant } from './extHostDocumentSaveParticipant.ts';
...
import { ExtHostEmbeddings } from './extHostEmbedding.ts';
import { ExtHostAiEmbeddingVector } from './extHostEmbeddingVector.ts';
import { Extension, IExtHostExtensionService } from './extHostExtensionService.ts';
import { ExtHostFileSystem } from './extHostFileSystem.ts';
import { IExtHostConsumerFileSystem } from './extHostFileSystemConsumer.ts';
import { ExtHostFileSystemEventService, FileSystemWatcherCreateOptions } from './extHostFileSystemEventService.ts';
import { IExtHostFileSystemInfo } from './extHostFileSystemInfo.ts';
import { IExtHostInitDataService } from './extHostInitDataService.ts';
import { ExtHostInteractive } from './extHostInteractive.ts';
import { ExtHostLabelService } from './extHostLabelService.ts';
...
import { IExtHostLanguageModels } from './extHostLanguageModels.ts';
import { ExtHostLanguages } from './extHostLanguages.ts';
import { IExtHostLocalizationService } from './extHostLocalizationService.ts';
import { IExtHostManagedSockets } from './extHostManagedSockets.ts';
import { IExtHostMpcService } from './extHostMcp.ts';
import { ExtHostMessageService } from './extHostMessageService.ts';
import { ExtHostNotebookController } from './extHostNotebook.ts';
import { ExtHostNotebookDocumentSaveParticipant } from './extHostNotebookDocumentSaveParticipant.ts';
import { ExtHostNotebookDocuments } from './extHostNotebookDocuments.ts';
import { ExtHostNotebookEditors } from './extHostNotebookEditors.ts';
import { ExtHostNotebookKernels } from './extHostNotebookKernels.ts';
import { ExtHostNotebookRenderers } from './extHostNotebookRenderers.ts';
import { IExtHostOutputService } from './extHostOutput.ts';
import { ExtHostProfileContentHandlers } from './extHostProfileContentHandler.ts';
import { IExtHostProgress } from './extHostProgress.ts';
import { ExtHostQuickDiff } from './extHostQuickDiff.ts';
import { createExtHostQuickOpen } from './extHostQuickOpen.ts';
import { IExtHostRpcService } from './extHostRpcService.ts';
import { ExtHostSCM } from './extHostSCM.ts';
import { IExtHostSearch } from './extHostSearch.ts';
import { IExtHostSecretState } from './extHostSecretState.ts';
import { ExtHostShare } from './extHostShare.ts';
import { ExtHostSpeech } from './extHostSpeech.ts';
import { ExtHostStatusBar } from './extHostStatusBar.ts';
import { IExtHostStorage } from './extHostStorage.ts';
import { IExtensionStoragePaths } from './extHostStoragePaths.ts';
import { IExtHostTask } from './extHostTask.ts';
import { ExtHostTelemetryLogger, IExtHostTelemetry, isNewAppInstall } from './extHostTelemetry.ts';
import { IExtHostTerminalService } from './extHostTerminalService.ts';
import { IExtHostTerminalShellIntegration } from './extHostTerminalShellIntegration.ts';
import { IExtHostTesting } from './extHostTesting.ts';
import { ExtHostEditors } from './extHostTextEditors.ts';
import { ExtHostTheming } from './extHostTheming.ts';
import { ExtHostTimeline } from './extHostTimeline.ts';
import { ExtHostTreeViews } from './extHostTreeViews.ts';
import { IExtHostTunnelService } from './extHostTunnelService.ts';
import * as typeConverters from './extHostTypeConverters.ts';
import * as extHostTypes from './extHostTypes.ts';
import { ExtHostUriOpeners } from './extHostUriOpener.ts';
...
import { ExtHostWebviewViews } from './extHostWebviewView.ts';
import { IExtHostWindow } from './extHostWindow.ts';
import { IExtHostWorkspace } from './extHostWorkspace.ts';
import { ExtHostChatContext } from './extHostChatContext.ts';
