...
import { asArray, coalesce, isNonEmptyArray } from '../../../base/common/arrays.ts';
import { VSBuffer, encodeBase64 } from '../../../base/common/buffer.ts';
import { IDataTransferFile, IDataTransferItem, UriList } from '../../../base/common/dataTransfer.ts';
...
import { parse, revive } from '../../../base/common/marshalling.ts';
...
import { IPrefixTreeNode, WellDefinedPrefixTree } from '../../../base/common/prefixTree.ts';
import { basename } from '../../../base/common/resources.ts';
import { ThemeIcon } from '../../../base/common/themables.ts';
import { isDefined, isEmptyObject, isNumber, isString, isUndefinedOrNull } from '../../../base/common/types.ts';
import { URI, UriComponents, isUriComponents } from '../../../base/common/uri.ts';
import { IURITransformer } from '../../../base/common/uriIpc.ts';
import { generateUuid } from '../../../base/common/uuid.ts';
import { RenderLineNumbersType } from '../../../editor/common/config/editorOptions.ts';
...
import { IContentDecorationRenderOptions, IDecorationOptions, IDecorationRenderOptions, IThemeDecorationRenderOptions } from '../../../editor/common/editorCommon.ts';
import * as encodedTokenAttributes from '../../../editor/common/encodedTokenAttributes.ts';
import * as languageSelector from '../../../editor/common/languageSelector.ts';
import * as languages from '../../../editor/common/languages.ts';
import { EndOfLineSequence, TrackedRangeStickiness } from '../../../editor/common/model.ts';
import { ITextEditorOptions } from '../../../platform/editor/common/editor.ts';
import { IExtensionDescription, IRelaxedExtensionDescription } from '../../../platform/extensions/common/extensions.ts';
import { ILogService } from '../../../platform/log/common/log.ts';
import { IMarkerData, IRelatedInformation, MarkerSeverity, MarkerTag } from '../../../platform/markers/common/markers.ts';
import { ProgressLocation as MainProgressLocation } from '../../../platform/progress/common/progress.ts';
import { DEFAULT_EDITOR_ASSOCIATION, SaveReason } from '../../common/editor.ts';
import { IViewBadge } from '../../common/views.ts';
import { IChatAgentRequest, IChatAgentResult } from '../../contrib/chat/common/chatAgents.ts';
import { IChatRequestDraft } from '../../contrib/chat/common/chatEditingService.ts';
import { IChatRequestModeInstructions } from '../../contrib/chat/common/chatModel.ts';
import { IChatAgentMarkdownContentWithVulnerability, IChatCodeCitation, IChatCommandButton, IChatConfirmation, IChatContentInlineReference, IChatContentReference, IChatExtensionsContent, IChatFollowup, IChatMarkdownContent, IChatMoveMessage, IChatMultiDiffData, IChatPrepareToolInvocationPart, IChatProgressMessage, IChatPullRequestContent, IChatResponseCodeblockUriPart, IChatTaskDto, IChatTaskResult, IChatTextEdit, IChatThinkingPart, IChatToolInvocationSerialized, IChatTreeData, IChatUserActionEvent, IChatWarningMessage } from '../../contrib/chat/common/chatService.ts';
import { ChatRequestToolReferenceEntry, IChatRequestVariableEntry, isImageVariableEntry, isPromptFileVariableEntry, isPromptTextVariableEntry } from '../../contrib/chat/common/chatVariableEntries.ts';
import { ChatAgentLocation } from '../../contrib/chat/common/constants.ts';
import { IToolInvocationContext, IToolResult, IToolResultInputOutputDetails, IToolResultOutputDetails, ToolDataSource } from '../../contrib/chat/common/languageModelToolsService.ts';
import * as chatProvider from '../../contrib/chat/common/languageModels.ts';
import { IChatMessageDataPart, IChatResponseDataPart, IChatResponsePromptTsxPart, IChatResponseTextPart } from '../../contrib/chat/common/languageModels.ts';
import { DebugTreeItemCollapsibleState, IDebugVisualizationTreeItem } from '../../contrib/debug/common/debug.ts';
import { McpServerLaunch, McpServerTransportType } from '../../contrib/mcp/common/mcpTypes.ts';
import * as notebooks from '../../contrib/notebook/common/notebookCommon.ts';
...
import { CoverageDetails, DetailType, ICoverageCount, IFileCoverage, ISerializedTestResults, ITestErrorMessage, ITestItem, ITestRunProfileReference, ITestTag, TestMessageType, TestResultItem, TestRunProfileBitset, denamespaceTestTag, namespaceTestTag } from '../../contrib/testing/common/testTypes.ts';
import { AiSettingsSearchResult, AiSettingsSearchResultKind } from '../../services/aiSettingsSearch/common/aiSettingsSearch.ts';
import { EditorGroupColumn } from '../../services/editor/common/editorGroupColumn.ts';
import { ACTIVE_GROUP, SIDE_GROUP } from '../../services/editor/common/editorService.ts';
...
import { getPrivateApiFor } from './extHostTestingPrivateApi.ts';
import * as types from './extHostTypes.ts';
import { LanguageModelDataPart, LanguageModelPromptTsxPart, LanguageModelTextPart } from './extHostTypes.ts';
