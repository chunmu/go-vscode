...
import { delta as arrayDelta, mapArrayOrNot } from '../../../base/common/arrays.ts';
import { AsyncIterableProducer, Barrier } from '../../../base/common/async.ts';
...
import { Counter } from '../../../base/common/numbers.ts';
import { basename, basenameOrAuthority, dirname, ExtUri, relativePath } from '../../../base/common/resources.ts';
...
import { FileSystemProviderCapabilities } from '../../../platform/files/common/files.ts';
...
import { Workspace, WorkspaceFolder } from '../../../platform/workspace/common/workspace.ts';
...
import { GlobPattern } from './extHostTypeConverters.ts';
import { Range } from './extHostTypes.ts';
import { IURITransformerService } from './extHostUriTransformerService.ts';
import { IFileQueryBuilderOptions, ISearchPatternBuilder, ITextQueryBuilderOptions } from '../../services/search/common/queryBuilder.ts';
import { IRawFileMatch2, ITextSearchResult, resultIsMatch } from '../../services/search/common/search.ts';
import type * as vscode from 'vscode';
import { ExtHostWorkspaceShape, IRelativePatternDto, IWorkspaceData, MainContext, MainThreadMessageOptions, MainThreadMessageServiceShape, MainThreadWorkspaceShape } from './extHost.protocol.ts';
import { revive } from '../../../base/common/marshalling.ts';
import { AuthInfo, Credentials } from '../../../platform/request/common/request.ts';
import { ExcludeSettingOptions, TextSearchContext2, TextSearchMatch2 } from '../../services/search/common/searchExtTypes.ts';
import { bufferToStream, readableToBuffer, VSBuffer } from '../../../base/common/buffer.ts';
import { toDecodeStream, toEncodeReadable, UTF8 } from '../../services/textfile/common/encoding.ts';
import { consumeStream } from '../../../base/common/stream.ts';
import { stringToSnapshot } from '../../services/textfile/common/textfiles.ts';
