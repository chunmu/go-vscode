...
import { originalFSPath, joinPath, extUriBiasedIgnorePathCase } from '../../../base/common/resources.ts';
import { asPromise, Barrier, IntervalTimer, timeout } from '../../../base/common/async.ts';
import { dispose, toDisposable, Disposable, DisposableStore, IDisposable } from '../../../base/common/lifecycle.ts';
import { TernarySearchTree } from '../../../base/common/ternarySearchTree.ts';
import { URI, UriComponents } from '../../../base/common/uri.ts';
import { ILogService } from '../../../platform/log/common/log.ts';
import { ExtHostExtensionServiceShape, MainContext, MainThreadExtensionServiceShape, MainThreadTelemetryShape, MainThreadWorkspaceShape } from './extHost.protocol.ts';
import { IExtensionDescriptionDelta, IExtensionHostInitData } from '../../services/extensions/common/extensionHostProtocol.ts';
import { ExtHostConfiguration, IExtHostConfiguration } from './extHostConfiguration.ts';
import { ActivatedExtension, EmptyExtension, ExtensionActivationTimes, ExtensionActivationTimesBuilder, ExtensionsActivator, IExtensionAPI, IExtensionModule, HostExtension, ExtensionActivationTimesFragment } from './extHostExtensionActivator.ts';
import { ExtHostStorage, IExtHostStorage } from './extHostStorage.ts';
import { ExtHostWorkspace, IExtHostWorkspace } from './extHostWorkspace.ts';
import { MissingExtensionDependency, ActivationKind, checkProposedApiEnabled, isProposedApiEnabled, ExtensionActivationReason } from '../../services/extensions/common/extensions.ts';
...
import { ExtensionGlobalMemento, ExtensionMemento } from './extHostMemento.ts';
import { RemoteAuthorityResolverError, ExtensionKind, ExtensionMode, ExtensionRuntime, ManagedResolvedAuthority as ExtHostManagedResolvedAuthority } from './extHostTypes.ts';
import { ResolvedAuthority, ResolvedOptions, RemoteAuthorityResolverErrorCode, IRemoteConnectionData, getRemoteAuthorityPrefix, TunnelInformation, ManagedRemoteConnection, WebSocketRemoteConnection } from '../../../platform/remote/common/remoteAuthorityResolver.ts';
import { IInstantiationService, createDecorator } from '../../../platform/instantiation/common/instantiation.ts';
...
import { IExtensionActivationHost, checkActivateWorkspaceContainsExtension } from '../../services/extensions/common/workspaceContains.ts';
import { ExtHostSecretState, IExtHostSecretState } from './extHostSecretState.ts';
import { ExtensionSecrets } from './extHostSecrets.ts';
...
import { isCI, setTimeout0 } from '../../../base/common/platform.ts';
