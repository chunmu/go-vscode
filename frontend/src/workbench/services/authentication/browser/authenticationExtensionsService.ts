...
import { Disposable, DisposableStore, dispose, IDisposable, MutableDisposable } from '../../../../base/common/lifecycle.ts';
import { scopesMatch } from '../../../../base/common/oauth.ts';
...
import { IActivityService, NumberBadge } from '../../activity/common/activity.ts';
import { IAuthenticationAccessService } from './authenticationAccessService.ts';
import { IAuthenticationUsageService } from './authenticationUsageService.ts';
import { AuthenticationSession, IAuthenticationProvider, IAuthenticationService, IAuthenticationExtensionsService, AuthenticationSessionAccount, IAuthenticationWwwAuthenticateRequest, isAuthenticationWwwAuthenticateRequest } from '../common/authentication.ts';
