...
import { Disposable, DisposableMap, DisposableStore, IDisposable, isDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { equalsIgnoreCase, isFalsyOrWhitespace } from '../../../../base/common/strings.ts';
...
import { ActivationKind, IExtensionService } from '../../extensions/common/extensions.ts';
...
import { IAuthorizationProtectedResourceMetadata, IAuthorizationServerMetadata, parseWWWAuthenticateHeader } from '../../../../base/common/oauth.ts';
import { raceCancellation, raceTimeout } from '../../../../base/common/async.ts';
