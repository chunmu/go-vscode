...
import { TestStorageService, TestProductService } from '../../../../test/common/workbenchTestServices.ts';
import { AuthenticationAccessService, IAuthenticationAccessService } from '../../browser/authenticationAccessService.ts';
import { AllowedExtension } from '../../common/authentication.ts';
