...
import { IHostService } from '../browser/host.ts';
...
import { IWindowOpenable, IOpenWindowOptions, isFolderToOpen, isWorkspaceToOpen, IOpenEmptyWindowOptions, IPoint, IRectangle, IOpenedAuxiliaryWindow, IOpenedMainWindow } from '../../../../platform/window/common/window.ts';
import { Disposable } from '../../../../base/common/lifecycle.ts';
import { NativeHostService } from '../../../../platform/native/common/nativeHostService.ts';
...
import { disposableWindowInterval, getActiveDocument, getWindowId, getWindowsCount, hasWindow, onDidRegisterWindow } from '../../../../base/browser/dom.ts';
