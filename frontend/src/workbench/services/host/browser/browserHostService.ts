...
import { IHostService } from './host.ts';
...
import { IWindowSettings, IWindowOpenable, IOpenWindowOptions, isFolderToOpen, isWorkspaceToOpen, isFileToOpen, IOpenEmptyWindowOptions, IPathData, IFileToOpen, IOpenedMainWindow, IOpenedAuxiliaryWindow } from '../../../../platform/window/common/window.ts';
import { isResourceEditorInput, pathsToEditors } from '../../../common/editor.ts';
import { whenEditorClosed } from '../../../browser/editor.ts';
import { IWorkspace, IWorkspaceProvider } from '../../../browser/web.api.ts';
import { IFileService } from '../../../../platform/files/common/files.ts';
import { ILabelService, Verbosity } from '../../../../platform/label/common/label.ts';
import { EventType, ModifierKeyEmitter, addDisposableListener, addDisposableThrottledListener, detectFullscreen, disposableWindowInterval, getActiveDocument, getActiveWindow, getWindowId, onDidRegisterWindow, trackFocus, getWindows as getDOMWindows } from '../../../../base/browser/dom.ts';
...
import { parseLineAndColumnAware } from '../../../../base/common/extpath.ts';
...
import { ILifecycleService, BeforeShutdownEvent, ShutdownReason } from '../../lifecycle/common/lifecycle.ts';
import { BrowserLifecycleService } from '../../lifecycle/browser/lifecycleService.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { getWorkspaceIdentifier } from '../../workspaces/browser/workspaces.ts';
...
import { isTemporaryWorkspace, IWorkspaceContextService, toWorkspaceIdentifier } from '../../../../platform/workspace/common/workspace.ts';
...
import { mainWindow, isAuxiliaryWindow } from '../../../../base/browser/window.ts';
