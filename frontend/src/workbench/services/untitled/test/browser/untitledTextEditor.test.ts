...
import { IUntitledTextEditorService, UntitledTextEditorService } from '../../common/untitledTextEditorService.ts';
import { workbenchInstantiationService, TestServiceAccessor } from '../../../../test/browser/workbenchTestServices.ts';
import { snapshotToString } from '../../../textfile/common/textfiles.ts';
...
import { UntitledTextEditorInput } from '../../common/untitledTextEditorInput.ts';
import { IUntitledTextEditorModel, UntitledTextEditorModel } from '../../common/untitledTextEditorModel.ts';
import { CancellationToken } from '../../../../../base/common/cancellation.ts';
import { EditorInputCapabilities } from '../../../../common/editor.ts';
import { DisposableStore } from '../../../../../base/common/lifecycle.ts';
import { isReadable, isReadableStream } from '../../../../../base/common/stream.ts';
import { readableToBuffer, streamToBuffer, VSBufferReadable, VSBufferReadableStream } from '../../../../../base/common/buffer.ts';
import { LanguageDetectionLanguageEventSource } from '../../../languageDetection/common/languageDetectionWorkerService.ts';
