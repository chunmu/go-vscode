...
import { IEditorSerializer } from '../../../common/editor.ts';
...
import { UntitledTextEditorInput } from './untitledTextEditorInput.ts';
import { IWorkbenchContribution } from '../../../common/contributions.ts';
import { IWorkingCopyIdentifier, NO_TYPE_ID } from '../../workingCopy/common/workingCopy.ts';
import { IWorkingCopyEditorHandler, IWorkingCopyEditorService } from '../../workingCopy/common/workingCopyEditorService.ts';
import { IUntitledTextEditorService } from './untitledTextEditorService.ts';
