...
import { ISaveOptions } from '../../../common/editor.ts';
...
import { IWorkingCopyBackupService } from '../../workingCopy/common/workingCopyBackup.ts';
...
import { createTextBufferFactory, createTextBufferFactoryFromStream } from '../../../../editor/common/model/textModel.ts';
...
import { IWorkingCopy, WorkingCopyCapabilities, IWorkingCopyBackup, NO_TYPE_ID, IWorkingCopySaveEvent } from '../../workingCopy/common/workingCopy.ts';
import { IEncodingSupport, ILanguageSupport, ITextFileService } from '../../textfile/common/textfiles.ts';
...
import { ensureValidWordDefinition } from '../../../../editor/common/core/wordHelper.ts';
import { IEditorService } from '../../editor/common/editorService.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { getCharContainingOffset } from '../../../../base/common/strings.ts';
import { UTF8 } from '../../textfile/common/encoding.ts';
import { bufferToReadable, bufferToStream, VSBuffer, VSBufferReadable, VSBufferReadableStream } from '../../../../base/common/buffer.ts';
