...
import { DEFAULT_EDITOR_ASSOCIATION, findViewStateForEditor, isUntitledResourceEditorInput, IUntitledTextResourceEditorInput, IUntypedEditorInput, Verbosity } from '../../../common/editor.ts';
import { EditorInput, IUntypedEditorOptions } from '../../../common/editor/editorInput.ts';
import { AbstractTextResourceEditorInput } from '../../../common/editor/textResourceEditorInput.ts';
import { IUntitledTextEditorModel } from './untitledTextEditorModel.ts';
import { EncodingMode, IEncodingSupport, ILanguageSupport, ITextFileService } from '../../textfile/common/textfiles.ts';
...
import { DisposableStore, dispose, IReference } from '../../../../base/common/lifecycle.ts';
import { ITextResourceConfigurationService } from '../../../../editor/common/services/textResourceConfiguration.ts';
import { ICustomEditorLabelService } from '../../editor/common/customEditorLabelService.ts';
