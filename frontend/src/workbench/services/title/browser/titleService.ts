...
import { IAuxiliaryTitlebarPart, ITitlebarPart } from '../../../browser/parts/titlebar/titlebarPart.ts';
import { IEditorGroupsContainer } from '../../editor/common/editorGroupsService.ts';
