...
import { getClientArea, getTopLeftOffset, isHTMLDivElement, isHTMLTextAreaElement } from '../../../../base/browser/dom.ts';
import { mainWindow } from '../../../../base/browser/window.ts';
import { coalesce } from '../../../../base/common/arrays.ts';
import { language, locale } from '../../../../base/common/platform.ts';
import { IEnvironmentService } from '../../../../platform/environment/common/environment.ts';
import { IFileService } from '../../../../platform/files/common/files.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import localizedStrings from '../../../../platform/languagePacks/common/localizedStrings.ts';
import { ILogFile, getLogs } from '../../../../platform/log/browser/log.ts';
...
import { IWindowDriver, IElement, ILocaleInfo, ILocalizedStrings } from '../common/driver.ts';
