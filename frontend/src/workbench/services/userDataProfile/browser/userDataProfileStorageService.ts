...
import { IStorageDatabase } from '../../../../base/parts/storage/common/storage.ts';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/extensions.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { AbstractUserDataProfileStorageService, IProfileStorageChanges, IUserDataProfileStorageService } from '../../../../platform/userDataProfile/common/userDataProfileStorageService.ts';
import { IProfileStorageValueChangeEvent, isProfileUsingDefaultStorage, IStorageService, StorageScope } from '../../../../platform/storage/common/storage.ts';
import { IUserDataProfile } from '../../../../platform/userDataProfile/common/userDataProfile.ts';
import { IndexedDBStorageDatabase } from '../../storage/browser/storageService.ts';
import { IUserDataProfileService } from '../common/userDataProfile.ts';
