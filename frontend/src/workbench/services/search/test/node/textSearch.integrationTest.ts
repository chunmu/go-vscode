...
import { flakySuite } from '../../../../../base/test/node/testUtils.ts';
import { deserializeSearchError, IFolderQuery, ISearchRange, ISerializedFileMatch, ITextQuery, ITextSearchContext, ITextSearchMatch, QueryType, SearchErrorCode } from '../../common/search.ts';
import { TextSearchEngineAdapter } from '../../node/textSearchAdapter.ts';
