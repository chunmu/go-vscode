...
import { IFileQuery, IFolderQuery, ISerializedSearchProgressItem, isProgressMessage, QueryType } from '../../common/search.ts';
import { SearchService } from '../../node/rawSearchService.ts';
