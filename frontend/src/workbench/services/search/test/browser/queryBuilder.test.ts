...
import { IExpression } from '../../../../../base/common/glob.ts';
...
import { IWorkspaceContextService, toWorkspaceFolder } from '../../../../../platform/workspace/common/workspace.ts';
import { toWorkspaceFolders } from '../../../../../platform/workspaces/common/workspaces.ts';
import { ISearchPathsInfo, QueryBuilder } from '../../common/queryBuilder.ts';
import { IPathService } from '../../../path/common/pathService.ts';
import { IFileQuery, IFolderQuery, IPatternInfo, ITextQuery, QueryType } from '../../common/search.ts';
import { TestPathService, TestEnvironmentService } from '../../../../test/browser/workbenchTestServices.ts';
import { TestContextService } from '../../../../test/common/workbenchTestServices.ts';
