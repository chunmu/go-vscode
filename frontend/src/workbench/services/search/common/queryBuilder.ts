...
import * as collections from '../../../../base/common/collections.ts';
import * as glob from '../../../../base/common/glob.ts';
import { untildify } from '../../../../base/common/labels.ts';
import { ResourceMap } from '../../../../base/common/map.ts';
import { Schemas } from '../../../../base/common/network.ts';
import * as path from '../../../../base/common/path.ts';
import { isEqual, basename, relativePath, isAbsolutePath } from '../../../../base/common/resources.ts';
import * as strings from '../../../../base/common/strings.ts';
import { assertReturnsDefined, isDefined } from '../../../../base/common/types.ts';
import { URI, URI as uri, UriComponents } from '../../../../base/common/uri.ts';
import { isMultilineRegexSource } from '../../../../editor/common/model/textModelSearch.ts';
...
import { IWorkspaceContextService, IWorkspaceFolderData, toWorkspaceFolder, WorkbenchState } from '../../../../platform/workspace/common/workspace.ts';
import { IEditorGroupsService } from '../../editor/common/editorGroupsService.ts';
import { IPathService } from '../../path/common/pathService.ts';
import { ExcludeGlobPattern, getExcludes, IAITextQuery, ICommonQueryProps, IFileQuery, IFolderQuery, IPatternInfo, ISearchConfiguration, ITextQuery, ITextSearchPreviewOptions, pathIncludedInQuery, QueryType } from './search.ts';
import { GlobPattern } from './searchExtTypes.ts';
