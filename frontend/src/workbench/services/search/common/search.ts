...
import * as extpath from '../../../../base/common/extpath.ts';
import { fuzzyContains, getNLines } from '../../../../base/common/strings.ts';
import { URI, UriComponents } from '../../../../base/common/uri.ts';
import { IFilesConfiguration } from '../../../../platform/files/common/files.ts';
...
import { AISearchKeyword, GlobPattern, TextSearchCompleteMessageType } from './searchExtTypes.ts';
