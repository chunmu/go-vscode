...
import { asArray, coalesce } from '../../../../base/common/arrays.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { URI } from '../../../../base/common/uri.ts';
import { IProgress } from '../../../../platform/progress/common/progress.ts';
import { DEFAULT_TEXT_SEARCH_PREVIEW_OPTIONS } from './search.ts';
import { Range, FileSearchProvider2, FileSearchProviderOptions, ProviderResult, TextSearchComplete2, TextSearchContext2, TextSearchMatch2, TextSearchProvider2, TextSearchProviderOptions, TextSearchQuery2, TextSearchResult2, TextSearchCompleteMessage } from './searchExtTypes.ts';
