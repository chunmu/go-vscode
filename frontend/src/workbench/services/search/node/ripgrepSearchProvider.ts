...
import { OutputChannel } from './ripgrepSearchUtils.ts';
import { RipgrepTextSearchEngine } from './ripgrepTextSearchEngine.ts';
import { TextSearchProvider2, TextSearchComplete2, TextSearchResult2, TextSearchQuery2, TextSearchProviderOptions, } from '../common/searchExtTypes.ts';
