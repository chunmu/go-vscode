...
import { normalizeNFD } from '../../../../base/common/normalization.ts';
import * as extpath from '../../../../base/common/extpath.ts';
import { isMacintosh as isMac } from '../../../../base/common/platform.ts';
import * as strings from '../../../../base/common/strings.ts';
import { IFileQuery, IFolderQuery } from '../common/search.ts';
import { anchorGlob } from './ripgrepSearchUtils.ts';
