...
import * as normalization from '../../../../base/common/normalization.ts';
...
import { IFileQuery, IFolderQuery, IProgressMessage, ISearchEngineStats, IRawFileMatch, ISearchEngine, ISearchEngineSuccess, isFilePatternMatch, hasSiblingFn } from '../common/search.ts';
import { spawnRipgrepCmd } from './ripgrepFileSearch.ts';
import { prepareQuery } from '../../../../base/common/fuzzyScorer.ts';
