...
import { IFileMatch, IProgressMessage, ITextQuery, ITextSearchMatch, ISerializedFileMatch, ISerializedSearchSuccess, resultIsMatch } from '../common/search.ts';
import { RipgrepTextSearchEngine } from './ripgrepTextSearchEngine.ts';
import { NativeTextSearchManager } from './textSearchManager.ts';
