...
import { ILocalFileSearchWorker, LocalFileSearchWorkerHost, IWorkerFileSearchComplete, IWorkerFileSystemDirectoryHandle, IWorkerFileSystemHandle, IWorkerTextSearchComplete } from '../common/localFileSearchWorkerTypes.ts';
import { ICommonQueryProps, IFileMatch, IFileQueryProps, IFolderQuery, IPatternInfo, ITextQueryProps, } from '../common/search.ts';
import * as paths from '../../../../base/common/path.ts';
import { CancellationToken, CancellationTokenSource } from '../../../../base/common/cancellation.ts';
import { getFileResults } from '../common/getFileResults.ts';
import { IgnoreFile } from '../common/ignoreFile.ts';
import { createRegExp } from '../../../../base/common/strings.ts';
