...
import { ShutdownReason, ILifecycleService, StartupKind } from '../common/lifecycle.ts';
...
import { addDisposableListener, EventType } from '../../../../base/browser/dom.ts';
import { IStorageService, WillSaveStateReason } from '../../../../platform/storage/common/storage.ts';
