...
import { ShutdownReason, WillShutdownJoinerOrder } from '../../common/lifecycle.ts';
import { NativeLifecycleService } from '../../electron-browser/lifecycleService.ts';
import { workbenchInstantiationService } from '../../../../test/electron-browser/workbenchTestServices.ts';
