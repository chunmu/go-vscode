...
import { Part } from '../../../browser/part.ts';
import { IDimension } from '../../../../base/browser/dom.ts';
import { Direction, IViewSize } from '../../../../base/browser/ui/grid/grid.ts';
import { isMacintosh, isNative, isWeb } from '../../../../base/common/platform.ts';
import { isAuxiliaryWindow } from '../../../../base/browser/window.ts';
import { CustomTitleBarVisibility, TitleBarSetting, getMenuBarVisibility, hasCustomTitlebar, hasNativeMenu, hasNativeTitlebar } from '../../../../platform/window/common/window.ts';
import { isFullscreen, isWCOEnabled } from '../../../../base/browser/browser.ts';
