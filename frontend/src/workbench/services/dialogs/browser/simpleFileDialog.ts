...
import { IFileService, IFileStat, FileKind, IFileStatWithPartialMetadata } from '../../../../platform/files/common/files.ts';
import { IQuickInputService, IQuickPickItem, IQuickPick, ItemActivation } from '../../../../platform/quickinput/common/quickInput.ts';
import { URI } from '../../../../base/common/uri.ts';
import { isWindows, OperatingSystem } from '../../../../base/common/platform.ts';
import { ISaveDialogOptions, IOpenDialogOptions, IFileDialogService } from '../../../../platform/dialogs/common/dialogs.ts';
...
import { IContextKeyService, IContextKey, RawContextKey } from '../../../../platform/contextkey/common/contextkey.ts';
import { equalsIgnoreCase, format, startsWithIgnoreCase } from '../../../../base/common/strings.ts';
...
import { createCancelablePromise, CancelablePromise } from '../../../../base/common/async.ts';
