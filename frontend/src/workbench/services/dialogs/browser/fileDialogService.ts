...
import { IPickAndOpenOptions, ISaveDialogOptions, IOpenDialogOptions, IFileDialogService, FileFilter, IPromptButton } from '../../../../platform/dialogs/common/dialogs.ts';
import { URI } from '../../../../base/common/uri.ts';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/extensions.ts';
import { AbstractFileDialogService } from './abstractFileDialogService.ts';
...
import { getMediaOrTextMime } from '../../../../base/common/mime.ts';
import { basename } from '../../../../base/common/resources.ts';
import { getActiveWindow, triggerDownload, triggerUpload } from '../../../../base/browser/dom.ts';
import Severity from '../../../../base/common/severity.ts';
import { VSBuffer } from '../../../../base/common/buffer.ts';
import { extractFileListData } from '../../../../platform/dnd/browser/dnd.ts';
