...
import { IWindowOpenable, isWorkspaceToOpen, isFileToOpen } from '../../../../platform/window/common/window.ts';
import { IPickAndOpenOptions, ISaveDialogOptions, IOpenDialogOptions, FileFilter, IFileDialogService, IDialogService, ConfirmResult, getFileNamesMessage } from '../../../../platform/dialogs/common/dialogs.ts';
import { isSavedWorkspace, isTemporaryWorkspace, IWorkspaceContextService, WorkbenchState, WORKSPACE_EXTENSION } from '../../../../platform/workspace/common/workspace.ts';
...
import { isAbsolute as localPathIsAbsolute, normalize as localPathNormalize } from '../../../../base/common/path.ts';
import { IInstantiationService, } from '../../../../platform/instantiation/common/instantiation.ts';
import { ISimpleFileDialog, SimpleFileDialog } from './simpleFileDialog.ts';
...
import { PLAINTEXT_EXTENSION } from '../../../../editor/common/languages/modesRegistry.ts';
...
import { EditorOpenSource } from '../../../../platform/editor/common/editor.ts';
