...
import { AbstractURLService } from '../../../../platform/url/common/urlService.ts';
import { Event } from '../../../../base/common/event.ts';
import { IBrowserWorkbenchEnvironmentService } from '../../environment/browser/environmentService.ts';
import { IOpenerService, IOpener, OpenExternalOptions, OpenInternalOptions } from '../../../../platform/opener/common/opener.ts';
