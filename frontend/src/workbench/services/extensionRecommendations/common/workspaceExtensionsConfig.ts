...
import { JSONPath, parse } from '../../../../base/common/json.ts';
...
import { isWorkspace, IWorkspace, IWorkspaceContextService, IWorkspaceFolder } from '../../../../platform/workspace/common/workspace.ts';
...
import { IJSONEditingService, IJSONValue } from '../../configuration/common/jsonEditing.ts';
