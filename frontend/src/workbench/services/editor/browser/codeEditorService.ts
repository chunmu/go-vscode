...
import { ICodeEditor, isCodeEditor, isDiffEditor, isCompositeEditor, getCodeEditor } from '../../../../editor/browser/editorBrowser.ts';
import { AbstractCodeEditorService } from '../../../../editor/browser/services/abstractCodeEditorService.ts';
...
import { IWorkbenchEditorConfiguration } from '../../../common/editor.ts';
import { ACTIVE_GROUP, IEditorService, SIDE_GROUP } from '../common/editorService.ts';
