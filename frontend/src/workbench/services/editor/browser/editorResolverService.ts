...
import { distinct, insert } from '../../../../base/common/arrays.ts';
import { Disposable, DisposableStore, IDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { basename, extname, isEqual } from '../../../../base/common/resources.ts';
import { URI } from '../../../../base/common/uri.ts';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { EditorActivation, EditorResolution, IEditorOptions } from '../../../../platform/editor/common/editor.ts';
...
import { IEditorGroup, IEditorGroupsService } from '../common/editorGroupsService.ts';
import { Schemas } from '../../../../base/common/network.ts';
import { RegisteredEditorInfo, RegisteredEditorPriority, RegisteredEditorOptions, EditorAssociation, EditorAssociations, editorsAssociationsSettingId, globMatchesResource, IEditorResolverService, priorityToRank, ResolvedEditor, ResolvedStatus, EditorInputFactoryObject } from '../common/editorResolverService.ts';
import { QuickPickItem, IKeyMods, IQuickInputService, IQuickPickItem, IQuickPickSeparator } from '../../../../platform/quickinput/common/quickInput.ts';
...
import { PreferredGroup } from '../common/editorService.ts';
import { SideBySideEditorInput } from '../../../common/editor/sideBySideEditorInput.ts';
import { PauseableEmitter } from '../../../../base/common/event.ts';
