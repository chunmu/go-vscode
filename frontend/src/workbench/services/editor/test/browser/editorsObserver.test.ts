...
import { IEditorFactoryRegistry, EditorExtensions, EditorInputCapabilities } from '../../../../common/editor.ts';
import { URI } from '../../../../../base/common/uri.ts';
import { workbenchInstantiationService, TestFileEditorInput, registerTestEditor, TestEditorPart, createEditorPart, registerTestSideBySideEditor } from '../../../../test/browser/workbenchTestServices.ts';
...
import { GroupDirection, IEditorGroupsService } from '../../common/editorGroupsService.ts';
import { EditorActivation } from '../../../../../platform/editor/common/editor.ts';
import { WillSaveStateReason } from '../../../../../platform/storage/common/storage.ts';
