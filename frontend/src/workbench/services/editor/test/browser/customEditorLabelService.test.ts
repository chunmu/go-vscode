...
import { CustomEditorLabelService } from '../../common/customEditorLabelService.ts';
import { ITestInstantiationService, TestServiceAccessor, workbenchInstantiationService } from '../../../../test/browser/workbenchTestServices.ts';
