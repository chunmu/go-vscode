...
import { EditorResolverService } from '../../browser/editorResolverService.ts';
import { IEditorGroupsService } from '../../common/editorGroupsService.ts';
import { IEditorResolverService, ResolvedStatus, RegisteredEditorPriority } from '../../common/editorResolverService.ts';
import { createEditorPart, ITestInstantiationService, TestFileEditorInput, TestServiceAccessor, workbenchInstantiationService } from '../../../../test/browser/workbenchTestServices.ts';
