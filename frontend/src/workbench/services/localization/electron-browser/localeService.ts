...
import { Language, LANGUAGE_DEFAULT } from '../../../../base/common/platform.ts';
...
import { IActiveLanguagePackService, ILocaleService } from '../common/locale.ts';
...
import { IViewPaneContainer, ViewContainerLocation } from '../../../common/views.ts';
