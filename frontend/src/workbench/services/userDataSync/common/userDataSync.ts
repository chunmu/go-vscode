...
import { IAuthenticationProvider, SyncStatus, SyncResource, IUserDataSyncResource, IResourcePreview } from '../../../../platform/userDataSync/common/userDataSync.ts';
...
import { IAction2Options } from '../../../../platform/actions/common/actions.ts';
