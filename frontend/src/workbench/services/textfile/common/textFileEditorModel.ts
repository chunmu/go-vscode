...
import { EncodingMode, ITextFileService, TextFileEditorModelState, ITextFileEditorModel, ITextFileStreamContent, ITextFileResolveOptions, IResolvedTextFileEditorModel, TextFileResolveReason, ITextFileEditorModelSaveEvent, ITextFileSaveAsOptions } from './textfiles.ts';
import { IRevertOptions, SaveReason, SaveSourceRegistry } from '../../../common/editor.ts';
import { BaseTextEditorModel } from '../../../common/editor/textEditorModel.ts';
import { IWorkingCopyBackupService, IResolvedWorkingCopyBackup } from '../../workingCopy/common/workingCopyBackup.ts';
import { IFileService, FileOperationError, FileOperationResult, FileChangesEvent, FileChangeType, IFileStatWithMetadata, ETAG_DISABLED, NotModifiedSinceFileOperationError } from '../../../../platform/files/common/files.ts';
...
import { timeout, TaskSequentializer } from '../../../../base/common/async.ts';
import { ITextBufferFactory, ITextModel } from '../../../../editor/common/model.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { basename } from '../../../../base/common/path.ts';
import { IWorkingCopyService } from '../../workingCopy/common/workingCopyService.ts';
import { IWorkingCopyBackup, WorkingCopyCapabilities, NO_TYPE_ID, IWorkingCopyBackupMeta } from '../../workingCopy/common/workingCopy.ts';
...
import { UTF16be, UTF16le, UTF8, UTF8_with_bom } from './encoding.ts';
import { createTextBufferFactoryFromStream } from '../../../../editor/common/model/textModel.ts';
import { ILanguageDetectionService } from '../../languageDetection/common/languageDetectionWorkerService.ts';
import { IPathService } from '../../path/common/pathService.ts';
import { extUri } from '../../../../base/common/resources.ts';
...
import { IProgress, IProgressService, IProgressStep, ProgressLocation } from '../../../../platform/progress/common/progress.ts';
import { isCancellationError } from '../../../../base/common/errors.ts';
import { TextModelEditSource, EditSources } from '../../../../editor/common/textModelEditSource.ts';
