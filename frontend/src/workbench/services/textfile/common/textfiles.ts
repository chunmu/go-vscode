...
import { ReadableStream } from '../../../../base/common/stream.ts';
import { IBaseFileStatWithMetadata, IFileStatWithMetadata, IWriteFileOptions, FileOperationError, FileOperationResult, IReadFileStreamOptions, IFileReadLimits } from '../../../../platform/files/common/files.ts';
import { createDecorator } from '../../../../platform/instantiation/common/instantiation.ts';
import { ITextEditorModel } from '../../../../editor/common/services/resolverService.ts';
import { ITextBufferFactory, ITextModel, ITextSnapshot } from '../../../../editor/common/model.ts';
import { VSBuffer, VSBufferReadable, VSBufferReadableStream } from '../../../../base/common/buffer.ts';
import { areFunctions, isUndefinedOrNull } from '../../../../base/common/types.ts';
import { IWorkingCopy, IWorkingCopySaveEvent } from '../../workingCopy/common/workingCopy.ts';
import { IUntitledTextEditorModelManager } from '../../untitled/common/untitledTextEditorService.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { IProgress, IProgressStep } from '../../../../platform/progress/common/progress.ts';
import { IFileOperationUndoRedoInfo } from '../../workingCopy/common/workingCopyFileService.ts';
