...
import { TextFileEditorModel } from './textFileEditorModel.ts';
import { dispose, IDisposable, Disposable, DisposableStore } from '../../../../base/common/lifecycle.ts';
import { ITextFileEditorModel, ITextFileEditorModelManager, ITextFileEditorModelResolveOrCreateOptions, ITextFileResolveEvent, ITextFileSaveEvent, ITextFileSaveParticipant } from './textfiles.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { ResourceMap } from '../../../../base/common/map.ts';
import { IFileService, FileChangesEvent, FileOperation, FileChangeType, IFileSystemProviderRegistrationEvent, IFileSystemProviderCapabilitiesChangeEvent } from '../../../../platform/files/common/files.ts';
import { Promises, ResourceQueue } from '../../../../base/common/async.ts';
...
import { IStoredFileWorkingCopySaveParticipantContext, IWorkingCopyFileService, WorkingCopyFileEvent } from '../../workingCopy/common/workingCopyFileService.ts';
import { ITextSnapshot } from '../../../../editor/common/model.ts';
import { extname, joinPath } from '../../../../base/common/resources.ts';
import { createTextBufferFactoryFromSnapshot } from '../../../../editor/common/model/textModel.ts';
import { PLAINTEXT_EXTENSION, PLAINTEXT_LANGUAGE_ID } from '../../../../editor/common/languages/modesRegistry.ts';
import { IUriIdentityService } from '../../../../platform/uriIdentity/common/uriIdentity.ts';
import { IProgress, IProgressStep } from '../../../../platform/progress/common/progress.ts';
