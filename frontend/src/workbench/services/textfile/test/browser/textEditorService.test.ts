...
import { IResourceDiffEditorInput, IResourceSideBySideEditorInput, isResourceDiffEditorInput, isResourceSideBySideEditorInput, isUntitledResourceEditorInput } from '../../../../common/editor.ts';
import { workbenchInstantiationService, registerTestEditor, TestFileEditorInput, registerTestResourceEditor, registerTestSideBySideEditor } from '../../../../test/browser/workbenchTestServices.ts';
...
import { UntitledTextEditorModel } from '../../../untitled/common/untitledTextEditorModel.ts';
import { NullFileSystemProvider } from '../../../../../platform/files/test/common/nullFileSystemProvider.ts';
...
import { ITextFileEditorModel } from '../../common/textfiles.ts';
import { TextEditorService } from '../../common/textEditorService.ts';
