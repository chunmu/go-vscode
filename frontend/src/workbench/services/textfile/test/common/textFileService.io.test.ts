...
import { ITextFileService, snapshotToString, TextFileOperationError, TextFileOperationResult, stringToSnapshot } from '../../common/textfiles.ts';
import { URI } from '../../../../../base/common/uri.ts';
import { join, basename } from '../../../../../base/common/path.ts';
import { UTF16le, UTF8_with_bom, UTF16be, UTF8, UTF16le_BOM, UTF16be_BOM, UTF8_BOM } from '../../common/encoding.ts';
import { bufferToStream, VSBuffer } from '../../../../../base/common/buffer.ts';
import { createTextModel } from '../../../../../editor/test/common/testTextModel.ts';
import { ITextSnapshot, DefaultEndOfLine } from '../../../../../editor/common/model.ts';
