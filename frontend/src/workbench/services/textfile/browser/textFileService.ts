...
import { IRevertOptions, SaveSourceRegistry } from '../../../common/editor.ts';
import { ILifecycleService } from '../../lifecycle/common/lifecycle.ts';
import { IFileService, FileOperationError, FileOperationResult, IFileStatWithMetadata, ICreateFileOptions, IFileStreamContent } from '../../../../platform/files/common/files.ts';
import { Disposable } from '../../../../base/common/lifecycle.ts';
import { extname as pathExtname } from '../../../../base/common/path.ts';
import { IWorkbenchEnvironmentService } from '../../environment/common/environmentService.ts';
import { IUntitledTextEditorService, IUntitledTextEditorModelManager } from '../../untitled/common/untitledTextEditorService.ts';
import { IResolvedUntitledTextEditorModel, UntitledTextEditorModel } from '../../untitled/common/untitledTextEditorModel.ts';
import { TextFileEditorModelManager } from '../common/textFileEditorModelManager.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { Schemas } from '../../../../base/common/network.ts';
import { createTextBufferFactoryFromSnapshot, createTextBufferFactoryFromStream } from '../../../../editor/common/model/textModel.ts';
import { IModelService } from '../../../../editor/common/services/model.ts';
import { joinPath, dirname, basename, toLocalResource, extname, isEqual } from '../../../../base/common/resources.ts';
import { IDialogService, IFileDialogService } from '../../../../platform/dialogs/common/dialogs.ts';
import { VSBuffer, VSBufferReadable, bufferToStream, VSBufferReadableStream } from '../../../../base/common/buffer.ts';
import { ITextSnapshot, ITextModel } from '../../../../editor/common/model.ts';
...
import { IResolvedTextEditorModel } from '../../../../editor/common/services/resolverService.ts';
...
import { IWorkingCopyFileService, IFileOperationUndoRedoInfo, ICreateFileOperation } from '../../workingCopy/common/workingCopyFileService.ts';
import { IUriIdentityService } from '../../../../platform/uriIdentity/common/uriIdentity.ts';
import { IWorkspaceContextService, WORKSPACE_EXTENSION } from '../../../../platform/workspace/common/workspace.ts';
import { UTF8, UTF8_with_bom, UTF16be, UTF16le, encodingExists, toEncodeReadable, toDecodeStream, IDecodeStreamResult, DecodeStreamError, DecodeStreamErrorKind } from '../common/encoding.ts';
import { consumeStream, ReadableStream } from '../../../../base/common/stream.ts';
...
import { IDecorationData, IDecorationsProvider, IDecorationsService } from '../../decorations/common/decorations.ts';
import { Emitter } from '../../../../base/common/event.ts';
import { Codicon } from '../../../../base/common/codicons.ts';
import { listErrorForeground } from '../../../../platform/theme/common/colorRegistry.ts';
