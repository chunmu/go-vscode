...
import { IWorkspaceEditingService } from '../common/workspaceEditing.ts';
import { URI } from '../../../../base/common/uri.ts';
import { localize } from '../../../../nls.ts';
import { hasWorkspaceFileExtension, isSavedWorkspace, isUntitledWorkspace, isWorkspaceIdentifier, IWorkspaceContextService, IWorkspaceIdentifier, toWorkspaceIdentifier, WorkbenchState, WORKSPACE_EXTENSION, WORKSPACE_FILTER } from '../../../../platform/workspace/common/workspace.ts';
import { IJSONEditingService, JSONEditingError, JSONEditingErrorCode } from '../../configuration/common/jsonEditing.ts';
import { IWorkspaceFolderCreationData, IWorkspacesService, rewriteWorkspaceFileForNewLocation, IEnterWorkspaceResult, IStoredWorkspace } from '../../../../platform/workspaces/common/workspaces.ts';
import { WorkspaceService } from '../../configuration/browser/configurationService.ts';
import { ConfigurationScope, IConfigurationRegistry, Extensions as ConfigurationExtensions, IConfigurationPropertySchema } from '../../../../platform/configuration/common/configurationRegistry.ts';
import { Registry } from '../../../../platform/registry/common/platform.ts';
import { ICommandService } from '../../../../platform/commands/common/commands.ts';
import { distinct } from '../../../../base/common/arrays.ts';
import { basename, isEqual, isEqualAuthority, joinPath, removeTrailingPathSeparator } from '../../../../base/common/resources.ts';
...
import { IWorkbenchConfigurationService } from '../../configuration/common/configuration.ts';
