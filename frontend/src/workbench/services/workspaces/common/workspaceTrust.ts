...
import { IPath } from '../../../../platform/window/common/window.ts';
...
import { isVirtualResource } from '../../../../platform/workspace/common/virtualWorkspace.ts';
import { IStorageService, StorageScope, StorageTarget } from '../../../../platform/storage/common/storage.ts';
import { ISingleFolderWorkspaceIdentifier, isSavedWorkspace, isSingleFolderWorkspaceIdentifier, isTemporaryWorkspace, IWorkspace, IWorkspaceContextService, IWorkspaceFolder, toWorkspaceIdentifier, WorkbenchState } from '../../../../platform/workspace/common/workspace.ts';
import { WorkspaceTrustRequestOptions, IWorkspaceTrustManagementService, IWorkspaceTrustInfo, IWorkspaceTrustUriInfo, IWorkspaceTrustRequestService, IWorkspaceTrustTransitionParticipant, WorkspaceTrustUriResponse, IWorkspaceTrustEnablementService } from '../../../../platform/workspace/common/workspaceTrust.ts';
...
import { isEqualAuthority } from '../../../../base/common/resources.ts';
import { isWeb } from '../../../../base/common/platform.ts';
import { IFileService } from '../../../../platform/files/common/files.ts';
import { promiseWithResolvers } from '../../../../base/common/async.ts';
