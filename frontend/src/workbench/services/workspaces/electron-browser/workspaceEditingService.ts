...
import { hasWorkspaceFileExtension, isUntitledWorkspace, isWorkspaceIdentifier, IWorkspaceContextService } from '../../../../platform/workspace/common/workspace.ts';
...
import { ILifecycleService, ShutdownReason } from '../../lifecycle/common/lifecycle.ts';
...
import { AbstractWorkspaceEditingService } from '../browser/abstractWorkspaceEditingService.ts';
import { INativeHostService } from '../../../../platform/native/common/native.ts';
import { isMacintosh } from '../../../../base/common/platform.ts';
import { WorkingCopyBackupService } from '../../workingCopy/common/workingCopyBackupService.ts';
