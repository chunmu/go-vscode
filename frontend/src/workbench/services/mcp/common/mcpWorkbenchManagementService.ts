...
import { IInstantiationService, refineServiceDecorator } from '../../../../platform/instantiation/common/instantiation.ts';
import { IUserDataProfileService } from '../../../services/userDataProfile/common/userDataProfile.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { IMcpResourceScannerService, McpResourceTarget } from '../../../../platform/mcp/common/mcpResourceScannerService.ts';
import { isWorkspaceFolder, IWorkspaceContextService, IWorkspaceFolder, IWorkspaceFoldersChangeEvent } from '../../../../platform/workspace/common/workspace.ts';
import { IUriIdentityService } from '../../../../platform/uriIdentity/common/uriIdentity.ts';
import { MCP_CONFIGURATION_KEY, WORKSPACE_STANDALONE_CONFIGURATIONS } from '../../configuration/common/configuration.ts';
...
import { AbstractMcpManagementService, AbstractMcpResourceManagementService, ILocalMcpServerInfo } from '../../../../platform/mcp/common/mcpManagementService.ts';
import { IFileService } from '../../../../platform/files/common/files.ts';
import { ResourceMap } from '../../../../base/common/map.ts';
import { IMarkdownString } from '../../../../base/common/htmlContent.ts';
import { IMcpServerConfiguration } from '../../../../platform/mcp/common/mcpPlatformTypes.ts';
