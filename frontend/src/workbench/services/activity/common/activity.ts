...
import { activityErrorBadgeBackground, activityErrorBadgeForeground, activityWarningBadgeBackground, activityWarningBadgeForeground } from '../../../../platform/theme/common/colors/miscColors.ts';
import { IColorTheme } from '../../../../platform/theme/common/themeService.ts';
import { ViewContainer } from '../../../common/views.ts';
