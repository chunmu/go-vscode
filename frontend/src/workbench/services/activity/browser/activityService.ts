...
import { IActivityService, IActivity } from '../common/activity.ts';
import { IDisposable, Disposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/extensions.ts';
import { IViewDescriptorService, ViewContainer } from '../../../common/views.ts';
import { GLOBAL_ACTIVITY_ID, ACCOUNTS_ACTIVITY_ID } from '../../../common/activity.ts';
