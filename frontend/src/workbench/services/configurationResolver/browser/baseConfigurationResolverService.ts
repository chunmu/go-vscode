...
import { ConfigurationTarget, IConfigurationOverrides, IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { ILabelService } from '../../../../platform/label/common/label.ts';
import { IInputOptions, IPickOptions, IQuickInputService, IQuickPickItem } from '../../../../platform/quickinput/common/quickInput.ts';
import { IStorageService, StorageScope, StorageTarget } from '../../../../platform/storage/common/storage.ts';
import { IWorkspaceContextService, IWorkspaceFolderData } from '../../../../platform/workspace/common/workspace.ts';
...
import { ConfiguredInput, VariableError, VariableKind } from '../common/configurationResolver.ts';
import { ConfigurationResolverExpression, IResolvedValue } from '../common/configurationResolverExpression.ts';
import { AbstractVariableResolverService } from '../common/variableResolver.ts';
