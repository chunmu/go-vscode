...
import { IProcessEnvironment, isWindows } from '../../../../base/common/platform.ts';
...
import { allVariableKinds, IConfigurationResolverService, VariableError, VariableKind } from './configurationResolver.ts';
import { ConfigurationResolverExpression, IResolvedValue, Replacement } from './configurationResolverExpression.ts';
