...
import { ETAG_DISABLED, FileOperationError, FileOperationResult, IFileReadLimits, IFileService, IFileStatWithMetadata, IFileStreamContent, IWriteFileOptions, NotModifiedSinceFileOperationError } from '../../../../platform/files/common/files.ts';
import { ISaveOptions, IRevertOptions, SaveReason } from '../../../common/editor.ts';
import { IWorkingCopyService } from './workingCopyService.ts';
import { IWorkingCopyBackup, IWorkingCopyBackupMeta, IWorkingCopySaveEvent, WorkingCopyCapabilities } from './workingCopy.ts';
import { raceCancellation, TaskSequentializer, timeout } from '../../../../base/common/async.ts';
...
import { IWorkingCopyBackupService, IResolvedWorkingCopyBackup } from './workingCopyBackup.ts';
...
import { isErrorWithActions, toErrorMessage } from '../../../../base/common/errorMessage.ts';
...
import { IResourceWorkingCopy, ResourceWorkingCopy } from './resourceWorkingCopy.ts';
import { IFileWorkingCopy, IFileWorkingCopyModel, IFileWorkingCopyModelFactory, SnapshotContext } from './fileWorkingCopy.ts';
