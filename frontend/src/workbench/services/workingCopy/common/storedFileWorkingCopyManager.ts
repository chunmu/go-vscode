...
import { StoredFileWorkingCopy, StoredFileWorkingCopyState, IStoredFileWorkingCopy, IStoredFileWorkingCopyModel, IStoredFileWorkingCopyModelFactory, IStoredFileWorkingCopyResolveOptions, IStoredFileWorkingCopySaveEvent as IBaseStoredFileWorkingCopySaveEvent } from './storedFileWorkingCopy.ts';
import { ResourceMap } from '../../../../base/common/map.ts';
import { Promises, ResourceQueue } from '../../../../base/common/async.ts';
import { FileChangesEvent, FileChangeType, FileOperation, IFileService, IFileSystemProviderCapabilitiesChangeEvent, IFileSystemProviderRegistrationEvent } from '../../../../platform/files/common/files.ts';
...
import { IWorkingCopyFileService, WorkingCopyFileEvent } from './workingCopyFileService.ts';
...
import { BaseFileWorkingCopyManager, IBaseFileWorkingCopyManager } from './abstractFileWorkingCopyManager.ts';
...
import { SnapshotContext } from './fileWorkingCopy.ts';
