...
import { ILifecycleService, LifecyclePhase, WillShutdownEvent } from '../../lifecycle/common/lifecycle.ts';
import { WorkingCopyHistoryTracker } from './workingCopyHistoryTracker.ts';
import { Disposable } from '../../../../base/common/lifecycle.ts';
import { IWorkingCopyHistoryEntry, IWorkingCopyHistoryEntryDescriptor, IWorkingCopyHistoryEvent, IWorkingCopyHistoryService, MAX_PARALLEL_HISTORY_IO_OPS } from './workingCopyHistory.ts';
import { FileOperationError, FileOperationResult, IFileService, IFileStatWithMetadata } from '../../../../platform/files/common/files.ts';
import { IRemoteAgentService } from '../../remote/common/remoteAgentService.ts';
import { URI } from '../../../../base/common/uri.ts';
import { DeferredPromise, Limiter, RunOnceScheduler } from '../../../../base/common/async.ts';
...
import { indexOfPath, randomPath } from '../../../../base/common/extpath.ts';
...
import { SaveSource, SaveSourceRegistry } from '../../../common/editor.ts';
