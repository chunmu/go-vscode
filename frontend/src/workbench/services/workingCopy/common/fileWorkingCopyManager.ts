...
import { toLocalResource, joinPath, isEqual, basename, dirname } from '../../../../base/common/resources.ts';
import { URI } from '../../../../base/common/uri.ts';
import { IFileDialogService, IDialogService } from '../../../../platform/dialogs/common/dialogs.ts';
import { IFileService } from '../../../../platform/files/common/files.ts';
import { ISaveOptions, SaveSourceRegistry } from '../../../common/editor.ts';
...
import { IStoredFileWorkingCopy, IStoredFileWorkingCopyModel, IStoredFileWorkingCopyModelFactory, IStoredFileWorkingCopyResolveOptions, StoredFileWorkingCopyState } from './storedFileWorkingCopy.ts';
import { StoredFileWorkingCopyManager, IStoredFileWorkingCopyManager, IStoredFileWorkingCopyManagerResolveOptions } from './storedFileWorkingCopyManager.ts';
import { IUntitledFileWorkingCopy, IUntitledFileWorkingCopyModel, IUntitledFileWorkingCopyModelFactory, UntitledFileWorkingCopy } from './untitledFileWorkingCopy.ts';
import { INewOrExistingUntitledFileWorkingCopyOptions, INewUntitledFileWorkingCopyOptions, INewUntitledFileWorkingCopyWithAssociatedResourceOptions, IUntitledFileWorkingCopyManager, UntitledFileWorkingCopyManager } from './untitledFileWorkingCopyManager.ts';
import { IWorkingCopyFileService } from './workingCopyFileService.ts';
import { IBaseFileWorkingCopyManager } from './abstractFileWorkingCopyManager.ts';
import { IFileWorkingCopy, SnapshotContext } from './fileWorkingCopy.ts';
...
import { IWorkingCopyBackupService } from './workingCopyBackup.ts';
import { IWorkingCopyEditorService } from './workingCopyEditorService.ts';
import { IWorkingCopyService } from './workingCopyService.ts';
