...
import { IWorkingCopy, IWorkingCopyIdentifier, WorkingCopyCapabilities } from './workingCopy.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { ShutdownReason, ILifecycleService, LifecyclePhase, InternalBeforeShutdownEvent } from '../../lifecycle/common/lifecycle.ts';
...
import { IWorkingCopyEditorHandler, IWorkingCopyEditorService } from './workingCopyEditorService.ts';
