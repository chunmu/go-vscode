...
import { NativeWorkingCopyBackupTracker } from '../../electron-browser/workingCopyBackupTracker.ts';
import { TextFileEditorModelManager } from '../../../textfile/common/textFileEditorModelManager.ts';
...
import { IWorkingCopyService } from '../../common/workingCopyService.ts';
import { ILogService } from '../../../../../platform/log/common/log.ts';
import { HotExitConfiguration } from '../../../../../platform/files/common/files.ts';
import { ShutdownReason, ILifecycleService } from '../../../lifecycle/common/lifecycle.ts';
...
import { createEditorPart, registerTestFileEditor, TestBeforeShutdownEvent, TestEnvironmentService, TestFilesConfigurationService, TestFileService, TestTextResourceConfigurationService, workbenchTeardown } from '../../../../test/browser/workbenchTestServices.ts';
...
import { TestWorkspace, Workspace } from '../../../../../platform/workspace/test/common/testWorkspace.ts';
import { IProgressService } from '../../../../../platform/progress/common/progress.ts';
import { IWorkingCopyEditorService } from '../../common/workingCopyEditorService.ts';
import { TestContextService, TestMarkerService, TestWorkingCopy } from '../../../../test/common/workbenchTestServices.ts';
import { CancellationToken } from '../../../../../base/common/cancellation.ts';
import { IWorkingCopyBackup, WorkingCopyCapabilities } from '../../common/workingCopy.ts';
...
import { TestServiceAccessor, workbenchInstantiationService } from '../../../../test/electron-browser/workbenchTestServices.ts';
