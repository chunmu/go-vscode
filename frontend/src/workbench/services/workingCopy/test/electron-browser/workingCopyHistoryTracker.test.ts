...
import { TestContextService, TestWorkingCopy } from '../../../../test/common/workbenchTestServices.ts';
import { randomPath } from '../../../../../base/common/extpath.ts';
import { join } from '../../../../../base/common/path.ts';
import { URI } from '../../../../../base/common/uri.ts';
import { WorkingCopyHistoryTracker } from '../../common/workingCopyHistoryTracker.ts';
import { WorkingCopyService } from '../../common/workingCopyService.ts';
import { UriIdentityService } from '../../../../../platform/uriIdentity/common/uriIdentityService.ts';
import { TestFileService, TestPathService } from '../../../../test/browser/workbenchTestServices.ts';
import { DeferredPromise } from '../../../../../base/common/async.ts';
import { IFileService } from '../../../../../platform/files/common/files.ts';
import { Schemas } from '../../../../../base/common/network.ts';
import { basename, dirname, isEqual, joinPath } from '../../../../../base/common/resources.ts';
...
import { IWorkingCopyHistoryEntry, IWorkingCopyHistoryEntryDescriptor } from '../../common/workingCopyHistory.ts';
import { assertReturnsDefined } from '../../../../../base/common/types.ts';
import { VSBuffer } from '../../../../../base/common/buffer.ts';
import { DisposableStore } from '../../../../../base/common/lifecycle.ts';
import { ensureNoDisposablesAreLeakedInTestSuite } from '../../../../../base/test/common/utils.ts';
import { TestWorkingCopyHistoryService } from './workingCopyHistoryService.test.ts';
