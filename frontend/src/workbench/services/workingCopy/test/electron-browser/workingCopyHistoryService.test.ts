...
import { TestContextService, TestStorageService, TestWorkingCopy } from '../../../../test/common/workbenchTestServices.ts';
...
import { IWorkingCopyHistoryEntry, IWorkingCopyHistoryEntryDescriptor, IWorkingCopyHistoryEvent } from '../../common/workingCopyHistory.ts';
import { IFileService } from '../../../../../platform/files/common/files.ts';
import { UriIdentityService } from '../../../../../platform/uriIdentity/common/uriIdentityService.ts';
import { LabelService } from '../../../label/common/labelService.ts';
import { TestEnvironmentService, TestLifecycleService, TestPathService, TestRemoteAgentService, TestWillShutdownEvent } from '../../../../test/browser/workbenchTestServices.ts';
