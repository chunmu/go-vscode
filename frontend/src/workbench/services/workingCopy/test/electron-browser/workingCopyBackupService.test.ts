...
import { insert } from '../../../../../base/common/arrays.ts';
import { hash } from '../../../../../base/common/hash.ts';
import { isEqual, joinPath, dirname } from '../../../../../base/common/resources.ts';
import { join } from '../../../../../base/common/path.ts';
import { URI } from '../../../../../base/common/uri.ts';
import { WorkingCopyBackupsModel, hashIdentifier } from '../../common/workingCopyBackupService.ts';
...
import { LogLevel, NullLogService } from '../../../../../platform/log/common/log.ts';
import { NativeWorkbenchEnvironmentService } from '../../../environment/electron-browser/environmentService.ts';
import { toBufferOrReadable } from '../../../textfile/common/textfiles.ts';
import { IFileService } from '../../../../../platform/files/common/files.ts';
import { NativeWorkingCopyBackupService } from '../../electron-browser/workingCopyBackupService.ts';
import { FileUserDataProvider } from '../../../../../platform/userData/common/fileUserDataProvider.ts';
import { bufferToReadable, bufferToStream, streamToBuffer, VSBuffer, VSBufferReadable, VSBufferReadableStream } from '../../../../../base/common/buffer.ts';
import { TestLifecycleService, toTypedWorkingCopyId, toUntypedWorkingCopyId } from '../../../../test/browser/workbenchTestServices.ts';
import { CancellationToken, CancellationTokenSource } from '../../../../../base/common/cancellation.ts';
import { IWorkingCopyBackupMeta, IWorkingCopyIdentifier } from '../../common/workingCopy.ts';
...
import { INativeWindowConfiguration } from '../../../../../platform/window/common/window.ts';
import product from '../../../../../platform/product/common/product.ts';
import { ensureNoDisposablesAreLeakedInTestSuite } from '../../../../../base/test/common/utils.ts';
import { DisposableStore } from '../../../../../base/common/lifecycle.ts';
import { UserDataProfilesService } from '../../../../../platform/userDataProfile/common/userDataProfile.ts';
