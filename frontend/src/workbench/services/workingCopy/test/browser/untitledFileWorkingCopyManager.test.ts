...
import { FileWorkingCopyManager, IFileWorkingCopyManager } from '../../common/fileWorkingCopyManager.ts';
import { NO_TYPE_ID, WorkingCopyCapabilities } from '../../common/workingCopy.ts';
...
import { TestInMemoryFileSystemProvider, TestServiceAccessor, workbenchInstantiationService } from '../../../../test/browser/workbenchTestServices.ts';
