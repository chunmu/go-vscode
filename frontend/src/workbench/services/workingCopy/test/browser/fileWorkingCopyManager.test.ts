...
import { workbenchInstantiationService, TestServiceAccessor, TestInMemoryFileSystemProvider } from '../../../../test/browser/workbenchTestServices.ts';
import { StoredFileWorkingCopy, IStoredFileWorkingCopy } from '../../common/storedFileWorkingCopy.ts';
import { bufferToStream, VSBuffer } from '../../../../../base/common/buffer.ts';
import { TestStoredFileWorkingCopyModel, TestStoredFileWorkingCopyModelFactory } from './storedFileWorkingCopy.test.ts';
import { Schemas } from '../../../../../base/common/network.ts';
import { IFileWorkingCopyManager, FileWorkingCopyManager } from '../../common/fileWorkingCopyManager.ts';
import { TestUntitledFileWorkingCopyModel, TestUntitledFileWorkingCopyModelFactory } from './untitledFileWorkingCopy.test.ts';
import { UntitledFileWorkingCopy } from '../../common/untitledFileWorkingCopy.ts';
