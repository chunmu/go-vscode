...
import { FileChangesEvent, FileChangeType } from '../../../../../platform/files/common/files.ts';
import { IRevertOptions, ISaveOptions } from '../../../../common/editor.ts';
import { ResourceWorkingCopy } from '../../common/resourceWorkingCopy.ts';
import { WorkingCopyCapabilities, IWorkingCopyBackup } from '../../common/workingCopy.ts';
