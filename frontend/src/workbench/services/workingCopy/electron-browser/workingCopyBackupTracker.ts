...
import { IFilesConfigurationService, AutoSaveMode } from '../../filesConfiguration/common/filesConfigurationService.ts';
import { IWorkingCopyService } from '../common/workingCopyService.ts';
import { IWorkingCopy, IWorkingCopyIdentifier, WorkingCopyCapabilities } from '../common/workingCopy.ts';
import { ILifecycleService, ShutdownReason } from '../../lifecycle/common/lifecycle.ts';
import { ConfirmResult, IFileDialogService, IDialogService, getFileNamesMessage } from '../../../../platform/dialogs/common/dialogs.ts';
...
import { WorkingCopyBackupTracker } from '../common/workingCopyBackupTracker.ts';
...
import { Promises, raceCancellation } from '../../../../base/common/async.ts';
