...
import { IViewsRegistry, IViewDescriptor, IViewContainersRegistry, Extensions as ViewContainerExtensions, ViewContainerLocation, IViewContainerModel, IViewDescriptorService, ViewContainer } from '../../../../common/views.ts';
import { IDisposable, dispose } from '../../../../../base/common/lifecycle.ts';
import { move } from '../../../../../base/common/arrays.ts';
...
import { ViewDescriptorService } from '../../browser/viewDescriptorService.ts';
...
import { getViewsStateStorageId } from '../../common/viewContainerModel.ts';
