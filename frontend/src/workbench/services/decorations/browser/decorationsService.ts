...
import { Emitter, DebounceEmitter, Event } from '../../../../base/common/event.ts';
import { IDecorationsService, IDecoration, IResourceDecorationChangeEvent, IDecorationsProvider, IDecorationData } from '../common/decorations.ts';
...
import { createStyleSheet, createCSSRule, removeCSSRulesContainingSelector } from '../../../../base/browser/domStylesheets.ts';
import * as cssValue from '../../../../base/browser/cssValue.ts';
...
import { asArray, distinct } from '../../../../base/common/arrays.ts';
import { asCssVariable, ColorIdentifier } from '../../../../platform/theme/common/colorRegistry.ts';
import { getIconRegistry } from '../../../../platform/theme/common/iconRegistry.ts';
