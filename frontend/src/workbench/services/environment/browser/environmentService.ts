...
import { IWorkbenchEnvironmentService } from '../common/environmentService.ts';
import { IWorkbenchConstructionOptions } from '../../../browser/web.api.ts';
...
import { LogLevelToString } from '../../../../platform/log/common/log.ts';
import { isUndefined } from '../../../../base/common/types.ts';
import { refineServiceDecorator } from '../../../../platform/instantiation/common/instantiation.ts';
import { ITextEditorOptions } from '../../../../platform/editor/common/editor.ts';
import { EXTENSION_IDENTIFIER_WITH_LOG_REGEX } from '../../../../platform/environment/common/environmentService.ts';
