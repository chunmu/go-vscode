...
import { IBrowserWorkbenchEnvironmentService } from '../browser/environmentService.ts';
import { IColorScheme, INativeWindowConfiguration, IOSConfiguration, IPath, IPathsToWaitFor } from '../../../../platform/window/common/window.ts';
...
import { AbstractNativeEnvironmentService } from '../../../../platform/environment/common/environmentService.ts';
