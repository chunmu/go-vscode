...
import { ExtensionsRegistry, IExtensionPoint } from '../../extensions/common/extensionsRegistry.ts';
import { languagesExtPoint } from '../../language/common/languageService.ts';
