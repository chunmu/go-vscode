...
import { canASAR, importAMDNodeModule, resolveAmdNodeModulePath } from '../../../../amdX.ts';
import * as domStylesheets from '../../../../base/browser/domStylesheets.ts';
import { equals as equalArray } from '../../../../base/common/arrays.ts';
...
import { FileAccess, nodeModulesAsarUnpackedPath, nodeModulesPath } from '../../../../base/common/network.ts';
import { IObservable, observableFromEvent } from '../../../../base/common/observable.ts';
...
import { ITokenizationSupport, LazyTokenizationSupport, TokenizationRegistry } from '../../../../editor/common/languages.ts';
...
import { ExtensionMessageCollector, IExtensionPointUser } from '../../extensions/common/extensionsRegistry.ts';
import { ITextMateTokenizationService } from './textMateTokenizationFeature.ts';
import { TextMateTokenizationSupport } from './tokenizationSupport/textMateTokenizationSupport.ts';
import { TokenizationSupportWithLineLimit } from './tokenizationSupport/tokenizationSupportWithLineLimit.ts';
import { ThreadedBackgroundTokenizerFactory } from './backgroundTokenization/threadedBackgroundTokenizerFactory.ts';
import { TMGrammarFactory, missingTMGrammarErrorMessage } from '../common/TMGrammarFactory.ts';
import { ITMSyntaxExtensionPoint, grammarsExtPoint } from '../common/TMGrammars.ts';
import { IValidEmbeddedLanguagesMap, IValidGrammarDefinition, IValidTokenTypeMap } from '../common/TMScopeRegistry.ts';
import { ITextMateThemingRule, IWorkbenchColorTheme, IWorkbenchThemeService } from '../../themes/common/workbenchThemeService.ts';
