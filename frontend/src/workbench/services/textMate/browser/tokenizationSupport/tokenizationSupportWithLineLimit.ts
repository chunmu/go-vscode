...
import { EncodedTokenizationResult, IBackgroundTokenizationStore, IBackgroundTokenizer, IState, ITokenizationSupport, TokenizationResult } from '../../../../../editor/common/languages.ts';
import { nullTokenizeEncoded } from '../../../../../editor/common/languages/nullTokenize.ts';
import { ITextModel } from '../../../../../editor/common/model.ts';
import { Disposable, IDisposable } from '../../../../../base/common/lifecycle.ts';
import { IObservable, keepObserved } from '../../../../../base/common/observable.ts';
