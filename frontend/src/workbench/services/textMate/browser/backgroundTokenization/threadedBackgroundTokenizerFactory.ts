...
import { AppResourcePath, FileAccess, nodeModulesAsarPath, nodeModulesPath } from '../../../../../base/common/network.ts';
import { IObservable } from '../../../../../base/common/observable.ts';
import { isWeb } from '../../../../../base/common/platform.ts';
import { URI, UriComponents } from '../../../../../base/common/uri.ts';
import { IBackgroundTokenizationStore, IBackgroundTokenizer } from '../../../../../editor/common/languages.ts';
...
import { ICreateData, StateDeltas, TextMateTokenizationWorker } from './worker/textMateTokenizationWorker.worker.ts';
import { TextMateWorkerHost } from './worker/textMateWorkerHost.ts';
import { TextMateWorkerTokenizerController } from './textMateWorkerTokenizerController.ts';
import { IValidGrammarDefinition } from '../../common/TMScopeRegistry.ts';
