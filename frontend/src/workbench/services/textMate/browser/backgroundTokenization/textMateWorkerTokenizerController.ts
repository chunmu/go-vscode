...
import { IObservable, autorun, keepObserved } from '../../../../../base/common/observable.ts';
import { Proxied } from '../../../../../base/common/worker/webWorker.ts';
import { LineRange } from '../../../../../editor/common/core/ranges/lineRange.ts';
import { Range } from '../../../../../editor/common/core/range.ts';
import { IBackgroundTokenizationStore, ILanguageIdCodec } from '../../../../../editor/common/languages.ts';
import { ITextModel } from '../../../../../editor/common/model.ts';
import { TokenizationStateStore } from '../../../../../editor/common/model/textModelTokens.ts';
import { IModelContentChangedEvent } from '../../../../../editor/common/textModelEvents.ts';
import { IModelContentChange } from '../../../../../editor/common/model/mirrorTextModel.ts';
...
import { MonotonousIndexTransformer } from '../indexTransformer.ts';
import type { StateDeltas, TextMateTokenizationWorker } from './worker/textMateTokenizationWorker.worker.ts';
import type { applyStateStackDiff, StateStack } from 'vscode-textmate';
import { linesLengthEditFromModelContentChange } from '../../../../../editor/common/model/textModelStringEdit.ts';
