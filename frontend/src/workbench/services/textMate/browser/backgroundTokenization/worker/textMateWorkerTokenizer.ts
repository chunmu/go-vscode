...
import { LanguageId } from '../../../../../../editor/common/encodedTokenAttributes.ts';
import { IModelChangedEvent, MirrorTextModel } from '../../../../../../editor/common/model/mirrorTextModel.ts';
import { TokenizerWithStateStore } from '../../../../../../editor/common/model/textModelTokens.ts';
import { ContiguousMultilineTokensBuilder } from '../../../../../../editor/common/tokens/contiguousMultilineTokensBuilder.ts';
import { LineTokens } from '../../../../../../editor/common/tokens/lineTokens.ts';
...
import { ICreateGrammarResult } from '../../../common/TMGrammarFactory.ts';
import { StateDeltas } from './textMateTokenizationWorker.worker.ts';
