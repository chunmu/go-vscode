...
import { parentOriginHash } from '../../../../base/browser/iframe.ts';
...
import { AppResourcePath, COI, FileAccess } from '../../../../base/common/network.ts';
...
import { getNLSLanguage, getNLSMessages } from '../../../../nls.ts';
...
import { ExtensionHostExitCode, IExtensionHostInitData, MessageType, UIKind, createMessageOfType, isMessageOfType } from '../common/extensionHostProtocol.ts';
import { LocalWebWorkerRunningLocation } from '../common/extensionRunningLocation.ts';
import { ExtensionHostExtensions, ExtensionHostStartup, IExtensionHost } from '../common/extensions.ts';
