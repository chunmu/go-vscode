...
import { IDisposable, combinedDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
...
import { IURLHandler, IURLService, IOpenURLOptions } from '../../../../platform/url/common/url.ts';
import { IHostService } from '../../host/browser/host.ts';
import { ActivationKind, IExtensionService } from '../common/extensions.ts';
...
import { disposableWindowInterval } from '../../../../base/browser/dom.ts';
