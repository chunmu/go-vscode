...
import { BrandedService, IConstructorSignature } from '../../../../platform/instantiation/common/instantiation.ts';
import { ExtensionHostKind } from './extensionHostKind.ts';
import { IExtensionHostProxy } from './extensionHostProxy.ts';
import { IInternalExtensionService } from './extensions.ts';
import { IRPCProtocol, ProxyIdentifier } from './proxyIdentifier.ts';
