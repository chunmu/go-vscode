...
import { IRemoteConnectionData, RemoteAuthorityResolverErrorCode, ResolverResult } from '../../../../platform/remote/common/remoteAuthorityResolver.ts';
import { IExtensionDescriptionDelta } from './extensionHostProtocol.ts';
import { ActivationKind, ExtensionActivationReason } from './extensions.ts';
