...
import { QueryBuilder } from '../../search/common/queryBuilder.ts';
import { ISearchService } from '../../search/common/search.ts';
import { toWorkspaceFolder } from '../../../../platform/workspace/common/workspace.ts';
