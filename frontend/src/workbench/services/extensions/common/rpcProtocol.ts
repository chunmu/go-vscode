...
import { IURITransformer, transformIncomingURIs } from '../../../../base/common/uriIpc.ts';
import { IMessagePassingProtocol } from '../../../../base/parts/ipc/common/ipc.ts';
import { CanceledLazyPromise, LazyPromise } from './lazyPromise.ts';
import { getStringIdentifierForProxy, IRPCProtocol, Proxied, ProxyIdentifier, SerializableObjectWithBuffers } from './proxyIdentifier.ts';
