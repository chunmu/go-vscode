...
import { IExtensionManifest, ExtensionUntrustedWorkspaceSupportType, ExtensionVirtualWorkspaceSupportType, IExtensionIdentifier, ALL_EXTENSION_KINDS, ExtensionIdentifierMap } from '../../../../platform/extensions/common/extensions.ts';
import { ExtensionKind } from '../../../../platform/environment/common/environment.ts';
import { ExtensionsRegistry } from './extensionsRegistry.ts';
...
import { ExtensionUntrustedWorkspaceSupport } from '../../../../base/common/product.ts';
import { Disposable } from '../../../../base/common/lifecycle.ts';
import { WORKSPACE_TRUST_EXTENSION_SUPPORT } from '../../workspaces/common/workspaceTrust.ts';
import { isBoolean } from '../../../../base/common/types.ts';
