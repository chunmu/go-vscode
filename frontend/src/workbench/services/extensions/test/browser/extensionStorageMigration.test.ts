...
import { IExtensionStorageService, ExtensionStorageService } from '../../../../../platform/extensionManagement/common/extensionStorage.ts';
...
import { migrateExtensionStorage } from '../../common/extensionStorageMigration.ts';
