...
import { ExtensionKind, IEnvironmentService } from '../../../../../platform/environment/common/environment.ts';
import { ExtensionIdentifier, IExtension, IExtensionDescription } from '../../../../../platform/extensions/common/extensions.ts';
import { IFileService } from '../../../../../platform/files/common/files.ts';
import { IInstantiationService } from '../../../../../platform/instantiation/common/instantiation.ts';
import { TestInstantiationService, createServices } from '../../../../../platform/instantiation/test/common/instantiationServiceMock.ts';
...
import { IRemoteAuthorityResolverService, ResolverResult } from '../../../../../platform/remote/common/remoteAuthorityResolver.ts';
...
import { IWorkspaceTrustEnablementService } from '../../../../../platform/workspace/common/workspaceTrust.ts';
...
import { BrowserExtensionHostKindPicker } from '../../browser/extensionService.ts';
import { AbstractExtensionService, IExtensionHostFactory, ResolvedExtensions } from '../../common/abstractExtensionService.ts';
import { ExtensionHostKind, ExtensionRunningPreference } from '../../common/extensionHostKind.ts';
import { IExtensionHostManager } from '../../common/extensionHostManagers.ts';
import { ExtensionManifestPropertiesService, IExtensionManifestPropertiesService } from '../../common/extensionManifestPropertiesService.ts';
import { ExtensionRunningLocation } from '../../common/extensionRunningLocation.ts';
import { ExtensionRunningLocationTracker } from '../../common/extensionRunningLocationTracker.ts';
import { IExtensionHost, IExtensionService } from '../../common/extensions.ts';
...
import { WorkspaceTrustEnablementService } from '../../../workspaces/common/workspaceTrust.ts';
import { TestEnvironmentService, TestLifecycleService, TestRemoteAgentService, TestRemoteExtensionsScannerService, TestWebExtensionsScannerService, TestWorkbenchExtensionEnablementService, TestWorkbenchExtensionManagementService } from '../../../../test/browser/workbenchTestServices.ts';
import { TestContextService, TestFileService, TestUserDataProfileService } from '../../../../test/common/workbenchTestServices.ts';
