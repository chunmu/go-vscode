...
import { removeDangerousEnvVariables } from '../../../../base/common/processes.ts';
import { StopWatch } from '../../../../base/common/stopwatch.ts';
import { URI } from '../../../../base/common/uri.ts';
import { generateUuid } from '../../../../base/common/uuid.ts';
import { IMessagePassingProtocol } from '../../../../base/parts/ipc/common/ipc.ts';
import { BufferedEmitter } from '../../../../base/parts/ipc/common/ipc.net.ts';
import { acquirePort } from '../../../../base/parts/ipc/electron-browser/ipc.mp.ts';
import * as nls from '../../../../nls.ts';
import { IExtensionHostDebugService } from '../../../../platform/debug/common/extensionHostDebug.ts';
import { IExtensionHostProcessOptions, IExtensionHostStarter } from '../../../../platform/extensions/common/extensionHostStarter.ts';
...
import { isLoggingOnly } from '../../../../platform/telemetry/common/telemetryUtils.ts';
import { IUserDataProfilesService } from '../../../../platform/userDataProfile/common/userDataProfile.ts';
import { IWorkspaceContextService, WorkbenchState, isUntitledWorkspace } from '../../../../platform/workspace/common/workspace.ts';
...
import { MessagePortExtHostConnection, writeExtHostConnection } from '../common/extensionHostEnv.ts';
import { IExtensionHostInitData, MessageType, NativeLogMarkers, UIKind, isMessageOfType } from '../common/extensionHostProtocol.ts';
import { LocalProcessRunningLocation } from '../common/extensionRunningLocation.ts';
import { ExtensionHostExtensions, ExtensionHostStartup, IExtensionHost, IExtensionInspectInfo } from '../common/extensions.ts';
import { IHostService } from '../../host/browser/host.ts';
import { ILifecycleService, WillShutdownEvent } from '../../lifecycle/common/lifecycle.ts';
