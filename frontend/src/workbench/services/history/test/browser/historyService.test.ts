...
import { workbenchInstantiationService, TestFileEditorInput, registerTestEditor, createEditorPart, registerTestFileEditor, TestServiceAccessor, TestTextFileEditor, workbenchTeardown, registerTestSideBySideEditor } from '../../../../test/browser/workbenchTestServices.ts';
...
import { IEditorGroupsService, GroupDirection } from '../../../editor/common/editorGroupsService.ts';
import { EditorNavigationStack, HistoryService } from '../../browser/historyService.ts';
...
import { GoFilter, GoScope, IHistoryService } from '../../common/history.ts';
import { DeferredPromise, timeout } from '../../../../../base/common/async.ts';
import { Event } from '../../../../../base/common/event.ts';
import { EditorPaneSelectionChangeReason, isResourceEditorInput, IUntypedEditorInput } from '../../../../common/editor.ts';
import { IResourceEditorInput, ITextEditorOptions } from '../../../../../platform/editor/common/editor.ts';
import { EditorInput } from '../../../../common/editor/editorInput.ts';
import { IResolvedTextFileEditorModel, ITextFileService } from '../../../textfile/common/textfiles.ts';
import { IInstantiationService } from '../../../../../platform/instantiation/common/instantiation.ts';
import { FileChangesEvent, FileChangeType, FileOperation, FileOperationEvent } from '../../../../../platform/files/common/files.ts';
