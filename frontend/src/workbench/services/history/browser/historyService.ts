...
import { IResourceEditorInput, IEditorOptions } from '../../../../platform/editor/common/editor.ts';
...
import { FileChangesEvent, IFileService, FileChangeType, FILES_EXCLUDE_CONFIG, FileOperationEvent, FileOperation } from '../../../../platform/files/common/files.ts';
import { IWorkspaceContextService } from '../../../../platform/workspace/common/workspace.ts';
import { dispose, Disposable, DisposableStore, IDisposable } from '../../../../base/common/lifecycle.ts';
import { IStorageService, StorageScope, StorageTarget } from '../../../../platform/storage/common/storage.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { IEditorGroup, IEditorGroupsService } from '../../editor/common/editorGroupsService.ts';
import { getExcludes, ISearchConfiguration, SEARCH_EXCLUDE_CONFIG } from '../../search/common/search.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { EditorServiceImpl } from '../../../browser/parts/editor/editor.ts';
...
import { coalesce, remove } from '../../../../base/common/arrays.ts';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/extensions.ts';
import { addDisposableListener, EventType, EventHelper, WindowIdleValue } from '../../../../base/browser/dom.ts';
...
import { ResourceGlobMatcher } from '../../../common/resources.ts';
