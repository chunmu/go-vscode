...
import { TestEnvironmentService, TestLifecycleService, TestPathService, TestRemoteAgentService } from '../../../../test/browser/workbenchTestServices.ts';
import { URI } from '../../../../../base/common/uri.ts';
import { LabelService } from '../../common/labelService.ts';
import { TestContextService, TestStorageService } from '../../../../test/common/workbenchTestServices.ts';
