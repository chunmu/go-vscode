...
import { IDisposable, Disposable, dispose } from '../../../../base/common/lifecycle.ts';
import { posix, sep, win32 } from '../../../../base/common/path.ts';
...
import { IWorkspaceContextService, IWorkspace, isWorkspace, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier, toWorkspaceIdentifier, WORKSPACE_EXTENSION, isUntitledWorkspace, isTemporaryWorkspace } from '../../../../platform/workspace/common/workspace.ts';
import { basenameOrAuthority, basename, joinPath, dirname } from '../../../../base/common/resources.ts';
import { tildify, getPathLabel } from '../../../../base/common/labels.ts';
import { ILabelService, ResourceLabelFormatter, ResourceLabelFormatting, IFormatterChangeEvent, Verbosity } from '../../../../platform/label/common/label.ts';
import { ExtensionsRegistry } from '../../extensions/common/extensionsRegistry.ts';
...
import { isProposedApiEnabled } from '../../extensions/common/extensions.ts';
