...
import { IWorkbenchThemeService, IWorkbenchColorTheme, IWorkbenchFileIconTheme, ExtensionData, ThemeSettings, IWorkbenchProductIconTheme, ThemeSettingTarget, ThemeSettingDefaults, COLOR_THEME_DARK_INITIAL_COLORS, COLOR_THEME_LIGHT_INITIAL_COLORS } from '../common/workbenchThemeService.ts';
...
import { IConfigurationService, ConfigurationTarget } from '../../../../platform/configuration/common/configuration.ts';
import { ColorThemeData } from '../common/colorThemeData.ts';
import { IColorTheme, Extensions as ThemingExtensions, IThemingRegistry } from '../../../../platform/theme/common/themeService.ts';
import { Event, Emitter } from '../../../../base/common/event.ts';
import { registerFileIconThemeSchemas } from '../common/fileIconThemeSchema.ts';
import { IDisposable, Disposable, DisposableStore } from '../../../../base/common/lifecycle.ts';
import { FileIconThemeData, FileIconThemeLoader } from './fileIconThemeData.ts';
...
import { IFileService, FileChangeType } from '../../../../platform/files/common/files.ts';
import { URI } from '../../../../base/common/uri.ts';
import * as resources from '../../../../base/common/resources.ts';
import { registerColorThemeSchemas } from '../common/colorThemeSchema.ts';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/extensions.ts';
import { getRemoteAuthority } from '../../../../platform/remote/common/remoteHosts.ts';
...
import { ThemeRegistry, registerColorThemeExtensionPoint, registerFileIconThemeExtensionPoint, registerProductIconThemeExtensionPoint } from '../common/themeExtensionPoints.ts';
import { updateColorThemeConfigurationSchemas, updateFileIconThemeConfigurationSchemas, ThemeConfiguration, updateProductIconThemeConfigurationSchemas } from '../common/themeConfiguration.ts';
import { ProductIconThemeData, DEFAULT_PRODUCT_ICON_THEME_ID } from './productIconThemeData.ts';
import { registerProductIconThemeSchemas } from '../common/productIconThemeSchema.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { isWeb } from '../../../../base/common/platform.ts';
import { ColorScheme, ThemeTypeSelector } from '../../../../platform/theme/common/theme.ts';
import { IHostColorSchemeService } from '../common/hostColorSchemeService.ts';
import { RunOnceScheduler, Sequencer } from '../../../../base/common/async.ts';
import { IUserDataInitializationService } from '../../userData/browser/userDataInit.ts';
import { getIconsStyleSheet } from '../../../../platform/theme/browser/iconsStyleSheet.ts';
import { asCssVariableName, getColorRegistry } from '../../../../platform/theme/common/colorRegistry.ts';
