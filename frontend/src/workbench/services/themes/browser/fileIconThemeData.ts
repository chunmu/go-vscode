...
import { ExtensionData, IThemeExtensionPoint, IWorkbenchFileIconTheme } from '../common/workbenchThemeService.ts';
...
import { fontColorRegex, fontSizeRegex } from '../../../../platform/theme/common/iconRegistry.ts';
import * as css from '../../../../base/browser/cssValue.ts';
import { fileIconSelectorEscape } from '../../../../editor/common/services/getIconClasses.ts';
