...
import { ThemeSettings } from '../common/workbenchThemeService.ts';
import { COLOR_THEME_CONFIGURATION_SETTINGS_TAG, formatSettingAsLink } from '../common/themeConfiguration.ts';
