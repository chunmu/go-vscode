...
import { isBoolean, isObject } from '../../../../base/common/types.ts';
import { IColorScheme } from '../../../../platform/window/common/window.ts';
import { ILifecycleService, StartupKind } from '../../lifecycle/common/lifecycle.ts';
