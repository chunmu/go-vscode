...
import { ExtensionData, ITokenColorCustomizations, ITextMateThemingRule, IWorkbenchColorTheme, IColorMap, IThemeExtensionPoint, IColorCustomizations, ISemanticTokenRules, ISemanticTokenColorizationSetting, ISemanticTokenColorCustomizations, IThemeScopableCustomizations, IThemeScopedCustomizations, THEME_SCOPE_CLOSE_PAREN, THEME_SCOPE_OPEN_PAREN, themeScopeRegex, THEME_SCOPE_WILDCARD } from './workbenchThemeService.ts';
import { convertSettings } from './themeCompatibility.ts';
import * as nls from '../../../../nls.ts';
import * as types from '../../../../base/common/types.ts';
import * as resources from '../../../../base/common/resources.ts';
import { Extensions as ColorRegistryExtensions, IColorRegistry, ColorIdentifier, editorBackground, editorForeground, DEFAULT_COLOR_CONFIG_VALUE } from '../../../../platform/theme/common/colorRegistry.ts';
import { ITokenStyle, getThemeTypeSelector } from '../../../../platform/theme/common/themeService.ts';
import { Registry } from '../../../../platform/registry/common/platform.ts';
import { getParseErrorMessage } from '../../../../base/common/jsonErrorMessages.ts';
import { URI } from '../../../../base/common/uri.ts';
import { parse as parsePList } from './plistParser.ts';
import { TokenStyle, SemanticTokenRule, ProbeScope, getTokenClassificationRegistry, TokenStyleValue, TokenStyleData, parseClassifierString } from '../../../../platform/theme/common/tokenClassificationRegistry.ts';
import { MatcherWithPriority, Matcher, createMatchers } from './textMateScopeMatcher.ts';
...
import { StorageScope, IStorageService, StorageTarget } from '../../../../platform/storage/common/storage.ts';
import { ThemeConfiguration } from './themeConfiguration.ts';
import { ColorScheme, ThemeTypeSelector } from '../../../../platform/theme/common/theme.ts';
import { ColorId, FontStyle, MetadataConsts } from '../../../../editor/common/encodedTokenAttributes.ts';
import { toStandardTokenType } from '../../../../editor/common/languages/supports/tokenization.ts';
