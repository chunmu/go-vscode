...
import { ExtensionMessageCollector, IExtensionPoint, ExtensionsRegistry } from '../../extensions/common/extensionsRegistry.ts';
import { ExtensionData, IThemeExtensionPoint } from './workbenchThemeService.ts';

import { Event, Emitter } from '../../../../base/common/event.ts';
import { URI } from '../../../../base/common/uri.ts';
import { Disposable, IDisposable } from '../../../../base/common/lifecycle.ts';
import { Extensions, IExtensionFeatureMarkdownRenderer, IExtensionFeaturesRegistry, IRenderedData } from '../../extensionManagement/common/extensionFeatures.ts';
...
import { ThemeTypeSelector } from '../../../../platform/theme/common/theme.ts';
