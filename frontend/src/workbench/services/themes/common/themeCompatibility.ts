...
import { ITextMateThemingRule, IColorMap } from './workbenchThemeService.ts';
import { Color } from '../../../../base/common/color.ts';
import * as colorRegistry from '../../../../platform/theme/common/colorRegistry.ts';

import * as editorColorRegistry from '../../../../editor/common/core/editorColorRegistry.ts';
