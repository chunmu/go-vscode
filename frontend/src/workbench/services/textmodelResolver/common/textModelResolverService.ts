...
import { IDisposable, toDisposable, IReference, ReferenceCollection, Disposable, AsyncReferenceCollection } from '../../../../base/common/lifecycle.ts';
import { IModelService } from '../../../../editor/common/services/model.ts';
import { TextResourceEditorModel } from '../../../common/editor/textResourceEditorModel.ts';
import { ITextFileService, TextFileResolveReason } from '../../textfile/common/textfiles.ts';
import { Schemas } from '../../../../base/common/network.ts';
import { ITextModelService, ITextModelContentProvider, ITextEditorModel, IResolvedTextEditorModel, isResolvedTextEditorModel } from '../../../../editor/common/services/resolverService.ts';
import { TextFileEditorModel } from '../../textfile/common/textFileEditorModel.ts';
import { IFileService } from '../../../../platform/files/common/files.ts';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/extensions.ts';
import { IUndoRedoService } from '../../../../platform/undoRedo/common/undoRedo.ts';
import { ModelUndoRedoParticipant } from '../../../../editor/common/services/modelUndoRedoParticipant.ts';
