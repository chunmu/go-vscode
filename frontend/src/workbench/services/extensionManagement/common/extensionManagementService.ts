...
import { Emitter, Event, EventMultiplexer } from '../../../../base/common/event.ts';
import {
...
} from '../../../../platform/extensionManagement/common/extensionManagement.ts';
import { DidChangeProfileForServerEvent, DidUninstallExtensionOnServerEvent, IExtensionManagementServer, IExtensionManagementServerService, InstallExtensionOnServerEvent, IPublisherInfo, IResourceExtension, IWorkbenchExtensionManagementService, UninstallExtensionOnServerEvent } from './extensionManagement.ts';
import { ExtensionType, isLanguagePackExtension, IExtensionManifest, getWorkspaceSupportTypeMessage, TargetPlatform } from '../../../../platform/extensions/common/extensions.ts';
import { URI } from '../../../../base/common/uri.ts';
import { Disposable, DisposableStore } from '../../../../base/common/lifecycle.ts';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { areSameExtensions, computeTargetPlatform } from '../../../../platform/extensionManagement/common/extensionManagementUtil.ts';
...
import { coalesce, distinct, isNonEmptyArray } from '../../../../base/common/arrays.ts';
...
import { IWorkspaceTrustRequestService, WorkspaceTrustRequestButton } from '../../../../platform/workspace/common/workspaceTrust.ts';
...
import { isString, isUndefined } from '../../../../base/common/types.ts';
import { FileChangesEvent, IFileService } from '../../../../platform/files/common/files.ts';
...
import { IExtensionsScannerService, IScannedExtension } from '../../../../platform/extensionManagement/common/extensionsScannerService.ts';
...
import { verifiedPublisherIcon } from './extensionsIcons.ts';
import { Codicon } from '../../../../base/common/codicons.ts';
import { IStringDictionary } from '../../../../base/common/collections.ts';
import { CommontExtensionManagementService } from '../../../../platform/extensionManagement/common/abstractExtensionManagementService.ts';
