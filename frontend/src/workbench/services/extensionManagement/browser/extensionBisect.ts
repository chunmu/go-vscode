...
import { IExtensionManagementService, IGlobalExtensionEnablementService, ILocalExtension } from '../../../../platform/extensionManagement/common/extensionManagement.ts';
import { IStorageService, StorageScope, StorageTarget } from '../../../../platform/storage/common/storage.ts';
import { ExtensionType, IExtension, isResolverExtension } from '../../../../platform/extensions/common/extensions.ts';
...
import { LifecyclePhase } from '../../lifecycle/common/lifecycle.ts';
...
import { IWorkbenchExtensionEnablementService } from '../common/extensionManagement.ts';
