...
import { ILocalExtension, IGalleryExtension, IExtensionGalleryService, InstallOperation, InstallOptions, ExtensionManagementError, ExtensionManagementErrorCode, EXTENSION_INSTALL_CLIENT_TARGET_PLATFORM_CONTEXT, IAllowedExtensionsService, VerifyExtensionSignatureConfigKey } from '../../../../platform/extensionManagement/common/extensionManagement.ts';
import { URI } from '../../../../base/common/uri.ts';
import { ExtensionType, IExtensionManifest } from '../../../../platform/extensions/common/extensions.ts';
...
import { IExtensionManagementServer } from '../common/extensionManagement.ts';
...
import { RemoteExtensionManagementService } from '../common/remoteExtensionManagementService.ts';
...
import { areApiProposalsCompatible } from '../../../../platform/extensions/common/extensionValidator.ts';
