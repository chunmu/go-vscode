...
import { DeferredPromise, runWhenGlobalIdle } from '../../../../../../base/common/async.ts';
import { decodeBase64 } from '../../../../../../base/common/buffer.ts';
import { Emitter, Event } from '../../../../../../base/common/event.ts';
import { IDisposable } from '../../../../../../base/common/lifecycle.ts';
import { getExtensionForMimeType, isTextStreamMime } from '../../../../../../base/common/mime.ts';
import { FileAccess, Schemas, matchesScheme, matchesSomeScheme } from '../../../../../../base/common/network.ts';
...
import { dirname, extname, isEqual, joinPath } from '../../../../../../base/common/resources.ts';
...
import { generateTokensCSSForColorMap } from '../../../../../../editor/common/languages/supports/tokenization.ts';
...
import { ITextEditorOptions, ITextEditorSelection } from '../../../../../../platform/editor/common/editor.ts';
...
import { editorFindMatch, editorFindMatchHighlight } from '../../../../../../platform/theme/common/colorRegistry.ts';
...
import { CellEditState, ICellOutputViewModel, ICellViewModel, ICommonCellInfo, IDisplayOutputLayoutUpdateRequest, IDisplayOutputViewModel, IFocusNotebookCellOptions, IGenericCellViewModel, IInsetRenderOutput, INotebookEditorCreationOptions, INotebookWebviewMessage, RenderOutputType } from '../../notebookBrowser.ts';
import { NOTEBOOK_WEBVIEW_BOUNDARY } from '../notebookCellList.ts';
import { preloadsScriptStr } from './webviewPreloads.ts';
import { transformWebviewThemeVars } from './webviewThemeMapping.ts';
import { MarkupCellViewModel } from '../../viewModel/markupCellViewModel.ts';
import { CellUri, ICellOutput, INotebookRendererInfo, RendererMessagingSpec } from '../../../common/notebookCommon.ts';
...
import { IScopedRendererMessaging } from '../../../common/notebookRendererMessagingService.ts';
import { INotebookService } from '../../../common/notebookService.ts';
import { IWebviewElement, IWebviewService, WebviewContentPurpose, WebviewOriginStore } from '../../../../webview/browser/webview.ts';
import { WebviewWindowDragMonitor } from '../../../../webview/browser/webviewWindowDragMonitor.ts';
import { asWebviewUri, webviewGenericCspSource } from '../../../../webview/common/webview.ts';
...
import { FromWebviewMessage, IAckOutputHeight, IClickedDataUrlMessage, ICodeBlockHighlightRequest, IContentWidgetTopRequest, IControllerPreload, ICreationContent, ICreationRequestMessage, IFindMatch, IMarkupCellInitialization, RendererMetadata, StaticPreloadMetadata, ToWebviewMessage } from './webviewMessages.ts';
import { getOutputText, getOutputStreamText, TEXT_BASED_MIMETYPES } from '../../viewModel/cellOutputTextHelper.ts';
