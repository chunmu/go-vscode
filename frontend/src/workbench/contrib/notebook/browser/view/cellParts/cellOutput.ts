...
import { ICellOutputViewModel, ICellViewModel, IInsetRenderOutput, INotebookEditorDelegate, JUPYTER_EXTENSION_ID, RenderOutputType } from '../../notebookBrowser.ts';
import { mimetypeIcon } from '../../notebookIcons.ts';
import { CellContentPart } from '../cellPart.ts';
import { CodeCellRenderTemplate } from '../notebookRenderingCommon.ts';
...
import { CellUri, IOrderedMimeType, NotebookCellExecutionState, NotebookCellOutputsSplice, RENDERER_NOT_AVAILABLE } from '../../../common/notebookCommon.ts';
...
import { COPY_OUTPUT_COMMAND_ID } from '../../controller/cellOutputActions.ts';
import { autorun, observableValue } from '../../../../../../base/common/observable.ts';
import { NOTEBOOK_CELL_HAS_HIDDEN_OUTPUTS, NOTEBOOK_CELL_IS_FIRST_OUTPUT, NOTEBOOK_CELL_OUTPUT_MIMETYPE } from '../../../common/notebookContextKeys.ts';
import { TEXT_BASED_MIMETYPES } from '../../viewModel/cellOutputTextHelper.ts';
