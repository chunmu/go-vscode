...
import { codiconsLibrary } from '../../../../../../base/common/codiconsLibrary.ts';
import { Disposable } from '../../../../../../base/common/lifecycle.ts';
import { Schemas } from '../../../../../../base/common/network.ts';
import { Position } from '../../../../../../editor/common/core/position.ts';
import { Range } from '../../../../../../editor/common/core/range.ts';
import { IWordAtPosition } from '../../../../../../editor/common/core/wordHelper.ts';
...
import { IChatWidget, IChatWidgetService } from '../../../../chat/browser/chat.ts';
import { IChatContextPicker, IChatContextPickerItem, IChatContextPickerPickItem, IChatContextPickService } from '../../../../chat/browser/chatContextPickService.ts';
import { ChatDynamicVariableModel } from '../../../../chat/browser/contrib/chatDynamicVariables.ts';
import { computeCompletionRanges } from '../../../../chat/browser/contrib/chatInputCompletions.ts';
import { IChatAgentService } from '../../../../chat/common/chatAgents.ts';
import { ChatContextKeys } from '../../../../chat/common/chatContextKeys.ts';
import { chatVariableLeader } from '../../../../chat/common/chatParserTypes.ts';
import { ChatAgentLocation } from '../../../../chat/common/constants.ts';
import { NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_CELL_OUTPUT_MIME_TYPE_LIST_FOR_CHAT, NOTEBOOK_CELL_OUTPUT_MIMETYPE } from '../../../common/notebookContextKeys.ts';
import { INotebookKernelService } from '../../../common/notebookKernelService.ts';
import { createNotebookOutputVariableEntry, NOTEBOOK_CELL_OUTPUT_MIME_TYPE_LIST_FOR_CHAT_CONST } from '../../contrib/chat/notebookChatUtils.ts';
import { getNotebookEditorFromEditorPane, ICellOutputViewModel, INotebookEditor } from '../../notebookBrowser.ts';
import * as icons from '../../notebookIcons.ts';
import { getOutputViewModelFromId } from '../cellOutputActions.ts';
import { INotebookOutputActionContext, NOTEBOOK_ACTIONS_CATEGORY } from '../coreActions.ts';
import './cellChatActions.ts';
