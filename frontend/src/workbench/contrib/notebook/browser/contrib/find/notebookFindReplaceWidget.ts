...
import { AnchorAlignment, IContextViewProvider } from '../../../../../../base/browser/ui/contextview/contextview.ts';
import { DropdownMenuActionViewItem } from '../../../../../../base/browser/ui/dropdown/dropdownActionViewItem.ts';
import { FindInput, IFindInputOptions } from '../../../../../../base/browser/ui/findinput/findInput.ts';
import { ReplaceInput } from '../../../../../../base/browser/ui/findinput/replaceInput.ts';
import { IMessage as InputBoxMessage } from '../../../../../../base/browser/ui/inputbox/inputBox.ts';
import { ProgressBar } from '../../../../../../base/browser/ui/progressbar/progressbar.ts';
import { ISashEvent, Orientation, Sash } from '../../../../../../base/browser/ui/sash/sash.ts';
import { IToggleStyles, Toggle } from '../../../../../../base/browser/ui/toggle/toggle.ts';
import { Widget } from '../../../../../../base/browser/ui/widget.ts';
import { Action, ActionRunner, IAction, IActionRunner, Separator } from '../../../../../../base/common/actions.ts';
import { Delayer } from '../../../../../../base/common/async.ts';
import { Codicon } from '../../../../../../base/common/codicons.ts';
import { Event } from '../../../../../../base/common/event.ts';
import { KeyCode } from '../../../../../../base/common/keyCodes.ts';
import { Disposable } from '../../../../../../base/common/lifecycle.ts';
import { isSafari } from '../../../../../../base/common/platform.ts';
import { IHistory } from '../../../../../../base/common/history.ts';
import { ThemeIcon } from '../../../../../../base/common/themables.ts';
import { Range } from '../../../../../../editor/common/core/range.ts';
import { FindReplaceState, FindReplaceStateChangedEvent } from '../../../../../../editor/contrib/find/browser/findState.ts';
import { findNextMatchIcon, findPreviousMatchIcon, findReplaceAllIcon, findReplaceIcon, findSelectionIcon, SimpleButton } from '../../../../../../editor/contrib/find/browser/findWidget.ts';
import { parseReplaceString, ReplacePattern } from '../../../../../../editor/contrib/find/browser/replacePattern.ts';
...
import { ContextScopedReplaceInput, registerAndCreateHistoryNavigationContext } from '../../../../../../platform/history/browser/contextScopedHistoryWidget.ts';

import { IHoverService } from '../../../../../../platform/hover/browser/hover.ts';
import { IInstantiationService } from '../../../../../../platform/instantiation/common/instantiation.ts';
import { defaultInputBoxStyles, defaultProgressBarStyles, defaultToggleStyles } from '../../../../../../platform/theme/browser/defaultStyles.ts';
...
import { registerIcon, widgetClose } from '../../../../../../platform/theme/common/iconRegistry.ts';
import { registerThemingParticipant } from '../../../../../../platform/theme/common/themeService.ts';
import { filterIcon } from '../../../../extensions/browser/extensionsIcons.ts';
import { NotebookFindFilters } from './findFilters.ts';
import { IShowNotebookFindWidgetOptions } from './notebookFindWidget.ts';
import { ICellModelDecorations, ICellModelDeltaDecorations, ICellViewModel, INotebookDeltaDecoration, INotebookEditor } from '../../notebookBrowser.ts';
import { NotebookFindScopeType, NotebookSetting } from '../../../common/notebookCommon.ts';
import { ICellRange } from '../../../common/notebookRange.ts';
import type { IHoverLifecycleOptions } from '../../../../../../base/browser/ui/hover/hover.ts';
