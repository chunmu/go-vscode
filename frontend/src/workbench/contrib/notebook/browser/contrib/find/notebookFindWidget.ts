...
import { FindMatch } from '../../../../../../editor/common/model.ts';
import { MATCHES_LIMIT, CONTEXT_FIND_WIDGET_VISIBLE } from '../../../../../../editor/contrib/find/browser/findModel.ts';
import { FindReplaceState } from '../../../../../../editor/contrib/find/browser/findState.ts';
import { NLS_MATCHES_LOCATION, NLS_NO_RESULTS } from '../../../../../../editor/contrib/find/browser/findWidget.ts';
import { FindWidgetSearchHistory } from '../../../../../../editor/contrib/find/browser/findWidgetSearchHistory.ts';
import { ReplaceWidgetHistory } from '../../../../../../editor/contrib/find/browser/replaceWidgetHistory.ts';
...
import { FindModel } from './findModel.ts';
import { SimpleFindReplaceWidget } from './notebookFindReplaceWidget.ts';
import { CellEditState, ICellViewModel, INotebookEditor, INotebookEditorContribution } from '../../notebookBrowser.ts';
import { INotebookFindScope } from '../../../common/notebookCommon.ts';
import { KEYBINDING_CONTEXT_NOTEBOOK_FIND_WIDGET_FOCUSED } from '../../../common/notebookContextKeys.ts';
