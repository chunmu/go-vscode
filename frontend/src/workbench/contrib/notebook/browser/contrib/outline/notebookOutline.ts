...
import { IIconLabelValueOptions, IconLabel } from '../../../../../../base/browser/ui/iconLabel/iconLabel.ts';
import { IKeyboardNavigationLabelProvider, IListVirtualDelegate } from '../../../../../../base/browser/ui/list/list.ts';
import { IListAccessibilityProvider } from '../../../../../../base/browser/ui/list/listWidget.ts';
import { IDataSource, ITreeNode, ITreeRenderer } from '../../../../../../base/browser/ui/tree/tree.ts';
import { Emitter, Event } from '../../../../../../base/common/event.ts';
import { FuzzyScore, createMatches } from '../../../../../../base/common/filters.ts';
import { Disposable, DisposableStore, IDisposable, toDisposable, type IReference } from '../../../../../../base/common/lifecycle.ts';
import { ThemeIcon } from '../../../../../../base/common/themables.ts';
import { URI } from '../../../../../../base/common/uri.ts';
import { getIconClassesForLanguageId } from '../../../../../../editor/common/services/getIconClasses.ts';
...
import { IWorkbenchDataTreeOptions } from '../../../../../../platform/list/browser/listService.ts';
import { MarkerSeverity } from '../../../../../../platform/markers/common/markers.ts';
import { Registry } from '../../../../../../platform/registry/common/platform.ts';
import { listErrorForeground, listWarningForeground } from '../../../../../../platform/theme/common/colorRegistry.ts';
...
import { CellFoldingState, CellRevealType, ICellModelDecorations, ICellModelDeltaDecorations, ICellViewModel, INotebookEditor, INotebookEditorOptions, INotebookEditorPane, INotebookViewModel } from '../../notebookBrowser.ts';
import { NotebookEditor } from '../../notebookEditor.ts';
import { INotebookCellOutlineDataSource, NotebookCellOutlineDataSource } from '../../viewModel/notebookOutlineDataSource.ts';
import { CellKind, NotebookCellsChangeType, NotebookSetting } from '../../../common/notebookCommon.ts';
import { IEditorService, SIDE_GROUP } from '../../../../../services/editor/common/editorService.ts';
import { LifecyclePhase } from '../../../../../services/lifecycle/common/lifecycle.ts';
import { IBreadcrumbsDataSource, IOutline, IOutlineComparator, IOutlineCreator, IOutlineListConfig, IOutlineService, IQuickPickDataSource, IQuickPickOutlineElement, OutlineChangeEvent, OutlineConfigCollapseItemsValues, OutlineConfigKeys, OutlineTarget } from '../../../../../services/outline/browser/outline.ts';
...
import { Action2, IMenu, IMenuService, MenuId, MenuItemAction, MenuRegistry, registerAction2 } from '../../../../../../platform/actions/common/actions.ts';
import { ContextKeyExpr, IContextKeyService, RawContextKey } from '../../../../../../platform/contextkey/common/contextkey.ts';
import { MenuEntryActionViewItem, getActionBarActions } from '../../../../../../platform/actions/browser/menuEntryActionViewItem.ts';
import { IAction } from '../../../../../../base/common/actions.ts';
import { NotebookOutlineEntryArgs } from '../../controller/sectionActions.ts';
import { MarkupCellViewModel } from '../../viewModel/markupCellViewModel.ts';
import { Delayer, disposableTimeout } from '../../../../../../base/common/async.ts';
import { IOutlinePane } from '../../../../outline/browser/outline.ts';
import { Codicon } from '../../../../../../base/common/codicons.ts';
import { NOTEBOOK_IS_ACTIVE_EDITOR } from '../../../common/notebookContextKeys.ts';
import { NotebookOutlineConstants } from '../../viewModel/notebookOutlineEntryFactory.ts';
import { INotebookCellOutlineDataSourceFactory } from '../../viewModel/notebookOutlineDataSourceFactory.ts';
