...
import { trimTrailingWhitespace } from '../../../../../../editor/common/commands/trimTrailingWhitespaceCommand.ts';
...
import { CodeActionProvider, CodeActionTriggerType, IWorkspaceTextEdit } from '../../../../../../editor/common/languages.ts';
...
import { ApplyCodeActionReason, applyCodeAction, getCodeActions } from '../../../../../../editor/contrib/codeAction/browser/codeAction.ts';
import { CodeActionItem, CodeActionKind, CodeActionTriggerSource } from '../../../../../../editor/contrib/codeAction/common/types.ts';
import { FormattingMode, getDocumentFormattingEditsWithSelectedProvider } from '../../../../../../editor/contrib/format/browser/format.ts';
...
import { NotebookFileWorkingCopyModel } from '../../../common/notebookEditorModel.ts';
...
import { NotebookMultiCursorController, NotebookMultiCursorState } from '../multicursor/notebookMulticursor.ts';
