...
import { EditorConfiguration } from '../../../../../../editor/browser/config/editorConfiguration.ts';
import { CoreEditingCommands } from '../../../../../../editor/browser/coreCommands.ts';
import { ICodeEditor, PastePayload } from '../../../../../../editor/browser/editorBrowser.ts';
...
import { IEditorConfiguration } from '../../../../../../editor/common/config/editorConfiguration.ts';
import { cursorBlinkingStyleFromString, cursorStyleFromString, TextEditorCursorBlinkingStyle, TextEditorCursorStyle } from '../../../../../../editor/common/config/editorOptions.ts';
...
import { IWordAtPosition, USUAL_WORD_SEPARATORS } from '../../../../../../editor/common/core/wordHelper.ts';
import { CommandExecutor, CursorsController } from '../../../../../../editor/common/cursor/cursor.ts';
import { DeleteOperations } from '../../../../../../editor/common/cursor/cursorDeleteOperations.ts';
import { CursorConfiguration, ICursorSimpleModel } from '../../../../../../editor/common/cursorCommon.ts';
import { CursorChangeReason } from '../../../../../../editor/common/cursorEvents.ts';
import { CompositionTypePayload, Handler, ITriggerEditorOperationEvent, ReplacePreviousCharPayload } from '../../../../../../editor/common/editorCommon.ts';
import { ILanguageConfigurationService } from '../../../../../../editor/common/languages/languageConfigurationRegistry.ts';
import { IModelDeltaDecoration, ITextModel, PositionAffinity } from '../../../../../../editor/common/model.ts';
import { indentOfLine } from '../../../../../../editor/common/model/textModel.ts';
import { ITextModelService } from '../../../../../../editor/common/services/resolverService.ts';
import { ViewModelEventsCollector } from '../../../../../../editor/common/viewModelEventDispatcher.ts';
...
import { IPastFutureElements, IUndoRedoElement, IUndoRedoService, UndoRedoElementType } from '../../../../../../platform/undoRedo/common/undoRedo.ts';
import { registerWorkbenchContribution2, WorkbenchPhase } from '../../../../../common/contributions.ts';
import { IEditorService } from '../../../../../services/editor/common/editorService.ts';
import { KEYBINDING_CONTEXT_NOTEBOOK_FIND_WIDGET_FOCUSED, NOTEBOOK_CELL_EDITOR_FOCUSED, NOTEBOOK_IS_ACTIVE_EDITOR } from '../../../common/notebookContextKeys.ts';
import { INotebookActionContext, NotebookAction } from '../../controller/coreActions.ts';
import { CellFindMatchWithIndex, getNotebookEditorFromEditorPane, ICellViewModel, INotebookEditor, INotebookEditorContribution } from '../../notebookBrowser.ts';
import { registerNotebookContribution } from '../../notebookEditorExtensions.ts';
import { CellEditorOptions } from '../../view/cellParts/cellEditorOptions.ts';
import { NotebookFindContrib } from '../find/notebookFindWidget.ts';
...
import { ICoordinatesConverter } from '../../../../../../editor/common/coordinatesConverter.ts';
