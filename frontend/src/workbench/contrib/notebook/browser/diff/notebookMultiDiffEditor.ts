...
import { IWorkbenchUIElementFactory, type IResourceLabel } from '../../../../../editor/browser/widget/multiDiffEditor/workbenchUIElementFactory.ts';
...
import { CellUri, INotebookDiffEditorModel, NOTEBOOK_MULTI_DIFF_EDITOR_ID } from '../../common/notebookCommon.ts';
...
import { NotebookMultiDiffEditorInput, NotebookMultiDiffEditorWidgetInput } from './notebookMultiDiffEditorInput.ts';
import { MultiDiffEditorWidget } from '../../../../../editor/browser/widget/multiDiffEditor/multiDiffEditorWidget.ts';
import { ResourceLabel } from '../../../../browser/labels.ts';
import type { IMultiDiffEditorOptions } from '../../../../../editor/browser/widget/multiDiffEditor/multiDiffEditorWidgetImpl.ts';
import { INotebookDocumentService } from '../../../../services/notebook/common/notebookDocumentService.ts';
...
import { NOTEBOOK_DIFF_CELLS_COLLAPSED, NOTEBOOK_DIFF_HAS_UNCHANGED_CELLS, NOTEBOOK_DIFF_UNCHANGED_CELLS_HIDDEN } from './notebookDiffEditorBrowser.ts';
import type { DocumentDiffItemViewModel, MultiDiffEditorViewModel } from '../../../../../editor/browser/widget/multiDiffEditor/multiDiffEditorViewModel.ts';
import type { URI } from '../../../../../base/common/uri.ts';
import { type IDiffElementViewModelBase } from './diffElementViewModel.ts';
import { autorun, transaction } from '../../../../../base/common/observable.ts';
import { DiffEditorHeightCalculatorService } from './editorHeightCalculator.ts';
