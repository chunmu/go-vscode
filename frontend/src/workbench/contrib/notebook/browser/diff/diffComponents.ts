...
import { CellEditType, CellUri, NotebookCellMetadata } from '../../common/notebookCommon.ts';
...
import { OutputContainer } from './diffElementOutputs.ts';
...
import { TabCompletionController } from '../../../snippets/browser/tabCompletion.ts';
...
import { fixedDiffEditorOptions, fixedEditorOptions, getEditorPadding } from './diffCellEditorOptions.ts';
...
import { IDiffEditorOptions } from '../../../../../editor/common/config/editorOptions.ts';
import { getUnchangedRegionSettings } from './unchangedEditorRegions.ts';
