...
import { IDisposable, Disposable, DisposableStore, dispose } from '../../../../base/common/lifecycle.ts';
import { parse } from '../../../../base/common/marshalling.ts';
...
import { ITextModel, ITextBufferFactory, ITextBuffer } from '../../../../editor/common/model.ts';
import { IModelService } from '../../../../editor/common/services/model.ts';
import { ILanguageSelection, ILanguageService } from '../../../../editor/common/languages/language.ts';
...
import { Extensions, IConfigurationPropertySchema, IConfigurationRegistry } from '../../../../platform/configuration/common/configurationRegistry.ts';
...
import { Extensions as WorkbenchExtensions, IWorkbenchContribution, IWorkbenchContributionsRegistry, WorkbenchPhase, registerWorkbenchContribution2 } from '../../../common/contributions.ts';
import { IEditorSerializer, IEditorFactoryRegistry, EditorExtensions } from '../../../common/editor.ts';
import { EditorInput } from '../../../common/editor/editorInput.ts';
import { NotebookEditor } from './notebookEditor.ts';
import { NotebookEditorInput, NotebookEditorInputOptions } from '../common/notebookEditorInput.ts';
import { INotebookService } from '../common/notebookService.ts';
import { NotebookService } from './services/notebookServiceImpl.ts';
import { CellKind, CellUri, IResolvedNotebookEditorModel, NotebookWorkingCopyTypeIdentifier, NotebookSetting, ICellOutput, ICell, NotebookCellsChangeType, NotebookMetadataUri } from '../common/notebookCommon.ts';
...
import { NotebookTextDiffEditor } from './diff/notebookDiffEditor.ts';
import { INotebookEditorWorkerService } from '../common/services/notebookWorkerService.ts';
import { NotebookEditorWorkerServiceImpl } from './services/notebookWorkerServiceImpl.ts';
import { INotebookCellStatusBarService } from '../common/notebookCellStatusBarService.ts';
import { NotebookCellStatusBarService } from './services/notebookCellStatusBarServiceImpl.ts';
import { INotebookEditorService } from './services/notebookEditorService.ts';
import { NotebookEditorWidgetService } from './services/notebookEditorServiceImpl.ts';
...
import { getFormattedOutputJSON, getStreamOutputData } from './diff/diffElementViewModel.ts';
import { NotebookModelResolverServiceImpl } from '../common/notebookEditorModelResolverServiceImpl.ts';
import { INotebookKernelHistoryService, INotebookKernelService } from '../common/notebookKernelService.ts';
import { NotebookKernelService } from './services/notebookKernelServiceImpl.ts';
import { IWorkingCopyIdentifier } from '../../../services/workingCopy/common/workingCopy.ts';
...
import { IWorkingCopyEditorHandler, IWorkingCopyEditorService } from '../../../services/workingCopy/common/workingCopyEditorService.ts';
...
import { NotebookRendererMessagingService } from './services/notebookRendererMessagingServiceImpl.ts';
import { INotebookRendererMessagingService } from '../common/notebookRendererMessagingService.ts';
import { INotebookCellOutlineDataSourceFactory, NotebookCellOutlineDataSourceFactory } from './viewModel/notebookOutlineDataSourceFactory.ts';

// Editor Controller
import './controller/coreActions.ts';
import './controller/insertCellActions.ts';
import './controller/executeActions.ts';
import './controller/sectionActions.ts';
import './controller/layoutActions.ts';
import './controller/editActions.ts';
import './controller/cellOutputActions.ts';
import './controller/apiActions.ts';
import './controller/foldingController.ts';
import './controller/chat/notebook.chat.contribution.ts';
import './controller/variablesActions.ts';

// Editor Contribution
import './contrib/editorHint/emptyCellEditorHint.ts';
import './contrib/clipboard/notebookClipboard.ts';
import './contrib/find/notebookFind.ts';
import './contrib/format/formatting.ts';
import './contrib/saveParticipants/saveParticipants.ts';
import './contrib/gettingStarted/notebookGettingStarted.ts';
import './contrib/layout/layoutActions.ts';
import './contrib/marker/markerProvider.ts';
import './contrib/navigation/arrow.ts';
import './contrib/outline/notebookOutline.ts';
import './contrib/profile/notebookProfile.ts';
import './contrib/cellStatusBar/statusBarProviders.ts';
import './contrib/cellStatusBar/contributedStatusBarItemController.ts';
import './contrib/cellStatusBar/executionStatusBarItemController.ts';
import './contrib/editorStatusBar/editorStatusBar.ts';
import './contrib/undoRedo/notebookUndoRedo.ts';
import './contrib/cellCommands/cellCommands.ts';
import './contrib/viewportWarmup/viewportWarmup.ts';
import './contrib/troubleshoot/layout.ts';
import './contrib/debug/notebookBreakpoints.ts';
import './contrib/debug/notebookCellPausing.ts';
import './contrib/debug/notebookDebugDecorations.ts';
import './contrib/execute/executionEditorProgress.ts';
import './contrib/kernelDetection/notebookKernelDetection.ts';
import './contrib/cellDiagnostics/cellDiagnostics.ts';
import './contrib/multicursor/notebookMulticursor.ts';
import './contrib/multicursor/notebookSelectionHighlight.ts';
import './contrib/notebookVariables/notebookInlineVariables.ts';

// Diff Editor Contribution
import './diff/notebookDiffActions.ts';

// Services
import { editorOptionsRegistry } from '../../../../editor/common/config/editorOptions.ts';
import { NotebookExecutionStateService } from './services/notebookExecutionStateServiceImpl.ts';
import { NotebookExecutionService } from './services/notebookExecutionServiceImpl.ts';
import { INotebookExecutionService } from '../common/notebookExecutionService.ts';
import { INotebookKeymapService } from '../common/notebookKeymapService.ts';
import { NotebookKeymapService } from './services/notebookKeymapServiceImpl.ts';
...
import { NotebookInfo } from '../../../../editor/common/languageFeatureRegistry.ts';
import { COMMENTEDITOR_DECORATION_KEY } from '../../comments/browser/commentReply.ts';
import { ICodeEditorService } from '../../../../editor/browser/services/codeEditorService.ts';
import { NotebookKernelHistoryService } from './services/notebookKernelHistoryServiceImpl.ts';
import { INotebookLoggingService } from '../common/notebookLoggingService.ts';
import { NotebookLoggingService } from './services/notebookLoggingServiceImpl.ts';
import product from '../../../../platform/product/common/product.ts';
import { NotebookVariables } from './contrib/notebookVariables/notebookVariables.ts';
import { AccessibleViewRegistry } from '../../../../platform/accessibility/browser/accessibleViewRegistry.ts';
import { NotebookAccessibilityHelp } from './notebookAccessibilityHelp.ts';
import { NotebookAccessibleView } from './notebookAccessibleView.ts';
import { DefaultFormatter } from '../../format/browser/formatActionsMultiple.ts';
import { NotebookMultiTextDiffEditor } from './diff/notebookMultiDiffEditor.ts';
import { NotebookMultiDiffEditorInput } from './diff/notebookMultiDiffEditorInput.ts';
import { getFormattedMetadataJSON } from '../common/model/notebookCellTextModel.ts';
import { INotebookOutlineEntryFactory, NotebookOutlineEntryFactory } from './viewModel/notebookOutlineEntryFactory.ts';
import { getFormattedNotebookMetadataJSON } from '../common/model/notebookMetadataTextModel.ts';
import { NotebookOutputEditor } from './outputEditor/notebookOutputEditor.ts';
import { NotebookOutputEditorInput } from './outputEditor/notebookOutputEditorInput.ts';
