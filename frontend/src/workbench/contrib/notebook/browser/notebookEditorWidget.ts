...
import * as domStylesheets from '../../../../base/browser/domStylesheets.ts';
import { IMouseWheelEvent, StandardMouseEvent } from '../../../../base/browser/mouseEvent.ts';
import { IListContextMenuEvent } from '../../../../base/browser/ui/list/list.ts';
...
import { combinedDisposable, Disposable, DisposableStore, dispose } from '../../../../base/common/lifecycle.ts';
import { setTimeout0 } from '../../../../base/common/platform.ts';
...
import { SuggestController } from '../../../../editor/contrib/suggest/browser/suggestController.ts';
...
import { registerZIndex, ZIndex } from '../../../../platform/layout/browser/zIndexRegistry.ts';
import { IEditorProgressService, IProgressRunner } from '../../../../platform/progress/common/progress.ts';
import { ITelemetryService } from '../../../../platform/telemetry/common/telemetry.ts';
import { contrastBorder, errorForeground, focusBorder, foreground, listInactiveSelectionBackground, registerColor, scrollbarSliderActiveBackground, scrollbarSliderBackground, scrollbarSliderHoverBackground, transparent } from '../../../../platform/theme/common/colorRegistry.ts';
import { EDITOR_PANE_BACKGROUND, PANEL_BORDER, SIDE_BAR_BACKGROUND } from '../../../common/theme.ts';
import { debugIconStartForeground } from '../../debug/browser/debugColors.ts';
import { CellEditState, CellFindMatchWithIndex, CellFocusMode, CellLayoutContext, CellRevealRangeType, CellRevealType, IActiveNotebookEditorDelegate, IBaseCellEditorOptions, ICellOutputViewModel, ICellViewModel, ICommonCellInfo, IDisplayOutputLayoutUpdateRequest, IFocusNotebookCellOptions, IInsetRenderOutput, IModelDecorationsChangeAccessor, INotebookCellOverlayChangeAccessor, INotebookDeltaDecoration, INotebookEditor, INotebookEditorContribution, INotebookEditorContributionDescription, INotebookEditorCreationOptions, INotebookEditorDelegate, INotebookEditorMouseEvent, INotebookEditorOptions, INotebookEditorViewState, INotebookViewCellsUpdateEvent, INotebookViewZoneChangeAccessor, INotebookWebviewMessage, RenderOutputType, ScrollToRevealBehavior } from './notebookBrowser.ts';
...
import { notebookDebug } from './notebookLogger.ts';
import { NotebookCellStateChangedEvent, NotebookLayoutChangedEvent, NotebookLayoutInfo } from './notebookViewEvents.ts';
import { CellContextKeyManager } from './view/cellParts/cellContextKeys.ts';
import { CellDragAndDropController } from './view/cellParts/cellDnd.ts';
import { ListViewInfoAccessor, NotebookCellList, NOTEBOOK_WEBVIEW_BOUNDARY } from './view/notebookCellList.ts';
import { INotebookCellList } from './view/notebookRenderingCommon.ts';
import { BackLayerWebView } from './view/renderers/backLayerWebView.ts';
import { CodeCellRenderer, MarkupCellRenderer, NotebookCellListDelegate } from './view/renderers/cellRenderer.ts';
import { IAckOutputHeight, IMarkupCellInitialization } from './view/renderers/webviewMessages.ts';
...
import { NotebookEditorWorkbenchToolbar } from './viewParts/notebookEditorToolbar.ts';
import { NotebookEditorContextKeys } from './viewParts/notebookEditorWidgetContextKeys.ts';
import { NotebookOverviewRuler } from './viewParts/notebookOverviewRuler.ts';
import { ListTopCellToolbar } from './viewParts/notebookTopCellToolbar.ts';
import { NotebookTextModel } from '../common/model/notebookTextModel.ts';
import { CellEditType, CellKind, INotebookFindOptions, NotebookFindScopeType, RENDERER_NOT_AVAILABLE, SelectionStateType } from '../common/notebookCommon.ts';
import { NOTEBOOK_CURSOR_NAVIGATION_MODE, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_OUTPUT_INPUT_FOCUSED } from '../common/notebookContextKeys.ts';
...
import { NotebookOptions, OutputInnerContainerTopPadding } from './notebookOptions.ts';
...
import { NotebookPerfMarks } from '../common/notebookPerformance.ts';
import { BaseCellEditorOptions } from './viewModel/cellEditorOptions.ts';
import { FloatingEditorClickMenu } from '../../../browser/codeeditor.ts';
import { IDimension } from '../../../../editor/common/core/2d/dimension.ts';
import { CellFindMatchModel } from './contrib/find/findModel.ts';
import { INotebookLoggingService } from '../common/notebookLoggingService.ts';
import { Schemas } from '../../../../base/common/network.ts';
import { DropIntoEditorController } from '../../../../editor/contrib/dropOrPasteInto/browser/dropIntoEditorController.ts';
import { CopyPasteController } from '../../../../editor/contrib/dropOrPasteInto/browser/copyPasteController.ts';
import { NotebookStickyScroll } from './viewParts/notebookEditorStickyScroll.ts';
import { PixelRatio } from '../../../../base/browser/pixelRatio.ts';
import { PreventDefaultContextMenuItemsContextKeyName } from '../../webview/browser/webview.contribution.ts';
import { NotebookAccessibilityProvider } from './notebookAccessibilityProvider.ts';
import { NotebookHorizontalTracker } from './viewParts/notebookHorizontalTracker.ts';
import { NotebookCellEditorPool } from './view/notebookCellEditorPool.ts';
import { InlineCompletionsController } from '../../../../editor/contrib/inlineCompletions/browser/controller/inlineCompletionsController.ts';
import { NotebookCellLayoutManager } from './notebookCellLayoutManager.ts';
import { FloatingEditorToolbar } from '../../../../editor/contrib/floatingMenu/browser/floatingMenu.ts';
