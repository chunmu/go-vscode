...
import { coalesce, compareBy, delta } from '../../../../../base/common/arrays.ts';
import { CancellationToken } from '../../../../../base/common/cancellation.ts';
import { Codicon } from '../../../../../base/common/codicons.ts';
import { groupBy } from '../../../../../base/common/collections.ts';
...
import { derived, IObservable, observableValueOpts, runOnChange, ValueWithChangeEventFromObservable } from '../../../../../base/common/observable.ts';
...
import { IDecorationData, IDecorationsProvider, IDecorationsService } from '../../../../services/decorations/common/decorations.ts';
...
import { IMultiDiffSourceResolver, IMultiDiffSourceResolverService, IResolvedMultiDiffSource, MultiDiffEditorItem } from '../../../multiDiffEditor/browser/multiDiffSourceResolverService.ts';
...
import { ChatModel, ICellTextEditOperation, IChatResponseModel, isCellTextEditOperationArray } from '../../common/chatModel.ts';
...
import { ChatEditingSession } from './chatEditingSession.ts';
import { ChatEditingSnapshotTextModelContentProvider, ChatEditingTextModelContentProvider } from './chatEditingTextModelContentProviders.ts';
