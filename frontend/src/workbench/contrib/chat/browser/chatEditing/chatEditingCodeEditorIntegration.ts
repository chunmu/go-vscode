...
import { getTotalWidth } from '../../../../../base/browser/dom.ts';
import { Event } from '../../../../../base/common/event.ts';
import { DisposableStore, dispose, IDisposable, toDisposable } from '../../../../../base/common/lifecycle.ts';
import { autorun, constObservable, derived, IObservable, observableFromEvent, observableValue } from '../../../../../base/common/observable.ts';
import { basename, isEqual } from '../../../../../base/common/resources.ts';
import { themeColorFromId } from '../../../../../base/common/themables.ts';
import { ICodeEditor, IOverlayWidget, IOverlayWidgetPosition, IOverlayWidgetPositionCoordinates, IViewZone, MouseTargetType } from '../../../../../editor/browser/editorBrowser.ts';
...
import { LineSource, renderLines, RenderOptions } from '../../../../../editor/browser/widget/diffEditor/components/diffEditorViewZones/renderLines.ts';
import { diffAddDecoration, diffDeleteDecoration, diffWholeLineAddDecoration } from '../../../../../editor/browser/widget/diffEditor/registrations.contribution.ts';
...
import { IEditorDecorationsCollection } from '../../../../../editor/common/editorCommon.ts';
import { IModelDeltaDecoration, ITextModel, MinimapPosition, OverviewRulerLane, TrackedRangeStickiness } from '../../../../../editor/common/model.ts';
...
import { EditorsOrder, IEditorIdentifier, isDiffEditorInput } from '../../../../common/editor.ts';
...
import { IModifiedFileEntry, IModifiedFileEntryChangeHunk, IModifiedFileEntryEditorIntegration, ModifiedFileEntryState } from '../../common/chatEditingService.ts';
import { isTextDiffEditorForEntry } from './chatEditing.ts';
...
import { ctxCursorInChangeRange } from './chatEditingEditorContextKeys.ts';
