...
import { addDisposableListener, getWindow } from '../../../../../base/browser/dom.ts';
...
import { StringEdit } from '../../../../../editor/common/core/edits/stringEdit.ts';
import { IRange, Range } from '../../../../../editor/common/core/range.ts';
import { LineRange } from '../../../../../editor/common/core/ranges/lineRange.ts';
import { IDocumentDiff, nullDocumentDiff } from '../../../../../editor/common/diff/documentDiffProvider.ts';
...
import { IModelDeltaDecoration, ITextModel, ITextSnapshot, MinimapPosition, OverviewRulerLane } from '../../../../../editor/common/model.ts';
import { ModelDecorationOptions } from '../../../../../editor/common/model/textModel.ts';
import { offsetEditFromContentChanges, offsetEditFromLineRangeMapping, offsetEditToEditOperations } from '../../../../../editor/common/model/textModelStringEdit.ts';
...
import { editorSelectionBackground } from '../../../../../platform/theme/common/colorRegistry.ts';
...
import { IDocumentDiff2 } from './chatEditingCodeEditorIntegration.ts';
import { pendingRewriteMinimap } from './chatEditingModifiedFileEntry.ts';
