...
import { findFirst, findLast, findLastIdx } from '../../../../../base/common/arraysFind.ts';
...
import { equals as objectsEqual } from '../../../../../base/common/objects.ts';
import { derived, derivedOpts, IObservable, IReader, ITransaction, ObservablePromise, observableSignalFromEvent, observableValue, observableValueOpts, transaction } from '../../../../../base/common/observable.ts';
...
import { CellEditType, CellUri, INotebookTextModel } from '../../../notebook/common/notebookCommon.ts';
...
import { IEditSessionEntryDiff, IModifiedEntryTelemetryInfo } from '../../common/chatEditingService.ts';
import { IChatRequestDisablement } from '../../common/chatModel.ts';
import { IChatEditingCheckpointTimeline } from './chatEditingCheckpointTimeline.ts';
import { FileOperation, FileOperationType, IChatEditingTimelineState, ICheckpoint, IFileBaseline, IReconstructedFileExistsState, IReconstructedFileNotExistsState, IReconstructedFileState } from './chatEditingOperations.ts';
import { ChatEditingSnapshotTextModelContentProvider } from './chatEditingTextModelContentProviders.ts';
import { createSnapshot as createNotebookSnapshot, restoreSnapshot as restoreNotebookSnapshot } from './notebook/chatEditingModifiedNotebookSnapshot.ts';
