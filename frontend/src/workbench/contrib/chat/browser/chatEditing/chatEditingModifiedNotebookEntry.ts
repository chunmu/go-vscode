...
import { streamToBuffer } from '../../../../../base/common/buffer.ts';
import { CancellationToken } from '../../../../../base/common/cancellation.ts';
import { StringSHA1 } from '../../../../../base/common/hash.ts';
import { DisposableStore, IReference, thenRegisterOrDispose } from '../../../../../base/common/lifecycle.ts';
import { ResourceMap, ResourceSet } from '../../../../../base/common/map.ts';
import { Schemas } from '../../../../../base/common/network.ts';
import { ITransaction, IObservable, observableValue, autorun, transaction, ObservablePromise } from '../../../../../base/common/observable.ts';
...
import { DetailedLineRangeMapping, RangeMapping } from '../../../../../editor/common/diff/rangeMapping.ts';
...
import { IUndoRedoElement, IUndoRedoService, UndoRedoElementType } from '../../../../../platform/undoRedo/common/undoRedo.ts';
import { IEditorPane, SaveReason } from '../../../../common/editor.ts';
...
import { NotebookTextDiffEditor } from '../../../notebook/browser/diff/notebookDiffEditor.ts';
import { INotebookTextDiffEditor } from '../../../notebook/browser/diff/notebookDiffEditorBrowser.ts';
import { CellDiffInfo } from '../../../notebook/browser/diff/notebookDiffViewModel.ts';
...
import { CellEditType, ICellDto2, ICellEditOperation, ICellReplaceEdit, IResolvedNotebookEditorModel, NotebookCellsChangeType, NotebookSetting, NotebookTextModelChangedEvent, TransientOptions } from '../../../notebook/common/notebookCommon.ts';
...
import { ChatEditKind, IModifiedEntryTelemetryInfo, IModifiedFileEntryEditorIntegration, ISnapshotEntry, ModifiedFileEntryState } from '../../common/chatEditingService.ts';
import { IChatResponseModel } from '../../common/chatModel.ts';
import { IChatService } from '../../common/chatService.ts';
import { AbstractChatEditingModifiedFileEntry } from './chatEditingModifiedFileEntry.ts';
import { createSnapshot, deserializeSnapshot, getNotebookSnapshotFileURI, restoreSnapshot, SnapshotComparer } from './notebook/chatEditingModifiedNotebookSnapshot.ts';
import { ChatEditingNewNotebookContentEdits } from './notebook/chatEditingNewNotebookContentEdits.ts';
import { ChatEditingNotebookCellEntry } from './notebook/chatEditingNotebookCellEntry.ts';
import { ChatEditingNotebookDiffEditorIntegration, ChatEditingNotebookEditorIntegration } from './notebook/chatEditingNotebookEditorIntegration.ts';
import { ChatEditingNotebookFileSystemProvider } from './notebook/chatEditingNotebookFileSystemProvider.ts';
import { adjustCellDiffAndOriginalModelBasedOnCellAddDelete, adjustCellDiffAndOriginalModelBasedOnCellMovements, adjustCellDiffForKeepingAnInsertedCell, adjustCellDiffForRevertingADeletedCell, adjustCellDiffForRevertingAnInsertedCell, calculateNotebookRewriteRatio, getCorrespondingOriginalCellIndex, isTransientIPyNbExtensionEvent } from './notebook/helpers.ts';
import { countChanges, ICellDiffInfo, sortCellChanges } from './notebook/notebookCellChanges.ts';
