...
import { IHoverOptions } from '../../../../base/browser/ui/hover/hover.ts';
...
import { ITreeContextMenuEvent, ITreeElement } from '../../../../base/browser/ui/tree/tree.ts';
import { disposableTimeout, RunOnceScheduler, timeout } from '../../../../base/common/async.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { Codicon } from '../../../../base/common/codicons.ts';
import { fromNow, fromNowByDay } from '../../../../base/common/date.ts';
...
import { Disposable, DisposableStore, IDisposable, MutableDisposable, thenIfNotDisposed } from '../../../../base/common/lifecycle.ts';
import { ResourceSet } from '../../../../base/common/map.ts';
import { Schemas } from '../../../../base/common/network.ts';
import { filter } from '../../../../base/common/objects.ts';
import { autorun, observableFromEvent, observableValue } from '../../../../base/common/observable.ts';
import { basename, extUri, isEqual } from '../../../../base/common/resources.ts';
import { MicrotaskDelay } from '../../../../base/common/symbols.ts';
...
import { ITextResourceEditorInput } from '../../../../platform/editor/common/editor.ts';
...
import { WorkbenchList, WorkbenchObjectTree } from '../../../../platform/list/browser/listService.ts';
import { ILogService } from '../../../../platform/log/common/log.ts';
import { bindContextKey } from '../../../../platform/observable/common/platformObservableUtils.ts';
...
import { buttonSecondaryBackground, buttonSecondaryForeground, buttonSecondaryHoverBackground } from '../../../../platform/theme/common/colorRegistry.ts';
...
import { EditorResourceAccessor } from '../../../../workbench/common/editor.ts';
import { IEditorService } from '../../../../workbench/services/editor/common/editorService.ts';
...
import { IWorkbenchLayoutService, Position } from '../../../services/layout/browser/layoutService.ts';
...
import { katexContainerClassName } from '../../markdown/common/markedKatexExtension.ts';
import { checkModeOption } from '../common/chat.ts';
import { IChatAgentAttachmentCapabilities, IChatAgentCommand, IChatAgentData, IChatAgentService } from '../common/chatAgents.ts';
import { ChatContextKeys } from '../common/chatContextKeys.ts';
import { applyingChatEditsFailedContextKey, decidedChatEditingResourceContextKey, hasAppliedChatEditsContextKey, hasUndecidedChatEditingResourceContextKey, IChatEditingService, IChatEditingSession, inChatEditingSessionContextKey, ModifiedFileEntryState } from '../common/chatEditingService.ts';
import { IChatLayoutService } from '../common/chatLayoutService.ts';
import { IChatModel, IChatModelInputState, IChatResponseModel } from '../common/chatModel.ts';
import { ChatMode, IChatModeService } from '../common/chatModes.ts';
import { chatAgentLeader, ChatRequestAgentPart, ChatRequestDynamicVariablePart, ChatRequestSlashPromptPart, ChatRequestToolPart, ChatRequestToolSetPart, chatSubcommandLeader, formatChatQuestion, IParsedChatRequest } from '../common/chatParserTypes.ts';
import { ChatRequestParser } from '../common/chatRequestParser.ts';
import { IChatLocationData, IChatSendRequestOptions, IChatService } from '../common/chatService.ts';
...
import { IChatTodoListService } from '../common/chatTodoListService.ts';
import { ChatRequestVariableSet, IChatRequestVariableEntry, isPromptFileVariableEntry, isPromptTextVariableEntry, PromptFileVariableKind, toPromptFileVariableEntry } from '../common/chatVariableEntries.ts';
import { ChatViewModel, IChatRequestViewModel, IChatResponseViewModel, isRequestVM, isResponseVM } from '../common/chatViewModel.ts';
...
import { ILanguageModelToolsService, IToolData, ToolSet } from '../common/languageModelToolsService.ts';
import { ComputeAutomaticInstructions } from '../common/promptSyntax/computeAutomaticInstructions.ts';
import { PromptsConfig } from '../common/promptSyntax/config/config.ts';
import { IHandOff, PromptHeader, Target } from '../common/promptSyntax/promptFileParser.ts';
import { IPromptsService } from '../common/promptSyntax/service/promptsService.ts';
import { handleModeSwitch } from './actions/chatActions.ts';
import { ChatTreeItem, ChatViewId, IChatAcceptInputOptions, IChatAccessibilityService, IChatCodeBlockInfo, IChatFileTreeInfo, IChatListItemRendererOptions, IChatWidget, IChatWidgetService, IChatWidgetViewContext, IChatWidgetViewOptions, isIChatResourceViewContext, isIChatViewViewContext } from './chat.ts';
import { ChatAccessibilityProvider } from './chatAccessibilityProvider.ts';
import { ChatAttachmentModel } from './chatAttachmentModel.ts';
import { ChatSuggestNextWidget } from './chatContentParts/chatSuggestNextWidget.ts';
import { ChatInputPart, IChatInputPartOptions, IChatInputStyles } from './chatInputPart.ts';
import { ChatListDelegate, ChatListItemRenderer, IChatListItemTemplate, IChatRendererDelegate } from './chatListRenderer.ts';
import { ChatEditorOptions } from './chatOptions.ts';
import { ChatViewPane } from './chatViewPane.ts';
import './media/chat.css';
import './media/chatAgentHover.css';
import './media/chatViewWelcome.css';
import { ChatViewWelcomePart, IChatSuggestedPrompts, IChatViewWelcomeContent } from './viewsWelcome/chatViewWelcomeController.ts';
