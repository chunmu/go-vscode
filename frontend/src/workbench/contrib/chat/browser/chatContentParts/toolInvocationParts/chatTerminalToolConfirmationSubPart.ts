...
import { append, h } from '../../../../../../base/browser/dom.ts';
...
import { createCommandUri, MarkdownString, type IMarkdownString } from '../../../../../../base/common/htmlContent.ts';
import { thenIfNotDisposed, thenRegisterOrDispose, toDisposable } from '../../../../../../base/common/lifecycle.ts';
...
import { TerminalContribCommandId, TerminalContribSettingId } from '../../../../terminal/terminalContribExports.ts';
import { migrateLegacyTerminalToolSpecificData } from '../../../common/chat.ts';
import { ChatContextKeys } from '../../../common/chatContextKeys.ts';
import { IChatToolInvocation, ToolConfirmKind, type IChatTerminalToolInvocationData, type ILegacyChatTerminalToolInvocationData } from '../../../common/chatService.ts';
import type { CodeBlockModelCollection } from '../../../common/codeBlockModelCollection.ts';
