...
import { allowedMarkdownHtmlAttributes, MarkdownRendererMarkedOptions, type MarkdownRenderOptions } from '../../../../../base/browser/markdownRenderer.ts';
...
import { autorun, autorunSelfDisposable, derived } from '../../../../../base/common/observable.ts';
...
import { IOpenEditorOptions, registerOpenEditorListeners } from '../../../../../platform/editor/browser/editor.ts';
...
import { MarkedKatexSupport } from '../../../markdown/browser/markedKatexSupport.ts';
import { extractCodeblockUrisFromText, IMarkdownVulnerability } from '../../common/annotations.ts';
...
import { IChatMarkdownContent, IChatService, IChatUndoStop } from '../../common/chatService.ts';
import { isRequestVM, isResponseVM } from '../../common/chatViewModel.ts';
import { CodeBlockEntry, CodeBlockModelCollection } from '../../common/codeBlockModelCollection.ts';
import { ChatConfiguration } from '../../common/constants.ts';
import { IChatCodeBlockInfo } from '../chat.ts';
import { allowedChatMarkdownHtmlTags } from '../chatContentMarkdownRenderer.ts';
import { IMarkdownDiffBlockData, MarkdownDiffBlockPart, parseUnifiedDiff } from '../chatDiffBlockPart.ts';
import { ChatEditingActionContext } from '../chatEditing/chatEditingActions.ts';
import { ChatMarkdownDecorationsRenderer } from '../chatMarkdownDecorationsRenderer.ts';
import { CodeBlockPart, ICodeBlockData, ICodeBlockRenderOptions, localFileLanguageId, parseLocalFileData } from '../codeBlockPart.ts';
