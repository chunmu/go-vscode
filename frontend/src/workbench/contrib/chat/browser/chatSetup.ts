...
import { IButton } from '../../../../base/browser/ui/button/button.ts';
import { Dialog, DialogContentsAlignment } from '../../../../base/browser/ui/dialog/dialog.ts';
...
import { Disposable, DisposableStore, IDisposable, markAsSingleton, MutableDisposable } from '../../../../base/common/lifecycle.ts';
...
import { IWorkspaceTrustManagementService, IWorkspaceTrustRequestService } from '../../../../platform/workspace/common/workspaceTrust.ts';
import { IWorkbenchContribution } from '../../../common/contributions.ts';
import { IViewDescriptorService, ViewContainerLocation } from '../../../common/views.ts';
import { IActivityService, ProgressBadge } from '../../../services/activity/common/activity.ts';
import { AuthenticationSession, IAuthenticationService } from '../../../services/authentication/common/authentication.ts';
import { IWorkbenchEnvironmentService } from '../../../services/environment/common/environmentService.ts';
import { EnablementState, IWorkbenchExtensionEnablementService } from '../../../services/extensionManagement/common/extensionManagement.ts';
import { ExtensionUrlHandlerOverrideRegistry } from '../../../services/extensions/browser/extensionUrlHandler.ts';
...
import { CountTokensCallback, ILanguageModelToolsService, IPreparedToolInvocation, IToolData, IToolImpl, IToolInvocation, IToolResult, ToolDataSource, ToolProgress } from '../../chat/common/languageModelToolsService.ts';
import { IExtension, IExtensionsWorkbenchService } from '../../extensions/common/extensions.ts';
import { IChatAgentImplementation, IChatAgentRequest, IChatAgentResult, IChatAgentService } from '../common/chatAgents.ts';
import { ChatContextKeys } from '../common/chatContextKeys.ts';
import { ChatEntitlement, ChatEntitlementContext, ChatEntitlementRequests, ChatEntitlementService, IChatEntitlementService, isProUser } from '../../../services/chat/common/chatEntitlementService.ts';
import { ChatModel, ChatRequestModel, IChatRequestModel, IChatRequestVariableData } from '../common/chatModel.ts';
import { ChatMode, IChatModeService } from '../common/chatModes.ts';
import { ChatRequestAgentPart, ChatRequestToolPart } from '../common/chatParserTypes.ts';
import { IChatProgress, IChatService } from '../common/chatService.ts';
import { IChatRequestToolEntry } from '../common/chatVariableEntries.ts';
...
import { CHAT_CATEGORY, CHAT_OPEN_ACTION_ID, CHAT_SETUP_ACTION_ID, CHAT_SETUP_SUPPORT_ANONYMOUS_ACTION_ID } from './actions/chatActions.ts';
import { ChatViewId, IChatWidgetService } from './chat.ts';
import { CHAT_SIDEBAR_PANEL_ID } from './chatViewPane.ts';
import { IEnvironmentService } from '../../../../platform/environment/common/environment.ts';
import { chatViewsWelcomeRegistry } from './viewsWelcome/chatViewsWelcome.ts';
import { ILanguageFeaturesService } from '../../../../editor/common/services/languageFeatures.ts';
import { CodeAction, CodeActionList, Command, NewSymbolName, NewSymbolNameTriggerKind } from '../../../../editor/common/languages.ts';
...
import { CodeActionKind } from '../../../../editor/contrib/codeAction/common/types.ts';
import { ACTION_START as INLINE_CHAT_START } from '../../inlineChat/common/inlineChat.ts';
import { IPosition } from '../../../../editor/common/core/position.ts';
import { IMarker, IMarkerService, MarkerSeverity } from '../../../../platform/markers/common/markers.ts';
...
import { AGENT_SESSIONS_VIEW_CONTAINER_ID } from './agentSessions/agentSessions.ts';
