...
import { LanguageSelector, score } from '../../../../editor/common/languageSelector.ts';
import { createDecorator } from '../../../../platform/instantiation/common/instantiation.ts';
import { IChatContextPicker, IChatContextPickerItem, IChatContextPickService } from './chatContextPickService.ts';
import { IChatContextItem, IChatContextProvider } from '../common/chatContext.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { IChatRequestWorkspaceVariableEntry, IGenericChatRequestVariableEntry, StringChatContextValue } from '../common/chatVariableEntries.ts';
