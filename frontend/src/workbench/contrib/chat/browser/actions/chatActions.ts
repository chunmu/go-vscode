...
import { isAncestorOfActiveElement } from '../../../../../base/browser/dom.ts';
import { mainWindow } from '../../../../../base/browser/window.ts';
import { toAction, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent } from '../../../../../base/common/actions.ts';
...
import { fromNowByDay, safeIntl } from '../../../../../base/common/date.ts';
import { Event } from '../../../../../base/common/event.ts';
import { MarkdownString } from '../../../../../base/common/htmlContent.ts';
import { KeyCode, KeyMod } from '../../../../../base/common/keyCodes.ts';
import { Disposable, DisposableStore, markAsSingleton } from '../../../../../base/common/lifecycle.ts';
...
import { Action2, ICommandPaletteOptions, IMenuService, MenuId, MenuItemAction, MenuRegistry, registerAction2, SubmenuItemAction } from '../../../../../platform/actions/common/actions.ts';
import { ICommandService } from '../../../../../platform/commands/common/commands.ts';
import { IConfigurationService } from '../../../../../platform/configuration/common/configuration.ts';
import { ContextKeyExpr, IContextKeyService } from '../../../../../platform/contextkey/common/contextkey.ts';
import { IsLinuxContext, IsWindowsContext } from '../../../../../platform/contextkey/common/contextkeys.ts';
...
import { IQuickInputButton, IQuickInputService, IQuickPickItem, IQuickPickSeparator } from '../../../../../platform/quickinput/common/quickInput.ts';
import { ITelemetryService } from '../../../../../platform/telemetry/common/telemetry.ts';
import { ToggleTitleBarConfigAction } from '../../../../browser/parts/titlebar/titlebarActions.ts';
import { ActiveEditorContext, IsCompactTitleBarContext } from '../../../../common/contextkeys.ts';
...
import { GroupDirection, IEditorGroupsService } from '../../../../services/editor/common/editorGroupsService.ts';
...
import { EXTENSIONS_CATEGORY, IExtensionsWorkbenchService } from '../../../extensions/common/extensions.ts';
import { SCMHistoryItemChangeRangeContentProvider, ScmHistoryItemChangeRangeUriFields } from '../../../scm/browser/scmHistoryChatContext.ts';
import { ISCMService } from '../../../scm/common/scm.ts';
import { IChatAgentResult, IChatAgentService } from '../../common/chatAgents.ts';
import { ChatContextKeys } from '../../common/chatContextKeys.ts';
import { IChatEditingSession, ModifiedFileEntryState } from '../../common/chatEditingService.ts';
import { IChatResponseModel } from '../../common/chatModel.ts';
import { ChatMode, IChatMode, IChatModeService } from '../../common/chatModes.ts';
import { IChatDetail, IChatService } from '../../common/chatService.ts';
import { IChatSessionItem, IChatSessionsService, localChatSessionType } from '../../common/chatSessionsService.ts';
import { ISCMHistoryItemChangeRangeVariableEntry, ISCMHistoryItemChangeVariableEntry } from '../../common/chatVariableEntries.ts';
import { IChatRequestViewModel, IChatResponseViewModel, isRequestVM } from '../../common/chatViewModel.ts';
import { IChatWidgetHistoryService } from '../../common/chatWidgetHistoryService.ts';
import { LEGACY_AGENT_SESSIONS_VIEW_ID, ChatAgentLocation, ChatConfiguration, ChatModeKind } from '../../common/constants.ts';
import { ILanguageModelChatSelector, ILanguageModelsService } from '../../common/languageModels.ts';
import { CopilotUsageExtensionFeatureId } from '../../common/languageModelStats.ts';
...
import { ChatEditorInput, shouldShowClearEditingSessionConfirmation, showClearEditingSessionConfirmation } from '../chatEditorInput.ts';
...
import { IMarshalledChatSessionContext } from './chatSessionActions.ts';
