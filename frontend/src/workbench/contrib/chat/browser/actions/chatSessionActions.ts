...
import { IChatSessionRecommendation } from '../../../../../base/common/product.ts';
import Severity from '../../../../../base/common/severity.ts';
import * as nls from '../../../../../nls.ts';
import { localize } from '../../../../../nls.ts';
import { Action2, MenuId, MenuRegistry } from '../../../../../platform/actions/common/actions.ts';
...
import { AUX_WINDOW_GROUP, IEditorService, SIDE_GROUP } from '../../../../services/editor/common/editorService.ts';
...
import { LEGACY_AGENT_SESSIONS_VIEW_ID, ChatConfiguration } from '../../common/constants.ts';
import { AGENT_SESSIONS_VIEW_CONTAINER_ID, AGENT_SESSIONS_VIEW_ID } from '../agentSessions/agentSessions.ts';
...
import { ACTION_ID_OPEN_CHAT, CHAT_CATEGORY } from './chatActions.ts';
