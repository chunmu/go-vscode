...
import { DeferredPromise, isThenable } from '../../../../../base/common/async.ts';
...
import { autorun, observableValue } from '../../../../../base/common/observable.ts';
...
import { AbstractGotoSymbolQuickAccessProvider, IGotoSymbolQuickPickItem } from '../../../../../editor/contrib/quickAccess/browser/gotoSymbolQuickAccess.ts';
...
import { IQuickInputService, IQuickPickItem, IQuickPickItemWithResource, QuickPickItem } from '../../../../../platform/quickinput/common/quickInput.ts';
...
import { EditorResourceAccessor, isEditorCommandsContext, SideBySideEditor } from '../../../../common/editor.ts';
...
import { CTX_INLINE_CHAT_V2_ENABLED } from '../../../inlineChat/common/inlineChat.ts';
import { AnythingQuickAccessProvider } from '../../../search/browser/anythingQuickAccess.ts';
import { isSearchTreeFileMatch, isSearchTreeMatch } from '../../../search/browser/searchTreeModel/searchTreeCommon.ts';
import { ISymbolQuickPickItem, SymbolsQuickAccessProvider } from '../../../search/browser/symbolsQuickAccess.ts';
import { SearchContext } from '../../../search/common/constants.ts';
import { ChatContextKeys } from '../../common/chatContextKeys.ts';
import { IChatRequestVariableEntry, OmittedState } from '../../common/chatVariableEntries.ts';
import { ChatAgentLocation, isSupportedChatFileScheme } from '../../common/constants.ts';
import { IChatWidget, IChatWidgetService, IQuickChatService } from '../chat.ts';
import { IChatContextPickerItem, IChatContextPickService, IChatContextValueItem, isChatContextPickerPickItem } from '../chatContextPickService.ts';
import { isQuickChat } from '../chatWidget.ts';
import { resizeImage } from '../imageUtils.ts';
import { registerPromptActions } from '../promptSyntax/promptFileActions.ts';
