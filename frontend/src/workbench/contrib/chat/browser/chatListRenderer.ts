...
import { renderFormattedText } from '../../../../base/browser/formattedTextRenderer.ts';
...
import { IListElementRenderDetails, IListVirtualDelegate } from '../../../../base/browser/ui/list/list.ts';
import { ITreeNode, ITreeRenderer } from '../../../../base/browser/ui/tree/tree.ts';
import { IAction } from '../../../../base/common/actions.ts';
import { coalesce, distinct } from '../../../../base/common/arrays.ts';
import { findLast } from '../../../../base/common/arraysFind.ts';
import { Codicon } from '../../../../base/common/codicons.ts';
import { toErrorMessage } from '../../../../base/common/errorMessage.ts';
import { canceledName } from '../../../../base/common/errors.ts';
...
import { Disposable, DisposableStore, IDisposable, dispose, thenIfNotDisposed, toDisposable } from '../../../../base/common/lifecycle.ts';
...
import { IMenuEntryActionViewItemOptions, createActionViewItem } from '../../../../platform/actions/browser/menuEntryActionViewItem.ts';
import { MenuWorkbenchToolBar } from '../../../../platform/actions/browser/toolbar.ts';
import { MenuId, MenuItemAction } from '../../../../platform/actions/common/actions.ts';
...
import { isDark } from '../../../../platform/theme/common/theme.ts';
import { IThemeService } from '../../../../platform/theme/common/themeService.ts';
import { IWorkbenchIssueService } from '../../issue/common/issue.ts';
import { CodiconActionViewItem } from '../../notebook/browser/view/cellParts/cellActionView.ts';
import { annotateSpecialMarkdownContent } from '../common/annotations.ts';
import { checkModeOption } from '../common/chat.ts';
import { IChatAgentMetadata } from '../common/chatAgents.ts';
import { ChatContextKeys } from '../common/chatContextKeys.ts';
import { IChatTextEditGroup } from '../common/chatModel.ts';
...
import { IChatChangesSummaryPart, IChatCodeCitations, IChatErrorDetailsPart, IChatReferences, IChatRendererContent, IChatRequestViewModel, IChatResponseViewModel, IChatViewModel, isRequestVM, isResponseVM } from '../common/chatViewModel.ts';
import { getNWords } from '../common/chatWordCounter.ts';
import { CodeBlockModelCollection } from '../common/codeBlockModelCollection.ts';
import { ChatAgentLocation, ChatConfiguration, ChatModeKind, ThinkingDisplayMode } from '../common/constants.ts';
import { MarkUnhelpfulActionId } from './actions/chatTitleActions.ts';
import { ChatTreeItem, IChatCodeBlockInfo, IChatFileTreeInfo, IChatListItemRendererOptions, IChatWidgetService } from './chat.ts';
import { ChatAgentHover, getChatAgentHoverOptions } from './chatAgentHover.ts';
import { ChatAgentCommandContentPart } from './chatContentParts/chatAgentCommandContentPart.ts';
import { ChatAttachmentsContentPart } from './chatContentParts/chatAttachmentsContentPart.ts';
import { ChatCheckpointFileChangesSummaryContentPart } from './chatContentParts/chatChangesSummaryPart.ts';
import { ChatCodeCitationContentPart } from './chatContentParts/chatCodeCitationContentPart.ts';
import { ChatCommandButtonContentPart } from './chatContentParts/chatCommandContentPart.ts';
import { ChatConfirmationContentPart } from './chatContentParts/chatConfirmationContentPart.ts';
import { IChatContentPart, IChatContentPartRenderContext } from './chatContentParts/chatContentParts.ts';
import { ChatElicitationContentPart } from './chatContentParts/chatElicitationContentPart.ts';
import { ChatErrorConfirmationContentPart } from './chatContentParts/chatErrorConfirmationPart.ts';
import { ChatErrorContentPart } from './chatContentParts/chatErrorContentPart.ts';
import { ChatExtensionsContentPart } from './chatContentParts/chatExtensionsContentPart.ts';
import { ChatMarkdownContentPart } from './chatContentParts/chatMarkdownContentPart.ts';
import { ChatMcpServersInteractionContentPart } from './chatContentParts/chatMcpServersInteractionContentPart.ts';
import { ChatMultiDiffContentPart } from './chatContentParts/chatMultiDiffContentPart.ts';
import { ChatProgressContentPart, ChatWorkingProgressContentPart } from './chatContentParts/chatProgressContentPart.ts';
import { ChatPullRequestContentPart } from './chatContentParts/chatPullRequestContentPart.ts';
import { ChatQuotaExceededPart } from './chatContentParts/chatQuotaExceededPart.ts';
import { ChatCollapsibleListContentPart, ChatUsedReferencesListContentPart, CollapsibleListPool } from './chatContentParts/chatReferencesContentPart.ts';
import { ChatTaskContentPart } from './chatContentParts/chatTaskContentPart.ts';
import { ChatTextEditContentPart } from './chatContentParts/chatTextEditContentPart.ts';
import { ChatThinkingContentPart } from './chatContentParts/chatThinkingContentPart.ts';
import { ChatTreeContentPart, TreePool } from './chatContentParts/chatTreeContentPart.ts';
import { ChatToolInvocationPart } from './chatContentParts/toolInvocationParts/chatToolInvocationPart.ts';
import { ChatMarkdownDecorationsRenderer } from './chatMarkdownDecorationsRenderer.ts';
import { ChatContentMarkdownRenderer } from './chatContentMarkdownRenderer.ts';
import { ChatEditorOptions } from './chatOptions.ts';
import { ChatCodeBlockContentProvider, CodeBlockPart } from './codeBlockPart.ts';
import { ChatAnonymousRateLimitedPart } from './chatContentParts/chatAnonymousRateLimitedPart.ts';
import { IChatEntitlementService } from '../../../services/chat/common/chatEntitlementService.ts';
import { EditorPool, DiffEditorPool } from './chatContentParts/chatContentCodePools.ts';
