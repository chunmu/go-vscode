...
import { isPatternInWord } from '../../../../../base/common/filters.ts';
...
import { ICodeEditor, getCodeEditor, isCodeEditor } from '../../../../../editor/browser/editorBrowser.ts';
...
import { IWordAtPosition, getWordAtText } from '../../../../../editor/common/core/wordHelper.ts';
import { CompletionContext, CompletionItem, CompletionItemKind, CompletionItemProvider, CompletionList, DocumentSymbol, Location, ProviderResult, SymbolKind, SymbolKinds } from '../../../../../editor/common/languages.ts';
...
import { IOutlineModelService } from '../../../../../editor/contrib/documentSymbols/browser/outlineModel.ts';
...
import { IHistoryService } from '../../../../services/history/common/history.ts';
import { LifecyclePhase } from '../../../../services/lifecycle/common/lifecycle.ts';
import { ISearchService } from '../../../../services/search/common/search.ts';
import { McpPromptArgumentPick } from '../../../mcp/browser/mcpPromptArgumentPick.ts';
import { IMcpPrompt, IMcpPromptMessage, IMcpServer, IMcpService, McpResourceURI } from '../../../mcp/common/mcpTypes.ts';
import { searchFilesAndFolders } from '../../../search/browser/searchChatContext.ts';
import { IChatAgentData, IChatAgentNameService, IChatAgentService, getFullyQualifiedId } from '../../common/chatAgents.ts';
import { IChatEditingService } from '../../common/chatEditingService.ts';
import { getAttachableImageExtension } from '../../common/chatModel.ts';
import { ChatRequestAgentPart, ChatRequestAgentSubcommandPart, ChatRequestSlashPromptPart, ChatRequestTextPart, ChatRequestToolPart, ChatRequestToolSetPart, chatAgentLeader, chatSubcommandLeader, chatVariableLeader } from '../../common/chatParserTypes.ts';
...
import { IDynamicVariable } from '../../common/chatVariables.ts';
import { ChatAgentLocation, ChatModeKind, isSupportedChatFileScheme } from '../../common/constants.ts';
import { ToolSet } from '../../common/languageModelToolsService.ts';
import { IPromptsService } from '../../common/promptSyntax/service/promptsService.ts';
import { ChatSubmitAction } from '../actions/chatExecuteActions.ts';
import { IChatWidget, IChatWidgetService } from '../chat.ts';
import { resizeImage } from '../imageUtils.ts';
import { ChatDynamicVariableModel } from './chatDynamicVariables.ts';
