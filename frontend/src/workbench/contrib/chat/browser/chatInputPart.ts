...
import { DEFAULT_FONT_FAMILY } from '../../../../base/browser/fonts.ts';
import { IHistoryNavigationWidget } from '../../../../base/browser/history.ts';
import { hasModifierKeys, StandardKeyboardEvent } from '../../../../base/browser/keyboardEvent.ts';
...
import { Button, ButtonWithIcon } from '../../../../base/browser/ui/button/button.ts';
import { createInstantHoverDelegate, getDefaultHoverDelegate } from '../../../../base/browser/ui/hover/hoverDelegateFactory.ts';
...
import { autorun, derived, derivedOpts, IObservable, ISettableObservable, observableValue } from '../../../../base/common/observable.ts';
...
import { IEditorConstructionOptions } from '../../../../editor/browser/config/editorConfiguration.ts';
...
import { EditorOptions, IEditorOptions } from '../../../../editor/common/config/editorOptions.ts';
...
import { ContentHoverController } from '../../../../editor/contrib/hover/browser/contentHoverController.ts';
import { GlyphHoverController } from '../../../../editor/contrib/hover/browser/glyphHoverController.ts';
import { LinkDetector } from '../../../../editor/contrib/links/browser/links.ts';
...
import { MenuWorkbenchButtonBar } from '../../../../platform/actions/browser/buttonbar.ts';
...
import { registerAndCreateHistoryNavigationContext } from '../../../../platform/history/browser/contextScopedHistoryWidget.ts';
...
import { ResourceLabels } from '../../../browser/labels.ts';
...
import { getSimpleCodeEditorWidgetOptions, getSimpleEditorOptions, setupSimpleEditorSelectionStyling } from '../../codeEditor/browser/simpleEditorOptions.ts';
import { IChatAgentService } from '../common/chatAgents.ts';
import { ChatContextKeys } from '../common/chatContextKeys.ts';
import { IChatEditingSession, IModifiedFileEntry, ModifiedFileEntryState } from '../common/chatEditingService.ts';
import { IChatModelInputState, IChatRequestModeInfo, IInputModel } from '../common/chatModel.ts';
import { ChatMode, IChatMode, IChatModeService } from '../common/chatModes.ts';
import { IChatFollowup, IChatService } from '../common/chatService.ts';
import { IChatSessionProviderOptionItem, IChatSessionsService } from '../common/chatSessionsService.ts';
...
import { ChatHistoryNavigator } from '../common/chatWidgetHistoryService.ts';
import { ChatAgentLocation, ChatConfiguration, ChatModeKind, validateChatMode } from '../common/constants.ts';
import { ILanguageModelChatMetadata, ILanguageModelChatMetadataAndIdentifier, ILanguageModelsService } from '../common/languageModels.ts';
import { ILanguageModelToolsService } from '../common/languageModelToolsService.ts';
import { ActionLocation, ChatContinueInSessionActionItem, ContinueChatInSessionAction } from './actions/chatContinueInAction.ts';
import { ChatOpenModelPickerActionId, ChatSessionPrimaryPickerAction, ChatSubmitAction, IChatExecuteActionContext, OpenModePickerAction } from './actions/chatExecuteActions.ts';
import { ImplicitContextAttachmentWidget } from './attachments/implicitContextAttachment.ts';
import { IChatWidget } from './chat.ts';
import { ChatAttachmentModel } from './chatAttachmentModel.ts';
import { DefaultChatAttachmentWidget, ElementChatAttachmentWidget, FileAttachmentWidget, ImageAttachmentWidget, NotebookCellOutputChatAttachmentWidget, PasteAttachmentWidget, PromptFileAttachmentWidget, PromptTextAttachmentWidget, SCMHistoryItemAttachmentWidget, SCMHistoryItemChangeAttachmentWidget, SCMHistoryItemChangeRangeAttachmentWidget, TerminalCommandAttachmentWidget, ToolSetOrToolItemAttachmentWidget } from './chatAttachmentWidgets.ts';
import { IDisposableReference } from './chatContentParts/chatCollections.ts';
import { CollapsibleListPool, IChatCollapsibleListItem } from './chatContentParts/chatReferencesContentPart.ts';
import { ChatTodoListWidget } from './chatContentParts/chatTodoListWidget.ts';
import { IChatContextService } from './chatContextService.ts';
import { ChatDragAndDrop } from './chatDragAndDrop.ts';
import { ChatEditingShowChangesAction, ViewPreviousEditsAction } from './chatEditing/chatEditingActions.ts';
import { ChatFollowups } from './chatFollowups.ts';
import { ChatSelectedTools } from './chatSelectedTools.ts';
import { ChatSessionPickerActionItem, IChatSessionPickerDelegate } from './chatSessions/chatSessionPickerActionItem.ts';
import { ChatImplicitContext } from './contrib/chatImplicitContext.ts';
import { ChatRelatedFiles } from './contrib/chatInputRelatedFilesContrib.ts';
import { resizeImage } from './imageUtils.ts';
import { IModelPickerDelegate, ModelPickerActionItem } from './modelPicker/modelPickerActionItem.ts';
import { IModePickerDelegate, ModePickerActionItem } from './modelPicker/modePickerActionItem.ts';
