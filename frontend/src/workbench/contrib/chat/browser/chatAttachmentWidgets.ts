...
import { HoverStyle, type IHoverLifecycleOptions, type IHoverOptions } from '../../../../base/browser/ui/hover/hover.ts';
...
import * as event from '../../../../base/common/event.ts';
...
import { Location, SymbolKind } from '../../../../editor/common/languages.ts';
...
import { IContextKey, IContextKeyService, IScopedContextKeyService, RawContextKey } from '../../../../platform/contextkey/common/contextkey.ts';
import { IContextMenuService } from '../../../../platform/contextview/browser/contextView.ts';
import { fillInSymbolsDragData } from '../../../../platform/dnd/browser/dnd.ts';
...
import { IOpenerService, OpenInternalOptions } from '../../../../platform/opener/common/opener.ts';
import { FolderThemeIcon, IThemeService } from '../../../../platform/theme/common/themeService.ts';
import { fillEditorsDragData } from '../../../browser/dnd.ts';
import { IFileLabelOptions, IResourceLabel, ResourceLabels } from '../../../browser/labels.ts';
...
import { revealInSideBarCommand } from '../../files/browser/fileActions.contribution.ts';
import { CellUri } from '../../notebook/common/notebookCommon.ts';
import { INotebookService } from '../../notebook/common/notebookService.ts';
import { toHistoryItemHoverContent } from '../../scm/browser/scmHistory.ts';
import { getHistoryItemEditorTitle } from '../../scm/browser/util.ts';
import { ITerminalService } from '../../terminal/browser/terminal.ts';
import { IChatContentReference } from '../common/chatService.ts';
...
import { ILanguageModelToolsService, ToolSet } from '../common/languageModelToolsService.ts';
