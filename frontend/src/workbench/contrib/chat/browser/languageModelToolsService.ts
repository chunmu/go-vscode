...
import { createMarkdownCommandLink, MarkdownString } from '../../../../base/common/htmlContent.ts';
import { Iterable } from '../../../../base/common/iterator.ts';
import { combinedDisposable, Disposable, DisposableStore, IDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { IObservable, ObservableSet } from '../../../../base/common/observable.ts';
...
import * as JSONContributionRegistry from '../../../../platform/jsonschemas/common/jsonContributionRegistry.ts';
...
import { ConfirmedReason, IChatService, IChatToolInvocation, ToolConfirmKind } from '../common/chatService.ts';
import { ChatRequestToolReferenceEntry, toToolSetVariableEntry, toToolVariableEntry } from '../common/chatVariableEntries.ts';
...
import { getToolConfirmationAlert } from './chatAccessibilityProvider.ts';
