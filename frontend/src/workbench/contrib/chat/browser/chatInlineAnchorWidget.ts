...
import { Location, SymbolKinds } from '../../../../editor/common/languages.ts';
...
import { DefinitionAction } from '../../../../editor/contrib/gotoSymbol/browser/goToCommands.ts';
...
import { IResourceStat } from '../../../../platform/dnd/browser/dnd.ts';
...
import { IWorkspaceSymbol } from '../../search/common/search.ts';
import { IChatContentInlineReference } from '../common/chatService.ts';
import { IChatWidgetService } from './chat.ts';
import { chatAttachmentResourceContextKey, hookUpSymbolAttachmentDragAndContextMenu } from './chatAttachmentWidgets.ts';
