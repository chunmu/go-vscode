...
import { WindowIntervalTimer } from '../../../../base/browser/dom.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { DisposableStore } from '../../../../base/common/lifecycle.ts';
import { themeColorFromId, ThemeIcon } from '../../../../base/common/themables.ts';
import { ICodeEditor, IViewZone, IViewZoneChangeAccessor } from '../../../../editor/browser/editorBrowser.ts';
import { StableEditorScrollState } from '../../../../editor/browser/stableEditorScroll.ts';
import { LineSource, RenderOptions, renderLines } from '../../../../editor/browser/widget/diffEditor/components/diffEditorViewZones/renderLines.ts';
...
import { IModelDecorationsChangeAccessor, IModelDeltaDecoration, IValidEditOperation, MinimapPosition, OverviewRulerLane, TrackedRangeStickiness } from '../../../../editor/common/model.ts';
...
import { countWords } from '../../chat/common/chatWordCounter.ts';
import { HunkInformation, Session, HunkState } from './inlineChatSession.ts';
import { InlineChatZoneWidget } from './inlineChatZoneWidget.ts';
import { ACTION_TOGGLE_DIFF, CTX_INLINE_CHAT_CHANGE_HAS_DIFF, CTX_INLINE_CHAT_CHANGE_SHOWS_DIFF, InlineChatConfigKeys, MENU_INLINE_CHAT_ZONE, minimapInlineChatDiffInserted, overviewRulerInlineChatDiffInserted } from '../common/inlineChat.ts';
import { assertType } from '../../../../base/common/types.ts';
import { performAsyncTextEdit, asProgressiveEdit } from './utils.ts';
...
import { DefaultChatTextEditor } from '../../chat/browser/codeBlockPart.ts';
import { isEqual } from '../../../../base/common/resources.ts';
import { Iterable } from '../../../../base/common/iterator.ts';
import { ConflictActionsFactory, IContentWidgetAction } from '../../mergeEditor/browser/view/conflictActions.ts';
import { observableValue } from '../../../../base/common/observable.ts';
import { IMenuService, MenuItemAction } from '../../../../platform/actions/common/actions.ts';
...
import { VersionedExtensionId } from '../../../../editor/common/languages.ts';
