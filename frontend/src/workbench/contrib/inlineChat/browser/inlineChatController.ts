...
import { Barrier, DeferredPromise, Queue, raceCancellation } from '../../../../base/common/async.ts';
...
import { autorun, derived, IObservable, observableSignalFromEvent, observableValue, waitForState } from '../../../../base/common/observable.ts';
...
import { ISelection, Selection, SelectionDirection } from '../../../../editor/common/core/selection.ts';
import { IEditorContribution } from '../../../../editor/common/editorCommon.ts';
import { TextEdit, VersionedExtensionId } from '../../../../editor/common/languages.ts';
...
import { IChatAttachmentResolveService } from '../../chat/browser/chatAttachmentResolveService.ts';
...
import { IChatEditingSession, ModifiedFileEntryState } from '../../chat/common/chatEditingService.ts';
import { ChatModel, ChatRequestRemovalReason, IChatRequestModel, IChatTextEditGroup, IChatTextEditGroupState, IResponse } from '../../chat/common/chatModel.ts';
import { ChatMode } from '../../chat/common/chatModes.ts';
import { IChatService } from '../../chat/common/chatService.ts';
import { IChatRequestVariableEntry, IDiagnosticVariableEntryFilterData } from '../../chat/common/chatVariableEntries.ts';
import { ChatAgentLocation } from '../../chat/common/constants.ts';
import { isNotebookContainingCellEditor as isNotebookWithCellEditor } from '../../notebook/browser/notebookEditor.ts';
...
import { CTX_INLINE_CHAT_EDITING, CTX_INLINE_CHAT_REQUEST_IN_PROGRESS, CTX_INLINE_CHAT_RESPONSE_TYPE, CTX_INLINE_CHAT_VISIBLE, INLINE_CHAT_ID, InlineChatConfigKeys, InlineChatResponseType } from '../common/inlineChat.ts';
import { HunkInformation, Session, StashedSession } from './inlineChatSession.ts';
import { IInlineChatSession2, IInlineChatSessionService, moveToPanelChat } from './inlineChatSessionService.ts';
import { InlineChatError } from './inlineChatSessionServiceImpl.ts';
import { HunkAction, IEditObserver, IInlineChatMetadata, LiveStrategy, ProgressingEditsOptions } from './inlineChatStrategies.ts';
import { EditorBasedInlineChatWidget } from './inlineChatWidget.ts';
import { InlineChatZoneWidget } from './inlineChatZoneWidget.ts';
