...
import { $, Dimension, getActiveElement, getTotalHeight, getWindow, h, reset, trackFocus } from '../../../../base/browser/dom.ts';
...
import { autorun, constObservable, derived, IObservable, ISettableObservable, observableValue } from '../../../../base/common/observable.ts';
import { isEqual } from '../../../../base/common/resources.ts';
import { ICodeEditor } from '../../../../editor/browser/editorBrowser.ts';
import { AccessibleDiffViewer, IAccessibleDiffViewerModel } from '../../../../editor/browser/widget/diffEditor/components/accessibleDiffViewer.ts';
import { EditorOption, IComputedEditorOptions } from '../../../../editor/common/config/editorOptions.ts';
...
import { ICodeEditorViewState, ScrollType } from '../../../../editor/common/editorCommon.ts';
...
import { IWorkbenchButtonBarOptions, MenuWorkbenchButtonBar } from '../../../../platform/actions/browser/buttonbar.ts';
import { createActionViewItem, IMenuEntryActionViewItemOptions } from '../../../../platform/actions/browser/menuEntryActionViewItem.ts';
...
import { asCssVariable, asCssVariableName, editorBackground, inputBackground } from '../../../../platform/theme/common/colorRegistry.ts';
...
import { MarkUnhelpfulActionId } from '../../chat/browser/actions/chatTitleActions.ts';
import { IChatWidgetViewOptions } from '../../chat/browser/chat.ts';
import { ChatVoteDownButton } from '../../chat/browser/chatListRenderer.ts';
import { ChatWidget, IChatWidgetLocationOptions } from '../../chat/browser/chatWidget.ts';
import { chatRequestBackground } from '../../chat/common/chatColors.ts';
import { ChatContextKeys } from '../../chat/common/chatContextKeys.ts';
import { IChatModel } from '../../chat/common/chatModel.ts';
import { ChatMode } from '../../chat/common/chatModes.ts';
import { ChatAgentVoteDirection, IChatService } from '../../chat/common/chatService.ts';
import { isResponseVM } from '../../chat/common/chatViewModel.ts';
import { CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_RESPONSE_FOCUSED, inlineChatBackground, inlineChatForeground } from '../common/inlineChat.ts';
import { HunkInformation, Session } from './inlineChatSession.ts';
