...
import { MOUSE_CURSOR_TEXT_CSS_CLASS_NAME } from '../../../../base/browser/ui/mouseCursor/mouseCursor.ts';
import { IAsyncDataSource, ITreeContextMenuEvent, ITreeNode } from '../../../../base/browser/ui/tree/tree.ts';
...
import { HistoryNavigator } from '../../../../base/common/history.ts';
...
import { ICodeEditor, isCodeEditor } from '../../../../editor/browser/editorBrowser.ts';
...
import { EDITOR_FONT_DEFAULTS } from '../../../../editor/common/config/fontInfo.ts';
...
import { CompletionContext, CompletionItem, CompletionItemInsertTextRule, CompletionItemKind, CompletionItemKinds, CompletionList } from '../../../../editor/common/languages.ts';
...
import { editorForeground, resolveColorValue } from '../../../../platform/theme/common/colorRegistry.ts';
import { IThemeService } from '../../../../platform/theme/common/themeService.ts';
import { registerNavigableContainer } from '../../../browser/actions/widgetNavigationCommands.ts';
import { FilterViewPane, IViewPaneOptions, ViewAction } from '../../../browser/parts/views/viewPane.ts';
...
import { getSimpleCodeEditorWidgetOptions, getSimpleEditorOptions } from '../../codeEditor/browser/simpleEditorOptions.ts';
import { CONTEXT_DEBUG_STATE, CONTEXT_IN_DEBUG_REPL, CONTEXT_MULTI_SESSION_REPL, DEBUG_SCHEME, IDebugConfiguration, IDebugService, IDebugSession, IReplConfiguration, IReplElement, IReplOptions, REPL_VIEW_ID, State, getStateLabel } from '../common/debug.ts';
import { Variable } from '../common/debugModel.ts';
import { resolveChildSession } from '../common/debugUtils.ts';
import { ReplEvaluationResult, ReplGroup } from '../common/replModel.ts';
import { FocusSessionActionViewItem } from './debugActionViewItems.ts';
import { DEBUG_COMMAND_CATEGORY, FOCUS_REPL_ID } from './debugCommands.ts';
import { DebugExpressionRenderer } from './debugExpressionRenderer.ts';
import { debugConsoleClearAll, debugConsoleEvaluationPrompt } from './debugIcons.ts';
import './media/repl.css';
import { ReplFilter } from './replFilter.ts';
import { ReplAccessibilityProvider, ReplDataSource, ReplDelegate, ReplEvaluationInputsRenderer, ReplEvaluationResultsRenderer, ReplGroupRenderer, ReplOutputElementRenderer, ReplRawObjectsRenderer, ReplVariablesRenderer } from './replViewer.ts';
