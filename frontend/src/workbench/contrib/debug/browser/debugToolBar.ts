...
import { ActionBar, ActionsOrientation, IActionViewItem } from '../../../../base/browser/ui/actionbar/actionbar.ts';
...
import { Action, IAction, IRunEvent, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent } from '../../../../base/common/actions.ts';
...
import { Platform, platform } from '../../../../base/common/platform.ts';
import { ThemeIcon } from '../../../../base/common/themables.ts';
import { URI } from '../../../../base/common/uri.ts';
import { ServicesAccessor } from '../../../../editor/browser/editorExtensions.ts';
import { localize } from '../../../../nls.ts';
import { ICommandAction, ICommandActionTitle } from '../../../../platform/action/common/action.ts';
import { DropdownWithPrimaryActionViewItem, IDropdownWithPrimaryActionViewItemOptions } from '../../../../platform/actions/browser/dropdownWithPrimaryActionViewItem.ts';
import { createActionViewItem, getFlatActionBarActions } from '../../../../platform/actions/browser/menuEntryActionViewItem.ts';
import { IMenu, IMenuService, MenuId, MenuItemAction, MenuRegistry } from '../../../../platform/actions/common/actions.ts';
...
import { widgetBorder, widgetShadow } from '../../../../platform/theme/common/colorRegistry.ts';
import { IThemeService, Themable } from '../../../../platform/theme/common/themeService.ts';
import { getTitleBarStyle, TitlebarStyle } from '../../../../platform/window/common/window.ts';
import { IWorkbenchContribution } from '../../../common/contributions.ts';
import { EditorTabsMode, IWorkbenchLayoutService, LayoutSettings, Parts } from '../../../services/layout/browser/layoutService.ts';
