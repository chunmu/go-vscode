...
import { ISelectOptionItem, SelectBox } from '../../../../base/browser/ui/selectBox/selectBox.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { onUnexpectedError } from '../../../../base/common/errors.ts';
import { KeyCode, KeyMod } from '../../../../base/common/keyCodes.ts';
import * as lifecycle from '../../../../base/common/lifecycle.ts';
import { URI as uri } from '../../../../base/common/uri.ts';
import { IActiveCodeEditor, ICodeEditor } from '../../../../editor/browser/editorBrowser.ts';
import { EditorCommand, ServicesAccessor, registerEditorCommand } from '../../../../editor/browser/editorExtensions.ts';
...
import { CompletionContext, CompletionItemKind, CompletionList } from '../../../../editor/common/languages.ts';
...
import { CompletionOptions, provideSuggestionItems } from '../../../../editor/contrib/suggest/browser/suggest.ts';
import { ZoneWidget } from '../../../../editor/contrib/zoneWidget/browser/zoneWidget.ts';
...
import { defaultButtonStyles, defaultSelectBoxStyles } from '../../../../platform/theme/browser/defaultStyles.ts';
import { editorForeground } from '../../../../platform/theme/common/colorRegistry.ts';
...
import { BREAKPOINT_EDITOR_CONTRIBUTION_ID, CONTEXT_BREAKPOINT_WIDGET_VISIBLE, CONTEXT_IN_BREAKPOINT_WIDGET, BreakpointWidgetContext as Context, DEBUG_SCHEME, IBreakpoint, IBreakpointEditorContribution, IBreakpointUpdateData, IDebugService } from '../common/debug.ts';
