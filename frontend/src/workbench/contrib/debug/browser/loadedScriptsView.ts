...
import type { ICompressedTreeNode } from '../../../../base/browser/ui/tree/compressedObjectTreeModel.ts';
import type { ICompressibleTreeRenderer } from '../../../../base/browser/ui/tree/objectTree.ts';
import { ITreeElement, ITreeFilter, ITreeNode, TreeFilterResult, TreeVisibility } from '../../../../base/browser/ui/tree/tree.ts';
import { RunOnceScheduler } from '../../../../base/common/async.ts';
import { Codicon } from '../../../../base/common/codicons.ts';
import { createMatches, FuzzyScore } from '../../../../base/common/filters.ts';
import { normalizeDriveLetter, tildify } from '../../../../base/common/labels.ts';
import { dispose } from '../../../../base/common/lifecycle.ts';
import { isAbsolute, normalize, posix } from '../../../../base/common/path.ts';
import { isWindows } from '../../../../base/common/platform.ts';
import { ltrim } from '../../../../base/common/strings.ts';
...
import { WorkbenchCompressibleObjectTree } from '../../../../platform/list/browser/listService.ts';
...
import { IWorkspaceContextService, IWorkspaceFolder } from '../../../../platform/workspace/common/workspace.ts';
import { IResourceLabel, IResourceLabelOptions, IResourceLabelProps, ResourceLabels } from '../../../browser/labels.ts';
...
import { CONTEXT_LOADED_SCRIPTS_ITEM_TYPE, IDebugService, IDebugSession, LOADED_SCRIPTS_VIEW_ID } from '../common/debug.ts';
