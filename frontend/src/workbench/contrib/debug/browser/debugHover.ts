...
import { AsyncDataTree } from '../../../../base/browser/ui/tree/asyncDataTree.ts';
...
import { ContentWidgetPositionPreference, ICodeEditor, IContentWidget, IContentWidgetPosition } from '../../../../editor/browser/editorBrowser.ts';
...
import { asCssVariable, editorHoverBackground, editorHoverBorder, editorHoverForeground } from '../../../../platform/theme/common/colorRegistry.ts';
import { IDebugService, IDebugSession, IExpression, IExpressionContainer, IStackFrame } from '../common/debug.ts';
...
import { AbstractExpressionDataSource } from './baseDebugView.ts';
import { DebugExpressionRenderer } from './debugExpressionRenderer.ts';
import { VariablesRenderer, VisualizedVariableRenderer, openContextMenuForVariableTreeElement } from './variablesView.ts';
