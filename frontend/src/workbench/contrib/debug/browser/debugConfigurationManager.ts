...
import { sequence } from '../../../../base/common/async.ts';
...
import { DisposableStore, IDisposable, dispose } from '../../../../base/common/lifecycle.ts';
...
import { IWorkspaceContextService, IWorkspaceFolder, IWorkspaceFoldersChangeEvent, WorkbenchState } from '../../../../platform/workspace/common/workspace.ts';
...
import { CONTEXT_DEBUG_CONFIGURATION_TYPE, DebugConfigurationProviderTriggerKind, IAdapterManager, ICompound, IConfig, IConfigPresentation, IConfigurationManager, IDebugConfigurationProvider, IGlobalConfig, IGuessedDebugger, ILaunch } from '../common/debug.ts';
import { launchSchema } from '../common/debugSchemas.ts';
import { getVisibleAndSorted } from '../common/debugUtils.ts';
