...
import { addDisposableListener, isKeyboardEvent } from '../../../../base/browser/dom.ts';
import { DomEmitter } from '../../../../base/browser/event.ts';
import { IKeyboardEvent, StandardKeyboardEvent } from '../../../../base/browser/keyboardEvent.ts';
import { IMouseEvent } from '../../../../base/browser/mouseEvent.ts';
...
import { illegalArgument, onUnexpectedExternalError } from '../../../../base/common/errors.ts';
import { Event } from '../../../../base/common/event.ts';
import { visit } from '../../../../base/common/json.ts';
import { setProperty } from '../../../../base/common/jsonEdit.ts';
import { KeyCode } from '../../../../base/common/keyCodes.ts';
import { DisposableStore, IDisposable, MutableDisposable, dispose, toDisposable } from '../../../../base/common/lifecycle.ts';
import { clamp } from '../../../../base/common/numbers.ts';
import { basename } from '../../../../base/common/path.ts';
import * as env from '../../../../base/common/platform.ts';
import * as strings from '../../../../base/common/strings.ts';
import { assertType, isDefined } from '../../../../base/common/types.ts';
import { Constants } from '../../../../base/common/uint.ts';
import { URI } from '../../../../base/common/uri.ts';
import { CoreEditingCommands } from '../../../../editor/browser/coreCommands.ts';
import { ICodeEditor, IEditorMouseEvent, IPartialEditorMouseEvent, MouseTargetType } from '../../../../editor/browser/editorBrowser.ts';
import { EditorOption, IEditorHoverOptions } from '../../../../editor/common/config/editorOptions.ts';
...
import { DEFAULT_WORD_REGEXP } from '../../../../editor/common/core/wordHelper.ts';
import { IEditorDecorationsCollection, ScrollType } from '../../../../editor/common/editorCommon.ts';
import { StandardTokenType } from '../../../../editor/common/encodedTokenAttributes.ts';
import { InlineValue, InlineValueContext } from '../../../../editor/common/languages.ts';
import { IModelDeltaDecoration, ITextModel, InjectedTextCursorStops } from '../../../../editor/common/model.ts';
import { IFeatureDebounceInformation, ILanguageFeatureDebounceService } from '../../../../editor/common/services/languageFeatureDebounce.ts';
...
import { HoverStartMode, HoverStartSource } from '../../../../editor/contrib/hover/browser/hoverOperation.ts';
...
import { FloatingEditorClickWidget } from '../../../browser/codeeditor.ts';
import { DebugHoverWidget, ShowDebugHoverResult } from './debugHover.ts';
import { ExceptionWidget } from './exceptionWidget.ts';
import { CONTEXT_EXCEPTION_WIDGET_VISIBLE, IDebugConfiguration, IDebugEditorContribution, IDebugService, IDebugSession, IExceptionInfo, IExpression, IStackFrame, State } from '../common/debug.ts';
import { Expression } from '../common/debugModel.ts';
import { IHostService } from '../../../services/host/browser/host.ts';
import { IEditorService } from '../../../services/editor/common/editorService.ts';
import { MarkdownString } from '../../../../base/common/htmlContent.ts';
import { InsertLineAfterAction } from '../../../../editor/contrib/linesOperations/browser/linesOperations.ts';
