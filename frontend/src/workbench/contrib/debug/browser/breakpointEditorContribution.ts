...
import { dispose, disposeIfDisposable, IDisposable } from '../../../../base/common/lifecycle.ts';
import * as env from '../../../../base/common/platform.ts';
import severity from '../../../../base/common/severity.ts';
import { noBreakWhitespace } from '../../../../base/common/strings.ts';
import { ThemeIcon } from '../../../../base/common/themables.ts';
import { URI } from '../../../../base/common/uri.ts';
import { generateUuid } from '../../../../base/common/uuid.ts';
import { ContentWidgetPositionPreference, IActiveCodeEditor, ICodeEditor, IContentWidget, IContentWidgetPosition, IEditorMouseEvent, MouseTargetType } from '../../../../editor/browser/editorBrowser.ts';
...
import { GlyphMarginLane, IModelDecorationOptions, IModelDecorationOverviewRulerOptions, IModelDecorationsChangeAccessor, ITextModel, OverviewRulerLane, TrackedRangeStickiness } from '../../../../editor/common/model.ts';
...
import { registerThemingParticipant, themeColorFromId } from '../../../../platform/theme/common/themeService.ts';
import { GutterActionsRegistry } from '../../codeEditor/browser/editorLineNumberMenu.ts';
import { getBreakpointMessageAndIcon } from './breakpointsView.ts';
import { BreakpointWidget } from './breakpointWidget.ts';
import * as icons from './debugIcons.ts';
import { BREAKPOINT_EDITOR_CONTRIBUTION_ID, BreakpointWidgetContext, CONTEXT_BREAKPOINT_WIDGET_VISIBLE, DebuggerString, IBreakpoint, IBreakpointEditorContribution, IBreakpointUpdateData, IDebugConfiguration, IDebugService, IDebugSession, State } from '../common/debug.ts';
