...
import { Extensions as WorkbenchExtensions, IWorkbenchContributionsRegistry, IWorkbenchContribution } from '../../../common/contributions.ts';
import { LifecyclePhase, ILifecycleService, StartupKind } from '../../../services/lifecycle/common/lifecycle.ts';
...
import ErrorTelemetry from '../../../../platform/telemetry/browser/errorTelemetry.ts';
import { supportsTelemetry, TelemetryLogGroup, telemetryLogId, TelemetryTrustedValue } from '../../../../platform/telemetry/common/telemetryUtils.ts';
import { ConfigurationTarget, ConfigurationTargetToString, IConfigurationService } from '../../../../platform/configuration/common/configuration.ts';
import { ITextFileService, ITextFileSaveEvent, ITextFileResolveEvent } from '../../../services/textfile/common/textfiles.ts';
import { extname, basename, isEqual, isEqualOrParent } from '../../../../base/common/resources.ts';
...
import { LayoutSettings } from '../../../services/layout/browser/layoutService.ts';
import { AutoRestartConfigurationKey, AutoUpdateConfigurationKey } from '../../extensions/common/extensions.ts';
...
import { IOutputService } from '../../../services/output/common/output.ts';
import { ILoggerResource, ILoggerService, LogLevel } from '../../../../platform/log/common/log.ts';
import { VerifyExtensionSignatureConfigKey } from '../../../../platform/extensionManagement/common/extensionManagement.ts';
import { TerminalContribSettingId } from '../../terminal/terminalContribExports.ts';
