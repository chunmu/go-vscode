...
import { RunOnceScheduler, retry } from '../../../../base/common/async.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { Disposable, DisposableStore } from '../../../../base/common/lifecycle.ts';
import { MenuId, IMenuService, MenuItemAction, MenuRegistry, registerAction2, Action2, SubmenuItemAction, IMenu } from '../../../../platform/actions/common/actions.ts';
import { IWorkbenchContribution } from '../../../common/contributions.ts';
import { StatusbarAlignment, IStatusbarService, IStatusbarEntryAccessor, IStatusbarEntry } from '../../../services/statusbar/browser/statusbar.ts';
...
import { QuickPickItem, IQuickInputService, IQuickInputButton } from '../../../../platform/quickinput/common/quickInput.ts';
...
import { PlatformName, PlatformToString, isWeb, platform } from '../../../../base/common/platform.ts';
import { truncate } from '../../../../base/common/strings.ts';
...
import { ReloadWindowAction } from '../../../browser/actions/windowActions.ts';
import { EXTENSION_INSTALL_SKIP_WALKTHROUGH_CONTEXT, IExtensionGalleryService, IExtensionManagementService } from '../../../../platform/extensionManagement/common/extensionManagement.ts';
import { IExtensionsWorkbenchService, LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID } from '../../extensions/common/extensions.ts';
...
import { RemoteNameContext, VirtualWorkspaceContext } from '../../../common/contextkeys.ts';
...
import { infoIcon } from '../../extensions/browser/extensionsIcons.ts';
