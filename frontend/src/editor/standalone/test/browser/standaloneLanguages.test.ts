...
import { LanguageId, MetadataConsts } from '../../../common/encodedTokenAttributes.ts';
import { IState, Token } from '../../../common/languages.ts';
import { TokenTheme } from '../../../common/languages/supports/tokenization.ts';
import { LanguageService } from '../../../common/services/languageService.ts';
import { ILineTokens, IToken, TokenizationSupportAdapter, TokensProvider } from '../../browser/standaloneLanguages.ts';
import { IStandaloneTheme, IStandaloneThemeData, IStandaloneThemeService } from '../../common/standaloneTheme.ts';
import { UnthemedProductIconTheme } from '../../../../platform/theme/browser/iconsStyleSheet.ts';
import { ColorIdentifier } from '../../../../platform/theme/common/colorRegistry.ts';
import { ColorScheme } from '../../../../platform/theme/common/theme.ts';
import { IColorTheme, IFileIconTheme, IProductIconTheme, ITokenStyle } from '../../../../platform/theme/common/themeService.ts';
