...
import { $, append, reset } from '../../../../base/browser/dom.ts';
...
import { ContentWidgetPositionPreference, IActiveCodeEditor, ICodeEditor, IContentWidget, IContentWidgetPosition } from '../../../browser/editorBrowser.ts';
import { EditorAction, ServicesAccessor, registerEditorAction, registerEditorContribution, EditorContributionInstantiation } from '../../../browser/editorExtensions.ts';
...
import { IState, ITokenizationSupport, TokenizationRegistry, ILanguageIdCodec, Token } from '../../../common/languages.ts';
import { FontStyle, StandardTokenType, TokenMetadata } from '../../../common/encodedTokenAttributes.ts';
import { NullState, nullTokenize, nullTokenizeEncoded } from '../../../common/languages/nullTokenize.ts';
import { ILanguageService } from '../../../common/languages/language.ts';
import { IStandaloneThemeService } from '../../common/standaloneTheme.ts';
import { InspectTokensNLS } from '../../../common/standaloneStrings.ts';
