...
import { ILanguageExtensionPoint, ILanguageService } from '../../common/languages/language.ts';
import { LanguageConfiguration } from '../../common/languages/languageConfiguration.ts';
import { ILanguageConfigurationService } from '../../common/languages/languageConfigurationRegistry.ts';
import { ModesRegistry } from '../../common/languages/modesRegistry.ts';
import { LanguageSelector } from '../../common/languageSelector.ts';
import * as model from '../../common/model.ts';
...
import { StandaloneServices } from './standaloneServices.ts';
import { compile } from '../common/monarch/monarchCompile.ts';
import { MonarchTokenizer } from '../common/monarch/monarchLexer.ts';
import { IMonarchLanguage } from '../common/monarch/monarchTypes.ts';
