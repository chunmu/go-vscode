...
import { ColorId, FontStyle, MetadataConsts } from '../../common/encodedTokenAttributes.ts';
import { ILanguageIdCodec, ITokenizationSupport, TokenizationRegistry } from '../../common/languages.ts';
...
import { RenderLineInput, renderViewLine2 as renderViewLine } from '../../common/viewLayout/viewLineRenderer.ts';
