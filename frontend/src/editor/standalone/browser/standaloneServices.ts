...
import './standaloneCodeEditorService.ts';
import './standaloneLayoutService.ts';
import '../../../platform/undoRedo/common/undoRedoService.ts';
import '../../common/services/languageFeatureDebounce.ts';
import '../../common/services/semanticTokensStylingService.ts';
import '../../common/services/languageFeaturesService.ts';
import '../../../platform/hover/browser/hoverService.ts';
import '../../browser/services/inlineCompletionsService.ts';

import * as strings from '../../../base/common/strings.ts';
import * as dom from '../../../base/browser/dom.ts';
import { StandardKeyboardEvent } from '../../../base/browser/keyboardEvent.ts';
import { Emitter, Event, IValueWithChangeEvent, ValueWithChangeEvent } from '../../../base/common/event.ts';
import { ResolvedKeybinding, KeyCodeChord, Keybinding, decodeKeybinding } from '../../../base/common/keybindings.ts';
import { IDisposable, IReference, ImmortalReference, toDisposable, DisposableStore, Disposable, combinedDisposable } from '../../../base/common/lifecycle.ts';
import { OS, isLinux, isMacintosh } from '../../../base/common/platform.ts';
import Severity from '../../../base/common/severity.ts';
import { URI } from '../../../base/common/uri.ts';
import { IBulkEditOptions, IBulkEditResult, IBulkEditService, ResourceEdit, ResourceTextEdit } from '../../browser/services/bulkEditService.ts';
import { isDiffEditorConfigurationKey, isEditorConfigurationKey } from '../../common/config/editorConfigurationSchema.ts';
import { EditOperation, ISingleEditOperation } from '../../common/core/editOperation.ts';
import { IPosition, Position as Pos } from '../../common/core/position.ts';
import { Range } from '../../common/core/range.ts';
import { ITextModel, ITextSnapshot } from '../../common/model.ts';
import { IModelService } from '../../common/services/model.ts';
import { IResolvedTextEditorModel, ITextModelContentProvider, ITextModelService } from '../../common/services/resolverService.ts';
import { ITextResourceConfigurationService, ITextResourcePropertiesService, ITextResourceConfigurationChangeEvent } from '../../common/services/textResourceConfiguration.ts';
import { CommandsRegistry, ICommandEvent, ICommandHandler, ICommandService } from '../../../platform/commands/common/commands.ts';
import { IConfigurationChangeEvent, IConfigurationData, IConfigurationOverrides, IConfigurationService, IConfigurationModel, IConfigurationValue, ConfigurationTarget } from '../../../platform/configuration/common/configuration.ts';
import { Configuration, ConfigurationModel, ConfigurationChangeEvent } from '../../../platform/configuration/common/configurationModels.ts';
import { IContextKeyService, ContextKeyExpression } from '../../../platform/contextkey/common/contextkey.ts';
import { IConfirmation, IConfirmationResult, IDialogService, IInputResult, IPrompt, IPromptResult, IPromptWithCustomCancel, IPromptResultWithCancel, IPromptWithDefaultCancel, IPromptBaseButton } from '../../../platform/dialogs/common/dialogs.ts';
import { createDecorator, IInstantiationService, ServiceIdentifier } from '../../../platform/instantiation/common/instantiation.ts';
...
import { IKeybindingItem, KeybindingsRegistry } from '../../../platform/keybinding/common/keybindingsRegistry.ts';
...
import { ILabelService, ResourceLabelFormatter, IFormatterChangeEvent, Verbosity } from '../../../platform/label/common/label.ts';
import { INotification, INotificationHandle, INotificationService, IPromptChoice, IPromptOptions, NoOpNotification, IStatusMessageOptions, INotificationSource, INotificationSourceFilter, NotificationsFilter, IStatusHandle } from '../../../platform/notification/common/notification.ts';
import { IProgressRunner, IEditorProgressService, IProgressService, IProgress, IProgressCompositeOptions, IProgressDialogOptions, IProgressNotificationOptions, IProgressOptions, IProgressStep, IProgressWindowOptions } from '../../../platform/progress/common/progress.ts';
import { ITelemetryService, TelemetryLevel } from '../../../platform/telemetry/common/telemetry.ts';
import { ISingleFolderWorkspaceIdentifier, IWorkspaceIdentifier, IWorkspace, IWorkspaceContextService, IWorkspaceFolder, IWorkspaceFoldersChangeEvent, IWorkspaceFoldersWillChangeEvent, WorkbenchState, WorkspaceFolder, STANDALONE_EDITOR_WORKSPACE_ID } from '../../../platform/workspace/common/workspace.ts';
import { ILayoutService } from '../../../platform/layout/browser/layoutService.ts';
import { StandaloneServicesNLS } from '../../common/standaloneStrings.ts';
import { basename } from '../../../base/common/resources.ts';
import { ICodeEditorService } from '../../browser/services/codeEditorService.ts';
import { ConsoleLogger, ILoggerService, ILogService, NullLoggerService } from '../../../platform/log/common/log.ts';
import { IWorkspaceTrustManagementService, IWorkspaceTrustTransitionParticipant, IWorkspaceTrustUriInfo } from '../../../platform/workspace/common/workspaceTrust.ts';
import { EditorOption } from '../../common/config/editorOptions.ts';
import { ICodeEditor, IDiffEditor } from '../../browser/editorBrowser.ts';
import { IContextMenuService, IContextViewDelegate, IContextViewService, IOpenContextView } from '../../../platform/contextview/browser/contextView.ts';
...
import { getSingletonServiceDescriptors, InstantiationType, registerSingleton } from '../../../platform/instantiation/common/extensions.ts';
import { OpenerService } from '../../browser/services/openerService.ts';
import { ILanguageService } from '../../common/languages/language.ts';
import { MarkerDecorationsService } from '../../common/services/markerDecorationsService.ts';
...
import { StandaloneQuickInputService } from './quickInput/standaloneQuickInputService.ts';
import { StandaloneThemeService } from './standaloneThemeService.ts';
import { IStandaloneThemeService } from '../common/standaloneTheme.ts';
...
import { IMenuService } from '../../../platform/actions/common/actions.ts';
import { MenuService } from '../../../platform/actions/common/menuService.ts';
import { BrowserClipboardService } from '../../../platform/clipboard/browser/clipboardService.ts';
...
import { DefaultConfiguration } from '../../../platform/configuration/common/configurations.ts';
import { WorkspaceEdit } from '../../common/languages.ts';
import { AccessibilitySignal, AccessibilityModality, IAccessibilitySignalService, Sound } from '../../../platform/accessibilitySignal/browser/accessibilitySignalService.ts';
import { LogService } from '../../../platform/log/common/logService.ts';
import { getEditorFeatures } from '../../common/editorFeatures.ts';
import { onUnexpectedError } from '../../../base/common/errors.ts';
import { ExtensionKind, IEnvironmentService, IExtensionHostDebugParams } from '../../../platform/environment/common/environment.ts';
...
import { StandaloneTreeSitterLibraryService } from './standaloneTreeSitterLibraryService.ts';
...
import { StandaloneWebWorkerService } from './services/standaloneWebWorkerService.ts';
