...
import { Disposable, IDisposable, toDisposable, DisposableStore } from '../../../base/common/lifecycle.ts';
import { ICodeEditor, IDiffEditor, IDiffEditorConstructionOptions } from '../../browser/editorBrowser.ts';
...
import { IDiffEditorOptions, IEditorOptions } from '../../common/config/editorOptions.ts';
import { InternalEditorAction } from '../../common/editorAction.ts';
import { IModelChangedEvent } from '../../common/editorCommon.ts';
import { ITextModel } from '../../common/model.ts';
import { StandaloneKeybindingService, updateConfigurationService } from './standaloneServices.ts';
...
import { ContextKeyExpr, ContextKeyValue, IContextKey, IContextKeyService } from '../../../platform/contextkey/common/contextkey.ts';
...
import { StandaloneCodeEditorNLS } from '../../common/standaloneStrings.ts';
...
import { ILanguageSelection, ILanguageService } from '../../common/languages/language.ts';
import { URI } from '../../../base/common/uri.ts';
import { StandaloneCodeEditorService } from './standaloneCodeEditorService.ts';
...
import { IEditorConstructionOptions } from '../../browser/config/editorConfiguration.ts';
import { ILanguageFeaturesService } from '../../common/services/languageFeatures.ts';
import { DiffEditorWidget } from '../../browser/widget/diffEditor/diffEditorWidget.ts';
...
import { EditorMarkdownCodeBlockRenderer } from '../../browser/widget/markdownRenderer/browser/editorMarkdownCodeBlockRenderer.ts';
