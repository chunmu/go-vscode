...
import { FontMeasurements } from '../../browser/config/fontMeasurements.ts';
import { ICodeEditor } from '../../browser/editorBrowser.ts';
import { EditorCommand, ServicesAccessor } from '../../browser/editorExtensions.ts';
import { ICodeEditorService } from '../../browser/services/codeEditorService.ts';
import { IInternalWebWorkerOptions, MonacoWebWorker, createWebWorker as actualCreateWebWorker } from './standaloneWebWorker.ts';
import { ApplyUpdateResult, ConfigurationChangedEvent, EditorOptions } from '../../common/config/editorOptions.ts';
import { EditorZoom } from '../../common/config/editorZoom.ts';
...
import { EditorType, IDiffEditor } from '../../common/editorCommon.ts';
import * as languages from '../../common/languages.ts';
...
import { NullState, nullTokenize } from '../../common/languages/nullTokenize.ts';
import { FindMatch, ITextModel, TextModelResolvedOptions } from '../../common/model.ts';
import { IModelService } from '../../common/services/model.ts';
import * as standaloneEnums from '../../common/standalone/standaloneEnums.ts';
import { Colorizer, IColorizerElementOptions, IColorizerOptions } from './colorizer.ts';
import { IActionDescriptor, IStandaloneCodeEditor, IStandaloneDiffEditor, IStandaloneDiffEditorConstructionOptions, IStandaloneEditorConstructionOptions, StandaloneDiffEditor2, StandaloneEditor, createTextModel } from './standaloneCodeEditor.ts';
import { IEditorOverrideServices, StandaloneKeybindingService, StandaloneServices } from './standaloneServices.ts';
import { StandaloneThemeService } from './standaloneThemeService.ts';
import { IStandaloneThemeData, IStandaloneThemeService } from '../common/standaloneTheme.ts';
import { IMenuItem, MenuId, MenuRegistry } from '../../../platform/actions/common/actions.ts';
import { CommandsRegistry, ICommandHandler } from '../../../platform/commands/common/commands.ts';
...
import { IMarker, IMarkerData, IMarkerService } from '../../../platform/markers/common/markers.ts';
import { IOpenerService } from '../../../platform/opener/common/opener.ts';
import { MultiDiffEditorWidget } from '../../browser/widget/multiDiffEditor/multiDiffEditorWidget.ts';
