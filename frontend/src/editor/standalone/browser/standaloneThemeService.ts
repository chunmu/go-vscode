...
import { addMatchMediaChangeListener } from '../../../base/browser/browser.ts';
import { Color } from '../../../base/common/color.ts';
import { Emitter } from '../../../base/common/event.ts';
import { TokenizationRegistry } from '../../common/languages.ts';
import { FontStyle, TokenMetadata } from '../../common/encodedTokenAttributes.ts';
import { ITokenThemeRule, TokenTheme, generateTokensCSSForColorMap } from '../../common/languages/supports/tokenization.ts';
import { BuiltinTheme, IStandaloneTheme, IStandaloneThemeData, IStandaloneThemeService } from '../common/standaloneTheme.ts';
import { hc_black, hc_light, vs, vs_dark } from '../common/themes.ts';
import { IEnvironmentService } from '../../../platform/environment/common/environment.ts';
import { Registry } from '../../../platform/registry/common/platform.ts';
import { asCssVariableName, ColorIdentifier, Extensions, IColorRegistry } from '../../../platform/theme/common/colorRegistry.ts';
import { Extensions as ThemingExtensions, ICssStyleCollector, IFileIconTheme, IProductIconTheme, IThemingRegistry, ITokenStyle } from '../../../platform/theme/common/themeService.ts';
import { IDisposable, Disposable } from '../../../base/common/lifecycle.ts';
import { ColorScheme, isDark, isHighContrast } from '../../../platform/theme/common/theme.ts';
import { getIconsStyleSheet, UnthemedProductIconTheme } from '../../../platform/theme/browser/iconsStyleSheet.ts';
