...
import { ResourceTextEdit } from '../../../browser/services/bulkEditService.ts';
import { DocumentDropEdit, DocumentPasteEdit, DropYieldTo, WorkspaceEdit } from '../../../common/languages.ts';
