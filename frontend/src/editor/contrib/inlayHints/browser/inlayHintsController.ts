...
import { isHTMLElement, ModifierKeyEmitter } from '../../../../base/browser/dom.ts';
import { isNonEmptyArray } from '../../../../base/common/arrays.ts';
import { disposableTimeout, RunOnceScheduler } from '../../../../base/common/async.ts';
...
import { DisposableStore, IDisposable, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { LRUCache } from '../../../../base/common/map.ts';
import { IRange } from '../../../../base/common/range.ts';
import { assertType } from '../../../../base/common/types.ts';
import { URI } from '../../../../base/common/uri.ts';
import { IActiveCodeEditor, ICodeEditor, IEditorMouseEvent, MouseTargetType } from '../../../browser/editorBrowser.ts';
import { ClassNameReference, CssProperties, DynamicCssRules } from '../../../browser/editorDom.ts';
import { StableEditorScrollState } from '../../../browser/stableEditorScroll.ts';
import { EditorOption } from '../../../common/config/editorOptions.ts';
import { EDITOR_FONT_DEFAULTS } from '../../../common/config/fontInfo.ts';
...
import { IModelDeltaDecoration, InjectedTextCursorStops, InjectedTextOptions, ITextModel, TrackedRangeStickiness } from '../../../common/model.ts';
import { ModelDecorationInjectedTextOptions } from '../../../common/model/textModel.ts';
...
import { ClickLinkGesture, ClickLinkMouseEvent } from '../../gotoSymbol/browser/link/clickLinkGesture.ts';
import { InlayHintAnchor, InlayHintItem, InlayHintsFragments } from './inlayHints.ts';
import { goToDefinitionWithLocation, showGoToContextMenu } from './inlayHintsLocations.ts';
...
import * as colors from '../../../../platform/theme/common/colorRegistry.ts';
