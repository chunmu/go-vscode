...
import { DefinitionAction, SymbolNavigationAction, SymbolNavigationAnchor } from '../../gotoSymbol/browser/goToCommands.ts';
import { ClickLinkMouseEvent } from '../../gotoSymbol/browser/link/clickLinkGesture.ts';
import { RenderedInlayHintLabelPart } from './inlayHintsController.ts';
import { PeekContext } from '../../peekView/browser/peekView.ts';
import { isIMenuItem, MenuId, MenuItemAction, MenuRegistry } from '../../../../platform/actions/common/actions.ts';
