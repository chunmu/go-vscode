...
import { SelectionRangeProvider } from '../../../../common/languages.ts';
...
import { BracketSelectionRangeProvider } from '../../browser/bracketSelections.ts';
import { provideSelectionRanges } from '../../browser/smartSelect.ts';
import { WordSelectionRangeProvider } from '../../browser/wordSelections.ts';
import { createModelServices } from '../../../../test/common/testTextModel.ts';
import { javascriptOnEnterRules } from '../../../../test/common/modes/supports/onEnterRules.ts';
