...
import { EditorOption, ShowLightbulbIconMode } from '../../../common/config/editorOptions.ts';
...
import { CodeActionProvider, CodeActionTriggerType } from '../../../common/languages.ts';
import { CodeActionKind, CodeActionSet, CodeActionTrigger, CodeActionTriggerSource } from '../common/types.ts';
import { getCodeActions } from './codeAction.ts';
