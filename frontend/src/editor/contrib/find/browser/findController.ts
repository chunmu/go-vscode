...
import { EditorAction, EditorCommand, EditorContributionInstantiation, MultiEditorAction, registerEditorAction, registerEditorCommand, registerEditorContribution, registerMultiEditorAction, ServicesAccessor } from '../../../browser/editorExtensions.ts';
import { EditorOption } from '../../../common/config/editorOptions.ts';
import { overviewRulerRangeHighlight } from '../../../common/core/editorColorRegistry.ts';
...
import { OverviewRulerLane } from '../../../common/model.ts';
import { CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_FIND_WIDGET_VISIBLE, CONTEXT_REPLACE_INPUT_FOCUSED, FindModelBoundToEditorModel, FIND_IDS, ToggleCaseSensitiveKeybinding, TogglePreserveCaseKeybinding, ToggleRegexKeybinding, ToggleSearchScopeKeybinding, ToggleWholeWordKeybinding } from './findModel.ts';
import { FindOptionsWidget } from './findOptionsWidget.ts';
import { FindReplaceState, FindReplaceStateChangedEvent, INewFindReplaceState } from './findState.ts';
import { FindWidget, IFindController } from './findWidget.ts';
...
import { FindWidgetSearchHistory } from './findWidgetSearchHistory.ts';
import { ReplaceWidgetHistory } from './replaceWidgetHistory.ts';
