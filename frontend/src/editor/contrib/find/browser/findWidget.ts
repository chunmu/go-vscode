...
import { alert as alertFn } from '../../../../base/browser/ui/aria/aria.ts';
...
import { FindInput } from '../../../../base/browser/ui/findinput/findInput.ts';
...
import { ISashEvent, IVerticalSashLayoutProvider, Orientation, Sash } from '../../../../base/browser/ui/sash/sash.ts';
...
import { ICodeEditor, IOverlayWidget, IOverlayWidgetPosition, IViewZone, OverlayWidgetPositionPreference } from '../../../browser/editorBrowser.ts';
import { ConfigurationChangedEvent, EditorOption } from '../../../common/config/editorOptions.ts';
import { Range } from '../../../common/core/range.ts';
import { CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_REPLACE_INPUT_FOCUSED, FIND_IDS, MATCHES_LIMIT } from './findModel.ts';
import { FindReplaceState, FindReplaceStateChangedEvent } from './findState.ts';
import * as nls from '../../../../nls.ts';
import { AccessibilitySupport } from '../../../../platform/accessibility/common/accessibility.ts';
import { ContextScopedFindInput, ContextScopedReplaceInput } from '../../../../platform/history/browser/contextScopedHistoryWidget.ts';
...
import { asCssVariable, contrastBorder, editorFindMatchForeground, editorFindMatchHighlightBorder, editorFindMatchHighlightForeground, editorFindRangeHighlightBorder, inputActiveOptionBackground, inputActiveOptionBorder, inputActiveOptionForeground } from '../../../../platform/theme/common/colorRegistry.ts';
...
import { defaultInputBoxStyles, defaultToggleStyles } from '../../../../platform/theme/browser/defaultStyles.ts';
...
import { HoverStyle, type IHoverLifecycleOptions } from '../../../../base/browser/ui/hover/hover.ts';
