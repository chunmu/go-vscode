...
import { CancellationError, onUnexpectedError } from '../../../../base/common/errors.ts';
...
import { ConfigurationScope, Extensions, IConfigurationRegistry } from '../../../../platform/configuration/common/configurationRegistry.ts';
...
import { EditorAction, EditorCommand, EditorContributionInstantiation, ServicesAccessor, registerEditorAction, registerEditorCommand, registerEditorContribution, registerModelAndPositionCommand } from '../../../browser/editorExtensions.ts';
...
import { NewSymbolNameTriggerKind, Rejection, RenameLocation, RenameProvider, WorkspaceEdit } from '../../../common/languages.ts';
...
import { CONTEXT_RENAME_INPUT_VISIBLE, RenameWidget } from './renameWidget.ts';
