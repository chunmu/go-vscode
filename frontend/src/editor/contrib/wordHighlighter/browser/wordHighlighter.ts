...
import { CancelablePromise, createCancelablePromise, Delayer, first } from '../../../../base/common/async.ts';
...
import { IActiveCodeEditor, ICodeEditor, isDiffEditor } from '../../../browser/editorBrowser.ts';
import { EditorAction, EditorContributionInstantiation, IActionOptions, registerEditorAction, registerEditorContribution, registerModelAndPositionCommand } from '../../../browser/editorExtensions.ts';
...
import { IDiffEditor, IEditorContribution, IEditorDecorationsCollection } from '../../../common/editorCommon.ts';
...
import { DocumentHighlight, DocumentHighlightProvider, MultiDocumentHighlightProvider } from '../../../common/languages.ts';
import { score } from '../../../common/languageSelector.ts';
import { IModelDeltaDecoration, ITextModel, shouldSynchronizeModel } from '../../../common/model.ts';
...
import { getHighlightDecorationOptions } from './highlightDecorations.ts';
import { TextualMultiDocumentHighlightFeature } from './textualHighlightProvider.ts';
