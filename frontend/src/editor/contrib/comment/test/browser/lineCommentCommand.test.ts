...
import { ColorId, MetadataConsts } from '../../../../common/encodedTokenAttributes.ts';
import { EncodedTokenizationResult, IState, TokenizationRegistry } from '../../../../common/languages.ts';
import { ILanguageService } from '../../../../common/languages/language.ts';
import { CommentRule } from '../../../../common/languages/languageConfiguration.ts';
...
import { ILinePreflightData, IPreflightData, ISimpleModel, LineCommentCommand, Type } from '../../browser/lineCommentCommand.ts';
