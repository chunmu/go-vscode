...
import { IObservable, autorun, autorunWithStore, constObservable, derived, observableSignalFromEvent, observableValue } from '../../../../../../base/common/observable.ts';
import * as strings from '../../../../../../base/common/strings.ts';
import { applyFontInfo } from '../../../../../browser/config/domFontInfo.ts';
import { ContentWidgetPositionPreference, ICodeEditor, IContentWidgetPosition, IViewZoneChangeAccessor, MouseTargetType } from '../../../../../browser/editorBrowser.ts';
import { observableCodeEditor } from '../../../../../browser/observableCodeEditor.ts';
import { EditorFontLigatures, EditorOption, IComputedEditorOptions } from '../../../../../common/config/editorOptions.ts';
import { StringEdit, StringReplacement } from '../../../../../common/core/edits/stringEdit.ts';
import { Position } from '../../../../../common/core/position.ts';
import { Range } from '../../../../../common/core/range.ts';
import { StringBuilder } from '../../../../../common/core/stringBuilder.ts';
import { IconPath, InlineCompletionWarning } from '../../../../../common/languages.ts';
import { ILanguageService } from '../../../../../common/languages/language.ts';
import { IModelDeltaDecoration, ITextModel, InjectedTextCursorStops, PositionAffinity } from '../../../../../common/model.ts';
import { LineTokens } from '../../../../../common/tokens/lineTokens.ts';
import { LineDecoration } from '../../../../../common/viewLayout/lineDecorations.ts';
import { RenderLineInput, renderViewLine } from '../../../../../common/viewLayout/viewLineRenderer.ts';
import { GhostText, GhostTextReplacement, IGhostTextLine } from '../../model/ghostText.ts';
import { RangeSingleLine } from '../../../../../common/core/ranges/rangeSingleLine.ts';
import { ColumnRange } from '../../../../../common/core/ranges/columnRange.ts';
import { addDisposableListener, getWindow, isHTMLElement, n } from '../../../../../../base/browser/dom.ts';
import './ghostTextView.css';
import { IMouseEvent, StandardMouseEvent } from '../../../../../../base/browser/mouseEvent.ts';
import { CodeEditorWidget } from '../../../../../browser/widget/codeEditor/codeEditorWidget.ts';
import { TokenWithTextArray } from '../../../../../common/tokens/tokenWithTextArray.ts';
import { InlineCompletionViewData } from '../inlineEdits/inlineEditsViewInterface.ts';
import { InlineDecorationType } from '../../../../../common/viewModel/inlineDecorations.ts';
import { sum } from '../../../../../../base/common/arrays.ts';
