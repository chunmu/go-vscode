...
import { singleTextRemoveCommonPrefix } from '../../../model/singleTextEditHelpers.ts';
import { IInlineEditsView } from '../inlineEditsViewInterface.ts';
import { InlineEditWithChanges } from '../inlineEditWithChanges.ts';
import { inlineEditIndicatorPrimaryBorder } from '../theme.ts';
import { getEditorValidOverlayRect, PathBuilder, rectToProps } from '../utils/utils.ts';
