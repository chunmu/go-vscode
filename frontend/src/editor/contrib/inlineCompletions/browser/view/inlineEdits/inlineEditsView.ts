...
import { itemEquals, itemsEquals } from '../../../../../../base/common/equals.ts';
import { BugIndicatingError, onUnexpectedError } from '../../../../../../base/common/errors.ts';
import { Event } from '../../../../../../base/common/event.ts';
import { Disposable } from '../../../../../../base/common/lifecycle.ts';
import { autorun, derived, derivedOpts, IObservable, IReader, mapObservableArrayCached, observableValue } from '../../../../../../base/common/observable.ts';
...
import { TextReplacement } from '../../../../../common/core/edits/textEdit.ts';
...
import { AbstractText, StringText } from '../../../../../common/core/text/abstractText.ts';
import { TextLength } from '../../../../../common/core/text/textLength.ts';
import { DetailedLineRangeMapping, lineRangeMappingFromRangeMappings, RangeMapping } from '../../../../../common/diff/rangeMapping.ts';
import { ITextModel } from '../../../../../common/model.ts';
import { TextModel } from '../../../../../common/model/textModel.ts';
import { InlineEditItem, InlineSuggestionIdentity } from '../../model/inlineSuggestionItem.ts';
...
import { InlineEditsCollapsedView } from './inlineEditsViews/inlineEditsCollapsedView.ts';
import { InlineEditsCustomView } from './inlineEditsViews/inlineEditsCustomView.ts';
import { InlineEditsDeletionView } from './inlineEditsViews/inlineEditsDeletionView.ts';
import { InlineEditsInsertionView } from './inlineEditsViews/inlineEditsInsertionView.ts';
import { InlineEditsLineReplacementView } from './inlineEditsViews/inlineEditsLineReplacementView.ts';
import { ILongDistanceHint, ILongDistanceViewState, InlineEditsLongDistanceHint } from './inlineEditsViews/longDistanceHint/inlineEditsLongDistanceHint.ts';
import { InlineEditsSideBySideView } from './inlineEditsViews/inlineEditsSideBySideView.ts';
import { InlineEditsWordReplacementView } from './inlineEditsViews/inlineEditsWordReplacementView.ts';
import { IOriginalEditorInlineDiffViewState, OriginalEditorInlineDiffView } from './inlineEditsViews/originalEditorInlineDiffView.ts';
import { applyEditToModifiedRangeMappings, createReindentEdit } from './utils/utils.ts';
import './view.css';
