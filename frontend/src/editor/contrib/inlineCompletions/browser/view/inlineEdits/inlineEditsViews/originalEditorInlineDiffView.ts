...
import { autorunWithStore, derived, IObservable, observableFromEvent } from '../../../../../../../base/common/observable.ts';
...
import { rangeIsSingleLine } from '../../../../../../browser/widget/diffEditor/components/diffEditorViewZones/diffEditorViewZones.ts';
...
import { EndOfLinePreference, IModelDeltaDecoration, InjectedTextCursorStops, ITextModel } from '../../../../../../common/model.ts';
import { ModelDecorationOptions } from '../../../../../../common/model/textModel.ts';
import { IInlineEditsView } from '../inlineEditsViewInterface.ts';
