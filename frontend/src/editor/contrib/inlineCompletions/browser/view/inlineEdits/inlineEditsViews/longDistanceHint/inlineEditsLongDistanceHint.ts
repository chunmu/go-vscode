 ...
 *--------------------------------------------------------------------------------------------*/
import { ChildNode, n, ObserverNode, ObserverNodeWithElement } from '../../../../../../../../base/browser/dom.ts';
import { Event } from '../../../../../../../../base/common/event.ts';
import { Disposable } from '../../../../../../../../base/common/lifecycle.ts';
import { IObservable, IReader, autorun, constObservable, debouncedObservable2, derived, derivedDisposable } from '../../../../../../../../base/common/observable.ts';
...
import { Rect } from '../../../../../../../common/core/2d/rect.ts';
import { Position } from '../../../../../../../common/core/position.ts';
import { ITextModel } from '../../../../../../../common/model.ts';
import { IInlineEditsView, InlineEditTabAction } from '../../inlineEditsViewInterface.ts';
import { InlineEditWithChanges } from '../../inlineEditWithChanges.ts';
import { getContentSizeOfLines, rectToProps } from '../../utils/utils.ts';
import { DetailedLineRangeMapping } from '../../../../../../../common/diff/rangeMapping.ts';
import { OffsetRange } from '../../../../../../../common/core/ranges/offsetRange.ts';
import { LineRange } from '../../../../../../../common/core/ranges/lineRange.ts';
import { HideUnchangedRegionsFeature } from '../../../../../../../browser/widget/diffEditor/features/hideUnchangedRegionsFeature.ts';
import { Codicon } from '../../../../../../../../base/common/codicons.ts';
import { renderIcon } from '../../../../../../../../base/browser/ui/iconLabel/iconLabels.ts';
import { SymbolKinds } from '../../../../../../../common/languages.ts';
import { debugLogHorizontalOffsetRanges, debugLogRects, debugView } from '../debugVisualization.ts';
import { distributeFlexBoxLayout } from '../../utils/flexBoxLayout.ts';
import { Point } from '../../../../../../../common/core/2d/point.ts';
import { Size2D } from '../../../../../../../common/core/2d/size.ts';
import { getMaxTowerHeightInAvailableArea } from '../../utils/towersLayout.ts';
...
import { getEditorBlendedColor, inlineEditIndicatorPrimaryBackground, inlineEditIndicatorSecondaryBackground, inlineEditIndicatorsuccessfulBackground } from '../../theme.ts';
import { asCssVariable, descriptionForeground, editorBackground, editorWidgetBackground } from '../../../../../../../../platform/theme/common/colorRegistry.ts';
import { ILongDistancePreviewProps, LongDistancePreviewEditor } from './longDistancePreviewEditor.ts';
import { InlineSuggestionGutterMenuData, SimpleInlineSuggestModel } from '../../components/gutterIndicatorView.ts';
import { jumpToNextInlineEditId } from '../../../../controller/commandIds.ts';
