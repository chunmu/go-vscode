...
import { GhostText, GhostTextPart } from '../../../model/ghostText.ts';
import { GhostTextView, IGhostTextWidgetData } from '../../ghostText/ghostTextView.ts';
import { IInlineEditsView, InlineEditTabAction } from '../inlineEditsViewInterface.ts';
import { getModifiedBorderColor, modifiedBackgroundColor } from '../theme.ts';
import { getPrefixTrim, mapOutFalsy } from '../utils/utils.ts';
