...
import { $, getWindow, n } from '../../../../../../../base/browser/dom.ts';
...
import { autorunDelta, constObservable, derived, IObservable } from '../../../../../../../base/common/observable.ts';
import { editorBackground, scrollbarShadow } from '../../../../../../../platform/theme/common/colorRegistry.ts';
...
import { IEditorMouseEvent, IViewZoneChangeAccessor } from '../../../../../../browser/editorBrowser.ts';
import { EditorMouseEvent } from '../../../../../../browser/editorDom.ts';
import { ObservableCodeEditor } from '../../../../../../browser/observableCodeEditor.ts';
import { LineSource, renderLines, RenderOptions } from '../../../../../../browser/widget/diffEditor/components/diffEditorViewZones/renderLines.ts';
...
import { LineTokens, TokenArray } from '../../../../../../common/tokens/lineTokens.ts';
import { InlineDecoration, InlineDecorationType } from '../../../../../../common/viewModel/inlineDecorations.ts';
import { IInlineEditsView, InlineEditTabAction } from '../inlineEditsViewInterface.ts';
import { getEditorBlendedColor, getModifiedBorderColor, getOriginalBorderColor, modifiedChangedLineBackgroundColor, originalBackgroundColor } from '../theme.ts';
import { getEditorValidOverlayRect, getPrefixTrim, mapOutFalsy, rectToProps } from '../utils/utils.ts';
