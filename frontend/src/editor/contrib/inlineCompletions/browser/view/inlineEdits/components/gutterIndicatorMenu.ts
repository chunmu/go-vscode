...
import { ChildNode, LiveElement, n } from '../../../../../../../base/browser/dom.ts';
import { ActionBar, IActionBarOptions } from '../../../../../../../base/browser/ui/actionbar/actionbar.ts';
import { renderIcon } from '../../../../../../../base/browser/ui/iconLabel/iconLabels.ts';
import { KeybindingLabel } from '../../../../../../../base/browser/ui/keybindingLabel/keybindingLabel.ts';
import { IAction } from '../../../../../../../base/common/actions.ts';
import { Codicon } from '../../../../../../../base/common/codicons.ts';
import { ResolvedKeybinding } from '../../../../../../../base/common/keybindings.ts';
import { IObservable, autorun, constObservable, derived, observableFromEvent, observableValue } from '../../../../../../../base/common/observable.ts';
...
import { defaultKeybindingLabelStyles } from '../../../../../../../platform/theme/browser/defaultStyles.ts';
import { asCssVariable, descriptionForeground, editorActionListForeground, editorHoverBorder } from '../../../../../../../platform/theme/common/colorRegistry.ts';
import { ObservableCodeEditor } from '../../../../../../browser/observableCodeEditor.ts';
import { EditorOption } from '../../../../../../common/config/editorOptions.ts';
import { hideInlineCompletionId, inlineSuggestCommitId, toggleShowCollapsedId } from '../../../controller/commandIds.ts';
import { FirstFnArg, } from '../utils/utils.ts';
import { InlineSuggestionGutterMenuData } from './gutterIndicatorView.ts';
