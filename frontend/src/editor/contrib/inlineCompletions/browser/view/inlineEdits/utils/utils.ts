...
import { getDomNodePagePosition, h } from '../../../../../../../base/browser/dom.ts';
import { KeybindingLabel, unthemedKeybindingLabelOptions } from '../../../../../../../base/browser/ui/keybindingLabel/keybindingLabel.ts';
import { numberComparator } from '../../../../../../../base/common/arrays.ts';
import { findFirstMin } from '../../../../../../../base/common/arraysFind.ts';
import { DisposableStore, toDisposable } from '../../../../../../../base/common/lifecycle.ts';
import { DebugLocation, derived, derivedObservableWithCache, derivedOpts, IObservable, IReader, observableSignalFromEvent, observableValue, transaction } from '../../../../../../../base/common/observable.ts';
...
import { RangeMapping } from '../../../../../../common/diff/rangeMapping.ts';
import { ITextModel } from '../../../../../../common/model.ts';
import { indentOfLine } from '../../../../../../common/model/textModel.ts';
