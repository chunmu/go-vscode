...
import { itemsEquals } from '../../../../../base/common/equals.ts';
import { BugIndicatingError, onUnexpectedExternalError } from '../../../../../base/common/errors.ts';
import { Emitter } from '../../../../../base/common/event.ts';
import { Disposable } from '../../../../../base/common/lifecycle.ts';
import { IObservable, IObservableWithChange, IReader, ITransaction, autorun, constObservable, derived, derivedHandleChanges, derivedOpts, mapObservableArrayCached, observableFromEvent, observableSignal, observableValue, recomputeInitiallyAndOnChange, subtransaction, transaction } from '../../../../../base/common/observable.ts';
import { firstNonWhitespaceIndex } from '../../../../../base/common/strings.ts';
...
import { observableCodeEditor } from '../../../../browser/observableCodeEditor.ts';
...
import { TextLength } from '../../../../common/core/text/textLength.ts';
import { ScrollType } from '../../../../common/editorCommon.ts';
import { InlineCompletionEndOfLifeReasonKind, InlineCompletion, InlineCompletionTriggerKind, PartialAcceptTriggerKind, InlineCompletionsProvider, InlineCompletionCommand } from '../../../../common/languages.ts';
import { ILanguageConfigurationService } from '../../../../common/languages/languageConfigurationRegistry.ts';
import { EndOfLinePreference, IModelDeltaDecoration, ITextModel } from '../../../../common/model.ts';
import { TextModelText } from '../../../../common/model/textModelText.ts';
import { IFeatureDebounceInformation } from '../../../../common/services/languageFeatureDebounce.ts';
import { ILanguageFeaturesService } from '../../../../common/services/languageFeatures.ts';
import { IModelContentChangedEvent } from '../../../../common/textModelEvents.ts';
import { SnippetController2 } from '../../../snippet/browser/snippetController2.ts';
import { getEndPositionsAfterApplying, removeTextReplacementCommonSuffixPrefix } from '../utils.ts';
import { AnimatedValue, easeOutCubic, ObservableAnimatedValue } from './animation.ts';
import { computeGhostText } from './computeGhostText.ts';
import { GhostText, GhostTextOrReplacement, ghostTextOrReplacementEquals, ghostTextsOrReplacementsEqual } from './ghostText.ts';
import { InlineCompletionsSource } from './inlineCompletionsSource.ts';
import { InlineEdit } from './inlineEdit.ts';
import { InlineCompletionItem, InlineEditItem, InlineSuggestionItem } from './inlineSuggestionItem.ts';
import { InlineCompletionContextWithoutUuid, InlineCompletionEditorType, InlineSuggestRequestInfo } from './provideInlineCompletions.ts';
import { singleTextEditAugments, singleTextRemoveCommonPrefix } from './singleTextEditHelpers.ts';
import { SuggestItemInfo } from './suggestWidgetAdapter.ts';
...
import { InlineCompletionViewData, InlineCompletionViewKind } from '../view/inlineEdits/inlineEditsViewInterface.ts';
import { IInlineCompletionsService } from '../../../../browser/services/inlineCompletionsService.ts';
import { TypingInterval } from './typingSpeed.ts';
import { StringReplacement } from '../../../../common/core/edits/stringEdit.ts';
import { OffsetRange } from '../../../../common/core/ranges/offsetRange.ts';
