...
import { matchesSubString } from '../../../../../base/common/filters.ts';
import { IObservable, ITransaction, observableSignal, observableValue } from '../../../../../base/common/observable.ts';
import { commonPrefixLength, commonSuffixLength, splitLines } from '../../../../../base/common/strings.ts';
import { URI } from '../../../../../base/common/uri.ts';
import { ICommandService } from '../../../../../platform/commands/common/commands.ts';
import { ISingleEditOperation } from '../../../../common/core/editOperation.ts';
import { applyEditsToRanges, StringEdit, StringReplacement } from '../../../../common/core/edits/stringEdit.ts';
...
import { StringText } from '../../../../common/core/text/abstractText.ts';
import { getPositionOffsetTransformerFromTextModel } from '../../../../common/core/text/getPositionOffsetTransformerFromTextModel.ts';
import { PositionOffsetTransformerBase } from '../../../../common/core/text/positionToOffset.ts';
import { TextLength } from '../../../../common/core/text/textLength.ts';
import { linesDiffComputers } from '../../../../common/diff/linesDiffComputers.ts';
import { Command, InlineCompletion, InlineCompletionHintStyle, InlineCompletionEndOfLifeReason, InlineCompletionTriggerKind, InlineCompletionWarning, PartialAcceptInfo, InlineCompletionHint } from '../../../../common/languages.ts';
import { EndOfLinePreference, ITextModel } from '../../../../common/model.ts';
...
import { InlineSuggestData, InlineSuggestionList, PartialAcceptance, SnippetInfo } from './provideInlineCompletions.ts';
import { singleTextRemoveCommonPrefix } from './singleTextEditHelpers.ts';
