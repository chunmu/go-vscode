...
import { booleanComparator, compareBy, compareUndefinedSmallest, numberComparator } from '../../../../../base/common/arrays.ts';
import { findLastMax } from '../../../../../base/common/arraysFind.ts';
import { RunOnceScheduler } from '../../../../../base/common/async.ts';
import { CancellationTokenSource } from '../../../../../base/common/cancellation.ts';
import { equalsIfDefined, itemEquals } from '../../../../../base/common/equals.ts';
import { Disposable, DisposableStore, IDisposable, MutableDisposable, toDisposable } from '../../../../../base/common/lifecycle.ts';
import { derived, IObservable, IObservableWithChange, ITransaction, observableValue, recordChangesLazy, transaction } from '../../../../../base/common/observable.ts';
// eslint-disable-next-line local/code-no-deep-import-of-internal
import { observableReducerSettable } from '../../../../../base/common/observableInternal/experimental/reducer.ts';
import { isDefined, isObject } from '../../../../../base/common/types.ts';
...
import { InlineCompletionEndOfLifeReasonKind, InlineCompletionTriggerKind, InlineCompletionsProvider } from '../../../../common/languages.ts';
...
import { offsetEditFromContentChanges } from '../../../../common/model/textModelStringEdit.ts';
...
import { formatRecordableLogEntry, IRecordableEditorLogEntry, IRecordableLogEntry, StructuredLogger } from '../structuredLogger.ts';
import { InlineCompletionEndOfLifeEvent, sendInlineCompletionsEndOfLifeTelemetry } from '../telemetry.ts';
import { wait } from '../utils.ts';
import { InlineSuggestionIdentity, InlineSuggestionItem } from './inlineSuggestionItem.ts';
import { InlineCompletionContextWithoutUuid, InlineSuggestRequestInfo, provideInlineCompletions, runWhenCancelled } from './provideInlineCompletions.ts';
