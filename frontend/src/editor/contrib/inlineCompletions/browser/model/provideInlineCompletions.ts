...
import { prefixedUuid } from '../../../../../base/common/uuid.ts';
...
import { InlineCompletionEndOfLifeReason, InlineCompletionEndOfLifeReasonKind, InlineCompletion, InlineCompletionContext, InlineCompletions, InlineCompletionsProvider, PartialAcceptInfo, InlineCompletionsDisposeReason, LifetimeSummary, ProviderId, InlineCompletionHint } from '../../../../common/languages.ts';
...
import { fixBracketsInLine } from '../../../../common/model/bracketPairsTextModelPart/fixBrackets.ts';
import { SnippetParser, Text } from '../../../snippet/browser/snippetParser.ts';
import { getReadonlyEmptyArray } from '../utils.ts';
import { groupByMap } from '../../../../../base/common/collections.ts';
...
import { inlineCompletionIsVisible } from './inlineSuggestionItem.ts';
import { EditDeltaInfo } from '../../../../common/textModelEditSource.ts';
