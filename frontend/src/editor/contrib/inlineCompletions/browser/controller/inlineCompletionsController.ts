...
import { cancelOnDispose } from '../../../../../base/common/cancellation.ts';
import { createHotClass } from '../../../../../base/common/hotReloadHelpers.ts';
import { Disposable, toDisposable } from '../../../../../base/common/lifecycle.ts';
import { ITransaction, autorun, derived, derivedDisposable, derivedObservableWithCache, observableFromEvent, observableSignal, observableValue, runOnChange, runOnChangeWithStore, transaction, waitForState } from '../../../../../base/common/observable.ts';
...
import { hotClassGetOriginalInstance } from '../../../../../platform/observable/common/wrapInHotClass.ts';
import { CoreEditingCommands } from '../../../../browser/coreCommands.ts';
import { ICodeEditor } from '../../../../browser/editorBrowser.ts';
import { observableCodeEditor } from '../../../../browser/observableCodeEditor.ts';
import { TriggerInlineEditCommandsRegistry } from '../../../../browser/triggerInlineEditCommandsRegistry.ts';
import { getOuterEditor } from '../../../../browser/widget/codeEditor/embeddedCodeEditorWidget.ts';
...
import { ILanguageFeatureDebounceService } from '../../../../common/services/languageFeatureDebounce.ts';
import { ILanguageFeaturesService } from '../../../../common/services/languageFeatures.ts';
import { FIND_IDS } from '../../../find/browser/findModel.ts';
import { InsertLineAfterAction, InsertLineBeforeAction } from '../../../linesOperations/browser/linesOperations.ts';
import { InlineSuggestionHintsContentWidget } from '../hintsWidget/inlineCompletionsHintsWidget.ts';
import { TextModelChangeRecorder } from '../model/changeRecorder.ts';
import { InlineCompletionsModel } from '../model/inlineCompletionsModel.ts';
import { ObservableSuggestWidgetAdapter } from '../model/suggestWidgetAdapter.ts';
import { ObservableContextKeyService } from '../utils.ts';
import { InlineSuggestionsView } from '../view/inlineSuggestionsView.ts';
import { inlineSuggestCommitId } from './commandIds.ts';
import { InlineCompletionContextKeys } from './inlineCompletionContextKeys.ts';
