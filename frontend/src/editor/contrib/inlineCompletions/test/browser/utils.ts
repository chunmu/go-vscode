...
import { InlineCompletion, InlineCompletionContext, InlineCompletions, InlineCompletionsProvider } from '../../../../common/languages.ts';
...
import { InlineSuggestionsView } from '../../browser/view/inlineSuggestionsView.ts';
