...
import { DocumentSemanticTokensProvider, SemanticTokens, SemanticTokensEdits, SemanticTokensLegend } from '../../../../common/languages.ts';
...
import { LanguageFeatureDebounceService } from '../../../../common/services/languageFeatureDebounce.ts';
...
import { DocumentSemanticTokensFeature } from '../../browser/documentSemanticTokens.ts';
import { getDocumentSemanticTokens, isSemanticTokens } from '../../common/getSemanticTokens.ts';
import { TestLanguageConfigurationService } from '../../../../test/common/modes/testLanguageConfigurationService.ts';
import { TestTextResourcePropertiesService } from '../../../../test/common/services/testTextResourcePropertiesService.ts';
...
import { TestTreeSitterLibraryService } from '../../../../test/common/services/testTreeSitterLibraryService.ts';
