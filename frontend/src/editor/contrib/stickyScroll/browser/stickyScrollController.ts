...
import { ICodeEditor, MouseTargetType } from '../../../browser/editorBrowser.ts';
...
import { EditorOption, RenderLineNumbersType, ConfigurationChangedEvent } from '../../../common/config/editorOptions.ts';
import { StickyScrollWidget, StickyScrollWidgetState } from './stickyScrollWidget.ts';
import { IStickyLineCandidateProvider, StickyLineCandidateProvider } from './stickyScrollProvider.ts';
import { IModelTokensChangedEvent } from '../../../common/textModelEvents.ts';
...
import { getDefinitionsAtPosition } from '../../gotoSymbol/browser/goToSymbol.ts';
import { goToDefinitionWithLocation } from '../../inlayHints/browser/inlayHintsLocations.ts';
...
import { StickyRange } from './stickyScrollElement.ts';
import { IMouseEvent, StandardMouseEvent } from '../../../../base/browser/mouseEvent.ts';
import { FoldingController } from '../../folding/browser/folding.ts';
import { FoldingModel, toggleCollapseState } from '../../folding/browser/foldingModel.ts';
