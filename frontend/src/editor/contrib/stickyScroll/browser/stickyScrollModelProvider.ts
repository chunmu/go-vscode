...
import { OutlineElement, OutlineGroup, OutlineModel } from '../../documentSymbols/browser/outlineModel.ts';
import { CancellationToken } from '../../../../base/common/cancellation.ts';
import { CancelablePromise, createCancelablePromise, Delayer } from '../../../../base/common/async.ts';
import { FoldingController, RangesLimitReporter } from '../../folding/browser/folding.ts';
import { SyntaxRangeProvider } from '../../folding/browser/syntaxRangeProvider.ts';
import { IndentRangeProvider } from '../../folding/browser/indentRangeProvider.ts';
import { ILanguageConfigurationService } from '../../../common/languages/languageConfigurationRegistry.ts';
import { FoldingRegions } from '../../folding/browser/foldingRanges.ts';
import { onUnexpectedError } from '../../../../base/common/errors.ts';
import { StickyElement, StickyModel, StickyRange } from './stickyScrollElement.ts';
