...
import { StickyScrollController } from '../../browser/stickyScrollController.ts';
...
import { StickyLineCandidate, StickyLineCandidateProvider } from '../../browser/stickyScrollProvider.ts';
