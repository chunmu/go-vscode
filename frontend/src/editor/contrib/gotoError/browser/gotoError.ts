...
import { EditorAction, EditorCommand, EditorContributionInstantiation, IActionOptions, registerEditorAction, registerEditorCommand, registerEditorContribution, ServicesAccessor } from '../../../browser/editorExtensions.ts';
...
import { IMarkerNavigationService, MarkerList } from './markerNavigationService.ts';
...
import { MarkerNavigationWidget } from './gotoErrorWidget.ts';
