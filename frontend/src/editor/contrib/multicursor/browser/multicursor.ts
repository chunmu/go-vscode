...
import { CursorState } from '../../../common/cursorCommon.ts';
...
import { IEditorContribution, IEditorDecorationsCollection, ScrollType } from '../../../common/editorCommon.ts';
import { EditorContextKeys } from '../../../common/editorContextKeys.ts';
import { FindMatch, ITextModel } from '../../../common/model.ts';
import { CommonFindController } from '../../find/browser/findController.ts';
import { FindOptionOverride, INewFindReplaceState } from '../../find/browser/findState.ts';
...
import { getSelectionHighlightDecorationOptions } from '../../wordHighlighter/browser/highlightDecorations.ts';
