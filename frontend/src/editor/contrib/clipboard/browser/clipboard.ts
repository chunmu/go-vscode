...
import { getActiveDocument, getActiveWindow } from '../../../../base/browser/dom.ts';
...
import { CopyOptions, InMemoryClipboardMetadataManager } from '../../../browser/controller/editContext/clipboardUtils.ts';
import { NativeEditContextRegistry } from '../../../browser/controller/editContext/native/nativeEditContextRegistry.ts';
import { ICodeEditor } from '../../../browser/editorBrowser.ts';
import { Command, EditorAction, MultiCommand, registerEditorAction } from '../../../browser/editorExtensions.ts';
...
import { CopyPasteController } from '../../dropOrPasteInto/browser/copyPasteController.ts';
