...
import { FoldingMarkers } from '../../../common/languages/languageConfiguration.ts';
import { ILanguageConfigurationService } from '../../../common/languages/languageConfigurationRegistry.ts';
import { FoldingRegions, MAX_LINE_NUMBER } from './foldingRanges.ts';
import { FoldingLimitReporter, RangeProvider } from './folding.ts';
