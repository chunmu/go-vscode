...
import { IModelDecorationOptions, IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel } from '../../../common/model.ts';
import { FoldingRegion, FoldingRegions, ILineRange, FoldRange, FoldSource } from './foldingRanges.ts';
import { hash } from '../../../../base/common/hash.ts';
import { SelectedLines } from './folding.ts';
