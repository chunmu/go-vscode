...
import { IModelDecorationOptions, IModelDecorationsChangeAccessor, MinimapPosition, TrackedRangeStickiness } from '../../../common/model.ts';
import { ModelDecorationOptions } from '../../../common/model/textModel.ts';
import { IDecorationProvider } from './foldingModel.ts';
import { localize } from '../../../../nls.ts';
import { editorSelectionBackground, iconForeground, registerColor, transparent } from '../../../../platform/theme/common/colorRegistry.ts';
