...
import { FoldingContext, FoldingRange, FoldingRangeProvider, ProviderResult } from '../../../../common/languages.ts';
import { SyntaxRangeProvider } from '../../browser/syntaxRangeProvider.ts';
import { createTextModel } from '../../../../test/common/testTextModel.ts';
import { FoldingLimitReporter } from '../../browser/folding.ts';
