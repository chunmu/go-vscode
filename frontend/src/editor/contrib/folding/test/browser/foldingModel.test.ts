...
import { IModelDecorationsChangeAccessor, ITextModel, TrackedRangeStickiness } from '../../../../common/model.ts';
import { ModelDecorationOptions } from '../../../../common/model/textModel.ts';
import { toSelectedLines } from '../../browser/folding.ts';
import { FoldingModel, getNextFoldLine, getParentFoldLine, getPreviousFoldLine, setCollapseStateAtLevel, setCollapseStateForMatchingLines, setCollapseStateForRest, setCollapseStateLevelsDown, setCollapseStateLevelsUp, setCollapseStateUp } from '../../browser/foldingModel.ts';
import { FoldingRegion } from '../../browser/foldingRanges.ts';
import { computeRanges } from '../../browser/indentRangeProvider.ts';
