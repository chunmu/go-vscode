...
import { CancellationError, isCancellationError, onUnexpectedExternalError } from '../../../../base/common/errors.ts';
import { FuzzyScore } from '../../../../base/common/filters.ts';
import { DisposableStore, IDisposable, isDisposable } from '../../../../base/common/lifecycle.ts';
...
import { historyNavigationVisible } from '../../../../platform/history/browser/contextScopedHistoryWidget.ts';
import { InternalQuickSuggestionsOptions, QuickSuggestionsValue } from '../../../common/config/editorOptions.ts';
