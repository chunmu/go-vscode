...
import { onUnexpectedError, onUnexpectedExternalError } from '../../../../base/common/errors.ts';
import { Emitter, Event } from '../../../../base/common/event.ts';
import { KeyCode, KeyMod } from '../../../../base/common/keyCodes.ts';
import { KeyCodeChord } from '../../../../base/common/keybindings.ts';
import { DisposableStore, dispose, IDisposable, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import * as platform from '../../../../base/common/platform.ts';
import { StopWatch } from '../../../../base/common/stopwatch.ts';
import { assertType, isObject } from '../../../../base/common/types.ts';
import { StableEditorScrollState } from '../../../browser/stableEditorScroll.ts';
import { ICodeEditor } from '../../../browser/editorBrowser.ts';
import { EditorAction, EditorCommand, EditorContributionInstantiation, registerEditorAction, registerEditorCommand, registerEditorContribution, ServicesAccessor } from '../../../browser/editorExtensions.ts';
import { EditorOption } from '../../../common/config/editorOptions.ts';
import { EditOperation } from '../../../common/core/editOperation.ts';
import { IPosition, Position } from '../../../common/core/position.ts';
import { Range } from '../../../common/core/range.ts';
import { IEditorContribution, ScrollType } from '../../../common/editorCommon.ts';
import { EditorContextKeys } from '../../../common/editorContextKeys.ts';
import { ITextModel, TrackedRangeStickiness } from '../../../common/model.ts';
import { CompletionItemInsertTextRule, CompletionItemProvider, CompletionTriggerKind, ProviderId } from '../../../common/languages.ts';
import { SnippetController2 } from '../../snippet/browser/snippetController2.ts';
import { SnippetParser } from '../../snippet/browser/snippetParser.ts';
import { ISuggestMemoryService } from './suggestMemory.ts';
import { WordContextKey } from './wordContextKey.ts';
...
import { CompletionItem, Context as SuggestContext, ISuggestItemPreselector, suggestWidgetStatusbarMenu } from './suggest.ts';
import { SuggestAlternatives } from './suggestAlternatives.ts';
import { CommitCharacterController } from './suggestCommitCharacters.ts';
import { State, SuggestModel } from './suggestModel.ts';
import { OvertypingCapturer } from './suggestOvertypingCapturer.ts';
import { ISelectedSuggestion, SuggestWidget } from './suggestWidget.ts';
import { ITelemetryService } from '../../../../platform/telemetry/common/telemetry.ts';
import { basename, extname } from '../../../../base/common/resources.ts';
import { hash } from '../../../../base/common/hash.ts';
import { WindowIdleValue, getWindow } from '../../../../base/browser/dom.ts';
import { ModelDecorationOptions } from '../../../common/model/textModel.ts';
import { EditSources } from '../../../common/textModelEditSource.ts';
