...
import { binarySearch, isFalsyOrEmpty } from '../../../../base/common/arrays.ts';
...
import { CompletionItem, CompletionItemKind } from '../../../common/languages.ts';
import { IEditorWorkerService } from '../../../common/services/editorWorker.ts';
import { BracketSelectionRangeProvider } from '../../smartSelect/browser/bracketSelections.ts';
