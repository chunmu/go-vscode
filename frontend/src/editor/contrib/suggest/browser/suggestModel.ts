...
import { getLeadingWhitespace, isHighSurrogate, isLowSurrogate } from '../../../../base/common/strings.ts';
import { ICodeEditor } from '../../../browser/editorBrowser.ts';
import { EditorOption } from '../../../common/config/editorOptions.ts';
import { CursorChangeReason, ICursorSelectionChangedEvent } from '../../../common/cursorEvents.ts';
...
import { CompletionContext, CompletionItemKind, CompletionItemProvider, CompletionTriggerKind } from '../../../common/languages.ts';
import { IEditorWorkerService } from '../../../common/services/editorWorker.ts';
import { WordDistance } from './wordDistance.ts';
...
import { CompletionModel } from './completionModel.ts';
import { CompletionDurations, CompletionItem, CompletionOptions, getSnippetSuggestSupport, provideSuggestionItems, QuickSuggestionsOptions, SnippetSortOrder } from './suggest.ts';
...
import { FuzzyScoreOptions } from '../../../../base/common/filters.ts';
import { assertType } from '../../../../base/common/types.ts';
import { InlineCompletionContextKeys } from '../../inlineCompletions/browser/controller/inlineCompletionContextKeys.ts';
