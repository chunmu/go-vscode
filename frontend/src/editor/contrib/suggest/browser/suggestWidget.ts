...
import { List } from '../../../../base/browser/ui/list/listWidget.ts';
...
import { ContentWidgetPositionPreference, ICodeEditor, IContentWidget, IContentWidgetPosition, IEditorMouseEvent } from '../../../browser/editorBrowser.ts';
...
import { SuggestWidgetStatus } from './suggestWidgetStatus.ts';
import '../../symbolIcons/browser/symbolIcons.ts'; // The codicon symbol colors are defined here and must be loaded to get colors
...
import { CompletionItem, Context as SuggestContext, suggestWidgetStatusbarMenu } from './suggest.ts';
import { canExpandCompletionItem, SuggestDetailsOverlay, SuggestDetailsWidget } from './suggestWidgetDetails.ts';
import { ItemRenderer } from './suggestWidgetRenderer.ts';
import { getListStyles } from '../../../../platform/theme/browser/defaultStyles.ts';
import { status } from '../../../../base/browser/ui/aria/aria.ts';
import { CompletionItemKinds } from '../../../common/languages.ts';
