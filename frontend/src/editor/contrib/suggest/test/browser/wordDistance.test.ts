...
import { DEFAULT_WORD_REGEXP } from '../../../../common/core/wordHelper.ts';
...
import { EditorWorkerService } from '../../../../browser/services/editorWorkerService.ts';
...
import { CompletionItem } from '../../browser/suggest.ts';
import { WordDistance } from '../../browser/wordDistance.ts';
import { createCodeEditorServices, instantiateTestCodeEditor } from '../../../../test/browser/testCodeEditor.ts';
import { instantiateTextModel } from '../../../../test/common/testTextModel.ts';
