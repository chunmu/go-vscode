...
import { EditorOptions, InternalSuggestOptions } from '../../../../common/config/editorOptions.ts';
import { IPosition } from '../../../../common/core/position.ts';
import * as languages from '../../../../common/languages.ts';
import { CompletionModel } from '../../browser/completionModel.ts';
import { CompletionItem, getSuggestionComparator, SnippetSortOrder } from '../../browser/suggest.ts';
