...
import { CompletionItemInsertTextRule, CompletionItemKind } from '../../../../common/languages.ts';
...
import { DeleteLinesAction } from '../../../linesOperations/browser/linesOperations.ts';
