...
import { USUAL_WORD_SEPARATORS } from '../../../../common/core/wordHelper.ts';
...
import { DeleteAllLeftAction } from '../../../linesOperations/browser/linesOperations.ts';
import { LinkedEditingContribution } from '../../browser/linkedEditing.ts';
import { DeleteWordLeft } from '../../../wordOperations/browser/wordOperations.ts';
import { ITestCodeEditor, createCodeEditorServices, instantiateTestCodeEditor } from '../../../../test/browser/testCodeEditor.ts';
