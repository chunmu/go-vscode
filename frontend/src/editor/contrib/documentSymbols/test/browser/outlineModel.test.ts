...
import { DocumentSymbol, SymbolKind } from '../../../../common/languages.ts';
...
import { createModelServices, createTextModel } from '../../../../test/common/testTextModel.ts';
import { NullLogService } from '../../../../../platform/log/common/log.ts';
import { IMarker, MarkerSeverity } from '../../../../../platform/markers/common/markers.ts';
import { OutlineElement, OutlineGroup, OutlineModel, OutlineModelService } from '../../browser/outlineModel.ts';
