...
import { reverseOrder, compareBy, numberComparator } from '../../../../base/common/arrays.ts';
import { observableValue, observableSignalFromEvent, autorunWithStore, IReader } from '../../../../base/common/observable.ts';
import { HideUnchangedRegionsFeature, IDiffEditorBreadcrumbsSource } from '../../../browser/widget/diffEditor/features/hideUnchangedRegionsFeature.ts';
import { DisposableCancellationTokenSource } from '../../../browser/widget/diffEditor/utils.ts';
...
import { IOutlineModelService, OutlineModel } from '../../documentSymbols/browser/outlineModel.ts';
import { Disposable } from '../../../../base/common/lifecycle.ts';
import { Event } from '../../../../base/common/event.ts';
import { SymbolKind } from '../../../common/languages.ts';
