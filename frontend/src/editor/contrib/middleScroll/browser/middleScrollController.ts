...
import { getWindow, addDisposableListener, n } from '../../../../base/browser/dom.ts';
...
import { IEditorContribution, INewScrollPosition } from '../../../common/editorCommon.ts';
import { EditorOption } from '../../../common/config/editorOptions.ts';
import { autorun, derived, disposableObservableValue, IObservable, observableValue } from '../../../../base/common/observable.ts';
import { observableCodeEditor } from '../../../browser/observableCodeEditor.ts';
import { Point } from '../../../common/core/2d/point.ts';
import { AnimationFrameScheduler } from '../../inlineCompletions/browser/model/animation.ts';
import { appendRemoveOnDispose } from '../../../browser/widget/diffEditor/utils.ts';
