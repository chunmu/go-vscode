...
import { EditorCommand, EditorContributionInstantiation, registerEditorCommand, registerEditorContribution } from '../../../browser/editorExtensions.ts';
...
import { CompletionItem, CompletionItemKind, CompletionItemProvider } from '../../../common/languages.ts';
...
import { Choice } from './snippetParser.ts';
import { showSimpleSuggestions } from '../../suggest/browser/suggest.ts';
...
import { ISnippetEdit, SnippetSession } from './snippetSession.ts';
