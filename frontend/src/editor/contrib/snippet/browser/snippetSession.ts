...
import { groupBy } from '../../../../base/common/arrays.ts';
import { CharCode } from '../../../../base/common/charCode.ts';
import { dispose } from '../../../../base/common/lifecycle.ts';
import { getLeadingWhitespace } from '../../../../base/common/strings.ts';
import './snippetSession.css';
import { IActiveCodeEditor } from '../../../browser/editorBrowser.ts';
...
import { TextChange } from '../../../common/core/textChange.ts';
import { ILanguageConfigurationService } from '../../../common/languages/languageConfigurationRegistry.ts';
import { IIdentifiedSingleEditOperation, ITextModel, TrackedRangeStickiness } from '../../../common/model.ts';
import { ModelDecorationOptions } from '../../../common/model/textModel.ts';
import { OvertypingCapturer } from '../../suggest/browser/suggestOvertypingCapturer.ts';
...
import { Choice, Marker, Placeholder, SnippetParser, Text, TextmateSnippet } from './snippetParser.ts';
import { ClipboardBasedVariableResolver, CommentBasedVariableResolver, CompositeSnippetVariableResolver, ModelBasedVariableResolver, RandomBasedVariableResolver, SelectionBasedVariableResolver, TimeBasedVariableResolver, WorkspaceBasedVariableResolver } from './snippetVariables.ts';
import { EditSources, TextModelEditSource } from '../../../common/textModelEditSource.ts';
