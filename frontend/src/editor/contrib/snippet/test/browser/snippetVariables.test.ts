...
import { SnippetParser, Variable, VariableResolver } from '../../browser/snippetParser.ts';
import { ClipboardBasedVariableResolver, CompositeSnippetVariableResolver, ModelBasedVariableResolver, SelectionBasedVariableResolver, TimeBasedVariableResolver, WorkspaceBasedVariableResolver } from '../../browser/snippetVariables.ts';
import { createTextModel } from '../../../../test/common/testTextModel.ts';
import { ILabelService } from '../../../../../platform/label/common/label.ts';
import { IWorkspace, IWorkspaceContextService, toWorkspaceFolder } from '../../../../../platform/workspace/common/workspace.ts';
