...
import { ICodeEditor, IEditorMouseEvent, IMouseTarget } from '../../../../browser/editorBrowser.ts';
import { EditorOption, MouseMiddleClickAction } from '../../../../common/config/editorOptions.ts';
