...
import { Sizing, SplitView } from '../../../../../base/browser/ui/splitview/splitview.ts';
...
import { DisposableStore, dispose, IDisposable, IReference } from '../../../../../base/common/lifecycle.ts';
import { Schemas } from '../../../../../base/common/network.ts';
import { basenameOrAuthority, dirname } from '../../../../../base/common/resources.ts';
import './referencesWidget.css';
import { ICodeEditor } from '../../../../browser/editorBrowser.ts';
import { EmbeddedCodeEditorWidget } from '../../../../browser/widget/codeEditor/embeddedCodeEditorWidget.ts';
...
import { IModelDeltaDecoration, TrackedRangeStickiness } from '../../../../common/model.ts';
import { ModelDecorationOptions, TextModel } from '../../../../common/model/textModel.ts';
import { Location } from '../../../../common/languages.ts';
import { PLAINTEXT_LANGUAGE_ID } from '../../../../common/languages/modesRegistry.ts';
import { ITextEditorModel, ITextModelService } from '../../../../common/services/resolverService.ts';
import { AccessibilityProvider, DataSource, Delegate, FileReferencesRenderer, IdentityProvider, OneReferenceRenderer, StringRepresentationProvider, TreeElement } from './referencesTree.ts';
import * as peekView from '../../../peekView/browser/peekView.ts';
...
import { IWorkbenchAsyncDataTreeOptions, WorkbenchAsyncDataTree } from '../../../../../platform/list/browser/listService.ts';
import { IColorTheme, IThemeService } from '../../../../../platform/theme/common/themeService.ts';
import { FileReferences, OneReference, ReferencesModel } from '../referencesModel.ts';
import { ITreeDragAndDrop, ITreeDragOverReaction } from '../../../../../base/browser/ui/tree/tree.ts';
import { DataTransfers, IDragAndDropData } from '../../../../../base/browser/dnd.ts';
import { ElementsDragAndDropData } from '../../../../../base/browser/ui/list/listView.ts';
import { withSelection } from '../../../../../platform/opener/common/opener.ts';
