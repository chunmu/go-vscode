...
import { ReplaceCommand, ReplaceCommandThatPreservesSelection, ReplaceCommandThatSelectsText } from '../../../common/commands/replaceCommand.ts';
import { TrimTrailingWhitespaceCommand } from '../../../common/commands/trimTrailingWhitespaceCommand.ts';
...
import { CopyLinesCommand } from './copyLinesCommand.ts';
import { MoveLinesCommand } from './moveLinesCommand.ts';
import { SortLinesCommand } from './sortLinesCommand.ts';
