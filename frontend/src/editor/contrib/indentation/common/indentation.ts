...
import { normalizeIndentation } from '../../../common/core/misc/indentation.ts';
...
import { ProcessedIndentRulesSupport } from '../../../common/languages/supports/indentationLineProcessor.ts';
