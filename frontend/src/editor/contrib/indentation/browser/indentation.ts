...
import { EditorAction, EditorContributionInstantiation, IActionOptions, registerEditorAction, registerEditorContribution, ServicesAccessor } from '../../../browser/editorExtensions.ts';
import { ShiftCommand } from '../../../common/commands/shiftCommand.ts';
import { EditorAutoIndentStrategy, EditorOption } from '../../../common/config/editorOptions.ts';
...
import { ICommand, ICursorStateComputerData, IEditOperationBuilder, IEditorContribution } from '../../../common/editorCommon.ts';
import { EditorContextKeys } from '../../../common/editorContextKeys.ts';
import { StandardTokenType } from '../../../common/encodedTokenAttributes.ts';
import { TextEdit } from '../../../common/languages.ts';
import { getGoodIndentForLine, getIndentMetadata } from '../../../common/languages/autoIndent.ts';
import { ILanguageConfigurationService } from '../../../common/languages/languageConfigurationRegistry.ts';
import { IndentConsts } from '../../../common/languages/supports/indentRules.ts';
import { EndOfLineSequence, ITextModel } from '../../../common/model.ts';
import { IModelService } from '../../../common/services/model.ts';
import { getStandardTokenTypeAtPosition } from '../../../common/tokens/lineTokens.ts';
import { getReindentEditOperations } from '../common/indentation.ts';
import * as indentUtils from '../common/indentUtils.ts';
