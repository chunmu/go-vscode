...
import { IsWindowsContext } from '../../../../platform/contextkey/common/contextkeys.ts';
...
import { EditorAction, EditorCommand, ICommandOptions, registerEditorAction, registerEditorCommand, ServicesAccessor } from '../../../browser/editorExtensions.ts';
import { ReplaceCommand } from '../../../common/commands/replaceCommand.ts';
import { EditorOption, EditorOptions } from '../../../common/config/editorOptions.ts';
...
import { getMapForWordSeparators, WordCharacterClassifier } from '../../../common/core/wordCharacterClassifier.ts';
import { DeleteWordContext, WordNavigationType, WordOperations } from '../../../common/cursor/cursorWordOperations.ts';
