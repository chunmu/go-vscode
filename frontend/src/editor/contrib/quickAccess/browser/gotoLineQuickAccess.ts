...
import { IQuickPick, IQuickPickItem } from '../../../../platform/quickinput/common/quickInput.ts';
import { IStorageService, StorageScope, StorageTarget } from '../../../../platform/storage/common/storage.ts';
import { inputActiveOptionBackground, inputActiveOptionBorder, inputActiveOptionForeground } from '../../../../platform/theme/common/colors/inputColors.ts';
import { asCssVariable } from '../../../../platform/theme/common/colorUtils.ts';
import { getCodeEditor } from '../../../browser/editorBrowser.ts';
...
import { IEditor, ScrollType } from '../../../common/editorCommon.ts';
import { AbstractEditorNavigationQuickAccessProvider, IQuickAccessTextEditorContext } from './editorNavigationQuickAccess.ts';
