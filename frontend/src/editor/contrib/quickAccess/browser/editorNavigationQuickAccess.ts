...
import { getCodeEditor, isDiffEditor } from '../../../browser/editorBrowser.ts';
import { IRange } from '../../../common/core/range.ts';
import { IDiffEditor, IEditor, ScrollType } from '../../../common/editorCommon.ts';
import { IModelDeltaDecoration, ITextModel, OverviewRulerLane } from '../../../common/model.ts';
import { overviewRulerRangeHighlight } from '../../../common/core/editorColorRegistry.ts';
import { IQuickAccessProvider, IQuickAccessProviderRunOptions } from '../../../../platform/quickinput/common/quickAccess.ts';
import { IKeyMods, IQuickPick, IQuickPickItem } from '../../../../platform/quickinput/common/quickInput.ts';
