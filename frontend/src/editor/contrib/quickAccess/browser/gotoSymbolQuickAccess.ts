...
import { IPreparedQuery, pieceToQuery, prepareQuery, scoreFuzzy2 } from '../../../../base/common/fuzzyScorer.ts';
import { Disposable, DisposableStore, IDisposable, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { format, trim } from '../../../../base/common/strings.ts';
...
import { DocumentSymbol, SymbolKind, SymbolKinds, SymbolTag, getAriaLabelForSymbol } from '../../../common/languages.ts';
import { IOutlineModelService } from '../../documentSymbols/browser/outlineModel.ts';
import { AbstractEditorNavigationQuickAccessProvider, IEditorNavigationQuickAccessOptions, IQuickAccessTextEditorContext } from './editorNavigationQuickAccess.ts';
import { localize } from '../../../../nls.ts';
import { IQuickInputButton, IQuickPick, IQuickPickItem, IQuickPickSeparator } from '../../../../platform/quickinput/common/quickInput.ts';
...
import { IQuickAccessProviderRunOptions } from '../../../../platform/quickinput/common/quickAccess.ts';
