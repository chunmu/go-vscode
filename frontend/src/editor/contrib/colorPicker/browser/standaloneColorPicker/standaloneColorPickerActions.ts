...
import { EditorAction, EditorAction2, ServicesAccessor } from '../../../../browser/editorExtensions.ts';
...
import { StandaloneColorPickerController } from './standaloneColorPickerController.ts';
