...
import { EditorHoverStatusBar } from '../../../hover/browser/contentHoverStatusBar.ts';
...
import { IColorInformation } from '../../../../common/languages.ts';
import { ILanguageFeaturesService } from '../../../../common/services/languageFeatures.ts';
import { IContextKey } from '../../../../../platform/contextkey/common/contextkey.ts';
import { IRange } from '../../../../common/core/range.ts';
import { DefaultDocumentColorProvider } from '../defaultDocumentColorProvider.ts';
import { IEditorWorkerService } from '../../../../common/services/editorWorker.ts';
import { StandaloneColorPickerHover, StandaloneColorPickerParticipant, StandaloneColorPickerRenderedParts } from './standaloneColorPickerParticipant.ts';
import * as dom from '../../../../../base/browser/dom.ts';
import { InsertButton } from '../colorPickerParts/colorPickerInsertButton.ts';
