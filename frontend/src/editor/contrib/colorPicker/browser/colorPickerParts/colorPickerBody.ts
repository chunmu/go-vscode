...
import { Color, HSVA } from '../../../../../base/common/color.ts';
import { Disposable } from '../../../../../base/common/lifecycle.ts';
import { ColorPickerModel } from '../colorPickerModel.ts';
import { SaturationBox } from './colorPickerSaturationBox.ts';
import { InsertButton } from './colorPickerInsertButton.ts';
import { HueStrip, OpacityStrip, Strip } from './colorPickerStrip.ts';
