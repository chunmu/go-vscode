...
import { EditorOptions, WrappingIndent, EditorAutoIndentStrategy } from './common/config/editorOptions.ts';
import { createMonacoBaseAPI } from './common/services/editorBaseApi.ts';
import { createMonacoEditorAPI } from './standalone/browser/standaloneEditor.ts';
import { createMonacoLanguagesAPI } from './standalone/browser/standaloneLanguages.ts';
import { FormattingConflicts } from './contrib/format/browser/format.ts';
import { getMonacoEnvironment } from '../base/browser/browser.ts';
