...
import { IEditorOptions } from './config/editorOptions.ts';
import { IDimension } from './core/2d/dimension.ts';
...
import { IModelDecoration, IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel, IValidEditOperation, OverviewRulerLane, TrackedRangeStickiness } from './model.ts';
import { IModelDecorationsChangedEvent } from './textModelEvents.ts';
