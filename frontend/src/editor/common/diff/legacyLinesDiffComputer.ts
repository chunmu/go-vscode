...
import { IDiffChange, ISequence, LcsDiff, IDiffResult } from '../../../base/common/diff/diff.ts';
import { ILinesDiffComputer, ILinesDiffComputerOptions, LinesDiff } from './linesDiffComputer.ts';
import { RangeMapping, DetailedLineRangeMapping } from './rangeMapping.ts';
