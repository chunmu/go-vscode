...
import { IScrollPosition, Scrollable } from '../../base/common/scrollable.ts';
import * as strings from '../../base/common/strings.ts';
import { ISimpleModel } from './viewModel/screenReaderSimpleModel.ts';
...
import { CursorConfiguration, CursorState, EditOperationType, IColumnSelectData, ICursorSimpleModel, PartialCursorState } from './cursorCommon.ts';
import { CursorChangeReason } from './cursorEvents.ts';
import { INewScrollPosition, ScrollType } from './editorCommon.ts';
import { EditorTheme } from './editorTheme.ts';
import { EndOfLinePreference, IGlyphMarginLanesModel, IModelDecorationOptions, ITextModel, TextDirection } from './model.ts';
import { ILineBreaksComputer, InjectedText } from './modelLineProjectionData.ts';
import { BracketGuideOptions, IActiveIndentGuideInfo, IndentGuide } from './textModelGuides.ts';
import { IViewLineTokens } from './tokens/lineTokens.ts';
import { ViewEventHandler } from './viewEventHandler.ts';
import { VerticalRevealType } from './viewEvents.ts';
import { InlineDecoration, SingleLineInlineDecoration } from './viewModel/inlineDecorations.ts';
