...
import { IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility, INewScrollPosition } from '../../../base/common/scrollable.ts';
import { ConfigurationChangedEvent, EditorOption } from '../config/editorOptions.ts';
import { ScrollType } from '../editorCommon.ts';
import { IEditorConfiguration } from '../config/editorConfiguration.ts';
import { LinesLayout } from './linesLayout.ts';
import { IEditorWhitespace, IPartialViewLinesViewportData, ILineHeightChangeAccessor, IViewLayout, IViewWhitespaceViewportData, IWhitespaceChangeAccessor, Viewport } from '../viewModel.ts';
import { ContentSizeChangedEvent } from '../viewModelEventDispatcher.ts';
import { ICustomLineHeightData } from './lineHeights.ts';
