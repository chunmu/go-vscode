...
import { IEditorWhitespace, IPartialViewLinesViewportData, ILineHeightChangeAccessor, IViewWhitespaceViewportData, IWhitespaceChangeAccessor } from '../viewModel.ts';
import * as strings from '../../../base/common/strings.ts';
import { ICustomLineHeightData, LineHeightsManager } from './lineHeights.ts';
