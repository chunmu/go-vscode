...
import { IPartialViewLinesViewportData, IViewModel, IViewWhitespaceViewportData, ViewLineRenderingData } from '../viewModel.ts';
import { ViewModelDecoration } from '../viewModel/viewModelDecoration.ts';
