...
import { IWordAtPosition, getWordAtText } from '../../core/wordHelper.ts';
import { StandardTokenType } from '../../encodedTokenAttributes.ts';
import { ILanguageService } from '../../languages/language.ts';
import { ILanguageConfigurationService, LanguageConfigurationServiceChangeEvent, ResolvedLanguageConfiguration } from '../../languages/languageConfigurationRegistry.ts';
import { BracketPairsTextModelPart } from '../bracketPairsTextModelPart/bracketPairsImpl.ts';
import { TextModel } from '../textModel.ts';
import { TextModelPart } from '../textModelPart.ts';
import { AbstractSyntaxTokenBackend, AttachedViews } from './abstractSyntaxTokenBackend.ts';
import { TreeSitterSyntaxTokenBackend } from './treeSitter/treeSitterSyntaxTokenBackend.ts';
import { IModelContentChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelTokensChangedEvent } from '../../textModelEvents.ts';
import { ITokenizationTextModelPart } from '../../tokenizationTextModelPart.ts';
import { LineTokens } from '../../tokens/lineTokens.ts';
import { SparseMultilineTokens } from '../../tokens/sparseMultilineTokens.ts';
import { SparseTokensStore } from '../../tokens/sparseTokensStore.ts';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.ts';
import { TokenizerSyntaxTokenBackend } from './tokenizerSyntaxTokenBackend.ts';
import { ITreeSitterLibraryService } from '../../services/treeSitter/treeSitterLibraryService.ts';
import { derived, IObservable, ISettableObservable, observableValue } from '../../../../base/common/observable.ts';
