...
import { LanguageId } from '../../../encodedTokenAttributes.ts';
import { ILanguageIdCodec, QueryCapture } from '../../../languages.ts';
import { IModelContentChangedEvent, IModelTokensChangedEvent } from '../../../textModelEvents.ts';
import { findLikelyRelevantLines } from '../../textModelTokens.ts';
import { TokenStore, TokenUpdate, TokenQuality } from './tokenStore.ts';
import { TreeSitterTree, RangeChange, RangeWithOffsets } from './treeSitterTree.ts';
import type * as TreeSitter from '@vscode/tree-sitter-wasm';
import { autorun, autorunHandleChanges, IObservable, recordChanges, runOnChange } from '../../../../../base/common/observable.ts';
...
import { ITreeSitterThemeService } from '../../../services/treeSitter/treeSitterThemeService.ts';
