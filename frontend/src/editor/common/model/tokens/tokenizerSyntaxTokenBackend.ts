...
import { MutableDisposable, DisposableMap } from '../../../../base/common/lifecycle.ts';
...
import { IBackgroundTokenizer, IState, ILanguageIdCodec, TokenizationRegistry, ITokenizationSupport, IBackgroundTokenizationStore } from '../../languages.ts';
import { IAttachedView } from '../../model.ts';
import { IModelContentChangedEvent } from '../../textModelEvents.ts';
import { BackgroundTokenizationState } from '../../tokenizationTextModelPart.ts';
import { ContiguousMultilineTokens } from '../../tokens/contiguousMultilineTokens.ts';
import { ContiguousMultilineTokensBuilder } from '../../tokens/contiguousMultilineTokensBuilder.ts';
import { ContiguousTokensStore } from '../../tokens/contiguousTokensStore.ts';
import { LineTokens } from '../../tokens/lineTokens.ts';
import { TextModel } from '../textModel.ts';
import { TokenizerWithStateStoreAndTextModel, DefaultBackgroundTokenizer, TrackingTokenizationStateStore } from '../textModelTokens.ts';
import { AbstractSyntaxTokenBackend, AttachedViewHandler, AttachedViews } from './abstractSyntaxTokenBackend.ts';
