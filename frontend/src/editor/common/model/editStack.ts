...
import { EndOfLineSequence, ICursorStateComputer, IValidEditOperation, ITextModel } from '../model.ts';
import { TextModel } from './textModel.ts';
import { IUndoRedoService, IResourceUndoRedoElement, UndoRedoElementType, IWorkspaceUndoRedoElement, UndoRedoGroup } from '../../../platform/undoRedo/common/undoRedo.ts';
import { URI } from '../../../base/common/uri.ts';
import { TextChange, compressConsecutiveTextChanges } from '../core/textChange.ts';
import * as buffer from '../../../base/common/buffer.ts';
