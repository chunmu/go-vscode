...
import { IdleDeadline, runWhenGlobalIdle } from '../../../base/common/async.ts';
...
import { EncodedTokenizationResult, IBackgroundTokenizationStore, IBackgroundTokenizer, ILanguageIdCodec, IState, ITokenizationSupport } from '../languages.ts';
import { nullTokenizeEncoded } from '../languages/nullTokenize.ts';
import { ITextModel } from '../model.ts';
import { FixedArray } from './fixedArray.ts';
import { IModelContentChange } from './mirrorTextModel.ts';
