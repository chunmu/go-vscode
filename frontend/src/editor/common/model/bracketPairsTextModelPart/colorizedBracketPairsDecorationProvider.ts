...
import { BracketPairColorizationOptions, IModelDecoration } from '../../model.ts';
import { BracketInfo } from '../../textModelBracketPairs.ts';
import { DecorationProvider } from '../decorationProvider.ts';
...
} from '../../core/editorColorRegistry.ts';
import { registerThemingParticipant } from '../../../../platform/theme/common/themeService.ts';
import { IModelOptionsChangedEvent } from '../../textModelEvents.ts';
