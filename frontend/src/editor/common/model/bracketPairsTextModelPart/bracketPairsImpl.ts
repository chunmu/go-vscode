...
import { CallbackIterable, compareBy } from '../../../../base/common/arrays.ts';
import { Emitter } from '../../../../base/common/event.ts';
import { Disposable, DisposableStore, IDisposable, IReference, MutableDisposable } from '../../../../base/common/lifecycle.ts';
import { IPosition, Position } from '../../core/position.ts';
import { Range } from '../../core/range.ts';
import { ILanguageConfigurationService, LanguageConfigurationServiceChangeEvent } from '../../languages/languageConfigurationRegistry.ts';
import { ignoreBracketsInToken } from '../../languages/supports.ts';
import { LanguageBracketsConfiguration } from '../../languages/supports/languageBracketsConfiguration.ts';
import { BracketsUtils, RichEditBracket, RichEditBrackets } from '../../languages/supports/richEditBrackets.ts';
import { BracketPairsTree } from './bracketPairsTree/bracketPairsTree.ts';
import { TextModel } from '../textModel.ts';
import { BracketInfo, BracketPairInfo, BracketPairWithMinIndentationInfo, IBracketPairsTextModelPart, IFoundBracket } from '../../textModelBracketPairs.ts';
import { IModelContentChangedEvent, IModelLanguageChangedEvent, IModelOptionsChangedEvent, IModelTokensChangedEvent } from '../../textModelEvents.ts';
