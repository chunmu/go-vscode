...
import { ApplyEditsResult, EndOfLinePreference, FindMatch, IInternalModelContentChange, ISingleEditOperationIdentifier, ITextBuffer, ITextSnapshot, ValidAnnotatedEditOperation, IValidEditOperation, SearchData } from '../../model.ts';
import { PieceTreeBase, StringBuffer } from './pieceTreeBase.ts';
import { countEOL, StringEOL } from '../../core/misc/eolCounter.ts';
