...
import { ArrayQueue, pushMany } from '../../../base/common/arrays.ts';
import { VSBuffer, VSBufferReadableStream } from '../../../base/common/buffer.ts';
import { Color } from '../../../base/common/color.ts';
import { BugIndicatingError, illegalArgument, onUnexpectedError } from '../../../base/common/errors.ts';
import { Emitter, Event } from '../../../base/common/event.ts';
import { IMarkdownString } from '../../../base/common/htmlContent.ts';
import { Disposable, IDisposable, MutableDisposable, combinedDisposable } from '../../../base/common/lifecycle.ts';
import { listenStream } from '../../../base/common/stream.ts';
...
import { ISingleEditOperation } from '../core/editOperation.ts';
import { countEOL } from '../core/misc/eolCounter.ts';
import { normalizeIndentation } from '../core/misc/indentation.ts';
import { IPosition, Position } from '../core/position.ts';
import { IRange, Range } from '../core/range.ts';
import { Selection } from '../core/selection.ts';
import { TextChange } from '../core/textChange.ts';
import { EDITOR_MODEL_DEFAULTS } from '../core/misc/textModelDefaults.ts';
import { IWordAtPosition } from '../core/wordHelper.ts';
import { FormattingOptions } from '../languages.ts';
import { ILanguageSelection, ILanguageService } from '../languages/language.ts';
import { ILanguageConfigurationService } from '../languages/languageConfigurationRegistry.ts';
import * as model from '../model.ts';
import { BracketPairsTextModelPart } from './bracketPairsTextModelPart/bracketPairsImpl.ts';
import { ColorizedBracketPairsDecorationProvider } from './bracketPairsTextModelPart/colorizedBracketPairsDecorationProvider.ts';
import { EditStack } from './editStack.ts';
import { GuidesTextModelPart } from './guidesTextModelPart.ts';
import { guessIndentation } from './indentationGuesser.ts';
import { IntervalNode, IntervalTree, recomputeMaxEnd } from './intervalTree.ts';
import { PieceTreeTextBuffer } from './pieceTreeTextBuffer/pieceTreeTextBuffer.ts';
import { PieceTreeTextBufferBuilder } from './pieceTreeTextBuffer/pieceTreeTextBufferBuilder.ts';
import { SearchParams, TextModelSearch } from './textModelSearch.ts';
import { TokenizationTextModelPart } from './tokens/tokenizationTextModelPart.ts';
import { AttachedViews } from './tokens/abstractSyntaxTokenBackend.ts';
import { IBracketPairsTextModelPart } from '../textModelBracketPairs.ts';
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelOptionsChangedEvent, InternalModelContentChangeEvent, ModelInjectedTextChangedEvent, ModelRawChange, ModelRawContentChangedEvent, ModelRawEOLChanged, ModelRawFlush, ModelRawLineChanged, ModelRawLinesDeleted, ModelRawLinesInserted, ModelLineHeightChangedEvent, ModelLineHeightChanged, ModelFontChangedEvent, ModelFontChanged, LineInjectedText } from '../textModelEvents.ts';
import { IGuidesTextModelPart } from '../textModelGuides.ts';
import { ITokenizationTextModelPart } from '../tokenizationTextModelPart.ts';
import { IInstantiationService } from '../../../platform/instantiation/common/instantiation.ts';
import { IColorTheme } from '../../../platform/theme/common/themeService.ts';
import { IUndoRedoService, ResourceEditStackSnapshot, UndoRedoGroup } from '../../../platform/undoRedo/common/undoRedo.ts';
import { TokenArray } from '../tokens/lineTokens.ts';
import { SetWithKey } from '../../../base/common/collections.ts';
import { EditSources, TextModelEditSource } from '../textModelEditSource.ts';
import { TextEdit } from '../core/edits/textEdit.ts';
