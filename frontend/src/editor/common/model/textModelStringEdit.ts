...
import { EditOperation } from '../core/editOperation.ts';
import { Range } from '../core/range.ts';
import { StringEdit, StringReplacement } from '../core/edits/stringEdit.ts';
import { OffsetRange } from '../core/ranges/offsetRange.ts';
import { DetailedLineRangeMapping } from '../diff/rangeMapping.ts';
import { ITextModel, IIdentifiedSingleEditOperation } from '../model.ts';
import { IModelContentChange } from './mirrorTextModel.ts';
import { LengthEdit } from '../core/edits/lengthEdit.ts';
