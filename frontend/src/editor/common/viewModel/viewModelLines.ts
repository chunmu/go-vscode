...
import { WrappingIndent } from '../config/editorOptions.ts';
import { FontInfo } from '../config/fontInfo.ts';
import { IPosition, Position } from '../core/position.ts';
import { Range } from '../core/range.ts';
import { IModelDecoration, IModelDeltaDecoration, ITextModel, PositionAffinity } from '../model.ts';
import { IActiveIndentGuideInfo, BracketGuideOptions, IndentGuide, IndentGuideHorizontalLine } from '../textModelGuides.ts';
import { ModelDecorationOptions } from '../model/textModel.ts';
import { LineInjectedText } from '../textModelEvents.ts';
import * as viewEvents from '../viewEvents.ts';
import { createModelLineProjection, IModelLineProjection } from './modelLineProjection.ts';
import { ILineBreaksComputer, ModelLineProjectionData, InjectedText, ILineBreaksComputerFactory } from '../modelLineProjectionData.ts';
import { ConstantTimePrefixSumComputer } from '../model/prefixSumComputer.ts';
import { ViewLineData } from '../viewModel.ts';
import { ICoordinatesConverter, IdentityCoordinatesConverter } from '../coordinatesConverter.ts';
