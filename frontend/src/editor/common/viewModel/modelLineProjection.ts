...
import { EndOfLinePreference, ITextModel, PositionAffinity } from '../model.ts';
import { LineInjectedText } from '../textModelEvents.ts';
import { InjectedText, ModelLineProjectionData } from '../modelLineProjectionData.ts';
import { ViewLineData } from '../viewModel.ts';
import { SingleLineInlineDecoration } from './inlineDecorations.ts';
