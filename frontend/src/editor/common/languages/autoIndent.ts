...
import { IndentAction } from './languageConfiguration.ts';
import { IndentConsts } from './supports/indentRules.ts';
import { EditorAutoIndentStrategy } from '../config/editorOptions.ts';
import { ILanguageConfigurationService } from './languageConfigurationRegistry.ts';
import { IViewLineTokens } from '../tokens/lineTokens.ts';
import { IndentationContextProcessor, isLanguageDifferentFromLineStart, ProcessedIndentRulesSupport } from './supports/indentationLineProcessor.ts';
import { CursorConfiguration } from '../cursorCommon.ts';
