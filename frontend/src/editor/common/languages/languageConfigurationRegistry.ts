...
import { Disposable, IDisposable, markAsSingleton, toDisposable } from '../../../base/common/lifecycle.ts';
import * as strings from '../../../base/common/strings.ts';
import { ITextModel } from '../model.ts';
import { DEFAULT_WORD_REGEXP, ensureValidWordDefinition } from '../core/wordHelper.ts';
import { EnterAction, FoldingRules, IAutoClosingPair, IndentationRule, LanguageConfiguration, AutoClosingPairs, CharacterPair, ExplicitLanguageConfiguration } from './languageConfiguration.ts';
import { CharacterPairSupport } from './supports/characterPair.ts';
import { BracketElectricCharacterSupport } from './supports/electricCharacter.ts';
import { IndentRulesSupport } from './supports/indentRules.ts';
import { OnEnterSupport } from './supports/onEnter.ts';
import { RichEditBrackets } from './supports/richEditBrackets.ts';
import { EditorAutoIndentStrategy } from '../config/editorOptions.ts';
import { createDecorator } from '../../../platform/instantiation/common/instantiation.ts';
import { IConfigurationService } from '../../../platform/configuration/common/configuration.ts';
import { ILanguageService } from './language.ts';
import { InstantiationType, registerSingleton } from '../../../platform/instantiation/common/extensions.ts';
import { PLAINTEXT_LANGUAGE_ID } from './modesRegistry.ts';
import { LanguageBracketsConfiguration } from './supports/languageBracketsConfiguration.ts';
