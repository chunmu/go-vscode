...
import { RegExpOptions } from '../../../../base/common/strings.ts';
import { LanguageConfiguration } from '../languageConfiguration.ts';
import { createBracketOrRegExp } from './richEditBrackets.ts';
