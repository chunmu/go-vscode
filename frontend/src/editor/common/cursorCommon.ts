...
import { ConfigurationChangedEvent, EditorAutoClosingEditStrategy, EditorAutoClosingStrategy, EditorAutoIndentStrategy, EditorAutoSurroundStrategy, EditorOption } from './config/editorOptions.ts';
...
import { ICommand } from './editorCommon.ts';
import { IEditorConfiguration } from './config/editorConfiguration.ts';
import { PositionAffinity, TextModelResolvedOptions } from './model.ts';
import { AutoClosingPairs } from './languages/languageConfiguration.ts';
...
import { CursorColumns } from './core/cursorColumns.ts';
