...
import { compareBy, groupAdjacentBy, numberComparator } from '../../../../base/common/arrays.ts';
import { assert, checkAdjacentItems } from '../../../../base/common/assert.ts';
import { splitLines } from '../../../../base/common/strings.ts';
import { LineRange } from '../ranges/lineRange.ts';
import { BaseStringEdit, StringEdit, StringReplacement } from './stringEdit.ts';
import { Position } from '../position.ts';
import { Range } from '../range.ts';
import { TextReplacement, TextEdit } from './textEdit.ts';
import { AbstractText } from '../text/abstractText.ts';
