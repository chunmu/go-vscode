...
import { CursorCollection } from './cursorCollection.ts';
import { CursorConfiguration, CursorState, EditOperationResult, EditOperationType, IColumnSelectData, PartialCursorState, ICursorSimpleModel } from '../cursorCommon.ts';
import { CursorContext } from './cursorContext.ts';
import { DeleteOperations } from './cursorDeleteOperations.ts';
import { CursorChangeReason } from '../cursorEvents.ts';
import { CompositionOutcome, TypeOperations } from './cursorTypeOperations.ts';
import { BaseTypeWithAutoClosingCommand } from './cursorTypeEditOperations.ts';
import { Position } from '../core/position.ts';
import { Range, IRange } from '../core/range.ts';
import { ISelection, Selection, SelectionDirection } from '../core/selection.ts';
import * as editorCommon from '../editorCommon.ts';
import { ITextModel, TrackedRangeStickiness, IModelDeltaDecoration, ICursorStateComputer, IIdentifiedSingleEditOperation, IValidEditOperation } from '../model.ts';
import { RawContentChangedType, ModelInjectedTextChangedEvent, InternalModelContentChangeEvent } from '../textModelEvents.ts';
import { VerticalRevealType, ViewCursorStateChangedEvent, ViewRevealRangeRequestEvent } from '../viewEvents.ts';
import { dispose, Disposable } from '../../../base/common/lifecycle.ts';
import { CursorStateChangedEvent, ViewModelEventsCollector } from '../viewModelEventDispatcher.ts';
import { TextModelEditSource, EditSources } from '../textModelEditSource.ts';
