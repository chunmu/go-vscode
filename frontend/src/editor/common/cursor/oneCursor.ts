...
import { CursorState, ICursorSimpleModel, SelectionStartKind, SingleCursorState } from '../cursorCommon.ts';
...
import { PositionAffinity, TrackedRangeStickiness } from '../model.ts';
