...
import { ReplaceCommand, ReplaceCommandWithOffsetCursorState, ReplaceCommandWithoutChangingPosition, ReplaceCommandThatPreservesSelection, ReplaceOvertypeCommand, ReplaceOvertypeCommandOnCompositionEnd } from '../commands/replaceCommand.ts';
import { ShiftCommand } from '../commands/shiftCommand.ts';
import { SurroundSelectionCommand } from '../commands/surroundSelectionCommand.ts';
import { CursorConfiguration, EditOperationResult, EditOperationType, ICursorSimpleModel, isQuote } from '../cursorCommon.ts';
import { WordCharacterClass, getMapForWordSeparators } from '../core/wordCharacterClassifier.ts';
import { Range } from '../core/range.ts';
import { Selection } from '../core/selection.ts';
import { Position } from '../core/position.ts';
import { ICommand, ICursorStateComputerData, IEditOperationBuilder } from '../editorCommon.ts';
import { ITextModel } from '../model.ts';
import { EnterAction, IndentAction, StandardAutoClosingPairConditional } from '../languages/languageConfiguration.ts';
import { getIndentationAtPosition } from '../languages/languageConfigurationRegistry.ts';
import { IElectricAction } from '../languages/supports/electricCharacter.ts';
import { EditorAutoClosingStrategy, EditorAutoIndentStrategy } from '../config/editorOptions.ts';
import { createScopedLineTokens } from '../languages/supports.ts';
import { getIndentActionForType, getIndentForEnter, getInheritIndentForLine } from '../languages/autoIndent.ts';
import { getEnterAction } from '../languages/enterAction.ts';
import { CompositionOutcome } from './cursorTypeOperations.ts';
