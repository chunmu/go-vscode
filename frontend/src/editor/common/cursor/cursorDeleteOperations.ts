...
import { ReplaceCommand } from '../commands/replaceCommand.ts';
...
import { MoveOperations } from './cursorMoveOperations.ts';
import { Range } from '../core/range.ts';
import { Selection } from '../core/selection.ts';
import { ICommand } from '../editorCommon.ts';
import { StandardAutoClosingPairConditional } from '../languages/languageConfiguration.ts';
