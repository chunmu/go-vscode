...
import type { IJSONSchemaSnippet } from '../../../base/common/jsonSchema.ts';
import { diffEditorDefaultOptions } from './diffEditor.ts';
import { editorOptionsRegistry } from './editorOptions.ts';
