...
import { EDITOR_FONT_DEFAULTS, FONT_VARIATION_OFF, FONT_VARIATION_TRANSLATE, FontInfo } from './fontInfo.ts';
import { EDITOR_MODEL_DEFAULTS } from '../core/misc/textModelDefaults.ts';
import { USUAL_WORD_SEPARATORS } from '../core/wordHelper.ts';
import * as nls from '../../../nls.ts';
import { AccessibilitySupport } from '../../../platform/accessibility/common/accessibility.ts';
import { IConfigurationPropertySchema } from '../../../platform/configuration/common/configurationRegistry.ts';
