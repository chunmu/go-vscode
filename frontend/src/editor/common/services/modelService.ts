...
import { IUndoRedoService, ResourceEditStackSnapshot } from '../../../platform/undoRedo/common/undoRedo.ts';
import { clampedInt } from '../config/editorOptions.ts';
import { EditOperation, ISingleEditOperation } from '../core/editOperation.ts';
...
import { DefaultEndOfLine, EndOfLinePreference, EndOfLineSequence, ITextBuffer, ITextBufferFactory, ITextModel, ITextModelCreationOptions } from '../model.ts';
import { isEditStackElement } from '../model/editStack.ts';
import { TextModel, createTextBuffer } from '../model/textModel.ts';
import { EditSources, TextModelEditSource } from '../textModelEditSource.ts';
import { IModelLanguageChangedEvent } from '../textModelEvents.ts';
import { IModelService } from './model.ts';
import { ITextResourcePropertiesService } from './textResourceConfiguration.ts';
