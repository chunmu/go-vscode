...
import { ParsedPattern, parse } from '../../../base/common/glob.ts';
import { Mimes } from '../../../base/common/mime.ts';
import { Schemas } from '../../../base/common/network.ts';
import { basename, posix } from '../../../base/common/path.ts';
import { DataUri } from '../../../base/common/resources.ts';
import { endsWithIgnoreCase, equals, startsWithUTF8BOM } from '../../../base/common/strings.ts';
