...
import { IWebWorkerClient, IWebWorkerServer } from '../../../../base/common/worker/webWorker.ts';
import { IPosition, Position } from '../../core/position.ts';
import { IRange, Range } from '../../core/range.ts';
import { ensureValidWordDefinition, getWordAtText, IWordAtPosition } from '../../core/wordHelper.ts';
import { IDocumentColorComputerTarget } from '../../languages/defaultDocumentColorsComputer.ts';
import { ILinkComputerTarget } from '../../languages/linkComputer.ts';
import { MirrorTextModel as BaseMirrorModel, IModelChangedEvent } from '../../model/mirrorTextModel.ts';
import { IMirrorModel, IWordRange } from '../editorWebWorker.ts';
import { IModelService } from '../model.ts';
import { IRawModelData, IWorkerTextModelSyncChannelServer } from './textModelSync.protocol.ts';
