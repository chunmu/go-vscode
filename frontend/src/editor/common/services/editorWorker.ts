...
import { IDocumentDiff, IDocumentDiffProviderOptions } from '../diff/documentDiffProvider.ts';
import { IChange } from '../diff/legacyLinesDiffComputer.ts';
import { IColorInformation, IInplaceReplaceSupportResult, TextEdit } from '../languages.ts';
import { UnicodeHighlighterOptions } from './unicodeTextModelHighlighter.ts';
import { createDecorator } from '../../../platform/instantiation/common/instantiation.ts';
import type { EditorWorker } from './editorWebWorker.ts';
import { SectionHeader, FindSectionHeaderOptions } from './findSectionHeaders.ts';
import { StringEdit } from '../core/edits/stringEdit.ts';
