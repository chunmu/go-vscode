...
import { IMarkerService, IMarker, MarkerSeverity, MarkerTag } from '../../../platform/markers/common/markers.ts';
import { Disposable, IDisposable, toDisposable } from '../../../base/common/lifecycle.ts';
import { URI } from '../../../base/common/uri.ts';
import { IModelDeltaDecoration, ITextModel, IModelDecorationOptions, TrackedRangeStickiness, OverviewRulerLane, IModelDecoration, MinimapPosition, IModelDecorationMinimapOptions } from '../model.ts';
import { ClassName } from '../model/intervalTree.ts';
import { themeColorFromId } from '../../../platform/theme/common/themeService.ts';
import { ThemeColor } from '../../../base/common/themables.ts';
import { overviewRulerWarning, overviewRulerInfo, overviewRulerError } from '../core/editorColorRegistry.ts';
import { IModelService } from './model.ts';
import { Range } from '../core/range.ts';
import { IMarkerDecorationsService } from './markerDecorations.ts';
import { Schemas } from '../../../base/common/network.ts';
import { Emitter, Event } from '../../../base/common/event.ts';
import { minimapInfo, minimapWarning, minimapError } from '../../../platform/theme/common/colorRegistry.ts';
import { BidirectionalMap, ResourceMap } from '../../../base/common/map.ts';
