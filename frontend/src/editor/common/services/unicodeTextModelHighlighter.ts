...
import { Searcher } from '../model/textModelSearch.ts';
import * as strings from '../../../base/common/strings.ts';
import { IUnicodeHighlightsResult } from './editorWorker.ts';
import { assertNever } from '../../../base/common/assert.ts';
import { DEFAULT_WORD_REGEXP, getWordAtText } from '../core/wordHelper.ts';
