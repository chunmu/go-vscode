...
import { stringDiff } from '../../../base/common/diff/diff.ts';
...
import { EndOfLineSequence, ITextModel } from '../model.ts';
import { IMirrorTextModel, IModelChangedEvent } from '../model/mirrorTextModel.ts';
import { IColorInformation, IInplaceReplaceSupportResult, ILink, TextEdit } from '../languages.ts';
import { computeLinks } from '../languages/linkComputer.ts';
import { BasicInplaceReplace } from '../languages/supports/inplaceReplaceSupport.ts';
import { DiffAlgorithmName, IDiffComputationResult, ILineChange, IUnicodeHighlightsResult } from './editorWorker.ts';
import { createMonacoBaseAPI } from './editorBaseApi.ts';
import { StopWatch } from '../../../base/common/stopwatch.ts';
import { UnicodeTextModelHighlighter, UnicodeHighlighterOptions } from './unicodeTextModelHighlighter.ts';
import { DiffComputer, IChange } from '../diff/legacyLinesDiffComputer.ts';
import { ILinesDiffComputer, ILinesDiffComputerOptions } from '../diff/linesDiffComputer.ts';
import { DetailedLineRangeMapping } from '../diff/rangeMapping.ts';
import { linesDiffComputers } from '../diff/linesDiffComputers.ts';
import { IDocumentDiffProviderOptions } from '../diff/documentDiffProvider.ts';
import { BugIndicatingError } from '../../../base/common/errors.ts';
import { computeDefaultDocumentColors } from '../languages/defaultDocumentColorsComputer.ts';
import { FindSectionHeaderOptions, SectionHeader, findSectionHeaders } from './findSectionHeaders.ts';
import { IRawModelData, IWorkerTextModelSyncChannelServer } from './textModelSync/textModelSync.protocol.ts';
import { ICommonModel, WorkerTextModelSyncServer } from './textModelSync/textModelSync.impl.ts';
import { ISerializedStringEdit, StringEdit } from '../core/edits/stringEdit.ts';
import { StringText } from '../core/text/abstractText.ts';
import { ensureDependenciesAreSet } from '../core/text/positionToOffset.ts';
