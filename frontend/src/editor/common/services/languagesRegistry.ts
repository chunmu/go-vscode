...
import { compareIgnoreCase, regExpLeadsToEndlessLoop } from '../../../base/common/strings.ts';
import { clearPlatformLanguageAssociations, getLanguageIds, registerPlatformLanguageAssociation } from './languagesAssociations.ts';
import { URI } from '../../../base/common/uri.ts';
import { ILanguageIdCodec } from '../languages.ts';
import { LanguageId } from '../encodedTokenAttributes.ts';
import { ModesRegistry, PLAINTEXT_LANGUAGE_ID } from '../languages/modesRegistry.ts';
import { ILanguageExtensionPoint, ILanguageNameIdPair, ILanguageIcon } from '../languages/language.ts';
