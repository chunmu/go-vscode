...
import { LanguagesRegistry } from './languagesRegistry.ts';
import { ILanguageNameIdPair, ILanguageSelection, ILanguageService, ILanguageIcon, ILanguageExtensionPoint } from '../languages/language.ts';
import { ILanguageIdCodec, TokenizationRegistry } from '../languages.ts';
