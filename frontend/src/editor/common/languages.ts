...
import { IReadonlyVSDataTransfer } from '../../base/common/dataTransfer.ts';
...
import { LanguageSelector } from './languageSelector.ts';
import * as model from './model.ts';
import { TokenizationRegistry as TokenizationRegistryImpl } from './tokenizationRegistry.ts';
...
import { EditDeltaInfo } from './textModelEditSource.ts';
