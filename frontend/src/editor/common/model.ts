...
import { WordCharacterClassifier } from './core/wordCharacterClassifier.ts';
...
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelOptionsChangedEvent, IModelTokensChangedEvent, InternalModelContentChangeEvent, ModelFontChangedEvent, ModelInjectedTextChangedEvent, ModelLineHeightChangedEvent } from './textModelEvents.ts';
import { IModelContentChange } from './model/mirrorTextModel.ts';
import { IGuidesTextModelPart } from './textModelGuides.ts';
import { ITokenizationTextModelPart } from './tokenizationTextModelPart.ts';
import { UndoRedoGroup } from '../../platform/undoRedo/common/undoRedo.ts';
import { TokenArray } from './tokens/lineTokens.ts';
import { IEditorModel } from './editorCommon.ts';
