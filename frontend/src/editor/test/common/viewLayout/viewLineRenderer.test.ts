...
import { CharacterMapping, DomPosition, IRenderLineInputOptions, RenderLineInput, RenderLineOutput2, renderViewLine2 as renderViewLine } from '../../../common/viewLayout/viewLineRenderer.ts';
import { InlineDecorationType } from '../../../common/viewModel/inlineDecorations.ts';
import { TestLineToken, TestLineTokens } from '../core/testLineToken.ts';
