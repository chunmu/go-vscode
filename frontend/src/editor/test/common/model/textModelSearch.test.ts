...
import { getMapForWordSeparators } from '../../../common/core/wordCharacterClassifier.ts';
import { USUAL_WORD_SEPARATORS } from '../../../common/core/wordHelper.ts';
import { EndOfLineSequence, FindMatch, SearchData } from '../../../common/model.ts';
import { TextModel } from '../../../common/model/textModel.ts';
import { SearchParams, TextModelSearch, isMultilineRegexSource } from '../../../common/model/textModelSearch.ts';
