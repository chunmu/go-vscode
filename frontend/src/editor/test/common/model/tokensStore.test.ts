...
import { ColorId, FontStyle, MetadataConsts, TokenMetadata } from '../../../common/encodedTokenAttributes.ts';
import { ILanguageConfigurationService, LanguageConfigurationService } from '../../../common/languages/languageConfigurationRegistry.ts';
import { TextModel } from '../../../common/model/textModel.ts';
import { LanguageIdCodec } from '../../../common/services/languagesRegistry.ts';
import { LineTokens } from '../../../common/tokens/lineTokens.ts';
import { SparseMultilineTokens } from '../../../common/tokens/sparseMultilineTokens.ts';
import { SparseTokensStore } from '../../../common/tokens/sparseTokensStore.ts';
import { createModelServices, createTextModel, instantiateTextModel } from '../testTextModel.ts';
