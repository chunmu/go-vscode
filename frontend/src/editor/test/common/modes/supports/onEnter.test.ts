...
import { CharacterPair, IndentAction } from '../../../../common/languages/languageConfiguration.ts';
import { OnEnterSupport } from '../../../../common/languages/supports/onEnter.ts';
import { javascriptOnEnterRules } from './onEnterRules.ts';
