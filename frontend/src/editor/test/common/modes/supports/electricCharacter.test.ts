...
import { BracketElectricCharacterSupport, IElectricAction } from '../../../../common/languages/supports/electricCharacter.ts';
import { RichEditBrackets } from '../../../../common/languages/supports/richEditBrackets.ts';
import { TokenText, createFakeScopedLineTokens } from '../../modesTestUtils.ts';
