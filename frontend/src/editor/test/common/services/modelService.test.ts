...
import { DefaultEndOfLine, ITextBuffer, ITextBufferFactory, ITextSnapshot } from '../../../common/model.ts';
import { createTextBuffer } from '../../../common/model/textModel.ts';
...
import { createModelServices, createTextModel } from '../testTextModel.ts';
