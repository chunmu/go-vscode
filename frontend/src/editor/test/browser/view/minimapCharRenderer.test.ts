...
import { MinimapCharRendererFactory } from '../../../browser/viewParts/minimap/minimapCharRendererFactory.ts';
import { Constants } from '../../../browser/viewParts/minimap/minimapCharSheet.ts';
