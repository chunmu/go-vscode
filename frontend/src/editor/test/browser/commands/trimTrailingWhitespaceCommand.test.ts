...
import { TrimTrailingWhitespaceCommand, trimTrailingWhitespace } from '../../../common/commands/trimTrailingWhitespaceCommand.ts';
...
import { EncodedTokenizationResult, ITokenizationSupport, TokenizationRegistry } from '../../../common/languages.ts';
import { ILanguageService } from '../../../common/languages/language.ts';
import { NullState } from '../../../common/languages/nullTokenize.ts';
import { getEditOperation } from '../testCommand.ts';
import { createModelServices, instantiateTextModel, withEditorModel } from '../../common/testTextModel.ts';
