...
import { SimplePagedScreenReaderStrategy } from '../../../browser/controller/editContext/screenReaderUtils.ts';
import { ISimpleModel } from '../../../common/viewModel/screenReaderSimpleModel.ts';
import { TextAreaState } from '../../../browser/controller/editContext/textArea/textAreaEditContextState.ts';
import { ITextAreaInputHost, TextAreaInput, TextAreaWrapper } from '../../../browser/controller/editContext/textArea/textAreaEditContextInput.ts';
