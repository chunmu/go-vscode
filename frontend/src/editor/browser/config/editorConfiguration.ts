...
import { ElementSizeObserver } from './elementSizeObserver.ts';
import { FontMeasurements } from './fontMeasurements.ts';
import { migrateOptions } from './migrateOptions.ts';
import { TabFocus } from './tabFocus.ts';
import { ComputeOptionsMemory, ConfigurationChangedEvent, EditorOption, editorOptionsRegistry, FindComputedEditorOptionValueById, IComputedEditorOptions, IEditorOptions, IEnvironmentalOptions } from '../../common/config/editorOptions.ts';
import { EditorZoom } from '../../common/config/editorZoom.ts';
import { BareFontInfo, FontInfo, IValidatedEditorOptions } from '../../common/config/fontInfo.ts';
import { createBareFontInfoFromValidatedSettings } from '../../common/config/fontInfoFromSettings.ts';
...
import { getWindow, getWindowById } from '../../../base/browser/dom.ts';
