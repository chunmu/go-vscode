...
import { ICodeEditor, IDiffEditor } from './editorBrowser.ts';
import { ICodeEditorService } from './services/codeEditorService.ts';
import { Position } from '../common/core/position.ts';
import { IEditorContribution, IDiffEditorContribution } from '../common/editorCommon.ts';
...
import { MenuId, MenuRegistry, Action2 } from '../../platform/actions/common/actions.ts';
import { CommandsRegistry, ICommandMetadata } from '../../platform/commands/common/commands.ts';
import { ContextKeyExpr, IContextKeyService, ContextKeyExpression } from '../../platform/contextkey/common/contextkey.ts';
import { ServicesAccessor as InstantiationServicesAccessor, BrandedService, IInstantiationService, IConstructorSignature } from '../../platform/instantiation/common/instantiation.ts';
import { IKeybindings, KeybindingsRegistry, KeybindingWeight } from '../../platform/keybinding/common/keybindingsRegistry.ts';
...
import { getActiveElement } from '../../base/browser/dom.ts';
import { TriggerInlineEditCommandsRegistry } from './triggerInlineEditCommandsRegistry.ts';
