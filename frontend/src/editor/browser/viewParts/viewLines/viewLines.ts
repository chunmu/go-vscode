...
import { HorizontalPosition, HorizontalRange, IViewLines, LineVisibleRanges, VisibleRanges } from '../../view/renderingContext.ts';
import { VisibleLinesCollection } from '../../view/viewLayer.ts';
import { PartFingerprint, PartFingerprints, ViewPart } from '../../view/viewPart.ts';
import { DomReadingContext } from './domReadingContext.ts';
import { ViewLine } from './viewLine.ts';
...
import { Viewport } from '../../../common/viewModel.ts';
import { ViewContext } from '../../../common/viewModel/viewContext.ts';
import { ViewLineOptions } from './viewLineOptions.ts';
