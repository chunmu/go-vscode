...
import { IVisibleLine } from '../../view/viewLayer.ts';
import { RangeUtil } from './rangeUtil.ts';
import { StringBuilder } from '../../../common/core/stringBuilder.ts';
import { FloatHorizontalRange, VisibleRanges } from '../../view/renderingContext.ts';
import { LineDecoration } from '../../../common/viewLayout/lineDecorations.ts';
import { CharacterMapping, ForeignElementType, RenderLineInput, renderViewLine, DomPosition, RenderWhitespace } from '../../../common/viewLayout/viewLineRenderer.ts';
...
import { EditorFontLigatures } from '../../../common/config/editorOptions.ts';
import { DomReadingContext } from './domReadingContext.ts';
import type { ViewLineOptions } from './viewLineOptions.ts';
...
import { TextDirection } from '../../../common/model.ts';
