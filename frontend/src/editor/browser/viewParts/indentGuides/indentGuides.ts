...
import { EditorOption, InternalGuidesOptions } from '../../../common/config/editorOptions.ts';
...
import { BracketPairGuidesClassNames } from '../../../common/model/guidesTextModelPart.ts';
import { IndentGuide, HorizontalGuidesState } from '../../../common/textModelGuides.ts';
