...
import { GlobalPointerMoveMonitor } from '../../../../base/browser/globalPointerMoveMonitor.ts';
import { CharCode } from '../../../../base/common/charCode.ts';
import { IDisposable, Disposable } from '../../../../base/common/lifecycle.ts';
import * as platform from '../../../../base/common/platform.ts';
import * as strings from '../../../../base/common/strings.ts';
import { ILine, RenderedLinesCollection } from '../../view/viewLayer.ts';
import { PartFingerprint, PartFingerprints, ViewPart } from '../../view/viewPart.ts';
import { RenderMinimap, EditorOption, MINIMAP_GUTTER_WIDTH, EditorLayoutInfoComputer } from '../../../common/config/editorOptions.ts';
import { Range } from '../../../common/core/range.ts';
import { RGBA8 } from '../../../common/core/misc/rgba.ts';
import { ScrollType } from '../../../common/editorCommon.ts';
import { IEditorConfiguration } from '../../../common/config/editorConfiguration.ts';
import { ColorId } from '../../../common/encodedTokenAttributes.ts';
import { MinimapCharRenderer } from './minimapCharRenderer.ts';
import { Constants } from './minimapCharSheet.ts';
import { MinimapTokensColorTracker } from '../../../common/viewModel/minimapTokensColorTracker.ts';
...
import { EditorTheme } from '../../../common/editorTheme.ts';
import * as viewEvents from '../../../common/viewEvents.ts';
import { ViewLineData } from '../../../common/viewModel.ts';
import { minimapSelection, minimapBackground, minimapForegroundOpacity, editorForeground } from '../../../../platform/theme/common/colorRegistry.ts';
import { ModelDecorationMinimapOptions } from '../../../common/model/textModel.ts';
import { Selection } from '../../../common/core/selection.ts';
import { Color } from '../../../../base/common/color.ts';
import { GestureEvent, EventType, Gesture } from '../../../../base/browser/touch.ts';
import { MinimapCharRendererFactory } from './minimapCharRendererFactory.ts';
import { MinimapPosition, MinimapSectionHeaderStyle, TextModelResolvedOptions } from '../../../common/model.ts';
...
import { ViewModelDecoration } from '../../../common/viewModel/viewModelDecoration.ts';
