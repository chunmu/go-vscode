...
import { autorun, runOnChange } from '../../../../base/common/observable.ts';
...
import { TextureAtlasPage } from '../../gpu/atlas/textureAtlasPage.ts';
import { BindingId, type IGpuRenderStrategy } from '../../gpu/gpu.ts';
import { GPULifecycle } from '../../gpu/gpuDisposable.ts';
import { quadVertices } from '../../gpu/gpuUtils.ts';
import { ViewGpuContext } from '../../gpu/viewGpuContext.ts';
import { FloatHorizontalRange, HorizontalPosition, HorizontalRange, IViewLines, LineVisibleRanges, RenderingContext, RestrictedRenderingContext, VisibleRanges } from '../../view/renderingContext.ts';
import { ViewPart } from '../../view/viewPart.ts';
import { ViewLineOptions } from '../viewLines/viewLineOptions.ts';
import type * as viewEvents from '../../../common/viewEvents.ts';
import { CursorColumns } from '../../../common/core/cursorColumns.ts';
import { TextureAtlas } from '../../gpu/atlas/textureAtlas.ts';
import { createContentSegmenter, type IContentSegmenter } from '../../gpu/contentSegmenter.ts';
import { ViewportRenderStrategy } from '../../gpu/renderStrategy/viewportRenderStrategy.ts';
import { FullFileRenderStrategy } from '../../gpu/renderStrategy/fullFileRenderStrategy.ts';
import { MutableDisposable } from '../../../../base/common/lifecycle.ts';
import type { ViewLineRenderingData } from '../../../common/viewModel.ts';
import { GlyphRasterizer } from '../../gpu/raster/glyphRasterizer.ts';
