...
import { IOverviewRulerLayoutInfo, SmoothScrollableElement } from '../../../../base/browser/ui/scrollbar/scrollableElement.ts';
import { ScrollableElementChangeOptions, ScrollableElementCreationOptions } from '../../../../base/browser/ui/scrollbar/scrollableElementOptions.ts';
import { PartFingerprint, PartFingerprints, ViewPart } from '../../view/viewPart.ts';
import { INewScrollPosition, ScrollType } from '../../../common/editorCommon.ts';
...
import { getThemeTypeSelector } from '../../../../platform/theme/common/themeService.ts';
