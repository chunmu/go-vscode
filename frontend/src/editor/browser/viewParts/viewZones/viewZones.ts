...
import { IViewZone, IViewZoneChangeAccessor } from '../../editorBrowser.ts';
...
import { IEditorWhitespace, IViewWhitespaceViewportData, IWhitespaceChangeAccessor } from '../../../common/viewModel.ts';
