...
import { RenderLineNumbersType, EditorOption } from '../../../common/config/editorOptions.ts';
...
import { editorDimmedLineNumber, editorLineNumbers } from '../../../common/core/editorColorRegistry.ts';
