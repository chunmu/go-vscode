...
import { HorizontalRange, LineVisibleRanges, RenderingContext } from '../../view/renderingContext.ts';
import { ViewContext } from '../../../common/viewModel/viewContext.ts';
import * as viewEvents from '../../../common/viewEvents.ts';
import { editorSelectionForeground } from '../../../../platform/theme/common/colorRegistry.ts';
