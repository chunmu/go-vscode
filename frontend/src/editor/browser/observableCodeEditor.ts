...
import { equalsIfDefined, itemsEquals } from '../../base/common/equals.ts';
import { Disposable, DisposableStore, IDisposable, toDisposable } from '../../base/common/lifecycle.ts';
import { DebugLocation, IObservable, IObservableWithChange, IReader, ITransaction, TransactionImpl, autorun, autorunOpts, derived, derivedOpts, derivedWithSetter, observableFromEvent, observableSignal, observableSignalFromEvent, observableValue, observableValueOpts } from '../../base/common/observable.ts';
import { EditorOption, FindComputedEditorOptionValueById } from '../common/config/editorOptions.ts';
...
import { ICursorSelectionChangedEvent } from '../common/cursorEvents.ts';
import { IModelDeltaDecoration, ITextModel } from '../common/model.ts';
import { IModelContentChangedEvent } from '../common/textModelEvents.ts';
import { ContentWidgetPositionPreference, ICodeEditor, IContentWidget, IContentWidgetPosition, IEditorMouseEvent, IOverlayWidget, IOverlayWidgetPosition, IPasteEvent } from './editorBrowser.ts';
