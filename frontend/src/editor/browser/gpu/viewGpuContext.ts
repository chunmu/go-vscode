...
import { addDisposableListener, getActiveWindow } from '../../../base/browser/dom.ts';
import { createFastDomNode, type FastDomNode } from '../../../base/browser/fastDomNode.ts';
...
import { observableValue, runOnChange, type IObservable } from '../../../base/common/observable.ts';
import { IInstantiationService } from '../../../platform/instantiation/common/instantiation.ts';
import { TextureAtlas } from './atlas/textureAtlas.ts';
import { IConfigurationService } from '../../../platform/configuration/common/configuration.ts';
import { INotificationService, IPromptChoice, Severity } from '../../../platform/notification/common/notification.ts';
import { GPULifecycle } from './gpuDisposable.ts';
import { ensureNonNullable, observeDevicePixelDimensions } from './gpuUtils.ts';
import { RectangleRenderer } from './rectangleRenderer.ts';
import type { ViewContext } from '../../common/viewModel/viewContext.ts';
import { DecorationCssRuleExtractor } from './css/decorationCssRuleExtractor.ts';
import { Event } from '../../../base/common/event.ts';
import { EditorOption, type IEditorOptions } from '../../common/config/editorOptions.ts';
import { DecorationStyleCache } from './css/decorationStyleCache.ts';
