...
import { Disposable, dispose, MutableDisposable, toDisposable } from '../../../../base/common/lifecycle.ts';
import { NKeyMap } from '../../../../base/common/map.ts';
...
import type { DecorationStyleCache } from '../css/decorationStyleCache.ts';
import { GlyphRasterizer } from '../raster/glyphRasterizer.ts';
import type { IGlyphRasterizer } from '../raster/raster.ts';
import { IdleTaskQueue, type ITaskQueue } from '../taskQueue.ts';
import type { IReadableTextureAtlasPage, ITextureAtlasPageGlyph, GlyphMap } from './atlas.ts';
import { AllocatorType, TextureAtlasPage } from './textureAtlasPage.ts';
