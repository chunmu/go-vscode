...
import type { IBoundingBox, IGlyphRasterizer } from '../raster/raster.ts';
import type { IReadableTextureAtlasPage, ITextureAtlasAllocator, ITextureAtlasPageGlyph, GlyphMap } from './atlas.ts';
import { TextureAtlasShelfAllocator } from './textureAtlasShelfAllocator.ts';
import { TextureAtlasSlabAllocator } from './textureAtlasSlabAllocator.ts';
