...
import { Disposable, dispose, toDisposable, type IDisposable } from '../../../base/common/lifecycle.ts';
import { LinkedList } from '../../../base/common/linkedList.ts';
import { BufferDirtyTracker, type IBufferDirtyTrackerReader } from './bufferDirtyTracker.ts';
