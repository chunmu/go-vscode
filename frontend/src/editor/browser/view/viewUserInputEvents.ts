...
import { IEditorMouseEvent, IMouseTarget, IMouseTargetViewZoneData, IPartialEditorMouseEvent, MouseTargetType } from '../editorBrowser.ts';
import { IMouseWheelEvent } from '../../../base/browser/mouseEvent.ts';
import { Position } from '../../common/core/position.ts';
import { ICoordinatesConverter } from '../../common/coordinatesConverter.ts';
