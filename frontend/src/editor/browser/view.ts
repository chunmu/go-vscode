...
import { FastDomNode, createFastDomNode } from '../../base/browser/fastDomNode.ts';
import { IMouseWheelEvent } from '../../base/browser/mouseEvent.ts';
import { inputLatency } from '../../base/browser/performance.ts';
import { CodeWindow } from '../../base/browser/window.ts';
import { BugIndicatingError, onUnexpectedError } from '../../base/common/errors.ts';
import { Disposable, IDisposable } from '../../base/common/lifecycle.ts';
import { IPointerHandlerHelper } from './controller/mouseHandler.ts';
import { PointerHandlerLastRenderData } from './controller/mouseTarget.ts';
import { PointerHandler } from './controller/pointerHandler.ts';
import { IContentWidget, IContentWidgetPosition, IEditorAriaOptions, IGlyphMarginWidget, IGlyphMarginWidgetPosition, IMouseTarget, IOverlayWidget, IOverlayWidgetPosition, IViewZoneChangeAccessor } from './editorBrowser.ts';
import { LineVisibleRanges, RenderingContext, RestrictedRenderingContext } from './view/renderingContext.ts';
import { ICommandDelegate, ViewController } from './view/viewController.ts';
import { ContentViewOverlays, MarginViewOverlays } from './view/viewOverlays.ts';
import { PartFingerprint, PartFingerprints, ViewPart } from './view/viewPart.ts';
import { ViewUserInputEvents } from './view/viewUserInputEvents.ts';
import { BlockDecorations } from './viewParts/blockDecorations/blockDecorations.ts';
import { ViewContentWidgets } from './viewParts/contentWidgets/contentWidgets.ts';
import { CurrentLineHighlightOverlay, CurrentLineMarginHighlightOverlay } from './viewParts/currentLineHighlight/currentLineHighlight.ts';
import { DecorationsOverlay } from './viewParts/decorations/decorations.ts';
import { EditorScrollbar } from './viewParts/editorScrollbar/editorScrollbar.ts';
import { GlyphMarginWidgets } from './viewParts/glyphMargin/glyphMargin.ts';
import { IndentGuidesOverlay } from './viewParts/indentGuides/indentGuides.ts';
import { LineNumbersOverlay } from './viewParts/lineNumbers/lineNumbers.ts';
import { ViewLines } from './viewParts/viewLines/viewLines.ts';
import { LinesDecorationsOverlay } from './viewParts/linesDecorations/linesDecorations.ts';
import { Margin } from './viewParts/margin/margin.ts';
import { MarginViewLineDecorationsOverlay } from './viewParts/marginDecorations/marginDecorations.ts';
import { Minimap } from './viewParts/minimap/minimap.ts';
import { ViewOverlayWidgets } from './viewParts/overlayWidgets/overlayWidgets.ts';
import { DecorationsOverviewRuler } from './viewParts/overviewRuler/decorationsOverviewRuler.ts';
import { OverviewRuler } from './viewParts/overviewRuler/overviewRuler.ts';
import { Rulers } from './viewParts/rulers/rulers.ts';
import { ScrollDecorationViewPart } from './viewParts/scrollDecoration/scrollDecoration.ts';
import { SelectionsOverlay } from './viewParts/selections/selections.ts';
import { ViewCursors } from './viewParts/viewCursors/viewCursors.ts';
import { ViewZones } from './viewParts/viewZones/viewZones.ts';
import { WhitespaceOverlay } from './viewParts/whitespace/whitespace.ts';
import { IEditorConfiguration } from '../common/config/editorConfiguration.ts';
...
import { ScrollType } from '../common/editorCommon.ts';
import { GlyphMarginLane, IGlyphMarginLanesModel } from '../common/model.ts';
import { ViewEventHandler } from '../common/viewEventHandler.ts';
import * as viewEvents from '../common/viewEvents.ts';
import { ViewportData } from '../common/viewLayout/viewLinesViewportData.ts';
import { IViewModel } from '../common/viewModel.ts';
import { ViewContext } from '../common/viewModel/viewContext.ts';
import { IInstantiationService } from '../../platform/instantiation/common/instantiation.ts';
import { IColorTheme, getThemeTypeSelector } from '../../platform/theme/common/themeService.ts';
import { ViewGpuContext } from './gpu/viewGpuContext.ts';
import { ViewLinesGpu } from './viewParts/viewLinesGpu/viewLinesGpu.ts';
import { AbstractEditContext } from './controller/editContext/editContext.ts';
import { IVisibleRangeProvider, TextAreaEditContext } from './controller/editContext/textArea/textAreaEditContext.ts';
import { NativeEditContext } from './controller/editContext/native/nativeEditContext.ts';
import { RulersGpu } from './viewParts/rulersGpu/rulersGpu.ts';
import { GpuMarkOverlay } from './viewParts/gpuMark/gpuMark.ts';
