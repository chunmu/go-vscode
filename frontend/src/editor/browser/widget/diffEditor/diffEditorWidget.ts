 ...
 *--------------------------------------------------------------------------------------------*/
import { getWindow, h } from '../../../../base/browser/dom.ts';
...
import { IObservable, ITransaction, autorun, autorunWithStore, derived, derivedDisposable, disposableObservableValue, observableFromEvent, observableValue, recomputeInitiallyAndOnChange, subtransaction, transaction } from '../../../../base/common/observable.ts';
...
import { CursorChangeReason, ICursorPositionChangedEvent } from '../../../common/cursorEvents.ts';
import { IDiffComputationResult, ILineChange } from '../../../common/diff/legacyLinesDiffComputer.ts';
import { LineRangeMapping, RangeMapping } from '../../../common/diff/rangeMapping.ts';
import { EditorType, IDiffEditorModel, IDiffEditorViewModel, IDiffEditorViewState } from '../../../common/editorCommon.ts';
import { EditorContextKeys } from '../../../common/editorContextKeys.ts';
import { IIdentifiedSingleEditOperation } from '../../../common/model.ts';
import { IEditorConstructionOptions } from '../../config/editorConfiguration.ts';
import { ICodeEditor, IDiffEditor, IDiffEditorConstructionOptions } from '../../editorBrowser.ts';
import { EditorExtensionsRegistry, IDiffEditorContributionDescription } from '../../editorExtensions.ts';
import { ICodeEditorService } from '../../services/codeEditorService.ts';
import { StableEditorScrollState } from '../../stableEditorScroll.ts';
import { CodeEditorWidget, ICodeEditorWidgetOptions } from '../codeEditor/codeEditorWidget.ts';
import { AccessibleDiffViewer, AccessibleDiffViewerModelFromEditors } from './components/accessibleDiffViewer.ts';
import { DiffEditorDecorations } from './components/diffEditorDecorations.ts';
import { DiffEditorEditors } from './components/diffEditorEditors.ts';
import { DiffEditorSash, SashLayout } from './components/diffEditorSash.ts';
import { DiffEditorViewZones } from './components/diffEditorViewZones/diffEditorViewZones.ts';
import { DelegatingEditor } from './delegatingEditorImpl.ts';
import { DiffEditorOptions } from './diffEditorOptions.ts';
import { DiffEditorViewModel, DiffMapping, DiffState } from './diffEditorViewModel.ts';
import { DiffEditorGutter } from './features/gutterFeature.ts';
import { HideUnchangedRegionsFeature } from './features/hideUnchangedRegionsFeature.ts';
import { MovedBlocksLinesFeature } from './features/movedBlocksLinesFeature.ts';
import { OverviewRulerFeature } from './features/overviewRulerFeature.ts';
import { RevertButtonsFeature } from './features/revertButtonsFeature.ts';
import './style.css';
import { CSSStyle, ObservableElementSizeObserver, RefCounted, applyStyle, applyViewZones, translatePosition } from './utils.ts';
