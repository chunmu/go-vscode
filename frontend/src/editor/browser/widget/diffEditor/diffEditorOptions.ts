...
import { IObservable, IObservableWithChange, ISettableObservable, derived, derivedConstOnceDefined, observableFromEvent, observableValue } from '../../../../base/common/observable.ts';
...
import { diffEditorDefaultOptions } from '../../../common/config/diffEditor.ts';
import { IDiffEditorBaseOptions, IDiffEditorOptions, IEditorOptions, ValidDiffEditorBaseOptions, clampedFloat, clampedInt, boolean as validateBooleanOption, stringSet as validateStringSetOption } from '../../../common/config/editorOptions.ts';
import { LineRangeMapping } from '../../../common/diff/rangeMapping.ts';
import { allowsTrueInlineDiffRendering } from './components/diffEditorViewZones/diffEditorViewZones.ts';
import { DiffEditorViewModel, DiffState } from './diffEditorViewModel.ts';
