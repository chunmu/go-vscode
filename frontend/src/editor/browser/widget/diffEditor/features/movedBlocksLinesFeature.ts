...
import { booleanComparator, compareBy, numberComparator, tieBreakComparators } from '../../../../../base/common/arrays.ts';
import { findMaxIdx } from '../../../../../base/common/arraysFind.ts';
import { Codicon } from '../../../../../base/common/codicons.ts';
import { Disposable, toDisposable } from '../../../../../base/common/lifecycle.ts';
import { IObservable, autorun, autorunHandleChanges, autorunWithStore, constObservable, derived, observableFromEvent, observableSignalFromEvent, observableValue, recomputeInitiallyAndOnChange } from '../../../../../base/common/observable.ts';
...
import { PlaceholderViewZone, ViewZoneOverlayWidget, applyStyle, applyViewZones } from '../utils.ts';
import { EditorLayoutInfo } from '../../../../common/config/editorOptions.ts';
import { LineRange } from '../../../../common/core/ranges/lineRange.ts';
import { OffsetRange, OffsetRangeSet } from '../../../../common/core/ranges/offsetRange.ts';
