...
import { EventType, addDisposableListener, h } from '../../../../../base/browser/dom.ts';
...
import { IObservable, autorun, autorunWithStore, derived, derivedDisposable, derivedWithSetter, observableFromEvent, observableValue } from '../../../../../base/common/observable.ts';
...
import { LineRange, LineRangeSet } from '../../../../common/core/ranges/lineRange.ts';
...
import { ActionRunnerWithContext } from '../../multiDiffEditor/utils.ts';
...
import { DiffEditorViewModel } from '../diffEditorViewModel.ts';
import { appendRemoveOnDispose, applyStyle, prependRemoveOnDispose } from '../utils.ts';
import { EditorGutter, IGutterItemInfo, IGutterItemView } from '../utils/editorGutter.ts';
