...
import { $, addDisposableListener, getWindow, h, reset } from '../../../../../base/browser/dom.ts';
...
import { IObservable, IReader, autorun, derived, derivedDisposable, observableValue, transaction } from '../../../../../base/common/observable.ts';
...
import { SymbolKind, SymbolKinds } from '../../../../common/languages.ts';
import { IModelDecorationOptions, IModelDeltaDecoration, ITextModel } from '../../../../common/model.ts';
import { ICodeEditor } from '../../../editorBrowser.ts';
import { observableCodeEditor } from '../../../observableCodeEditor.ts';
import { DiffEditorEditors } from '../components/diffEditorEditors.ts';
import { DiffEditorOptions } from '../diffEditorOptions.ts';
import { DiffEditorViewModel, RevealPreference, UnchangedRegion } from '../diffEditorViewModel.ts';
import { IObservableViewZone, PlaceholderViewZone, ViewZoneOverlayWidget, applyObservableDecorations, applyStyle } from '../utils.ts';
