...
import { IDimension } from '../../../../base/browser/dom.ts';
import { findLast } from '../../../../base/common/arraysFind.ts';
import { CancellationTokenSource } from '../../../../base/common/cancellation.ts';
import { Disposable, DisposableStore, IDisposable, IReference, toDisposable } from '../../../../base/common/lifecycle.ts';
import { IObservable, IObservableWithChange, ISettableObservable, autorun, autorunHandleChanges, autorunOpts, autorunWithStore, observableValue, transaction } from '../../../../base/common/observable.ts';
import { ElementSizeObserver } from '../../config/elementSizeObserver.ts';
import { ICodeEditor, IOverlayWidget, IViewZone } from '../../editorBrowser.ts';
