...
import { IObservable, derived } from '../../../../../base/common/observable.ts';
import { DiffEditorEditors } from './diffEditorEditors.ts';
import { allowsTrueInlineDiffRendering } from './diffEditorViewZones/diffEditorViewZones.ts';
...
import { applyObservableDecorations } from '../utils.ts';
