...
import { addDisposableListener, addStandardDisposableListener, reset } from '../../../../../base/browser/dom.ts';
...
import { forEachAdjacent, groupAdjacentBy } from '../../../../../base/common/arrays.ts';
...
import { IObservable, ITransaction, autorun, autorunWithStore, derived, observableValue, subtransaction, transaction } from '../../../../../base/common/observable.ts';
import { ThemeIcon } from '../../../../../base/common/themables.ts';
import { applyFontInfo } from '../../../config/domFontInfo.ts';
import { applyStyle } from '../utils.ts';
...
import { DetailedLineRangeMapping, LineRangeMapping } from '../../../../common/diff/rangeMapping.ts';
import { ILanguageIdCodec } from '../../../../common/languages.ts';
import { ILanguageService } from '../../../../common/languages/language.ts';
import { ITextModel, TextModelResolvedOptions } from '../../../../common/model.ts';
import { LineTokens } from '../../../../common/tokens/lineTokens.ts';
import { RenderLineInput, renderViewLine2 } from '../../../../common/viewLayout/viewLineRenderer.ts';
import { ViewLineRenderingData } from '../../../../common/viewModel.ts';
