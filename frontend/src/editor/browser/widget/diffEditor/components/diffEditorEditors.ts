...
import { IReader, autorunHandleChanges, derived, derivedOpts, observableFromEvent } from '../../../../../base/common/observable.ts';
import { IEditorConstructionOptions } from '../../../config/editorConfiguration.ts';
import { IDiffEditorConstructionOptions } from '../../../editorBrowser.ts';
...
import { IDiffCodeEditorWidgetOptions } from '../diffEditorWidget.ts';
import { OverviewRulerFeature } from '../features/overviewRulerFeature.ts';
import { EditorOptions, IEditorOptions } from '../../../../common/config/editorOptions.ts';
import { Position } from '../../../../common/core/position.ts';
import { IContentSizeChangedEvent } from '../../../../common/editorCommon.ts';
