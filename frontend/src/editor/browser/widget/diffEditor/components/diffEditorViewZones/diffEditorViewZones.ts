...
import { IObservable, autorun, derived, observableFromEvent, observableValue } from '../../../../../../base/common/observable.ts';
import { ThemeIcon } from '../../../../../../base/common/themables.ts';
import { assertReturnsDefined } from '../../../../../../base/common/types.ts';
import { applyFontInfo } from '../../../../config/domFontInfo.ts';
import { CodeEditorWidget } from '../../../codeEditor/codeEditorWidget.ts';
import { diffDeleteDecoration, diffRemoveIcon } from '../../registrations.contribution.ts';
import { DiffEditorEditors } from '../diffEditorEditors.ts';
import { DiffEditorViewModel, DiffMapping } from '../../diffEditorViewModel.ts';
import { DiffEditorWidget } from '../../diffEditorWidget.ts';
import { InlineDiffDeletedCodeMargin } from './inlineDiffDeletedCodeMargin.ts';
import { LineSource, RenderOptions, renderLines } from './renderLines.ts';
import { IObservableViewZone, animatedObservable, joinCombine } from '../../utils.ts';
...
import { BackgroundTokenizationState } from '../../../../../common/tokenizationTextModelPart.ts';
