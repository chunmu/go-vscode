...
import { IObservable, IReader, ISettableObservable, ITransaction, autorun, autorunWithStore, derived, observableSignal, observableSignalFromEvent, observableValue, transaction, waitForState } from '../../../../base/common/observable.ts';
import { IDiffProviderFactoryService } from './diffProviderFactoryService.ts';
import { filterWithPrevious } from './utils.ts';
import { readHotReloadableExport } from '../../../../base/common/hotReloadHelpers.ts';
import { ISerializedLineRange, LineRange, LineRangeSet } from '../../../common/core/ranges/lineRange.ts';
import { DefaultLinesDiffComputer } from '../../../common/diff/defaultLinesDiffComputer/defaultLinesDiffComputer.ts';
import { IDocumentDiff } from '../../../common/diff/documentDiffProvider.ts';
import { MovedText } from '../../../common/diff/linesDiffComputer.ts';
import { DetailedLineRangeMapping, LineRangeMapping, RangeMapping } from '../../../common/diff/rangeMapping.ts';
import { IDiffEditorModel, IDiffEditorViewModel } from '../../../common/editorCommon.ts';
import { ITextModel } from '../../../common/model.ts';
import { TextEditInfo } from '../../../common/model/bracketPairsTextModelPart/bracketPairsTree/beforeEditPositionMapper.ts';
import { combineTextEditInfos } from '../../../common/model/bracketPairsTextModelPart/bracketPairsTree/combineTextEditInfos.ts';
import { DiffEditorOptions } from './diffEditorOptions.ts';
import { optimizeSequenceDiffs } from '../../../common/diff/defaultLinesDiffComputer/heuristicSequenceOptimizations.ts';
import { isDefined } from '../../../../base/common/types.ts';
import { groupAdjacentBy } from '../../../../base/common/arrays.ts';
import { softAssert } from '../../../../base/common/assert.ts';
