...
import '../../services/markerDecorations.ts';
...
import { Emitter, EmitterOptions, Event, EventDeliveryQueue, createEventDeliveryQueue } from '../../../../base/common/event.ts';
import { hash } from '../../../../base/common/hash.ts';
import { Disposable, DisposableStore, IDisposable, dispose } from '../../../../base/common/lifecycle.ts';
import { Schemas } from '../../../../base/common/network.ts';
import './editor.css';
import { applyFontInfo } from '../../config/domFontInfo.ts';
import { EditorConfiguration, IEditorConstructionOptions } from '../../config/editorConfiguration.ts';
import { TabFocus } from '../../config/tabFocus.ts';
import * as editorBrowser from '../../editorBrowser.ts';
import { EditorExtensionsRegistry, IEditorContributionDescription } from '../../editorExtensions.ts';
import { ICodeEditorService } from '../../services/codeEditorService.ts';
import { IContentWidgetData, IGlyphMarginWidgetData, IOverlayWidgetData, View } from '../../view.ts';
import { DOMLineBreaksComputerFactory } from '../../view/domLineBreaksComputer.ts';
import { ICommandDelegate } from '../../view/viewController.ts';
import { ViewUserInputEvents } from '../../view/viewUserInputEvents.ts';
import { CodeEditorContributions } from './codeEditorContributions.ts';
import { IEditorConfiguration } from '../../../common/config/editorConfiguration.ts';
import { ConfigurationChangedEvent, EditorLayoutInfo, EditorOption, FindComputedEditorOptionValueById, IComputedEditorOptions, IEditorOptions, filterFontDecorations, filterValidationDecorations } from '../../../common/config/editorOptions.ts';
import { CursorColumns } from '../../../common/core/cursorColumns.ts';
import { IDimension } from '../../../common/core/2d/dimension.ts';
import { editorUnnecessaryCodeOpacity } from '../../../common/core/editorColorRegistry.ts';
import { IPosition, Position } from '../../../common/core/position.ts';
import { IRange, Range } from '../../../common/core/range.ts';
import { ISelection, Selection } from '../../../common/core/selection.ts';
import { IWordAtPosition } from '../../../common/core/wordHelper.ts';
import { WordOperations } from '../../../common/cursor/cursorWordOperations.ts';
import { CursorChangeReason, ICursorPositionChangedEvent, ICursorSelectionChangedEvent } from '../../../common/cursorEvents.ts';
import { InternalEditorAction } from '../../../common/editorAction.ts';
import * as editorCommon from '../../../common/editorCommon.ts';
...
import { EndOfLinePreference, IAttachedView, ICursorStateComputer, IIdentifiedSingleEditOperation, IModelDecoration, IModelDecorationOptions, IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel } from '../../../common/model.ts';
import { ClassName } from '../../../common/model/intervalTree.ts';
import { ModelDecorationOptions } from '../../../common/model/textModel.ts';
import { ILanguageFeaturesService } from '../../../common/services/languageFeatures.ts';
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelOptionsChangedEvent, IModelTokensChangedEvent, ModelFontChangedEvent, ModelLineHeightChangedEvent } from '../../../common/textModelEvents.ts';
import { VerticalRevealType } from '../../../common/viewEvents.ts';
import { IEditorWhitespace, IViewModel } from '../../../common/viewModel.ts';
...
import { OutgoingViewModelEventKind } from '../../../common/viewModelEventDispatcher.ts';
import * as nls from '../../../../nls.ts';
import { IAccessibilityService } from '../../../../platform/accessibility/common/accessibility.ts';
import { ICommandService } from '../../../../platform/commands/common/commands.ts';
import { ContextKeyValue, IContextKey, IContextKeyService } from '../../../../platform/contextkey/common/contextkey.ts';
...
import { editorErrorForeground, editorHintForeground, editorInfoForeground, editorWarningForeground } from '../../../../platform/theme/common/colorRegistry.ts';
import { IThemeService, registerThemingParticipant } from '../../../../platform/theme/common/themeService.ts';
import { MenuId } from '../../../../platform/actions/common/actions.ts';
import { TextModelEditSource, EditSources } from '../../../common/textModelEditSource.ts';
