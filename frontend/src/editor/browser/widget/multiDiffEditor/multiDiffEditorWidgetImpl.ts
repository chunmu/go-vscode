...
import { Dimension, getWindow, h, scheduleAtNextAnimationFrame } from '../../../../base/browser/dom.ts';
import { SmoothScrollableElement } from '../../../../base/browser/ui/scrollbar/scrollableElement.ts';
import { compareBy, numberComparator } from '../../../../base/common/arrays.ts';
import { findFirstMax } from '../../../../base/common/arraysFind.ts';
import { BugIndicatingError } from '../../../../base/common/errors.ts';
import { Disposable, IReference, toDisposable } from '../../../../base/common/lifecycle.ts';
import { IObservable, IReader, ITransaction, autorun, autorunWithStore, derived, disposableObservableValue, globalTransaction, observableFromEvent, observableValue, transaction } from '../../../../base/common/observable.ts';
import { Scrollable, ScrollbarVisibility } from '../../../../base/common/scrollable.ts';
import { URI } from '../../../../base/common/uri.ts';
import { localize } from '../../../../nls.ts';
import { ContextKeyValue, IContextKeyService } from '../../../../platform/contextkey/common/contextkey.ts';
...
import { ObservableElementSizeObserver } from '../diffEditor/utils.ts';
import { DiffEditorItemTemplate, TemplateData } from './diffEditorItemTemplate.ts';
import { IDocumentDiffItem } from './model.ts';
import { DocumentDiffItemViewModel, MultiDiffEditorViewModel } from './multiDiffEditorViewModel.ts';
import { RevealOptions } from './multiDiffEditorWidget.ts';
