...
import { IObservable, ITransaction, constObservable, derived, derivedObservableWithWritableCache, mapObservableArrayCached, observableFromValueWithChangeEvent, observableValue, transaction } from '../../../../base/common/observable.ts';
...
import { IDiffEditorViewModel } from '../../../common/editorCommon.ts';
import { IModelService } from '../../../common/services/model.ts';
import { DiffEditorOptions } from '../diffEditor/diffEditorOptions.ts';
import { DiffEditorViewModel } from '../diffEditor/diffEditorViewModel.ts';
