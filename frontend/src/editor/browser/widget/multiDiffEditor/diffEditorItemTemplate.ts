...
import { autorun, derived, globalTransaction, observableValue } from '../../../../base/common/observable.ts';
...
import { IContextKeyService, type IScopedContextKeyService } from '../../../../platform/contextkey/common/contextkey.ts';
...
import { DocumentDiffItemViewModel } from './multiDiffEditorViewModel.ts';
import { IObjectData, IPooledObject } from './objectPool.ts';
import { ActionRunnerWithContext } from './utils.ts';
