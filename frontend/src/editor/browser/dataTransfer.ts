...
import { createFileDataTransferItem, createStringDataTransferItem, IDataTransferItem, UriList, VSDataTransfer } from '../../base/common/dataTransfer.ts';
import { Mimes } from '../../base/common/mime.ts';
import { URI } from '../../base/common/uri.ts';
import { CodeDataTransfers, getPathForFile } from '../../platform/dnd/browser/dnd.ts';
