...
import { EditorOption, IComputedEditorOptions } from '../../../../common/config/editorOptions.ts';
import { EndOfLineSequence } from '../../../../common/model.ts';
import { ViewContext } from '../../../../common/viewModel/viewContext.ts';
import { Selection } from '../../../../common/core/selection.ts';
import { SimplePagedScreenReaderStrategy, ISimpleScreenReaderContentState } from '../screenReaderUtils.ts';
