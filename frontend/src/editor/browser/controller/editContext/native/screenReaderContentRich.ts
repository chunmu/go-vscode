...
import { addDisposableListener, getActiveWindow, isHTMLElement } from '../../../../../base/browser/dom.ts';
...
import { EditorFontLigatures, EditorOption, FindComputedEditorOptionValueById, IComputedEditorOptions } from '../../../../common/config/editorOptions.ts';
...
import { IPagedScreenReaderStrategy } from '../screenReaderUtils.ts';
import { ISimpleModel } from '../../../../common/viewModel/screenReaderSimpleModel.ts';
...
import { IScreenReaderContent } from './screenReaderUtils.ts';
