...
import { ViewConfigurationChangedEvent, ViewCursorStateChangedEvent } from '../../../../common/viewEvents.ts';
...
import { ariaLabelForScreenReaderContent } from '../screenReaderUtils.ts';
import { RichScreenReaderContent } from './screenReaderContentRich.ts';
import { SimpleScreenReaderContent } from './screenReaderContentSimple.ts';
