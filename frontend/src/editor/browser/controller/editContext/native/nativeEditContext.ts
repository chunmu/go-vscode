...
import { isFirefox } from '../../../../../base/browser/browser.ts';
import { addDisposableListener, getActiveElement, getWindow, getWindowId } from '../../../../../base/browser/dom.ts';
...
import { EndOfLinePreference, IModelDeltaDecoration } from '../../../../common/model.ts';
import { ViewConfigurationChangedEvent, ViewCursorStateChangedEvent, ViewDecorationsChangedEvent, ViewFlushedEvent, ViewLinesChangedEvent, ViewLinesDeletedEvent, ViewLinesInsertedEvent, ViewScrollChangedEvent, ViewZonesChangedEvent } from '../../../../common/viewEvents.ts';
import { ViewContext } from '../../../../common/viewModel/viewContext.ts';
import { RestrictedRenderingContext, RenderingContext, HorizontalPosition } from '../../../view/renderingContext.ts';
import { ViewController } from '../../../view/viewController.ts';
import { ClipboardEventUtils, ClipboardStoredMetadata, getDataToCopy, InMemoryClipboardMetadataManager } from '../clipboardUtils.ts';
import { AbstractEditContext } from '../editContext.ts';
import { editContextAddDisposableListener, FocusTracker, ITypeData } from './nativeEditContextUtils.ts';
import { ScreenReaderSupport } from './screenReaderSupport.ts';
...
import { IVisibleRangeProvider } from '../textArea/textAreaEditContext.ts';
import { PositionOffsetTransformer } from '../../../../common/core/text/positionToOffset.ts';
import { EditContext } from './editContextFactory.ts';
import { NativeEditContextRegistry } from './nativeEditContextRegistry.ts';
import { IEditorAriaOptions } from '../../../editorBrowser.ts';
import { isHighSurrogate, isLowSurrogate } from '../../../../../base/common/strings.ts';
