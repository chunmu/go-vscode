...
import { ViewController } from '../../../view/viewController.ts';
import { PartFingerprint, PartFingerprints } from '../../../view/viewPart.ts';
import { LineNumbersOverlay } from '../../../viewParts/lineNumbers/lineNumbers.ts';
import { Margin } from '../../../viewParts/margin/margin.ts';
import { RenderLineNumbersType, EditorOption, IComputedEditorOptions, EditorOptions } from '../../../../common/config/editorOptions.ts';
import { FontInfo } from '../../../../common/config/fontInfo.ts';
...
import { EndOfLinePreference } from '../../../../common/model.ts';
import { RenderingContext, RestrictedRenderingContext, HorizontalPosition, LineVisibleRanges } from '../../../view/renderingContext.ts';
...
import { TokenizationRegistry } from '../../../../common/languages.ts';
import { ColorId, ITokenPresentation } from '../../../../common/encodedTokenAttributes.ts';
import { Color } from '../../../../../base/common/color.ts';
import { IME } from '../../../../../base/common/ime.ts';
import { IKeybindingService } from '../../../../../platform/keybinding/common/keybinding.ts';
import { IInstantiationService } from '../../../../../platform/instantiation/common/instantiation.ts';
import { AbstractEditContext } from '../editContext.ts';
import { ICompositionData, IPasteData, ITextAreaInputHost, TextAreaInput, TextAreaWrapper } from './textAreaEditContextInput.ts';
import { ariaLabelForScreenReaderContent, newlinecount, SimplePagedScreenReaderStrategy } from '../screenReaderUtils.ts';
import { ClipboardDataToCopy, getDataToCopy } from '../clipboardUtils.ts';
import { _debugComposition, ITypeData, TextAreaState } from './textAreaEditContextState.ts';
import { getMapForWordSeparators, WordCharacterClass } from '../../../../common/core/wordCharacterClassifier.ts';
