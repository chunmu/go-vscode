...
import { StandardWheelEvent, IMouseWheelEvent } from '../../../base/browser/mouseEvent.ts';
import { Disposable, IDisposable } from '../../../base/common/lifecycle.ts';
import * as platform from '../../../base/common/platform.ts';
import { HitTestContext, MouseTarget, MouseTargetFactory, PointerHandlerLastRenderData } from './mouseTarget.ts';
import { IMouseTarget, IMouseTargetViewZoneData, MouseTargetType } from '../editorBrowser.ts';
import { ClientCoordinates, EditorMouseEvent, EditorMouseEventFactory, GlobalEditorPointerMoveMonitor, createEditorPagePosition, createCoordinatesRelativeToEditor } from '../editorDom.ts';
...
import { NavigationCommandRevealType } from '../coreCommands.ts';
import { MouseWheelClassifier } from '../../../base/browser/ui/scrollbar/scrollableElement.ts';
import type { ViewLinesGpu } from '../viewParts/viewLinesGpu/viewLinesGpu.ts';
import { TopBottomDragScrolling, LeftRightDragScrolling } from './dragScrolling.ts';
