...
import { EventType, Gesture, GestureEvent } from '../../../base/browser/touch.ts';
import { mainWindow } from '../../../base/browser/window.ts';
import { Disposable } from '../../../base/common/lifecycle.ts';
import * as platform from '../../../base/common/platform.ts';
import { IPointerHandlerHelper, MouseHandler } from './mouseHandler.ts';
import { NavigationCommandRevealType } from '../coreCommands.ts';
import { IMouseTarget, MouseTargetType } from '../editorBrowser.ts';
import { EditorMouseEvent, EditorPointerEventFactory } from '../editorDom.ts';
import { ViewController } from '../view/viewController.ts';
import { ViewContext } from '../../common/viewModel/viewContext.ts';
import { TextAreaSyntethicEvents } from './editContext/textArea/textAreaEditContextInput.ts';
