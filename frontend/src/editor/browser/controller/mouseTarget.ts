...
import { IPointerHandlerHelper } from './mouseHandler.ts';
import { IMouseTargetContentEmptyData, IMouseTargetMarginData, IMouseTarget, IMouseTargetContentEmpty, IMouseTargetContentText, IMouseTargetContentWidget, IMouseTargetMargin, IMouseTargetOutsideEditor, IMouseTargetOverlayWidget, IMouseTargetScrollbar, IMouseTargetTextarea, IMouseTargetUnknown, IMouseTargetViewZone, IMouseTargetContentTextData, IMouseTargetViewZoneData, MouseTargetType } from '../editorBrowser.ts';
import { ClientCoordinates, EditorMouseEvent, EditorPagePosition, PageCoordinates, CoordinatesRelativeToEditor } from '../editorDom.ts';
import { PartFingerprint, PartFingerprints } from '../view/viewPart.ts';
import { ViewLine } from '../viewParts/viewLines/viewLine.ts';
import { IViewCursorRenderData } from '../viewParts/viewCursors/viewCursor.ts';
import { EditorLayoutInfo, EditorOption } from '../../common/config/editorOptions.ts';
import { Position } from '../../common/core/position.ts';
import { Range as EditorRange } from '../../common/core/range.ts';
import { HorizontalPosition } from '../view/renderingContext.ts';
...
import { AtomicTabMoveOperations, Direction } from '../../common/cursor/cursorAtomicMoveOperations.ts';
import { PositionAffinity, TextDirection } from '../../common/model.ts';
...
import type { ViewLinesGpu } from '../viewParts/viewLinesGpu/viewLinesGpu.ts';
