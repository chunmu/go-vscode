...
import { IMouseTarget, IMouseTargetOutsideEditor } from '../editorBrowser.ts';
import { createCoordinatesRelativeToEditor, createEditorPagePosition, EditorMouseEvent, PageCoordinates } from '../editorDom.ts';
import { IPointerHandlerHelper } from './mouseHandler.ts';
import { MouseTarget, MouseTargetFactory } from './mouseTarget.ts';
