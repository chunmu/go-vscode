...
import { IMouseEvent, IMouseWheelEvent } from '../../base/browser/mouseEvent.ts';
...
import { ConfigurationChangedEvent, EditorLayoutInfo, EditorOption, FindComputedEditorOptionValueById, IComputedEditorOptions, IDiffEditorOptions, IEditorOptions, OverviewRulerPosition } from '../common/config/editorOptions.ts';
...
import { ICursorPositionChangedEvent, ICursorSelectionChangedEvent } from '../common/cursorEvents.ts';
...
import { GlyphMarginLane, ICursorStateComputer, IIdentifiedSingleEditOperation, IModelDecoration, IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel, PositionAffinity } from '../common/model.ts';
import { InjectedText } from '../common/modelLineProjectionData.ts';
import { TextModelEditSource } from '../common/textModelEditSource.ts';
...
import { OverviewRulerZone } from '../common/viewModel/overviewZoneManager.ts';
