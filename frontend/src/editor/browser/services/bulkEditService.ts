...
import { TextEdit, WorkspaceEdit, WorkspaceEditMetadata, IWorkspaceFileEdit, WorkspaceFileEditOptions, IWorkspaceTextEdit } from '../../common/languages.ts';
...
import { UndoRedoSource } from '../../../platform/undoRedo/common/undoRedo.ts';
