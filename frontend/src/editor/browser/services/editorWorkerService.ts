...
import { logOnceWebWorkerWarning, IWebWorkerClient, Proxied } from '../../../base/common/worker/webWorker.ts';
...
import { EditorWorker } from '../../common/services/editorWebWorker.ts';
import { DiffAlgorithmName, IEditorWorkerService, ILineChange, IUnicodeHighlightsResult } from '../../common/services/editorWorker.ts';
import { IModelService } from '../../common/services/model.ts';
import { ITextResourceConfigurationService } from '../../common/services/textResourceConfiguration.ts';
import { isNonEmptyArray } from '../../../base/common/arrays.ts';
import { ILogService } from '../../../platform/log/common/log.ts';
import { StopWatch } from '../../../base/common/stopwatch.ts';
import { canceled, onUnexpectedError } from '../../../base/common/errors.ts';
import { UnicodeHighlighterOptions } from '../../common/services/unicodeTextModelHighlighter.ts';
...
import { ILinesDiffComputerOptions, MovedText } from '../../common/diff/linesDiffComputer.ts';
import { DetailedLineRangeMapping, RangeMapping, LineRangeMapping } from '../../common/diff/rangeMapping.ts';
import { LineRange } from '../../common/core/ranges/lineRange.ts';
import { SectionHeader, FindSectionHeaderOptions } from '../../common/services/findSectionHeaders.ts';
import { mainWindow } from '../../../base/browser/window.ts';
import { WindowIntervalTimer } from '../../../base/browser/dom.ts';
import { WorkerTextModelSyncClient } from '../../common/services/textModelSync/textModelSync.impl.ts';
import { EditorWorkerHost } from '../../common/services/editorWorkerHost.ts';
