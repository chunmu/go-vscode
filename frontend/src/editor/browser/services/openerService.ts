...
import { matchesScheme, matchesSomeScheme, Schemas } from '../../../base/common/network.ts';
import { normalizePath } from '../../../base/common/resources.ts';
import { URI } from '../../../base/common/uri.ts';
import { ICodeEditorService } from './codeEditorService.ts';
import { ICommandService } from '../../../platform/commands/common/commands.ts';
import { EditorOpenSource } from '../../../platform/editor/common/editor.ts';
import { extractSelection, IExternalOpener, IExternalUriResolver, IOpener, IOpenerService, IResolvedExternalUri, IValidator, OpenOptions, ResolveExternalUriOptions } from '../../../platform/opener/common/opener.ts';
