...
import { EqualityComparer, strictEquals, BugIndicatingError } from '../commonFacade/deps.ts';
import { IObservable, IObservableWithChange, ISettableObservable } from '../base.ts';
import { subtransaction } from '../transaction.ts';
import { IChangeTracker } from '../changeTracker.ts';
import { DebugNameData, DebugOwner } from '../debugName.ts';
import { DerivedWithSetter, IDerivedReader } from '../observables/derivedImpl.ts';
