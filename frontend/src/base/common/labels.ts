...
import { hasDriveLetter, toSlashes } from './extpath.ts';
import { posix, sep, win32 } from './path.ts';
import { isMacintosh, isWindows, OperatingSystem, OS } from './platform.ts';
import { extUri, extUriIgnorePathCase } from './resources.ts';
import { rtrim, startsWithIgnoreCase } from './strings.ts';
