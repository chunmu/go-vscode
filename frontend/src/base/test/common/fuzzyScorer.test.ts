...
import { compareItemsByFuzzyScore, FuzzyScore, FuzzyScore2, FuzzyScorerCache, IItemAccessor, IItemScore, pieceToQuery, prepareQuery, scoreFuzzy, scoreFuzzy2, scoreItemFuzzy } from '../../common/fuzzyScorer.ts';
import { Schemas } from '../../common/network.ts';
import { basename, dirname, posix, sep, win32 } from '../../common/path.ts';
...
suite('Fuzzy Scorer', () => {
	...
	test('compareFilesByScore - avoid match scattering (bug #34210)', function () {
		...
		let query = isWindows ? 'modu1\\index.js' : 'modu1/index.ts';
		...
		query = isWindows ? 'un1\\index.js' : 'un1/index.ts';
