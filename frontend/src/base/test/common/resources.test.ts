...
import { toSlashes } from '../../common/extpath.ts';
import { posix, win32 } from '../../common/path.ts';
import { isWindows } from '../../common/platform.ts';
import { addTrailingPathSeparator, basename, dirname, distinctParents, extUri, extUriIgnorePathCase, hasTrailingPathSeparator, isAbsolutePath, joinPath, normalizePath, relativePath, removeTrailingPathSeparator, resolvePath } from '../../common/resources.ts';
