...
import { ResourceQueue, timeout } from '../common/async.ts';
import { isEqualOrParent, isRootOrDriveLetter, randomPath } from '../common/extpath.ts';
import { normalizeNFC } from '../common/normalization.ts';
import { basename, dirname, join, normalize, sep } from '../common/path.ts';
import { isLinux, isMacintosh, isWindows } from '../common/platform.ts';
import { extUriBiasedIgnorePathCase } from '../common/resources.ts';
import { URI } from '../common/uri.ts';
import { CancellationToken } from '../common/cancellation.ts';
import { rtrim } from '../common/strings.ts';
