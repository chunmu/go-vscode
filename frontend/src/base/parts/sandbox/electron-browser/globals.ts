...
import { INodeProcess, IProcessEnvironment } from '../../../common/platform.ts';
import { ISandboxConfiguration } from '../common/sandboxTypes.ts';
import { IpcRenderer, ProcessMemoryInfo, WebFrame, WebUtils } from './electronTypes.ts';
