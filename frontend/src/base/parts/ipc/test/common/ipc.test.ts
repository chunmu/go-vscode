...
import { canceled } from '../../../../common/errors.ts';
import { Emitter, Event } from '../../../../common/event.ts';
import { DisposableStore } from '../../../../common/lifecycle.ts';
import { isEqual } from '../../../../common/resources.ts';
import { URI } from '../../../../common/uri.ts';
import { BufferReader, BufferWriter, ClientConnectionEvent, deserialize, IChannel, IMessagePassingProtocol, IPCClient, IPCServer, IServerChannel, ProxyChannel, serialize } from '../../common/ipc.ts';
