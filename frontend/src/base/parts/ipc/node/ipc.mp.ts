...
import { MessagePortMain, isUtilityProcess, MessageEvent } from '../../sandbox/node/electronTypes.ts';
import { VSBuffer } from '../../../common/buffer.ts';
import { ClientConnectionEvent, IMessagePassingProtocol, IPCServer } from '../common/ipc.ts';
