...
import { validatedIpcMain } from '../../ipc/electron-main/ipcMain.ts';
import { CONTEXT_MENU_CHANNEL, CONTEXT_MENU_CLOSE_CHANNEL, IPopupOptions, ISerializableContextMenuItem } from '../common/contextmenu.ts';
