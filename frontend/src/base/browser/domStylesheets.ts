...
import { DisposableStore, toDisposable, IDisposable } from '../common/lifecycle.ts';
import { autorun, IObservable } from '../common/observable.ts';
import { isFirefox } from './browser.ts';
import { getWindows, sharedMutationObserver } from './dom.ts';
