...
import { BrowserFeatures } from './canIUse.ts';
import { hasModifierKeys, IKeyboardEvent, StandardKeyboardEvent } from './keyboardEvent.ts';
import { IMouseEvent, StandardMouseEvent } from './mouseEvent.ts';
import { AbstractIdleValue, IntervalTimer, TimeoutTimer, _runWhenIdle, IdleDeadline } from '../common/async.ts';
import { BugIndicatingError, onUnexpectedError } from '../common/errors.ts';
import * as event from '../common/event.ts';
...
import { RemoteAuthorities } from '../common/network.ts';
import * as platform from '../common/platform.ts';
import { URI } from '../common/uri.ts';
import { hash } from '../common/hash.ts';
import { CodeWindow, ensureCodeWindow, mainWindow } from './window.ts';
import { isPointWithinTriangle } from '../common/numbers.ts';
import { IObservable, derived, derivedOpts, IReader, observableValue } from '../common/observable.ts';
