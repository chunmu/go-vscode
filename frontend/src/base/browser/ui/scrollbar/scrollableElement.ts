...
import { getZoomFactor, isChrome } from '../../browser.ts';
import * as dom from '../../dom.ts';
import { FastDomNode, createFastDomNode } from '../../fastDomNode.ts';
import { IMouseEvent, IMouseWheelEvent, StandardWheelEvent } from '../../mouseEvent.ts';
import { ScrollbarHost } from './abstractScrollbar.ts';
import { HorizontalScrollbar } from './horizontalScrollbar.ts';
import { ScrollableElementChangeOptions, ScrollableElementCreationOptions, ScrollableElementResolvedOptions } from './scrollableElementOptions.ts';
import { VerticalScrollbar } from './verticalScrollbar.ts';
import { Widget } from '../widget.ts';
import { TimeoutTimer } from '../../../common/async.ts';
import { Emitter, Event } from '../../../common/event.ts';
import { IDisposable, dispose } from '../../../common/lifecycle.ts';
import * as platform from '../../../common/platform.ts';
import { INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility } from '../../../common/scrollable.ts';
