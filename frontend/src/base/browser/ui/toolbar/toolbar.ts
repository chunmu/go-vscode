...
import { AnchorAlignment } from '../contextview/contextview.ts';
import { DropdownMenuActionViewItem } from '../dropdown/dropdownActionViewItem.ts';
import { Action, IAction, IActionRunner, Separator, SubmenuAction } from '../../../common/actions.ts';
import { Codicon } from '../../../common/codicons.ts';
import { ThemeIcon } from '../../../common/themables.ts';
import { EventMultiplexer } from '../../../common/event.ts';
import { ResolvedKeybinding } from '../../../common/keybindings.ts';
import { Disposable, DisposableStore, toDisposable } from '../../../common/lifecycle.ts';
import './toolbar.css';
import * as nls from '../../../../nls.ts';
import { IHoverDelegate } from '../hover/hoverDelegate.ts';
import { createInstantHoverDelegate } from '../hover/hoverDelegateFactory.ts';
