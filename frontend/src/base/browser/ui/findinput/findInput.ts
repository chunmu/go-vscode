...
import { IKeyboardEvent } from '../../keyboardEvent.ts';
import { IMouseEvent } from '../../mouseEvent.ts';
import { IToggleStyles, Toggle } from '../toggle/toggle.ts';
import { IContextViewProvider } from '../contextview/contextview.ts';
import { CaseSensitiveToggle, RegexToggle, WholeWordsToggle } from './findInputToggles.ts';
import { HistoryInputBox, IInputBoxStyles, IInputValidator, IMessage as InputBoxMessage } from '../inputbox/inputBox.ts';
import { Widget } from '../widget.ts';
import { Emitter, Event } from '../../../common/event.ts';
import { KeyCode } from '../../../common/keyCodes.ts';
import './findInput.css';
import * as nls from '../../../../nls.ts';
import { DisposableStore, MutableDisposable } from '../../../common/lifecycle.ts';
import { IHistory } from '../../../common/history.ts';
