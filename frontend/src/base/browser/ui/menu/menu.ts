...
import { EventType as TouchEventType, Gesture } from '../../touch.ts';
import { $, addDisposableListener, append, clearNode, Dimension, EventHelper, EventLike, EventType, getActiveElement, getWindow, IDomNodePagePosition, isAncestor, isInShadowDOM } from '../../dom.ts';
import { createStyleSheet } from '../../domStylesheets.ts';
import { StandardKeyboardEvent } from '../../keyboardEvent.ts';
import { StandardMouseEvent } from '../../mouseEvent.ts';
import { ActionBar, ActionsOrientation, IActionViewItemProvider } from '../actionbar/actionbar.ts';
import { ActionViewItem, BaseActionViewItem, IActionViewItemOptions } from '../actionbar/actionViewItems.ts';
import { AnchorAlignment, layout, LayoutAnchorPosition } from '../contextview/contextview.ts';
import { DomScrollableElement } from '../scrollbar/scrollableElement.ts';
import { EmptySubmenuAction, IAction, IActionRunner, Separator, SubmenuAction } from '../../../common/actions.ts';
import { RunOnceScheduler } from '../../../common/async.ts';
import { Codicon } from '../../../common/codicons.ts';
import { getCodiconFontCharacters } from '../../../common/codiconsUtil.ts';
import { ThemeIcon } from '../../../common/themables.ts';
import { Event } from '../../../common/event.ts';
import { stripIcons } from '../../../common/iconLabels.ts';
import { KeyCode } from '../../../common/keyCodes.ts';
import { ResolvedKeybinding } from '../../../common/keybindings.ts';
import { DisposableStore } from '../../../common/lifecycle.ts';
import { isLinux, isMacintosh } from '../../../common/platform.ts';
import { ScrollbarVisibility, ScrollEvent } from '../../../common/scrollable.ts';
import * as strings from '../../../common/strings.ts';
