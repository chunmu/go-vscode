...
import { EventType, Gesture, GestureEvent } from '../../touch.ts';
import { cleanMnemonic, HorizontalDirection, IMenuDirection, IMenuOptions, IMenuStyles, Menu, MENU_ESCAPED_MNEMONIC_REGEX, MENU_MNEMONIC_REGEX, VerticalDirection } from './menu.ts';
import { ActionRunner, IAction, IActionRunner, Separator, SubmenuAction } from '../../../common/actions.ts';
import { asArray } from '../../../common/arrays.ts';
...
import { KeyCode, KeyMod, ScanCode, ScanCodeUtils } from '../../../common/keyCodes.ts';
import { ResolvedKeybinding } from '../../../common/keybindings.ts';
import { Disposable, DisposableStore, dispose, IDisposable } from '../../../common/lifecycle.ts';
import { isMacintosh } from '../../../common/platform.ts';
