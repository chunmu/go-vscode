...
import type { IHoverDelegate } from './hoverDelegate.ts';
import type { HoverPosition } from './hoverWidget.ts';
import type { CancellationToken } from '../../../common/cancellation.ts';
import type { IMarkdownString } from '../../../common/htmlContent.ts';
import type { IDisposable } from '../../../common/lifecycle.ts';
