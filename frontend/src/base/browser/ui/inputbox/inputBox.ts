...
import { renderFormattedText, renderText } from '../../formattedTextRenderer.ts';
import { IHistoryNavigationWidget } from '../../history.ts';
import { ActionBar } from '../actionbar/actionbar.ts';
import * as aria from '../aria/aria.ts';
import { AnchorAlignment, IContextViewProvider } from '../contextview/contextview.ts';
import { getBaseLayerHoverDelegate } from '../hover/hoverDelegate2.ts';
import { ScrollableElement } from '../scrollbar/scrollableElement.ts';
import { Widget } from '../widget.ts';
import { IAction } from '../../../common/actions.ts';
import { Emitter, Event } from '../../../common/event.ts';
import { HistoryNavigator, IHistory } from '../../../common/history.ts';
import { equals } from '../../../common/objects.ts';
import { ScrollbarVisibility } from '../../../common/scrollable.ts';
import './inputBox.css';
import * as nls from '../../../../nls.ts';
import { MutableDisposable, type IDisposable } from '../../../common/lifecycle.ts';
