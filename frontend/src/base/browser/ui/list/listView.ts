...
import { DataTransfers, IDragAndDropData } from '../../dnd.ts';
import { addDisposableListener, animate, Dimension, getActiveElement, getContentHeight, getContentWidth, getDocument, getTopLeftOffset, getWindow, isAncestor, isHTMLElement, isSVGElement, scheduleAtNextAnimationFrame } from '../../dom.ts';
import { DomEmitter } from '../../event.ts';
import { IMouseWheelEvent } from '../../mouseEvent.ts';
import { EventType as TouchEventType, Gesture, GestureEvent } from '../../touch.ts';
import { SmoothScrollableElement } from '../scrollbar/scrollableElement.ts';
import { distinct, equals, splice } from '../../../common/arrays.ts';
import { Delayer, disposableTimeout } from '../../../common/async.ts';
import { memoize } from '../../../common/decorators.ts';
import { Emitter, Event, IValueWithChangeEvent } from '../../../common/event.ts';
import { Disposable, DisposableStore, IDisposable, toDisposable } from '../../../common/lifecycle.ts';
import { IRange, Range } from '../../../common/range.ts';
import { INewScrollDimensions, Scrollable, ScrollbarVisibility, ScrollEvent } from '../../../common/scrollable.ts';
import { ISpliceable } from '../../../common/sequence.ts';
import { IListDragAndDrop, IListDragEvent, IListGestureEvent, IListMouseEvent, IListRenderer, IListTouchEvent, IListVirtualDelegate, ListDragOverEffectPosition, ListDragOverEffectType } from './list.ts';
import { IRangeMap, RangeMap, shift } from './rangeMap.ts';
import { IRow, RowCache } from './rowCache.ts';
import { BugIndicatingError } from '../../../common/errors.ts';
import { AriaRole } from '../aria/aria.ts';
import { ScrollableElementChangeOptions } from '../scrollbar/scrollableElementOptions.ts';
import { clamp } from '../../../common/numbers.ts';
import { applyDragImage } from '../dnd/dnd.ts';
