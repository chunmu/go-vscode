...
import { $, addDisposableListener, append, clearNode, EventHelper, EventType, getWindow, isHTMLElement, trackFocus } from '../../dom.ts';
...
import { IBoundarySashes, Orientation } from '../sash/sash.ts';
import { Color, RGBA } from '../../../common/color.ts';
...
import { IView, Sizing, SplitView } from './splitview.ts';
