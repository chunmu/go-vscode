...
import { $, addDisposableListener, append, getWindow, scheduleAtNextAnimationFrame } from '../../dom.ts';
import { DomEmitter } from '../../event.ts';
import { ISashEvent as IBaseSashEvent, Orientation, Sash, SashState } from '../sash/sash.ts';
import { SmoothScrollableElement } from '../scrollbar/scrollableElement.ts';
import { pushToEnd, pushToStart, range } from '../../../common/arrays.ts';
import { Color } from '../../../common/color.ts';
import { Emitter, Event } from '../../../common/event.ts';
import { combinedDisposable, Disposable, dispose, IDisposable, toDisposable } from '../../../common/lifecycle.ts';
import { clamp } from '../../../common/numbers.ts';
import { Scrollable, ScrollbarVisibility, ScrollEvent } from '../../../common/scrollable.ts';
import * as types from '../../../common/types.ts';
import './splitview.css';
export { Orientation } from '../sash/sash.ts';
