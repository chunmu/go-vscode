...
import { equals, tail } from '../../../common/arrays.ts';
import { Event } from '../../../common/event.ts';
import { Disposable } from '../../../common/lifecycle.ts';
import './gridview.css';
import { Box, GridView, IGridViewOptions, IGridViewStyles, IView as IGridViewView, IViewSize, orthogonal, Sizing as GridViewSizing, GridLocation } from './gridview.ts';
import type { SplitView, AutoSizing as SplitViewAutoSizing } from '../splitview/splitview.ts';

export type { IViewSize };
export { LayoutPriority, Orientation, orthogonal } from './gridview.ts';
